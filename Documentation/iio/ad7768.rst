...
If the enabled channels request more than two distinct pairs, buffer setup
fails and capture does not start.
...
.. list-table::
   ...
   * - ``in_voltage<N>_calibbias``
     - Signed 24-bit two's complement channel offset register value.
