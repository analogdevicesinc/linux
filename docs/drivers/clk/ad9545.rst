.. imported from: https://wiki.analog.com/resources/tools-software/linux-drivers/clk/adi/clk-ad9545/c
...
.. list-table::
   ...
   * - Source
     - Mainlined?
     -
   * - :git-linux:`drivers/clk/adi/clk-ad9545.c`
     - No
     -
   * - :git-linux:`drivers/clk/adi/clk-ad9545-i2c.c`
     - No
     -
   * - :git-linux:`drivers/clk/adi/clk-ad9545-spi.c`
     - No
     -
   * - :git-linux:`drivers/clk/adi/clk-ad9545.h`
     - No
     -
...
- **reg**: Must be either the I2C device address or the SPI device chip select
  number.
...
:git-linux:`dt-bindings <Documentation/devicetree/bindings/clock/clk-ad9545.yaml>`.
...
- `CLOCK Linux Kernel Documentation <https://www.kernel.org/doc/Documentation/clk.txt>`__
