.. imported from: https://wiki.analog.com/resources/tools-software/linux-drivers/iio-adc/ad4030
...
.. note::
   ...
   This is the mainlined driver (ad4030.c).
   An alternative out-of-tree driver is documented at :ref:`ad463x`.
...
- :adi:`EVAL-AD4632-16 <en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/eval-ad4630-16.html>`
- :adi:`EVAL-AD4632-24 <en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/eval-ad4630-24.html>`
- :adi:`EVAL-ADAQ4216-FMCZ <en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/eval-adaq4216-fmcz.html>`
- :adi:`EVAL-ADAQ4224-FMCZ <en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/eval-adaq4224-fmcz.html>`
...
.. list-table::
   ...
   * - Source
     ...
     -
     -
   * - `git <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/adc/ad4030.c>`__
     - `Yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/adc/ad4030.c>`__
     -
     -
...
.. list-table::
   ...
   * - Function
     ...
     -
   * - driver file
     - `drivers/iio/adc/ad4030.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/adc/ad4030.c>`__
     -
   * - devicetree bindings
     - `Documentation/devicetree/bindings/iio/adc/adi,ad4030.yaml <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/devicetree/bindings/iio/adc/adi,ad4030.yaml>`__
     -
   * - documentation
     - `Documentation/iio/ad4030.rst <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/iio/ad4030.rst>`__
     -

Overview
--------

The :adi:`ad4030-24`, :adi:`ad4630-24`, and similar ADCs are low noise, low
power, high speed, 2 MSPS or 500 kSPS SAR ADCs. The digital features include
offset correction, gain adjustment, and averaging, which offload the host
processor. The user can configure the device for one of several output code
formats.
...
.. note::
   ...
   The AD4030 driver depends on **CONFIG_SPI**, **CONFIG_GPIOLIB**,
   **CONFIG_PWM, CONFIG_REGMAP, CONFIG_IIO_BUFFER, CONFIG_IIO_BUFFER_DMA,
   CONFIG_IIO_BUFFER_DMAENGINE, CONFIG_IIO_TRIGGERED_BUFFER**,
   **CONFIG_SPI_OFFLOAD**, and **CONFIG_SPI_OFFLOAD_TRIGGER_PWM**
...
Analog Devices :adi:`ADAQ4003` can be easily managed with
:external+system-level:ref:`iio-oscilloscope` which has interfaces for
configuring and retrieving data from IIO devices. After installing IIO
Oscilloscope in the host computer, open the application and connect to the IIO
context provided by the Kuiper Linux installation running on the ZedBoard.

The example below shows ADAQ4216 running a 125 kSPS data capture of a test sine
wave. 1000 samples were kept for the plot.

.. figure:: https://wiki.analog.com/_media/resources/tools-software/linux-drivers/iio-adc/ad4030/adaq4216_125ksps_capture.png
   :width: 600px

The example below shows the same sine wave but captured at 500 kSPS.

.. figure:: https://wiki.analog.com/_media/resources/tools-software/linux-drivers/iio-adc/ad4030/adaq4216_500ksps_capture.png
   :width: 600px

Finally, at 2 MSPS, we keep a larger number of samples to be able to visualize
the sine wave captured with ADAQ4216.

.. figure:: https://wiki.analog.com/_media/resources/tools-software/linux-drivers/iio-adc/ad4030/adaq4216_2msps_capture.png
   :width: 600px
