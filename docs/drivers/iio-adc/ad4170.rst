.. imported from: https://wiki.analog.com/resources/tools-software/linux-drivers/iio-adc/ad4170
...
**Description:** Channel Ainp29-Ainm24 is configured as unipolar, with a gain of
1 **U** = //in_voltage29-voltage24_raw \* in_voltage29-voltage24_scale -
in_voltage29-voltage24_offset // = 16777216\* 0.000149011 - 0 = **2499.98 mV**
...
The **adi,gpio0-power-down-switch** and **adi,gpio1-power-down-switch**
properties enable the power down switches on GPIO0 and GPIO1 repectively. AC
excitation is controlled via **adi,chop_iexc** and **adi,chop_adc** properties
and can use 2 or 4 gpio pins.
