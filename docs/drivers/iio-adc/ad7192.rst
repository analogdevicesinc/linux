.. imported from: https://wiki.analog.com/resources/tools-software/linux-drivers/iio-adc/ad7192
...
.. list-table::
   ...
   * - Source
     ...
     -
     -
   * - `git <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/staging/iio/adc/ad7192.c>`__
     - `yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/staging/iio/adc/ad7192.c>`__
     -
     -
...
.. list-table::
   ...
   * - Function
     - File
   * - driver
     - `drivers/staging/iio/adc/ad7192.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/staging/iio/adc/ad7192.c>`__
   * - include
     - `drivers/staging/iio/adc/ad7192.h <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/staging/iio/adc/ad7192.h>`__
...
Device tree is the new method for describing non-discoverable hardware in Linux.
This replaces former structure based method. For configuring a device using this
drivers please follow the example bellow:
...
.. important::
   ...
   Interrupt pin connection - interrupts = <25 0x2>; this line means that gpio
   pin 25 is used for the interrupt and it must be connect to the DOUT/RDY pin
   of AD7192 along with the SPI MISO.
...
.. figure:: https://wiki.analog.com/_media/resources/tools-software/linux-drivers/iio-adc/ad7192_eval_lr.jpg
   :width: 600px
...
Setting these directly influences the ADC input range, by altering the GAIN
amplifier.
...
Scale to be applied to in1-in2_raw, in2-in3_raw in order to obtain the measured
voltage in millivolts. Allows the user to select one scale out of the available
scales. If the written scale differs from the current scale. The driver performs
full and zero offset calibration on all differential input channels.
...
**U** = *in_voltage1_raw \* in_voltage_scale* = 3983772\* 0.000393390 =
**1567.17606708 mV**

Show channel in_voltage1-in_voltage2 measurement
''''''''''''''''''''''''''''''''''''''''''''''''

**Description:** Raw unscaled voltage measurement on channel
in_voltage1-in_voltage2
...
**U** = *in_voltage1-in_voltage3_raw \* in_voltage-in_voltage_scale* = -1 \*
0.000393390 = **-0.000393390 mV**
...
**Description:** /sys/bus/iio/devices/iio:deviceX/bridge_switch_en Writing 1
closes the bridge switch.
...
**Description:** /sys/bus/iio/devices/iio:deviceX/ac_excitation_en Writing 1
enables AC excitation on the AD7195 ACX strobes.
