...
.. list-table::
   ...
   * - Source
     - Mainlined?
   * - :git+linux:`ADI tree <2019_R2:drivers/iio/adc/ad738x.c>`
     - `Yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/adc/ad7380.c>`__
...
can be found in the
example :external+hdl:ref:`ad738x_fmc`.
