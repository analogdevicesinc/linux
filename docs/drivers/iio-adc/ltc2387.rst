.. imported from: https://wiki.analog.com/resources/tools-software/linux-drivers/iio-adc/ltc2387
...
.. list-table::
   ...
   * - Source
     - Mainlined?
     -
   * - :git-linux:`git <drivers/iio/adc/ltc2387.c>`
     - [No]
     -
...
.. list-table::
   ...
   * - driver
     ...
     -
   * - devicetree bindings
     - :git-linux:`Documentation/devicetree/bindings/iio/adc/lltc,ltc2387.yaml <Documentation/devicetree/bindings/iio/adc/lltc%2Cltc2387.yaml>`
     -
