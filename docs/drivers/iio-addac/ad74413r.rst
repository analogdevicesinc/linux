.. imported from: https://wiki.analog.com/resources/tools-software/linux-drivers/iio-addac/ad74413r
...
AD74413R/AD74412R Quad-Channel, Software Configurable, Input and Output Circuit
Linux Driver.
...
.. list-table::
   ...
   * - Source
     ...
     -
     -
   * - `git <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/addac/ad74413r.c>`__
     - `Yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/addac/ad74413r.c>`__
     -
     -
...
.. list-table::
   ...
   * - Function
     ...
     -
   * - core driver
     - :git+linux:`ad74413r.c <main:drivers/iio/addac/ad74413r.c>`
     -
   * - Documentation
     - :git+linux:`adi,ad74413r.yaml <main:./Documentation/devicetree/bindings/iio/addac/adi,ad74413r.yaml>`
     -
...
.. list-table::
   ...
   * - Function
     ...
     -
   * - dts
     - :git+linux:`rpi-ad74413r-overlay.dts <rpi-5.15.y:arch/arm/boot/dts/overlays/rpi-ad74413r-overlay.dts>`
     -

Driver testing
--------------

When configured with channel 0 as voltage output, channel 1 as current output,
channel 2 as voltage input and channel 3 as current input, the following
structure is created under the corresponding IIO device.
...
**Description:** Scale to be applied to the raw measurement of current on
channel 0 in order to obtain the actual current.
...
**Description:** Show available sampling frequencies and select one for channel
0.
...
- For example, if we want to capture all input channels, we need to enable the
  scan elements:
