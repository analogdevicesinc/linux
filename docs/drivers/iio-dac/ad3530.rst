...
.. list-table::
   ...
   * - Source
     - Mainlined?
   * - :git+linux:`ADI tree <main:drivers/iio/dac/ad3530r.c>`
     - `Yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/dac/ad3530r.c>`__
...
.. list-table::
   ...
   * - Function
     - Status
   * - `driver <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/dac/ad3530r.c>`_
     - 
   * - `dt-bindings <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/devicetree/bindings/iio/dac/adi,ad3530r.yaml>`_
     - 
