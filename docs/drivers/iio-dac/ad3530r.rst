.. imported from: https://wiki.analog.com/resources/tools-software/linux-drivers/iio-dac/ad3530r
...
.. list-table::
   ...
   * - Function
     - Status
   * - driver
     - :git+linux:`main:drivers/iio/dac/ad3530r.c`
   * - dt-bindings
     - :git+linux:`main:Documentation/devicetree/bindings/iio/dac/adi,ad3530r.yaml`
   * - overlay
     - :git+linux:`rpi-6.6.y:arch/arm/boot/dts/overlays/rpi-ad3530r-overlay.dts`
...
- ``adi,range-double``: Configure the output range for all channels. If the
  property is present, the output will range from 0V to 2Vref. If the property
  is not present, the output will range from 0V to Vref.
...
- :adi:`EVAL-AD3530R` AD3530R Evaluation Board
- Raspberry Pi 4
