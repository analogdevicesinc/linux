.. imported from: https://wiki.analog.com/resources/tools-software/linux-drivers/iio-dac/ad5504
...
AD5504 IIO High Voltage DAC Linux Driver.
...
.. list-table::
   ...
   * - Source
     ...
     -
     -
   * - `git <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/dac/ad5504.c>`__
     - `Yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/dac/ad5504.c>`__
     -
     -
...
.. list-table::
   ...
   * - Function
     - File
   * - driver
     - `drivers/iio/dac/ad5504.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/dac/ad5504.c>`__
   * - include
     - `drivers/iio/dac/ad5504.h <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/dac/ad5504.h>`__
...
Below example specifies a 30 Volt reference for the SPI device 3 on SPI-Bus 0.
(**spi0.3**)
...
.. figure:: https://wiki.analog.com/_media/software/driver/linux/ad5504_eval_lr.jpg
   :width: 600px
...
**U** = *out_voltage0_raw \* out_voltage_scale* = 1234 \* 7.324 = **9037,816
mV**
...
.. list-table::
   ...
   * - 20kohm_to_gnd
     - connected to ground via an 20kOhm resistor
   * - three_state
     - left floating
