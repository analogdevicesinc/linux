...
.. list-table::
   ...
   * - Function
     ...
     -
   * - driver
     - :git+linux:`main:drivers/iio/dac/ad5592r-base.c`
     -
   * - include
     - :git+linux:`main:drivers/iio/dac/ad5592r-base.h`
     -
   * - driver
     - :git+linux:`main:drivers/iio/dac/ad5592r.c`
     -
   * - include
     - :git+linux:`main:include/dt-bindings/iio/adi,ad5592r.h`
     -
   * - Documentation
     - :git+linux:`main:Documentation/devicetree/bindings/iio/dac/ad5592r.txt`
     -
