.. imported from: https://wiki.analog.com/resources/tools-software/linux-drivers/iio-gyroscope/adis16136
...
.. list-table::
   ...
   * - Source
     ...
     -
     -
   * - `git <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/gyro/adis16136.c>`__
     - `Yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/gyro/adis16136.c>`__
     -
     -
...
.. list-table::
   ...
   * - Function
     - File
   * - driver
     - `drivers/iio/gyro/adis16136.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/gyro/adis16136.c>`__
...
.. note::
   ...
   For the adis16133 and adis16135 the trigger will be called adis16133-dev0 and
   adis16135-dev0 respectively.
...
- :dokuwiki:`ADIS1613x Evaluation on the EVAL-ADIS </resources/eval/user-guides/inertial-mems/gyroscopes/adis1613x>`
