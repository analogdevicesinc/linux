.. imported from: https://wiki.analog.com/resources/tools-software/linux-drivers/iio-pll/adrf6780
...
.. list-table::
   ...
   * - Source
     - Mainlined?
   * - :git+linux:`ADI tree <main:drivers/iio/frequency/adrf6780.c>`
     - `Yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/frequency/adrf6780.c>`__
...
.. list-table::
   ...
   * - Function
     - File
   * - driver
     - `adrf6780.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/frequency/adrf6780.c>`_
   * - Documentation
