...
.. list-table::
   ...
   * - Source
     ...
     -
     -
   * - :git-linux:`git <drivers/iio/frequency/adrf6780.c>`
     - `WIP <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/frequency/adrf6780.c>`__
     -
     -
...
.. list-table::
   ...
   * - Function
     ...
     -
   * - driver
     - :git-linux:`drivers/iio/frequency/adrf6780.c`
     -
   * - Documentation
