 ...
 *
 * The SPU is the peripheral firewall of the ADSP-SC59x processors: it
 * write-protects a peripheral's MMR space from selected bus masters and can
 * mark peripherals as secure completers.
 *
...
/*
 * Number of write-protect registers: SPU_WP[n] spans 0x400-0x754, 214 entries.
 */
