...
static const struct cpg_core_clk r9a08g046_core_clks[] __initconst = {
	...
	DEF_MUX_FLAGS(".sel_eth0_tx", CLK_SEL_ETH0_TX, G3L_SEL_ETH0_TX, sel_eth0_tx,
		      CLK_SET_RATE_PARENT),
	...
	DEF_MUX_FLAGS(".sel_eth1_tx", CLK_SEL_ETH1_TX, G3L_SEL_ETH1_TX, sel_eth1_tx,
		      CLK_SET_RATE_PARENT),
	...
	DEF_FIXED(".p4_div2", CLK_P4_DIV2, R9A08G046_CLK_P4, 1, 2),
...
static const struct rzg2l_mod_clk r9a08g046_mod_clks[] = {
	...
	DEF_MOD("rspi2_tclk",		R9A08G046_RSPI2_TCLK, R9A08G046_CLK_P19, 0x590, 10,
					MSTOP(BUS_MCPU2, BIT(0))),
	DEF_MOD("canfd_pclk",		R9A08G046_CANFD_PCLK, CLK_P4_DIV2, 0x594, 0,
