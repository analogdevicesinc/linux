...
KBASE_KTRACE_CODE_MAKE_CODE(CORE_CTX_DESTROY),
	...
	KBASE_KTRACE_CODE_MAKE_CODE(PM_CORES_POWERED_STACK),
	KBASE_KTRACE_CODE_MAKE_CODE(PM_CORES_POWERED_BASE),
	KBASE_KTRACE_CODE_MAKE_CODE(PM_PWRON_NEURAL), KBASE_KTRACE_CODE_MAKE_CODE(PM_PWROFF_NEURAL),
	KBASE_KTRACE_CODE_MAKE_CODE(PM_CORES_POWERED_NEURAL),
...
#undef KBASEP_L2_STATE
	 ...
	 * Arbitration events
	 */
	KBASE_KTRACE_CODE_MAKE_CODE(ARB_VM_STATE), KBASE_KTRACE_CODE_MAKE_CODE(ARB_VM_EVT),
	KBASE_KTRACE_CODE_MAKE_CODE(ARB_GPU_GRANTED), KBASE_KTRACE_CODE_MAKE_CODE(ARB_GPU_LOST),
