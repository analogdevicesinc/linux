 ...
 */
#define BASEP_MEM_DONT_NEED ((base_mem_alloc_flags)1 << 59)

/* Allocation is actively used for JIT memory */
#define BASEP_MEM_ACTIVE_JIT_ALLOC ((base_mem_alloc_flags)1 << 58)
 ...
 */
#define BASEP_MEM_FIRST_FREE_FLAG ((base_mem_alloc_flags)1 << 57)
