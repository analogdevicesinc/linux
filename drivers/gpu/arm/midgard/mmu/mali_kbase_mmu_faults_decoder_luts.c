...
static struct decode_lut_element lut_fault_source_core_type_t_name_major_13[] = {
	{ 0xFFFF, 0, "shader" }, { 0xFFFF, 1, "l2c" }, { 0xFFFF, 2, "tiler" },
	{ 0xFFFF, 3, "mmu" },	 { 0xFFFF, 4, "csf" }, { 0xFFFF, 5, "memsys" },
};

static struct decode_lut_element lut_fault_source_core_type_t_desc_major_13[] = {
	{ 0xFFFF, 0, "Shader core" }, { 0xFFFF, 1, "Level 2 cache" },
	{ 0xFFFF, 2, "Tiler" },	      { 0xFFFF, 3, "MMU" },
	{ 0xFFFF, 4, "CSF" },	      { 0xFFFF, 5, "Memory system" },
};

static struct decode_lut_element lut_fault_source_core_type_t_name_major_14[] = {
	{ 0xFFFF, 0, "shader" }, { 0xFFFF, 1, "l2c" }, { 0xFFFF, 2, "tiler" },
	{ 0xFFFF, 3, "mmu" },	 { 0xFFFF, 4, "csf" }, { 0xFFFF, 5, "memsys" },
};

static struct decode_lut_element lut_fault_source_core_type_t_desc_major_14[] = {
	{ 0xFFFF, 0, "Shader core" }, { 0xFFFF, 1, "Level 2 cache" },
	{ 0xFFFF, 2, "Tiler" },	      { 0xFFFF, 3, "MMU" },
	{ 0xFFFF, 4, "CSF" },	      { 0xFFFF, 5, "Memory system" },
};
...
static struct decode_lut_element lut_fault_source_core_id_t_desc_major_13[] = {
	{ 0xFFFF, 0, "Shader core 0" },
	{ 0xFFFF, 1, "Shader core 1" },
	{ 0xFFFF, 2, "Shader core 2" },
	{ 0xFFFF, 3, "Shader core 3" },
...
static struct decode_lut_element lut_fault_source_core_id_t_core_type_major_13[] = {
	{ 0xFFFF, 0, "shader" },  { 0xFFFF, 1, "shader" },  { 0xFFFF, 2, "shader" },
	{ 0xFFFF, 3, "shader" },  { 0xFFFF, 4, "shader" },  { 0xFFFF, 5, "shader" },
	{ 0xFFFF, 6, "shader" },  { 0xFFFF, 7, "shader" },  { 0xFFFF, 8, "shader" },
	{ 0xFFFF, 9, "shader" },  { 0xFFFF, 10, "shader" }, { 0xFFFF, 11, "shader" },
...
static struct decode_lut_element lut_fault_source_shader_r_t_major_13[] = {
	{ 0xFFFF, 4, "scm" },	{ 0xFFFF, 6, "plr" },	{ 0xFFFF, 7, "fsdc" },
	{ 0xFFFF, 8, "lsc" },	{ 0xFFFF, 9, "cse" },	{ 0xFFFF, 10, "tb" },
	{ 0xFFFF, 11, "tmdi" }, { 0xFFFF, 12, "tmu0" }, { 0xFFFF, 13, "tmu1" },
	{ 0xFFFF, 14, "tma0" }, { 0xFFFF, 15, "tma1" }, { 0xFFFF, 0, "ic0" },
	{ 0xFFFF, 1, "ic1" },	{ 0xFFFF, 2, "adc" },
};
...
static struct decode_lut_element lut_fault_source_shader_w_t_major_13[] = {
	{ 0xFFFF, 0, "pcb" },  { 0xFFFF, 8, "lsc" },  { 0xFFFF, 12, "tb0" },
	{ 0xFFFF, 13, "tb1" }, { 0xFFFF, 14, "tb2" }, { 0xFFFF, 15, "tb3" },
};
...
static struct decode_lut_element lut_fault_source_tiler_r_t_major_13[] = {
	{ 0xFFFF, 0, "pf" },
	{ 0xFFFF, 1, "pcache" },
	{ 0xFFFF, 2, "tcu" },
	{ 0xFFFF, 3, "idx" },
...
static struct decode_lut_element lut_fault_source_tiler_r_t_major_14[] = {
	{ 0xFFFF, 0, "pf" },
	{ 0xFFFF, 1, "pcache" },
	{ 0xFFFF, 2, "tcu" },
	{ 0xFFFF, 3, "idx" },
...
static struct decode_lut_element lut_fault_source_tiler_w_t_major_13[] = {
	{ 0xFFFF, 1, "pcache_wb" },
	{ 0xFFFF, 2, "tcu_pcb" },
};

static struct decode_lut_element lut_fault_source_tiler_w_t_major_14[] = {
	{ 0xFFFF, 1, "pcache_wb" },
	{ 0xFFFF, 2, "tcu_pcb" },
	{ 0xFFFF, 16, "plw" },
};
...
const char *decode_fault_source_core_type_t_name(u16 idx, u32 gpu_id)
{
	...
	case 13:
		ret = decode_lut_element_lookup(min_rev, idx,
						lut_fault_source_core_type_t_name_major_13,
						NELEMS(lut_fault_source_core_type_t_name_major_13));
		break;
	case 14:
		ret = decode_lut_element_lookup(min_rev, idx,
...
const char *decode_fault_source_core_type_t_desc(u16 idx, u32 gpu_id)
{
	...
	case 13:
		ret = decode_lut_element_lookup(min_rev, idx,
						lut_fault_source_core_type_t_desc_major_13,
						NELEMS(lut_fault_source_core_type_t_desc_major_13));
		break;
	case 14:
		ret = decode_lut_element_lookup(min_rev, idx,
...
const char *decode_fault_source_core_id_t_desc(u16 idx, u32 gpu_id)
{
	...
	case 13:
		ret = decode_lut_element_lookup(min_rev, idx,
						lut_fault_source_core_id_t_desc_major_13,
						NELEMS(lut_fault_source_core_id_t_desc_major_13));
		break;
	}
	return ret;
}
...
const char *decode_fault_source_core_id_t_core_type(u16 idx, u32 gpu_id)
{
	...
	case 13:
		ret = decode_lut_element_lookup(
			min_rev, idx, lut_fault_source_core_id_t_core_type_major_13,
			NELEMS(lut_fault_source_core_id_t_core_type_major_13));
		break;
	}
	return ret;
}
...
const char *decode_fault_source_shader_r_t(u16 idx, u32 gpu_id)
{
	...
	case 12:
		...
		break;
	case 13:
		ret = decode_lut_element_lookup(min_rev, idx, lut_fault_source_shader_r_t_major_13,
						NELEMS(lut_fault_source_shader_r_t_major_13));
		break;
	case 14:
...
const char *decode_fault_source_shader_w_t(u16 idx, u32 gpu_id)
{
	...
	case 12:
		...
		break;
	case 13:
		ret = decode_lut_element_lookup(min_rev, idx, lut_fault_source_shader_w_t_major_13,
						NELEMS(lut_fault_source_shader_w_t_major_13));
		break;
	case 14:
...
const char *decode_fault_source_tiler_r_t(u16 idx, u32 gpu_id)
{
	...
	case 12:
		...
		break;
	case 13:
		ret = decode_lut_element_lookup(min_rev, idx, lut_fault_source_tiler_r_t_major_13,
						NELEMS(lut_fault_source_tiler_r_t_major_13));
		break;
	case 14:
...
const char *decode_fault_source_tiler_w_t(u16 idx, u32 gpu_id)
{
	...
	case 12:
		...
		break;
	case 13:
		ret = decode_lut_element_lookup(min_rev, idx, lut_fault_source_tiler_w_t_major_13,
						NELEMS(lut_fault_source_tiler_w_t_major_13));
		break;
	case 14:
