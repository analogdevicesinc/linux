...
int ltc4296_port_prebias(struct ltc4296_state *st, enum ltc4296_port port_no,
...
int ltc4296_port_en(struct ltc4296_state *st, enum ltc4296_port port_no)
{
	int ret;
	u8 port_addr = 0;
...
int ltc4296_init(struct ltc4296_state *st)
{
	int ret;
	u16 value;
