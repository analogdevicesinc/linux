...
enum chips { adpm12160, max34440, max34441, max34446, max34451, max34460, max34461 };
 ...
 * ADPM12160 has both commands in correct addresses.
 */
#define MAX34440_IOUT_OC_WARN_LIMIT	0x46
#define MAX34440_IOUT_OC_FAULT_LIMIT	0x4A

#define ADPM12160_IOUT_OC_FAULT_LIMIT	0x46
#define ADPM12160_IOUT_OC_WARN_LIMIT	0x4A
				   ...
				   int phase, int reg)
{
	...
	case PMBUS_IOUT_OC_FAULT_LIMIT:
		if (data->id != adpm12160)
			ret = pmbus_read_word_data(client, page, phase,
						   MAX34440_IOUT_OC_FAULT_LIMIT);
		else
			ret = pmbus_read_word_data(client, page, phase,
						   ADPM12160_IOUT_OC_FAULT_LIMIT);
		break;
				    ...
				    int reg, u16 word)
{
	...
	case PMBUS_IOUT_OC_FAULT_LIMIT:
		if (data->id != adpm12160)
			...
			ret = pmbus_write_word_data(client, page, ADPM12160_IOUT_OC_FAULT_LIMIT,
						    word);
		break;
	case PMBUS_IOUT_OC_WARN_LIMIT:
		if (data->id != adpm12160)
			...
			ret = pmbus_write_word_data(client, page, ADPM12160_IOUT_OC_WARN_LIMIT,
						    word);
		break;
	case PMBUS_VIRT_RESET_POUT_HISTORY:
