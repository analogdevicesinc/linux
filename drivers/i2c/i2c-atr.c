			...
			struct fwnode_handle *bus_handle)
{
	...
	if (bus_handle) {
		struct fwnode_handle *fwnode = fwnode_handle_get(bus_handle);
		chan->adap.dev.fwnode = fwnode;
		chan->adap.dev.of_node = to_of_node(fwnode);
	} else {
		...
		chan->adap.dev.fwnode = child;
		chan->adap.dev.of_node = to_of_node(child);
