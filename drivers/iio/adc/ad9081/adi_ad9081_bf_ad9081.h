...
#define BF_CH_INTERP_MODE_INFO 0x00000400
#define BF_CH_INTERP_MODE(val) (val & 0x0000000F)
#define BF_CH_INTERP_MODE_GET(val) (val & 0x0000000F)
#define BF_DP_INTERP_MODE_INFO 0x00000404
#define BF_DP_INTERP_MODE(val) ((val & 0x0000000F) << 0x00000004)
#define BF_DP_INTERP_MODE_GET(val) ((val >> 0x00000004) & 0x0000000F)
...
#define BF_DELAY_RANGE_INFO 0x00000500
#define BF_DELAY_RANGE(val) (val & 0x0000001F)
#define BF_DELAY_RANGE_GET(val) (val & 0x0000001F)
#define BF_SLEW_RATE_ENABLE_INFO 0x00000107
#define BF_SLEW_RATE_ENABLE(val) ((val & 0x00000001) << 0x00000007)
#define BF_SLEW_RATE_ENABLE_GET(val) ((val >> 0x00000007) & 0x00000001)

#define REG_SLEW_RATE_THRESHOLD0_ADDR 0x00000326
#define BF_SLEW_RATE_THRESHOLD_INFO 0x00001B00
#define BF_SLEW_RATE_THRESHOLD(val) (val & 0x07FFFFFF)
#define BF_SLEW_RATE_THRESHOLD_GET(val) (val & 0x07FFFFFF)

#define REG_SLEW_RATE_THRESHOLD1_ADDR 0x00000327

#define REG_SLEW_RATE_THRESHOLD2_ADDR 0x00000328

#define REG_SLEW_RATE_THRESHOLD3_ADDR 0x00000329

#define REG_SLEW_RATE_DATA0_ADDR 0x0000032A
#define BF_SLEW_RATE_DATA_INFO 0x00001B00
#define BF_SLEW_RATE_DATA(val) (val & 0x07FFFFFF)
#define BF_SLEW_RATE_DATA_GET(val) (val & 0x07FFFFFF)

#define REG_SLEW_RATE_DATA1_ADDR 0x0000032B

#define REG_SLEW_RATE_DATA2_ADDR 0x0000032C

#define REG_SLEW_RATE_DATA3_ADDR 0x0000032D
...
#define BF_JRX_LINK_LANE_SEL_0_INFO 0x00000500
#define BF_JRX_LINK_LANE_SEL_0(val) (val & 0x0000001F)
#define BF_JRX_LINK_LANE_SEL_0_GET(val) (val & 0x0000001F)
...
#define BF_JRX_LINK_LANE_SEL_1_INFO 0x00000500
#define BF_JRX_LINK_LANE_SEL_1(val) (val & 0x0000001F)
#define BF_JRX_LINK_LANE_SEL_1_GET(val) (val & 0x0000001F)
...
#define BF_JRX_LINK_LANE_SEL_2_INFO 0x00000500
#define BF_JRX_LINK_LANE_SEL_2(val) (val & 0x0000001F)
#define BF_JRX_LINK_LANE_SEL_2_GET(val) (val & 0x0000001F)
...
#define BF_JRX_LINK_LANE_SEL_3_INFO 0x00000500
#define BF_JRX_LINK_LANE_SEL_3(val) (val & 0x0000001F)
#define BF_JRX_LINK_LANE_SEL_3_GET(val) (val & 0x0000001F)
...
#define BF_JRX_LINK_LANE_SEL_4_INFO 0x00000500
#define BF_JRX_LINK_LANE_SEL_4(val) (val & 0x0000001F)
#define BF_JRX_LINK_LANE_SEL_4_GET(val) (val & 0x0000001F)
...
#define BF_JRX_LINK_LANE_SEL_5_INFO 0x00000500
#define BF_JRX_LINK_LANE_SEL_5(val) (val & 0x0000001F)
#define BF_JRX_LINK_LANE_SEL_5_GET(val) (val & 0x0000001F)
...
#define BF_JRX_LINK_LANE_SEL_6_INFO 0x00000500
#define BF_JRX_LINK_LANE_SEL_6(val) (val & 0x0000001F)
#define BF_JRX_LINK_LANE_SEL_6_GET(val) (val & 0x0000001F)
...
#define BF_JRX_LINK_LANE_SEL_7_INFO 0x00000500
#define BF_JRX_LINK_LANE_SEL_7(val) (val & 0x0000001F)
#define BF_JRX_LINK_LANE_SEL_7_GET(val) (val & 0x0000001F)
...
#define BF_JRX_204C_CRC_IRQ_ENABLE(val) (val & 0x00000001)
#define BF_JRX_204C_CRC_IRQ_ENABLE_GET(val) (val & 0x00000001)
#define BF_JRX_204C_MB_IRQ_ENABLE_INFO 0x00000101
#define BF_JRX_204C_MB_IRQ_ENABLE(val) ((val & 0x00000001) << 0x00000001)
#define BF_JRX_204C_MB_IRQ_ENABLE_GET(val) ((val >> 0x00000001) & 0x00000001)
#define BF_JRX_204C_SH_IRQ_ENABLE_INFO 0x00000102
#define BF_JRX_204C_SH_IRQ_ENABLE(val) ((val & 0x00000001) << 0x00000002)
#define BF_JRX_204C_SH_IRQ_ENABLE_GET(val) ((val >> 0x00000002) & 0x00000001)
#define BF_JRX_204C_CRC_IRQ_INFO 0x00000103
#define BF_JRX_204C_CRC_IRQ(val) ((val & 0x00000001) << 0x00000003)
#define BF_JRX_204C_CRC_IRQ_GET(val) ((val >> 0x00000003) & 0x00000001)
#define BF_JRX_204C_MB_IRQ_INFO 0x00000104
#define BF_JRX_204C_MB_IRQ(val) ((val & 0x00000001) << 0x00000004)
#define BF_JRX_204C_MB_IRQ_GET(val) ((val >> 0x00000004) & 0x00000001)
#define BF_JRX_204C_SH_IRQ_INFO 0x00000105
#define BF_JRX_204C_SH_IRQ(val) ((val & 0x00000001) << 0x00000005)
#define BF_JRX_204C_SH_IRQ_GET(val) ((val >> 0x00000005) & 0x00000001)
