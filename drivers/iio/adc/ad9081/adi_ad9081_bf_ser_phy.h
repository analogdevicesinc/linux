...
#define REG_JTX_SWING5_ADDR 0x00000756
#define BF_DRVSWING_CH8_SER_RC_INFO 0x00000300
#define BF_DRVSWING_CH8_SER_RC(val) (val & 0x00000007)
#define BF_DRVSWING_CH8_SER_RC_GET(val) (val & 0x00000007)
#define BF_DRVSWING_CH9_SER_RC_INFO 0x00000304
#define BF_DRVSWING_CH9_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_DRVSWING_CH9_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)

#define REG_JTX_SWING6_ADDR 0x00000757
#define BF_DRVSWING_CH10_SER_RC_INFO 0x00000300
#define BF_DRVSWING_CH10_SER_RC(val) (val & 0x00000007)
#define BF_DRVSWING_CH10_SER_RC_GET(val) (val & 0x00000007)
#define BF_DRVSWING_CH11_SER_RC_INFO 0x00000304
#define BF_DRVSWING_CH11_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_DRVSWING_CH11_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)

#define REG_JTX_SWING7_ADDR 0x00000758
#define BF_DRVSWING_CH12_SER_RC_INFO 0x00000300
#define BF_DRVSWING_CH12_SER_RC(val) (val & 0x00000007)
#define BF_DRVSWING_CH12_SER_RC_GET(val) (val & 0x00000007)
#define BF_DRVSWING_CH13_SER_RC_INFO 0x00000304
#define BF_DRVSWING_CH13_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_DRVSWING_CH13_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)

#define REG_JTX_SWING8_ADDR 0x00000759
#define BF_DRVSWING_CH14_SER_RC_INFO 0x00000300
#define BF_DRVSWING_CH14_SER_RC(val) (val & 0x00000007)
#define BF_DRVSWING_CH14_SER_RC_GET(val) (val & 0x00000007)
#define BF_DRVSWING_CH15_SER_RC_INFO 0x00000304
#define BF_DRVSWING_CH15_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_DRVSWING_CH15_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)
...
#define REG_POST_TAP_LEVEL5_ADDR 0x0000075E
#define BF_DRVPOSTEM_CH8_SER_RC_INFO 0x00000300
#define BF_DRVPOSTEM_CH8_SER_RC(val) (val & 0x00000007)
#define BF_DRVPOSTEM_CH8_SER_RC_GET(val) (val & 0x00000007)
#define BF_DRVPOSTEM_CH9_SER_RC_INFO 0x00000304
#define BF_DRVPOSTEM_CH9_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_DRVPOSTEM_CH9_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)

#define REG_POST_TAP_LEVEL6_ADDR 0x0000075F
#define BF_DRVPOSTEM_CH10_SER_RC_INFO 0x00000300
#define BF_DRVPOSTEM_CH10_SER_RC(val) (val & 0x00000007)
#define BF_DRVPOSTEM_CH10_SER_RC_GET(val) (val & 0x00000007)
#define BF_DRVPOSTEM_CH11_SER_RC_INFO 0x00000304
#define BF_DRVPOSTEM_CH11_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_DRVPOSTEM_CH11_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)

#define REG_POST_TAP_LEVEL7_ADDR 0x00000760
#define BF_DRVPOSTEM_CH12_SER_RC_INFO 0x00000300
#define BF_DRVPOSTEM_CH12_SER_RC(val) (val & 0x00000007)
#define BF_DRVPOSTEM_CH12_SER_RC_GET(val) (val & 0x00000007)
#define BF_DRVPOSTEM_CH13_SER_RC_INFO 0x00000304
#define BF_DRVPOSTEM_CH13_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_DRVPOSTEM_CH13_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)

#define REG_POST_TAP_LEVEL8_ADDR 0x00000761
#define BF_DRVPOSTEM_CH14_SER_RC_INFO 0x00000300
#define BF_DRVPOSTEM_CH14_SER_RC(val) (val & 0x00000007)
#define BF_DRVPOSTEM_CH14_SER_RC_GET(val) (val & 0x00000007)
#define BF_DRVPOSTEM_CH15_SER_RC_INFO 0x00000304
#define BF_DRVPOSTEM_CH15_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_DRVPOSTEM_CH15_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)
...
#define REG_PRE_TAP_LEVEL_CH8_ADDR 0x0000076B
#define BF_DRVPREEM_CH8_SER_RC_INFO 0x00000800
#define BF_DRVPREEM_CH8_SER_RC(val) (val & 0x000000FF)
#define BF_DRVPREEM_CH8_SER_RC_GET(val) (val & 0x000000FF)

#define REG_PRE_TAP_LEVEL_CH9_ADDR 0x0000076C
#define BF_DRVPREEM_CH9_SER_RC_INFO 0x00000800
#define BF_DRVPREEM_CH9_SER_RC(val) (val & 0x000000FF)
#define BF_DRVPREEM_CH9_SER_RC_GET(val) (val & 0x000000FF)

#define REG_PRE_TAP_LEVEL_CH10_ADDR 0x0000076D
#define BF_DRVPREEM_CH10_SER_RC_INFO 0x00000800
#define BF_DRVPREEM_CH10_SER_RC(val) (val & 0x000000FF)
#define BF_DRVPREEM_CH10_SER_RC_GET(val) (val & 0x000000FF)

#define REG_PRE_TAP_LEVEL_CH11_ADDR 0x0000076E
#define BF_DRVPREEM_CH11_SER_RC_INFO 0x00000800
#define BF_DRVPREEM_CH11_SER_RC(val) (val & 0x000000FF)
#define BF_DRVPREEM_CH11_SER_RC_GET(val) (val & 0x000000FF)

#define REG_PRE_TAP_LEVEL_CH12_ADDR 0x0000076F
#define BF_DRVPREEM_CH12_SER_RC_INFO 0x00000800
#define BF_DRVPREEM_CH12_SER_RC(val) (val & 0x000000FF)
#define BF_DRVPREEM_CH12_SER_RC_GET(val) (val & 0x000000FF)

#define REG_PRE_TAP_LEVEL_CH13_ADDR 0x00000770
#define BF_DRVPREEM_CH13_SER_RC_INFO 0x00000800
#define BF_DRVPREEM_CH13_SER_RC(val) (val & 0x000000FF)
#define BF_DRVPREEM_CH13_SER_RC_GET(val) (val & 0x000000FF)

#define REG_PRE_TAP_LEVEL_CH14_ADDR 0x00000771
#define BF_DRVPREEM_CH14_SER_RC_INFO 0x00000800
#define BF_DRVPREEM_CH14_SER_RC(val) (val & 0x000000FF)
#define BF_DRVPREEM_CH14_SER_RC_GET(val) (val & 0x000000FF)

#define REG_PRE_TAP_LEVEL_CH15_ADDR 0x00000772
#define BF_DRVPREEM_CH15_SER_RC_INFO 0x00000800
#define BF_DRVPREEM_CH15_SER_RC(val) (val & 0x000000FF)
#define BF_DRVPREEM_CH15_SER_RC_GET(val) (val & 0x000000FF)
...
#define REG_CLK_OFFSET5_ADDR 0x0000077D
#define BF_CLKOFFSET_CH8_SER_RC_INFO 0x00000300
#define BF_CLKOFFSET_CH8_SER_RC(val) (val & 0x00000007)
#define BF_CLKOFFSET_CH8_SER_RC_GET(val) (val & 0x00000007)
#define BF_CLKOFFSET_CH9_SER_RC_INFO 0x00000304
#define BF_CLKOFFSET_CH9_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_CLKOFFSET_CH9_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)

#define REG_CLK_OFFSET6_ADDR 0x0000077E
#define BF_CLKOFFSET_CH10_SER_RC_INFO 0x00000300
#define BF_CLKOFFSET_CH10_SER_RC(val) (val & 0x00000007)
#define BF_CLKOFFSET_CH10_SER_RC_GET(val) (val & 0x00000007)
#define BF_CLKOFFSET_CH11_SER_RC_INFO 0x00000304
#define BF_CLKOFFSET_CH11_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_CLKOFFSET_CH11_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)

#define REG_CLK_OFFSET7_ADDR 0x0000077F
#define BF_CLKOFFSET_CH12_SER_RC_INFO 0x00000300
#define BF_CLKOFFSET_CH12_SER_RC(val) (val & 0x00000007)
#define BF_CLKOFFSET_CH12_SER_RC_GET(val) (val & 0x00000007)
#define BF_CLKOFFSET_CH13_SER_RC_INFO 0x00000304
#define BF_CLKOFFSET_CH13_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_CLKOFFSET_CH13_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)

#define REG_CLK_OFFSET8_ADDR 0x00000780
#define BF_CLKOFFSET_CH14_SER_RC_INFO 0x00000300
#define BF_CLKOFFSET_CH14_SER_RC(val) (val & 0x00000007)
#define BF_CLKOFFSET_CH14_SER_RC_GET(val) (val & 0x00000007)
#define BF_CLKOFFSET_CH15_SER_RC_INFO 0x00000304
#define BF_CLKOFFSET_CH15_SER_RC(val) ((val & 0x00000007) << 0x00000004)
#define BF_CLKOFFSET_CH15_SER_RC_GET(val) ((val >> 0x00000004) & 0x00000007)
...
#define BF_EN_DRVSLICEOFFSET_CH89_SER_RC_INFO 0x00000104
#define BF_EN_DRVSLICEOFFSET_CH89_SER_RC(val) ((val & 0x00000001) << 0x00000004)
#define BF_EN_DRVSLICEOFFSET_CH89_SER_RC_GET(val)                              \
	((val >> 0x00000004) & 0x00000001)
#define BF_EN_DRVSLICEOFFSET_CH1011_SER_RC_INFO 0x00000105
#define BF_EN_DRVSLICEOFFSET_CH1011_SER_RC(val)                                \
	((val & 0x00000001) << 0x00000005)
#define BF_EN_DRVSLICEOFFSET_CH1011_SER_RC_GET(val)                            \
	((val >> 0x00000005) & 0x00000001)
#define BF_EN_DRVSLICEOFFSET_CH1213_SER_RC_INFO 0x00000106
#define BF_EN_DRVSLICEOFFSET_CH1213_SER_RC(val)                                \
	((val & 0x00000001) << 0x00000006)
#define BF_EN_DRVSLICEOFFSET_CH1213_SER_RC_GET(val)                            \
	((val >> 0x00000006) & 0x00000001)
#define BF_EN_DRVSLICEOFFSET_CH1415_SER_RC_INFO 0x00000107
#define BF_EN_DRVSLICEOFFSET_CH1415_SER_RC(val)                                \
	((val & 0x00000001) << 0x00000007)
#define BF_EN_DRVSLICEOFFSET_CH1415_SER_RC_GET(val)                            \
...
#define REG_MAIN_DATA_INV2_ADDR 0x0000078A
#define BF_OUTPUTDATAINVERT_CH8_SER_RC_INFO 0x00000100
#define BF_OUTPUTDATAINVERT_CH8_SER_RC(val) (val & 0x00000001)
#define BF_OUTPUTDATAINVERT_CH8_SER_RC_GET(val) (val & 0x00000001)
#define BF_OUTPUTDATAINVERT_CH9_SER_RC_INFO 0x00000101
#define BF_OUTPUTDATAINVERT_CH9_SER_RC(val) ((val & 0x00000001) << 0x00000001)
#define BF_OUTPUTDATAINVERT_CH9_SER_RC_GET(val)                                \
	((val >> 0x00000001) & 0x00000001)
#define BF_OUTPUTDATAINVERT_CH10_SER_RC_INFO 0x00000102
#define BF_OUTPUTDATAINVERT_CH10_SER_RC(val) ((val & 0x00000001) << 0x00000002)
#define BF_OUTPUTDATAINVERT_CH10_SER_RC_GET(val)                               \
	((val >> 0x00000002) & 0x00000001)
#define BF_OUTPUTDATAINVERT_CH11_SER_RC_INFO 0x00000103
#define BF_OUTPUTDATAINVERT_CH11_SER_RC(val) ((val & 0x00000001) << 0x00000003)
#define BF_OUTPUTDATAINVERT_CH11_SER_RC_GET(val)                               \
	((val >> 0x00000003) & 0x00000001)
#define BF_OUTPUTDATAINVERT_CH12_SER_RC_INFO 0x00000104
#define BF_OUTPUTDATAINVERT_CH12_SER_RC(val) ((val & 0x00000001) << 0x00000004)
#define BF_OUTPUTDATAINVERT_CH12_SER_RC_GET(val)                               \
	((val >> 0x00000004) & 0x00000001)
#define BF_OUTPUTDATAINVERT_CH13_SER_RC_INFO 0x00000105
#define BF_OUTPUTDATAINVERT_CH13_SER_RC(val) ((val & 0x00000001) << 0x00000005)
#define BF_OUTPUTDATAINVERT_CH13_SER_RC_GET(val)                               \
	((val >> 0x00000005) & 0x00000001)
#define BF_OUTPUTDATAINVERT_CH14_SER_RC_INFO 0x00000106
#define BF_OUTPUTDATAINVERT_CH14_SER_RC(val) ((val & 0x00000001) << 0x00000006)
#define BF_OUTPUTDATAINVERT_CH14_SER_RC_GET(val)                               \
	((val >> 0x00000006) & 0x00000001)
#define BF_OUTPUTDATAINVERT_CH15_SER_RC_INFO 0x00000107
#define BF_OUTPUTDATAINVERT_CH15_SER_RC(val) ((val & 0x00000001) << 0x00000007)
#define BF_OUTPUTDATAINVERT_CH15_SER_RC_GET(val)                               \
	((val >> 0x00000007) & 0x00000001)
