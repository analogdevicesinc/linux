...
#define ENSM_CONFIG_1_EN_RX_DATAPORT_CAL	(1 << 7)
#define ENSM_CONFIG_1_FORCE_RX_ON	(1 << 6)
#define ENSM_CONFIG_1_FORCE_TX_ON	(1 << 5)
#define ENSM_CONFIG_1_ENSM_PINCTRL_EN	(1 << 4)
#define ENSM_CONFIG_1_LEVEL_MODE		(1 << 3)
#define ENSM_CONFIG_1_FORCE_ALERT	(1 << 2)
#define ENSM_CONFIG_1_AUTO_GAIN_LOCK	(1 << 1)
#define ENSM_CONFIG_1_TO_ALERT		(1 << 0)

#define ENSM_CONFIG_2			0x015
#define ENSM_CONFIG_2_FDD_EXT_CTRL	(1 << 7)
#define ENSM_CONFIG_2_PD_RX_SYNTH	(1 << 6)
#define ENSM_CONFIG_2_PD_TX_SYNTH	(1 << 5)
#define ENSM_CONFIG_2_TXNRX_SPI_CTRL	(1 << 4)
#define ENSM_CONFIG_2_SYNTH_EN_PIN_CTRL	(1 << 3)
#define ENSM_CONFIG_2_DUAL_SYNTH_MODE	(1 << 2)
