...
static const struct axiadc_chip_info axiadc_chip_info_tbl[] = {
	...
	.max_rate = 1000000UL,
	.num_channels = 4,
	.channel[0] = AIM_CHAN_NOCALIB(0, 0, 16, 'u'),
	.channel[1] = AIM_CHAN_NOCALIB(1, 1, 16, 'u'),
	.channel[2] = AIM_CHAN_NOCALIB(2, 2, 16, 'u'),
	.channel[3] = AIM_CHAN_NOCALIB(3, 3, 16, 'u'),
	},
};
...
static int axiadc_of_probe(struct platform_device *op)
{
	...
	conv->chip_info = &axiadc_chip_info_tbl[ID_AD_MC_ADC];
	...
	axiadc_configure_ring(indio_dev, "ad-mc-adc-dma");
	...
	*indio_dev->buffer->scan_mask =
	...
	dev_info(dev, "ADI AIM (0x%X) at 0x%08llX mapped to 0x%p, probed ADC %s as %s\n",
		 st->pcore_version,
		 (unsigned long long)phys_addr, st->regs, conv->chip_info->name,
