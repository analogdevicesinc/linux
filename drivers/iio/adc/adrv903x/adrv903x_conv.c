...
static const struct axiadc_chip_info adrv9032_axi_chip_info = {
	.name = "ADRV903X",
	.max_rate = 245760000,
	.max_testmode = 0,
	.num_channels = 16,
...
static const struct axiadc_chip_info adrv9032r_axi_chip_info = {
	.name = "ADRV9032R",
	.max_rate = 245760000,
	.max_testmode = 0,
	.num_channels = 4,
...
static int adrv903x_write_raw(struct iio_dev *indio_dev,
			      struct iio_chan_spec const *chan, int val,
			      int val2, long mask)
{
	switch (mask) {
...
EXPORT_SYMBOL(adrv903x_hdl_loopback);

static int adrv903x_post_setup(struct iio_dev *indio_dev)
{
...
EXPORT_SYMBOL(adrv903x_register_axi_converter);
...
EXPORT_SYMBOL(adrv903x_spi_to_phy);
