...
*
*
* \pre The device must have been previously opened using adi_adrv903x_hal_HwOpen.
*
* \dep_begin
* \dep{device->common}
* \dep_end
...
* \retval adi_common_ErrAction_e - ADI_COMMON_ERR_ACT_NONE if Successful
*/
ADI_API adi_common_ErrAction_e adi_adrv903x_hal_HwReset(  const adi_common_Device_t* const    commonDev,
...
* \retval adi_common_ErrAction_e - ADI_COMMON_ERR_ACT_NONE if Successful
*/
ADI_API adi_common_ErrAction_e adi_adrv903x_hal_Wait_us(  const adi_common_Device_t* const    commonDev,
...
* \retval adi_common_ErrAction_e - ADI_COMMON_ERR_ACT_NONE if Successful
*/
ADI_API adi_common_ErrAction_e adi_adrv903x_hal_Wait_ms(  const adi_common_Device_t* const    commonDev,
