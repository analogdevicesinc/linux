...
ADI_API adi_common_ErrAction_e adi_adrv903x_LogStatusGet( const adi_common_Device_t* const    commonDev,
...
ADI_API void adi_adrv903x_LogConsoleSet(const adi_common_Device_t* const commonDev, adi_hal_LogConsole_e logConsoleFlag)
{
    if ((NULL != commonDev)                 &&
        (NULL != commonDev->devHalInfo))
    {
...
ADI_API adi_common_ErrAction_e adi_adrv903x_ErrLog(   const adi_common_Device_t* const    commonDev,
