/** 
 * \file adrv903x_bf_tdr_dpath_top.c Automatically generated file with generator ver 0.0.13.0.
 * 
...
#define ADI_FILE ADI_ADRV903X_FILE_PRIVATE_BF_TDR_DPATH_TOP
                                                                        ...
                                                                        const uint8_t bfValue)
{
        ...
        (bfValue > 15U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid BitField Value in adrv903x_TdrDpathTop_FlashThresh_BfSet");
        return recoveryAction;
    }
#endif /* ADRV903X_BITFIELD_VALUE_CHECK */

#if ADRV903X_BITFIELD_ADDR_CHECK > 0
    if ((baseAddr != ADRV903X_BF_SLICE_RX_0__ADC32_ANALOG_REGS_TDR_DPATH_TOP_0_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_0__ADC32_ANALOG_REGS_TDR_DPATH_TOP_1_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_1__ADC32_ANALOG_REGS_TDR_DPATH_TOP_0_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_1__ADC32_ANALOG_REGS_TDR_DPATH_TOP_1_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_2__ADC32_ANALOG_REGS_TDR_DPATH_TOP_0_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_2__ADC32_ANALOG_REGS_TDR_DPATH_TOP_1_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_3__ADC32_ANALOG_REGS_TDR_DPATH_TOP_0_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_3__ADC32_ANALOG_REGS_TDR_DPATH_TOP_1_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_4__ADC32_ANALOG_REGS_TDR_DPATH_TOP_0_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_4__ADC32_ANALOG_REGS_TDR_DPATH_TOP_1_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_5__ADC32_ANALOG_REGS_TDR_DPATH_TOP_0_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_5__ADC32_ANALOG_REGS_TDR_DPATH_TOP_1_) &&
            (baseAddr != ADRV903X_BF_SLICE_RX_6__ADC32_ANALOG_REGS_TDR_DPATH_TOP_0_) &&
            ...
            (baseAddr != ADRV903X_BF_SLICE_RX_7__ADC32_ANALOG_REGS_TDR_DPATH_TOP_1_))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ADI_ADRV903X_ERRSRC_DEVICEBF, 
                         ADI_COMMON_ERRCODE_INVALID_PARAM, 
                         ADI_ADRV903X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv903x_TdrDpathTop_FlashThresh_BfSet Address");
        return recoveryAction;
    }
    ...
    *bfValue = (uint8_t) 0;
            ...
            (baseAddr != ADRV903X_BF_SLICE_RX_7__ADC32_ANALOG_REGS_TDR_DPATH_TOP_1_))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV903X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv903x_TdrDpathTop_FlashThresh_BfGet Address");
        return recoveryAction;
    }
#endif /* ADRV903X_BITFIELD_ADDR_CHECK */ 
