...
adi_adrv903x_Version_t initStructApiVersion = {2, 11, 0, 4};

adi_adrv903x_CpuFwVersion_t initStructArmVersion = { {2, 11, 0, 4} , ADI_ADRV903X_CPU_FW_BUILD_RELEASE};

adi_adrv903x_Version_t initStructStreamVersion = {2, 11, 0, 4};
