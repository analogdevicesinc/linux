...
* \brief Contains ADI Hardware Abstraction layer function prototypes and type definitions for adi_adrv904x_log.c
*
* ADI common lib Version: 0.0.2.1
*/

#ifndef _ADI_ADRV904X_LOG_H_
#define _ADI_ADRV904X_LOG_H_
...
* 
* This macro will call adi_adrv904x_LogWrite function with the __func__ preprocessor.
* 
...
* \param[in] ...        variable argument(s) passed to adi_adrv904x_Logwrite
*/
...
*
* This macro will call adi_adrv904x_LogWrite function with the required string for logging the error.
*
* \param[in] commonDev  pointer to adi_common_Device_t
* \param[in] err        pointer to the error structure
*/
#define  ADI_ERROR_LOG(commonDev, err)      adi_adrv904x_LogWrite(commonDev,                                                              \
                                                                ADI_HAL_LOG_ERR,                                                        \
...
* \param[in]    ...             variable(s) argument passed to adi_adrv904x_Logwrite
*
*/
