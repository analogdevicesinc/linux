/** 
 * \file adrv904x_bf_tx_datapath.c Automatically generated file with generator ver 0.0.16.0.
 * 
...
#define ADI_FILE ADI_ADRV904X_FILE_PRIVATE_BF_TX_DATAPATH
                                                                                  ...
                                                                                  uint16_t* const bfValue)
{
    ...
    *bfValue = (uint16_t) 0;
    ...
    if ((baseAddr != ADRV904X_BF_SLICE_TX_0__TX_DATAPATH) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_1__TX_DATAPATH) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_2__TX_DATAPATH) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_3__TX_DATAPATH) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_4__TX_DATAPATH) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_5__TX_DATAPATH) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_6__TX_DATAPATH) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DATAPATH))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         baseAddr, 
                         "Invalid adrv904x_TxDatapath_PostAttenHcClipCntStat_BfGet Address");
                                                                               ...
                                                                               const uint8_t bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM, 
                         bfValue,
                         "Invalid BitField Value in adrv904x_TxDatapath_PostAttenHcCntClear_BfSet");
        return recoveryAction;
    }
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DATAPATH))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDatapath_PostAttenHcCntClear_BfSet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
                                                                             ...
                                                                             const uint8_t bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM, 
                         bfValue,
                         "Invalid BitField Value in adrv904x_TxDatapath_PostAttenHcCntUpd_BfSet");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_VALUE_CHECK */
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DATAPATH))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDatapath_PostAttenHcCntUpd_BfSet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
                                                                         ...
                                                                         const uint8_t bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM, 
                         bfValue,
                         "Invalid BitField Value in adrv904x_TxDatapath_PostAttenHcEn_BfSet");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_VALUE_CHECK */
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DATAPATH))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDatapath_PostAttenHcEn_BfSet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
    ...
    *bfValue = (uint8_t) 0;
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DATAPATH))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDatapath_PostAttenHcEn_BfGet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
                                                                                ...
                                                                                const uint32_t bfValue)
{
        ...
        (bfValue > 262143U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM, 
                         bfValue,
                         "Invalid BitField Value in adrv904x_TxDatapath_PostAttenHcThreshold_BfSet");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_VALUE_CHECK */
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DATAPATH))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDatapath_PostAttenHcThreshold_BfSet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
                                                                                ...
                                                                                uint32_t* const bfValue)
{
    ...
    *bfValue = (uint32_t) 0;
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DATAPATH))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDatapath_PostAttenHcThreshold_BfGet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
    ...
    *bfValue = (uint32_t) ((uint64_t)(*bfValue) | (((uint64_t)bfValueTmp) >> 4));
    ...
    *bfValue = (uint32_t) ((uint64_t)(*bfValue) | (((uint64_t)bfValueTmp) << 12));
