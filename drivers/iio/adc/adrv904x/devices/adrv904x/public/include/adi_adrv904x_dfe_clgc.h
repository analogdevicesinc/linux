...
#ifndef ADI_LIBRARY_RM_FLOATS
/**
* \brief Retrieves the CLGC Status for the requested Tx channel from the device
*
...
/** 
* \brief Configures the CLGC Capture Config for the requested Tx channel(s), without using floating point
*
* This function configures a capture for the CLGC in the ADRV904x device. 
*
* \dep_begin
...
/**
* \brief Retrieves the CLGC Capture Config for the requested Tx channel from the device, without using floating point
*
* This function retrieves the CLGC capture config in the ADRV904x device.
*
* \dep_begin
...
/** 
* \brief Configures the CLGC Tracking Config for the requested Tx channel(s), without using floating point
*
* This function configures a tracking for the CLGC in the ADRV904x device. 
*
* \dep_begin
...
/**
* \brief Retrieves the CLGC Tracking Config for the requested Tx channel from the device, without using floating point
*
* This function retrieves the CLGC tracking config in the ADRV904x device.
*
* \dep_begin
...
/**
* \brief Retrieves the CLGC Status for the requested Tx channel from the device, without using floating point
*
* This function retrieves the CLGC status in the ADRV904x device.
*
* \dep_begin
