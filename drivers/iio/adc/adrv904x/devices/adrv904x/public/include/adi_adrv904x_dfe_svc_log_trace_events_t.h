...
typedef enum
{
    ...
    ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_END,
    ...
    ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_APP_END
} adi_adrv904x_DfeSvcLogTraceEvent_e;


#define ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENTS_SDK_MASK0    (                     \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_ERROR) |               \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_DRV_INT) |             \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_CAP_PERIOD_CH0) |      \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_CAP_PERIOD_CH1) |      \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_CAP_PERIOD_CH2) |      \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_CAP_PERIOD_CH3) |      \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_CAP_PERIOD_CH4) |      \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_CAP_PERIOD_CH5) |      \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_CAP_PERIOD_CH6) |      \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_CAP_PERIOD_CH7) |      \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_DATA_CAP_ABORT_CH0) |  \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_DATA_CAP_ABORT_CH1) |  \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_DATA_CAP_ABORT_CH2) |  \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_DATA_CAP_ABORT_CH3) |  \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_DATA_CAP_ABORT_CH4) |  \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_DATA_CAP_ABORT_CH5) |  \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_DATA_CAP_ABORT_CH6) |  \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_DATA_CAP_ABORT_CH7) |  \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_POWER_CAP_ABORT_CH0) | \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_POWER_CAP_ABORT_CH1) | \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_POWER_CAP_ABORT_CH2) | \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_POWER_CAP_ABORT_CH3) | \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_POWER_CAP_ABORT_CH4) | \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_POWER_CAP_ABORT_CH5) | \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_POWER_CAP_ABORT_CH6) | \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_POWER_CAP_ABORT_CH7) | \
        /* Skipping [DATA|POWER_CAP_[START|DONE] events */          \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_CMD_ACK) |             \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_CMD_INC) |             \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_APP_CMD_ACK) |         \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_APP_CMD_INC) |         \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_MAILBOX_INTERRUPT) |   \
        (1ULL << ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_WATCHDOG_1))

#define ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENTS_SDK_MASK1    (                                              \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_WATCHDOG_2 - 64)) |                            \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_NMI_EXCEPTION - 64)) |                         \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_SYNC_EXCEPTION - 64)) |                        \
        /* THREAD_ and ISR_ events are only logged when OSAL_ENTER_EXIT_TELEM_ENABLE == 1 */ \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_THREAD_ENTER - 64)) |                          \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_THREAD_ENTER_STACK_START - 64)) |              \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_THREAD_ENTER_STACK_PTR - 64)) |                \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_THREAD_EXIT - 64)) |                           \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_THREAD_EXIT_STACK_START - 64)) |               \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_THREAD_EXIT_STACK_PTR - 64)) |                 \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_ISR_ENTER - 64)) |                             \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_ISR_EXIT - 64)) |                              \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_ISR_INT_ID - 64)) |                            \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_ASSERTION - 64)) |                             \
        (1ULL << (ADI_ADRV904X_DFE_SVC_LOG_TRACE_EVENT_SDK_TRACE_CYCLE_SYNC - 64)))
