 ...
 *
 *   This should be used in platform implementation of adrv904x_LogFileOpen
 ...
 *
 *   This should be used in platform implementation of adrv904x_LogWrite
 ...
 *
 *   Can be used in platform implementation of adrv904x_DevHalCfgCreate to 
