 ...
 */
ADI_API adi_hal_Err_e linux_adrv904x_HwOpen(void * const devHalCfg);
 ...
 * \retval ADI_HAL_ERR_OK Function completed successfully, no action required
 */
ADI_API adi_hal_Err_e linux_adrv904x_HwReset(void * const devHalCfg,
					     const u8 pinLevel);
 ...
 * \retval ADI_HAL_ERR_OK Function completed successfully, no action required
 */
ADI_API adi_hal_Err_e linux_adrv904x_HwClose(void * const devHalCfg);
 ...
 *
 */
ADI_API adi_hal_Err_e linux_adrv904x_LogFileOpen(void * const devHalCfg,
 ...
 *
 */
ADI_API adi_hal_Err_e linux_adrv904x_LogFileClose(void * const devHalCfg);
 ...
 */
ADI_API adi_hal_Err_e linux_adrv904x_TimerWait_ms(void * const devHalCfg,
						  const u32 time_ms);
 ...
 * \retval ADI_HAL_ERR_OK Function completed successfully
 */
ADI_API adi_hal_Err_e linux_adrv904x_TimerWait_us(void * const devHalCfg,
						  const u32 time_us);
 ...
 * \retval ADI_HAL_OK Function completed successfully, no action required
 */
ADI_API adi_hal_Err_e linux_adrv904x_MutexInit(adi_hal_mutex_t * const mutex);
 ...
 * \retval ADI_HAL_OK Function completed successfully, no action required
 */
ADI_API adi_hal_Err_e linux_adrv904x_MutexDestroy(adi_hal_mutex_t * const mutex);
 ...
 * \retval ADI_HAL_OK Function completed successfully, no action required
 */
ADI_API adi_hal_Err_e linux_adrv904x_MutexLock(adi_hal_mutex_t * const mutex);
 ...
 * \retval ADI_HAL_OK Function completed successfully, no action required
 */
ADI_API adi_hal_Err_e linux_adrv904x_MutexUnlock(adi_hal_mutex_t * const mutex);
