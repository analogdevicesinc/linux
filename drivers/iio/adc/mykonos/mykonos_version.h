...
#define MYKONOS_CURRENT_MAJOR_VERSION 4			/*!< Mykonos current ARM major version */
#define MYKONOS_CURRENT_MINOR_VERSION 0			/*!< Mykonos current ARM minor version */
#define MYKONOS_CURRENT_BUILD_VERSION 3546		/*!< Mykonos current API build version */
