 ...
 */
int ad917x_init(ad917x_handle_t *h);
 ...
 * \retval API_ERROR_INVALID_HANDLE_PTR   Invalid reference handle
 */
int ad917x_deinit(ad917x_handle_t *h);
 ...
 * \retval API_ERROR_SPI_SDO    Invalid SPI configuration
 */
int ad917x_reset(ad917x_handle_t *h, uint8_t hw_reset);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_get_chip_id(ad917x_handle_t *h, adi_chip_id_t *chip_id);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_register_write(ad917x_handle_t *h,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_register_read(ad917x_handle_t *h,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_get_revision(ad917x_handle_t *h, uint8_t *rev_major,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_set_dac_pll_config(ad917x_handle_t *h, uint8_t dac_pll_en,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_set_dac_clk_freq(ad917x_handle_t *h,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_get_dac_clk_freq(ad917x_handle_t *h,
				    uint64_t *dac_clk_freq_hz);
/**
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_get_dac_clk_status(ad917x_handle_t *h,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_set_clkout_config(ad917x_handle_t *h, uint8_t l_div);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_set_dac_clk(ad917x_handle_t *h,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_jesd_get_link_status(ad917x_handle_t *h,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_set_page_idx(ad917x_handle_t *h, const unsigned int dac,
 ...
 * \retval API_ERROR_INVALID_XFER_PTR SPI Access Failed
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */int ad917x_get_page_idx(ad917x_handle_t *h, int *dac, int *channel);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_set_channel_gain(ad917x_handle_t *h, const uint16_t gain);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_get_channel_gain(ad917x_handle_t *h, uint16_t *gain);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_set_dc_cal_tone_amp(ad917x_handle_t *h, const uint16_t amp);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_nco_get_phase_offset(ad917x_handle_t *h,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_nco_set_phase_offset(ad917x_handle_t *h,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_nco_set_ftw(ad917x_handle_t *h,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_nco_get_ftw(ad917x_handle_t *h,
			       const ad917x_dds_select_t nco,
			       uint64_t *ftw,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_nco_set(ad917x_handle_t *h,
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_nco_enable(ad917x_handle_t *h,
			      const ad917x_dac_select_t dacs,
			      const ad917x_channel_select_t channels);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_ddsm_cal_dc_input_set(ad917x_handle_t *h,
		int ddsm_cal_dc_input_en);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_ddsm_cal_dc_input_get(ad917x_handle_t *h,
		int *ddsm_cal_dc_input_en);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_dc_test_tone_set(ad917x_handle_t *h, int dc_test_tone_en);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_dc_test_tone_get(ad917x_handle_t *h, int *dc_test_tone_en);
 ...
 * \retval API_ERROR_INVALID_PARAM    Invalid Parameter
 */
int ad917x_nco_channel_freq_get(ad917x_handle_t *h,
