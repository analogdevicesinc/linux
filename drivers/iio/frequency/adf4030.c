...
#define ADI_ADF4030_BSYNC_FREQ_MAX	200000000U
...
static int adf4030_set_background_serial_alignment(struct adf4030_state *st, bool enable,
						   u32 channel_flags)
{
	u32 tmp;
	int ret;
	...
	if (tmp & ADF4030_EN_BKGND_ALGN_MSK) {
		...
		ret = regmap_update_bits(st->regmap, ADF4030_REG(0x37), ADF4030_EN_BKGND_ALGN_MSK,
					 0x0);
		if (ret)
			return ret;
...
static const int adf4030_avg_range[] = {512, 1024, 2048, 4096, 8192, 16384,
