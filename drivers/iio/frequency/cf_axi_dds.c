...
static struct cf_axi_dds_chip_info cf_axi_dds_chip_info_tbl[] = {
	...
	[ID_AD9172_DUAL_M2] = {
		...
		.channel = {
			CF_AXI_DDS_CHAN_BUF_MOD(0, IIO_MOD_I, 0),
			CF_AXI_DDS_CHAN_BUF_MOD(0, IIO_MOD_Q, 1),
			CF_AXI_DDS_CHAN_BUF_MOD(3, IIO_MOD_I, 2),
			CF_AXI_DDS_CHAN_BUF_MOD(3, IIO_MOD_Q, 3),
			CF_AXI_DDS_CHAN(0, 0, "TX1_I_F1"),
			CF_AXI_DDS_CHAN(1, 0, "TX1_I_F2"),
			CF_AXI_DDS_CHAN(2, 0, "TX1_Q_F1"),
			CF_AXI_DDS_CHAN(3, 0, "TX1_Q_F2"),
	...
	[ID_AD9172_DUAL_M4] = {
		...
		.channel = {
			...
			CF_AXI_DDS_CHAN_BUF_MOD(1, IIO_MOD_I, 2),
			CF_AXI_DDS_CHAN_BUF_MOD(1, IIO_MOD_Q, 3),
			CF_AXI_DDS_CHAN_BUF_MOD(3, IIO_MOD_I, 4),
			CF_AXI_DDS_CHAN_BUF_MOD(3, IIO_MOD_Q, 5),
			CF_AXI_DDS_CHAN_BUF_MOD(4, IIO_MOD_I, 6),
			CF_AXI_DDS_CHAN_BUF_MOD(4, IIO_MOD_Q, 7),
			CF_AXI_DDS_CHAN(0, 0, "TX1_I_F1"),
			CF_AXI_DDS_CHAN(1, 0, "TX1_I_F2"),
			CF_AXI_DDS_CHAN(2, 0, "TX1_Q_F1"),
			CF_AXI_DDS_CHAN(3, 0, "TX1_Q_F2"),
	...
	[ID_AD9172_DUAL_M6] = {
		...
		.channel = {
			...
			CF_AXI_DDS_CHAN_BUF_MOD(2, IIO_MOD_I, 4),
			CF_AXI_DDS_CHAN_BUF_MOD(2, IIO_MOD_Q, 5),
			CF_AXI_DDS_CHAN_BUF_MOD(3, IIO_MOD_I, 6),
			CF_AXI_DDS_CHAN_BUF_MOD(3, IIO_MOD_Q, 7),
			CF_AXI_DDS_CHAN_BUF_MOD(4, IIO_MOD_I, 8),
			CF_AXI_DDS_CHAN_BUF_MOD(4, IIO_MOD_Q, 9),
			CF_AXI_DDS_CHAN_BUF_MOD(5, IIO_MOD_I, 10),
			CF_AXI_DDS_CHAN_BUF_MOD(5, IIO_MOD_Q, 11),
			CF_AXI_DDS_CHAN(0, 0, "1A"),
			CF_AXI_DDS_CHAN(1, 0, "1B"),
			CF_AXI_DDS_CHAN(2, 0, "2A"),
			CF_AXI_DDS_CHAN(3, 0, "2B"),
			...
			CF_AXI_DDS_CHAN(10, 0, "6A"),
			CF_AXI_DDS_CHAN(11, 0, "6B"),
			CF_AXI_DDS_CHAN(12, 0, "7A"),
			CF_AXI_DDS_CHAN(13, 0, "7B"),
			CF_AXI_DDS_CHAN(14, 0, "8A"),
			CF_AXI_DDS_CHAN(15, 0, "8B"),
			CF_AXI_DDS_CHAN(16, 0, "9A"),
			CF_AXI_DDS_CHAN(17, 0, "9B"),
			CF_AXI_DDS_CHAN(18, 0, "10A"),
			CF_AXI_DDS_CHAN(19, 0, "10B"),
			CF_AXI_DDS_CHAN(20, 0, "11A"),
			CF_AXI_DDS_CHAN(21, 0, "11B"),
			CF_AXI_DDS_CHAN(22, 0, "12A"),
			CF_AXI_DDS_CHAN(23, 0, "12B"),
		},
		.num_channels = 36,
		.num_dp_disable_channels = 12,
		.num_dds_channels = 24,
		.num_buf_channels = 12,
	},
};
