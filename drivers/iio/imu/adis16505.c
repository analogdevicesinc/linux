...
/** @struct adis16505_variant
 *  @brief ADIS16505 supported ids
 */
enum adis16505_variant {
	ADIS16505_1,
	ADIS16505_2,
	ADIS16505_3,
};

static const struct adis_extd_data_field_map_def adis16505_def = {
...
static const struct iio_chan_spec adis16505_channels[] = {
	ADIS_EXTD_GYRO_CHAN(adis16505_def.x_gyro.reg_addr, X,  32, 32),
	ADIS_EXTD_GYRO_CHAN(adis16505_def.y_gyro.reg_addr, Y,  32, 32),
	ADIS_EXTD_GYRO_CHAN(adis16505_def.z_gyro.reg_addr, Z,  32, 32),
	ADIS_EXTD_ACCEL_CHAN(adis16505_def.x_accl.reg_addr, X, 32, 32),
	ADIS_EXTD_ACCEL_CHAN(adis16505_def.y_accl.reg_addr, Y, 32, 32),
	ADIS_EXTD_ACCEL_CHAN(adis16505_def.z_accl.reg_addr, Z, 32, 32),
	ADIS_EXTD_TEMP_CHAN(adis16505_def,                     32, 32),
	ADIS_EXTD_DELTA_ANGL_CHAN(adis16505_def.x_deltang.reg_addr, X, 32, 32),
	ADIS_EXTD_DELTA_ANGL_CHAN(adis16505_def.y_deltang.reg_addr, Y, 32, 32),
	ADIS_EXTD_DELTA_ANGL_CHAN(adis16505_def.z_deltang.reg_addr, Z, 32, 32),
	ADIS_EXTD_DELTA_VEL_CHAN(adis16505_def.x_deltvel.reg_addr, X,  32, 32),
	ADIS_EXTD_DELTA_VEL_CHAN(adis16505_def.y_deltvel.reg_addr, Y,  32, 32),
	ADIS_EXTD_DELTA_VEL_CHAN(adis16505_def.z_deltvel.reg_addr, Z,  32, 32),
	ADIS_EXTD_DATA_COUNTER_CHAN(ADIS_EXTD_DATA_COUNTER,            32, 32)
};

static const struct adis_extd_clk_freq_limit adis16505_sync_mode[] = {
...
static const struct adis_timeout adis16505_adis_timeouts = {
	.reset_ms = 260,
	.sw_reset_ms = 260,
	.self_test_ms = 30,
};

static const struct adis_extd_timeout adis16505_timeouts = {
	.reset_ms			= 310,
...
static const struct adis_extd_clk_freq_limit adis16505_sampling_clk_limits = {
	.min_freq = 1900,
	.max_freq = 2100,
};

static const struct adis_extd_chip_info adis16505_chip_info[] = {
	[ADIS16505_1] = {
		.name = "adis16505-1",
		.num_channels = ARRAY_SIZE(adis16505_channels),
		...
		.vel_scale = {100, 31},
		.int_clk = 2000,
		.sync_clk_freq_limits = adis16505_sync_mode,
		.adis_data = ADIS_EXTD_DATA(adis16505_def.msc_ctrl.reg_addr,
					    adis16505_def.glob_cmd.reg_addr,
					    adis16505_def.diag_stat.reg_addr,
					    adis16505_def.prod_id.reg_addr,
					    adis16505_def.snsr_self_test.reg_addr,
					    adis16505_def.glob_cmd.reg_addr,
					    16505,
					    &adis16505_adis_timeouts,
					    1000000,
					    16,
					    0,
					    0),
...
static const enum adis_extd_debug_attr adis16505_debug_attr[] = {
...
static const struct of_device_id adis16505_of_match[] = {
	{
		.compatible = "adi,adis16505-1_extd",
		.data = &adis16505_chip_info[ADIS16505_1]
	},
	{
		.compatible = "adi,adis16505-2_extd",
		.data = &adis16505_chip_info[ADIS16505_2]
	},
	{
		.compatible = "adi,adis16505-3_extd",
		.data = &adis16505_chip_info[ADIS16505_3]
	},
	{ },
};
MODULE_DEVICE_TABLE(of, adis16505_of_match);

static const struct spi_device_id adis16505_spi_id[] = {
	{ "adis16505-1_extd", (kernel_ulong_t)&adis16505_of_match[ADIS16505_1] },
	{ "adis16505-2_extd", (kernel_ulong_t)&adis16505_of_match[ADIS16505_2] },
	{ "adis16505-3_extd", (kernel_ulong_t)&adis16505_of_match[ADIS16505_3] },
	{ }
};
MODULE_DEVICE_TABLE(spi, adis16505_spi_id);

static int adis16505_probe(struct spi_device *spi)
{
	return adis_extd_init(spi, adis16505_debug_attr,
			      ARRAY_SIZE(adis16505_debug_attr));
}

static struct spi_driver adis16505_driver = {
	.driver = {
		.name = "adis16505",
		.of_match_table = adis16505_of_match,
	},
	.probe = adis16505_probe,
	.id_table = adis16505_spi_id,
};
module_spi_driver(adis16505_driver);

MODULE_AUTHOR("Ramona Bolboaca <ramona.bolboaca@analog.com>");
MODULE_DESCRIPTION("Analog Devices adis16505 IMU driver");
MODULE_LICENSE("GPL");
