				    ...
				    struct adis_extd_diag_flags *diag_flags)
{
	...
	printk(KERN_ERR "read diag data");
 ...
 * @return 0 in case of success, error code otherwise.
 */
static int adis_extd_read_fifo_cnt(void *arg, u64 *fifo_cnt)
{
	struct adis_extd *adis_extd = arg;
	u32 field_val;
	int ret;
 ...
 * @return 0 in case of success, error code otherwise.
 */
static int adis_extd_write_burst32(void *arg, u64 burst32)
{
	struct adis_extd *adis_extd = arg;
	struct adis *adis = &adis_extd->adis;
	int ret;
 ...
 * @return 0 in case of success, error code otherwise.
 */
static int adis_extd_write_sync_4khz(void *arg, u64 sync_4khz)
{
	struct adis_extd *adis_extd = arg;
	int ret;
