...
#ifndef ADI_JESD204B_V51_H_
#define ADI_JESD204B_V51_H_
...
#define XLNX_JESD204_ILA_MFC(x)			(((x) - 1) & 0xFF) /* TX only 4..256 */

#define XLNX_JESD204_REG_TEST_MODE_SEL		0x018
#define XLNX_JESD204_TEST_MODE_OFF		0 /* Normal operation */
#define XLNX_JESD204_TEST_MODE_K28_5		1 /* Send/Receive /K28.5/ indefinitely */
#define XLNX_JESD204_TEST_MODE_ILA		2 /* Synchronize as normal then send/receive repeated ILA sequences */
#define XLNX_JESD204_TEST_MODE_D21_5		3 /* Send/Receive /D21.5/ indefinitely */
#define XLNX_JESD204_TEST_MODE_RPAT		5 /* Send/Receive modified random pattern (RPAT) */
#define XLNX_JESD204_TEST_MODE_JSPAT		7 /* Send/Receive a scrambled jitter pattern (JSPAT) */
