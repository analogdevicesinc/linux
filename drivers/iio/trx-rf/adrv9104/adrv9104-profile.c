...
static const deviceProfile_t default_profile = {
	...
	.vcoFreq_daHz = 921600000,
	.hsDigFreq_Hz = 38400000,
	.hsDigFreq_PLL_Hz = 1152000000,
	...
	.txConfig = { {
		...
		.primaryBw_Hz = 1000000,
		.txInputRate = 2400000,
		.txInterfaceSampleRate = 2400000,
		.offsetLo_Hz = 0,
		.outputSignalingSel = IQ,
		.txBbfConfig = {
			.butterFilterBw = 1000000,
		...
		.freqDev = 648,
		.txSsiConfig = {
			.ssiType = SSI_TYPE_CMOS,
			.ssiDataFormatSel = SSI_FORMAT_16_BIT_I_Q_DATA,
			.numLaneSel = SSI_4_LANE,
			.strobeType = SSI_SHORT_STROBE,
			.lsbFirst = 0,
			.qFirst = 0,
			.txRefClockPin = TX_REF_CLOCK_PIN_CMOS_DCLK_OUT_P_ENABLED,
			.lvdsBitInversion = 0,
			.lvdsUseLsbIn12bitMode = 0,
			.rxSsiDataSrc = SSI_RX1_DP_RXNB_DP1,
			.txDataSrc = TX_SSI,
	...
	.rxConfig = { {
		...
		.primaryBw_Hz = 1000000,
		.rxOutputRate = 2400000,
		.rxInterfaceSampleRate = 2400000,
		.offsetLo_Hz = 0,
		.ncoEn = 1,
		.outputSignalingSel = RX_SIGNAL_TYPE_IQ,
		.adcCorner = 480000,
	...
	.rxNbConfig = {
		...
		.sincHbTopNb = {
		.sincGainMux = RX_SINC_GAIN_MUX_0_DB,
		.sincMux = RXNB_SINC_MUX5_OUTPUT_SINC2,
		.hbMux = RXNB_HB_MUX_OUTPUT_HB1,
		.isGainCompEnabled = 0,
...
pfirBuffer_t pfirBuffer = {
	...
	.pfirRxMagLowTia_RXNB = {
		.numCoeff = 21,
		.padding = { 0 },
		.coefficients = { 561, -488, -1330, 807, 2329, 98, -3652, -3306, 3692, 13169, 17573,
				  13169, 3692, -3306, -3652, 98, 2329, 807, -1330, -488, 561 }
	},
	...
	.pfirTxMagComp2 = {
		.numCoeff = 21,
		.padding = { 0 },
		.coefficients = { -147, 517, -179, -1298, 458, 3171, -674, -8285, -4169, 14261, 25460,
				  14261, -4169, -8285, -674, 3171, 458, -1298, -179, 517, -147 }
	},
	.pfirTxMagCompNb = { {
		.numCoeff = 13,
		.padding = { 0 },
