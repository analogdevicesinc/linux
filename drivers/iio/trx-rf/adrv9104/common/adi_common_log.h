...
#define ADI_LOG_TRACE(commonDev, fmt, ...) \
    adrv9104_common_LogWrite((adi_common_Device_t *)(commonDev), ADI_LOGLEVEL_TRACE, fmt, ##__VA_ARGS__)
#else
#define ADI_LOG_TRACE(commonDev, fmt, ...) {}
#endif
...
#define ADI_LOG_DEBUG(commonDev, fmt, ...) \
    adrv9104_common_LogWrite((adi_common_Device_t *)(commonDev), ADI_LOGLEVEL_DEBUG, fmt, ##__VA_ARGS__)

/**
* \brief Macro to log API function entry
*
* This macro will call adrv9104_common_LogWrite function with the __FUNCTION__ preprocessor
* It will report any error discovered.
*
* \param commonDev pointer to adi_common_Device_t
*/
#define ADI_FUNCTION_ENTRY_LOG(commonDev) \
    adrv9104_common_LogWrite((adi_common_Device_t *)(commonDev), ADI_LOGLEVEL_DEBUG, "%s(...)", __FUNCTION__)
...
* \param ... variable argument passed to adrv9104_common_LogWrite
*/
#define ADI_FUNCTION_ENTRY_VARIABLE_LOG(commonDev, message, ...) \
    adrv9104_common_LogWrite(commonDev, ADI_LOGLEVEL_DEBUG, message, __FUNCTION__, ##__VA_ARGS__)
#else
#define ADI_LOG_DEBUG(commonDev, fmt, ...) {}
#define ADI_FUNCTION_ENTRY_LOG(commonDev) {}
#define ADI_FUNCTION_ENTRY_VARIABLE_LOG(commonDev, message, ...) {}
...
#define ADI_LOG_INFO(commonDev, fmt, ...) \
    adrv9104_common_LogWrite((adi_common_Device_t *)(commonDev), ADI_LOGLEVEL_INFO, fmt, ##__VA_ARGS__)
#else
#define ADI_LOG_INFO(commonDev, fmt, ...) {}
#endif
...
#define ADI_LOG_WARN(commonDev, fmt, ...) \
    adrv9104_common_LogWrite((adi_common_Device_t *)(commonDev), ADI_LOGLEVEL_WARN, fmt, ##__VA_ARGS__)
#else
#define ADI_LOG_WARN(commonDev, fmt, ...) {}
#endif
...
#define ADI_LOG_ERROR(commonDev, fmt, ...) \
    adrv9104_common_LogWrite((adi_common_Device_t *)(commonDev), ADI_LOGLEVEL_ERROR, fmt, ##__VA_ARGS__)
#else
#define ADI_LOG_ERROR(commonDev, fmt, ...) {}
#endif
...
#define ADI_LOG_FATAL(commonDev, fmt, ...) \
    adrv9104_common_LogWrite((adi_common_Device_t *)(commonDev), ADI_LOGLEVEL_FATAL, fmt, ##__VA_ARGS__)
#else
#define ADI_LOG_FATAL(commonDev, fmt, ...) {}
#endif
...
*
* This macro will call adrv9104_common_LogWrite function with the required string for logging the error.
*
* \param commonDev pointer to adi_common_Device_t
