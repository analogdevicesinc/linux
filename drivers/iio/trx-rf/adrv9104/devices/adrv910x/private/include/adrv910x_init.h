...
//#define ADRV910X_INIT_WARNING 1
#ifdef ADRV910X_INIT_WARNING
#include <stdio.h>
#define ADRV910X_WARNING_INFO(x) printf("WARNING: %s ******************************* \n", (x));
#else
#define ADRV910X_WARNING_INFO(x)
#endif

#ifdef NEVIS_PS2
#define ADI_PS1_REG_UNLOCK_KEY 0xABABFEFEU
#endif
