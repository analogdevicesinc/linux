...
/**
* \brief Get Temperature Sensor reading in Celsius
* 
* This function reads the ADRV910X internal temperature sensor and returns the value in Celsius (C).
* 
* \param[in]  device		   Context variable - Pointer to the ADRV910X device data structure
* \param[out] temperature      Return value of the ADRV910X internal temperature sensor in Celsius (C)
* 
* \returns A code indicating success (ADI_COMMON_ACT_NO_ACTION) or the required action to recover
*/
