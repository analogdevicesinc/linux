...
typedef struct adi_adrv910x_Info
{
    ...
    uint32_t txAllowedInitCalMask[2];									/*!< Allowed Init calibrations for Tx channels from the profile parameters*/
    uint32_t rxAllowedInitCalMask[2];									/*!< Allowed Init calibrations for Rx channels from the profile paramters*/
    uint32_t txAllowedTrackingCalMask[2];								/*!< Allowed Tracking Calibrations for Tx channels from the profile parameters*/
    uint32_t rxAllowedTrackingCalMask[2];								/*!< Allowed Tracking Calibrations for Rx channels from the profile parameters*/
} adi_adrv910x_Info_t;
