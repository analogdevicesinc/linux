...
static void adin1110_ptp_clock_unregister(void *data)
{
...
static int adin1110_setup_ptp(struct adin1110_priv *priv)
{
	...
	return devm_add_action_or_reset(&priv->spidev->dev,
					adin1110_ptp_clock_unregister, priv);
}
