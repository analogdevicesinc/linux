...
#define LTC4162L_CELL_COUNT_MASK		GENMASK(3, 0)
#define LTC4162L_CHEM_MASK			GENMASK(11, 8)
#define LTC4162L_REGVAL_MASK			GENMASK(15, 0)
...
struct ltc4162l_info {
	...
	u8 chem_type;	/* Chemistry type, 0 while unknown */
};
			     ...
			     union power_supply_propval *val)
{
	...
	ret = (s16)FIELD_GET(LTC4162L_REGVAL_MASK, regval);
