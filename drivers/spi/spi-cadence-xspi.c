...
#define CDNS_XSPI_READ_SEQ_CFG1_REG		0x0434
					  ...
					  const struct spi_mem_op *op)
{
	...
	/* No command extension, no mode byte, no cache-random read. */
	writel(0, cdns_xspi->iobase + CDNS_XSPI_READ_SEQ_CFG1_REG);
}
