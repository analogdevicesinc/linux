...
#define AD9523_TRANSFER_LEN(x)			((x) >> 16)
...
#define AD9523_PLL1_CHARGE_PUMP_CURRENT_nA(x)	(((x) / 500) & 0x7F) /* 0,5uA..63,5uA */
...
#define AD9523_PLL2_CHARGE_PUMP_CURRENT_nA(x)	((x) / 3500) /* 3,5uA..900uA */
...
#define AD9523_CLOCK_DIST_DIV_PHASE(x)		(((x) & 0x3F) << 18)
#define AD9523_CLOCK_DIST_DIV(x)		((((x) - 1) & 0x3FF) << 8)
#define AD9523_CLOCK_DIST_INV_DIV_OUTPUT_EN	(1 << 7)
#define AD9523_CLOCK_DIST_IGNORE_SYNC_EN	(1 << 6)
#define AD9523_CLOCK_DIST_PWR_DOWN_EN		(1 << 5)
#define AD9523_CLOCK_DIST_LOW_PWR_MODE_EN	(1 << 4)
#define AD9523_CLOCK_DIST_DRIVER_MODE(x)	(((x) & 0xF) << 0)
...
struct ad9523_channel_spec {
	...
	bool		use_alt_clock_src; /* CH0..CH3 VCXO, CH4..CH9 VCO2 */
	bool		output_dis;
