...
/*
 * MAX77958 CC Pin Management Header
 *
 * Copyright (c) 2024 Analog Devices, Inc.
 */

#ifndef __MAX77958_CC_H__
#define __MAX77958_CC_H__
#include <linux/usb/typec/maxim/max77958.h>

#define MAX77958_CC_NAME	"MAX77958_CC"

enum max77958_vcon_role_e {
	VCON_OFF,
	VCON_ON,
};
...
struct max77958_cc_data {
	...
	enum max77958_vcon_role_e	current_vcon;
	enum max77958_vcon_role_e	previous_vcon;
