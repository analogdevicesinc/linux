...
#define GPU_ID_U8_COMP_SHIFT(comp, idx) \
	(((__u32)comp) >> (idx * 8U))
#define GPU_ID_U8_COMP_GET(comp, idx) \
	(GPU_ID_U8_COMP_SHIFT(comp, idx) & 0xFF)

#define GPU_ID_PRODUCT_MAKE(arch_major, product_major) \
	GPU_ID_U8_COMP(0, 0, arch_major, product_major)
...
#define GPU_ID_PRODUCT_TMIX GPU_ID_PRODUCT_MAKE(6, 0)
#define GPU_ID_PRODUCT_THEX GPU_ID_PRODUCT_MAKE(6, 1)
#define GPU_ID_PRODUCT_TSIX GPU_ID_PRODUCT_MAKE(7, 0)
#define GPU_ID_PRODUCT_TDVX GPU_ID_PRODUCT_MAKE(7, 3)
#define GPU_ID_PRODUCT_TNOX GPU_ID_PRODUCT_MAKE(7, 1)
#define GPU_ID_PRODUCT_TGOX GPU_ID_PRODUCT_MAKE(7, 2)
#define GPU_ID_PRODUCT_TTRX GPU_ID_PRODUCT_MAKE(9, 0)
#define GPU_ID_PRODUCT_TNAX GPU_ID_PRODUCT_MAKE(9, 1)
#define GPU_ID_PRODUCT_TBEX GPU_ID_PRODUCT_MAKE(9, 2)
#define GPU_ID_PRODUCT_LBEX GPU_ID_PRODUCT_MAKE(9, 4)
#define GPU_ID_PRODUCT_TBAX GPU_ID_PRODUCT_MAKE(9, 5)
#define GPU_ID_PRODUCT_TODX GPU_ID_PRODUCT_MAKE(10, 2)
#define GPU_ID_PRODUCT_TGRX GPU_ID_PRODUCT_MAKE(10, 3)
#define GPU_ID_PRODUCT_TVAX GPU_ID_PRODUCT_MAKE(10, 4)
#define GPU_ID_PRODUCT_LODX GPU_ID_PRODUCT_MAKE(10, 7)
#define GPU_ID_PRODUCT_TTUX GPU_ID_PRODUCT_MAKE(11, 2)
#define GPU_ID_PRODUCT_LTUX GPU_ID_PRODUCT_MAKE(11, 3)
#define GPU_ID_PRODUCT_TTIX GPU_ID_PRODUCT_MAKE(12, 0)
#define GPU_ID_PRODUCT_LTIX GPU_ID_PRODUCT_MAKE(12, 1)
