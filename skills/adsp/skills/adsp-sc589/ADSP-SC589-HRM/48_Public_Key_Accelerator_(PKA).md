...
Table 45-1: ADSP-SC58x PKA Register List
...
Figure 45-1: PKA Block Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000000_17b13fe7add03aa7b9c5f3093a8f581577bfee08a4cec429b360fbf850bdedc8.png)
...
Table 45-2: Summary of PKCP Vector Operations
...
- Max\_Len equals 128 (32-bit) words, for example, the standard maximum vector size is 4096 bit

Table 45-3: Operational Restrictions on Input Vectors for PKCP Operations
...
Table 45-4: PKCP Result Vector Memory Allocation
...
Table 45-5: PKCP Result Vector/Input Overlap Restrictions
...
Table 45-6: Summary of ExpMod Operations
...
Table 45-7: Restrictions on Input Vectors for ExpMod Operations
...
Table 45-8: ExpMod Result Vector/Scratchpad Area Memory Allocation Starting at PKA\_DPTR
...
Table 45-9: ExpMod Scratchpad Area / Input Vector Overlap Restrictions
...
Table 45-10: Maximum Number of Odd Powers
...
Table 45-11: 2K-bit Modular Exponentiation PKA RAM Allocation Examples
...
```
// Perform a 512/160 bits modular exponentiation without CRT (using 4 'odd-powers') // Exponent equals value 0x8FD84098_8A0930CC_9CDC1E8A_B246EB46_2D39F064 // write as vector A to PKA
```
...
Table 45-12: Summary of ModInv Operation
...
Table 45-13: PKA\_SHIFT Result Values for ModInv Operation
...
Table 45-14: Operational Restrictions on Input Vectors for the ModInv Operation
...
Table 45-15: ModInv Scratchpad Area/Input Vector Overlap Restrictions
...
Table 45-16: ModInv Result Vector/Scratchpad Area Memory Allocation (Both Starting at PKA\_DPTR)
...
Table 45-17: Summary of ECC Operations
...
- Vector D not only addresses the result but also a workspace
- The PKA\_SHIFT register is used to return info on the result of the operation

Table 45-18: PKA\_SHIFT Result Values for ECC Operations
...
Table 45-19: Operational Restrictions on Input Vectors for ECC Operations
...
Table 45-20: ECC Scratchpad Area/Input Vector Overlap Restrictions
...
Table 45-21: ECC Result Vector/Scratchpad Area Memory Allocation (Both Starting at PKA\_DPTR)
...
Table 45-22: ECC Point Multiplication PKA RAM Allocation Examples
...
Table 45-22: ECC Point Multiplication PKA RAM Allocation Examples (Continued)
...
Table 45-23: ADSP-SC58x PKA Register List
...
Figure 45-2: PKA\_ALEN Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000001_12b8e166a2172d7c26ee0bcda795442a4c350391c8b79c3448318ac5c164f785.png)

Table 45-24: PKA\_ALEN Register Fields
...
Figure 45-3: PKA\_APTR Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000002_7654b5fcf9a2fb1ec5a5f14ce51c5cf84dae5146964ca520137777fde7a68ed8.png)

Table 45-25: PKA\_APTR Register Fields
...
Figure 45-4: PKA\_BLEN Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000003_67ff7b28a97dbbb9c921c1cc161bed0f266dadb76dc6aa2ebaded8781f91ec94.png)

Table 45-26: PKA\_BLEN Register Fields
...
Figure 45-5: PKA\_BPTR Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000004_fa53596032f6a464cf9fe6c4e0d5c88ade300d7ea8d0c092c3acb9957f96c155.png)

Table 45-27: PKA\_BPTR Register Fields
...
Figure 45-6: PKA\_COMPARE Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000005_4f6b6e75636cfd4e58ac1d30c6aa78742ee66b0bbbdb4f8550247b80fac060e2.png)

Table 45-28: PKA\_COMPARE Register Fields
...
Figure 45-7: PKA\_CPTR Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000006_e35a2cd7964fc9e2dcfa392804cd1ac6aa53af115604789021cf86d9e9b70b68.png)

Table 45-29: PKA\_CPTR Register Fields
...
Figure 45-8: PKA\_DIVMSW Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000007_e08eb1e10e2c075ebd4a8d7b77e02cdc5b067c9d42ed06e9bb370ecd75fb4872.png)

Table 45-30: PKA\_DIVMSW Register Fields
...
Figure 45-9: PKA\_DPTR Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000008_d064c01851546f0286fdc7d022550e92ce7dfefde8fe4954efcfc88bb9edb8d6.png)

Table 45-31: PKA\_DPTR Register Fields
...
![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000009_0682651d62aa4b2d7b432d820fc6fb7e6a28a95ddf72cefe2dc8f7d9883b2133.png)

Stall Result

Figure 45-10: PKA\_FUNC Register Diagram

Table 45-32: PKA\_FUNC Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Description/Enumeration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 24 (R/W)           | STALLRSLT  | Stall Result. When the PKA_FUNC.STALLRSLT bit is set, updating the PKA_COMPARE , PKA_RESULTMSW and PKA_DIVMSW registers, as well as resetting the Run bit, is stalled beyond the point that a running operation is actually finished. Use this to allow software enough time to read results from a previous operation when the newly started operation is known to take only a short amount of time. If a result is waiting, the result                                                                                                                              | Stall Result. When the PKA_FUNC.STALLRSLT bit is set, updating the PKA_COMPARE , PKA_RESULTMSW and PKA_DIVMSW registers, as well as resetting the Run bit, is stalled beyond the point that a running operation is actually finished. Use this to allow software enough time to read results from a previous operation when the newly started operation is known to take only a short amount of time. If a result is waiting, the result                                                                                                                              |
...
| 11 (R/W)           | CPY        | Copy. Setting the PKA_FUNC.CPY bit performs the copy operation. For more information,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Copy. Setting the PKA_FUNC.CPY bit performs the copy operation. For more information,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 10 (R/W)           | CMP        | Perform Compare Operation. Setting the PKA_FUNC.CMP bit performs the compare operation. For more informa- tion, see the "PKCP Vector Operations" section.                                                                                                                                                                                                                                                                                                                                                                                                             | Perform Compare Operation. Setting the PKA_FUNC.CMP bit performs the compare operation. For more informa- tion, see the "PKCP Vector Operations" section.                                                                                                                                                                                                                                                                                                                                                                                                             |

Table 45-32: PKA\_FUNC Register Fields (Continued)
...
The PKA\_RAM register provides the the starting location of the RAM space to hold the input, output and other vectors.

Figure 45-11: PKA\_RAM Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000010_04b86c6a86ec1a9e34cbc8b89f1e68d77e8787e03036f5133f526a843af9c4f5.png)

Table 45-33: PKA\_RAM Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                 |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| 31:0 (R/W)         | VALUE      | First Location in PKA RAM. The PKA_RAM.VALUE bit field provides the the starting location of the RAM space to hold the input, output and other vectors. |
...
Figure 45-12: PKA\_RESULTMSW Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000011_f1cb1e4e54a30c61fca6fa1e9ee0e51278627844ccac180cbbcbc4a7b588e75e.png)

Table 45-34: PKA\_RESULTMSW Register Fields
...
Figure 45-13: PKA\_SHIFT Register Diagram

![Image](48_Public_Key_Accelerator_(PKA)_artifacts/image_000012_efa86596f7fbfc76121a0402558ca0e27f78a143ad3aee122b4c61ba0efecdae.png)

Table 45-35: PKA\_SHIFT Register Fields
