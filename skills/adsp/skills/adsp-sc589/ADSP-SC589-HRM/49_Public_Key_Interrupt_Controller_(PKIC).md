## 46   Public Key Interrupt Controller (PKIC)
...
Table 46-1: ADSP-SC58x PKIC Register List
...
Table 46-1: ADSP-SC58x PKIC Register List (Continued)
...
## ADSP-SC58x PKIC Interrupt List

Table 46-2: ADSP-SC58x PKIC Interrupt List

|   Interrupt ID | Name      | Description     | Sensitivity   | DMA Channel   |
|----------------|-----------|-----------------|---------------|---------------|
|            129 | PKIC0_IRQ | PKIC0 Interrupt | Level         |               |
...
Figure 46-1: PKIC\_ACK Register Diagram

![Image](49_Public_Key_Interrupt_Controller_(PKIC)_artifacts/image_000000_5e47fda7441839e94adc9c4f155522f1dc3d0ebb395068a4e3c782f8369aeb54.png)

Table 46-4: PKIC\_ACK Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                |
|--------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5 (RX/W)           | SLERRINT   | Slave Error IRQ. The PKIC_ACK.SLERRINT bit is the acknowledge bit for the Slave Error interrupt. When set =1 the PKIC_ACK.SLERRINT bit acknowledges the interrupt signal and clears the status bit (and is cleared automatically). 0 Do not acknowledge interrupt and clear status bit |
...
Figure 46-2: PKIC\_EN\_CLR Register Diagram

![Image](49_Public_Key_Interrupt_Controller_(PKIC)_artifacts/image_000001_ebb620c20117a694b5851e5ff68f58818aa8c866ffa851aa4d7f5b1a710e808e.png)

Table 46-5: PKIC\_EN\_CLR Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                            | Description/Enumeration                                                                                                                                                                                                                                                            |
|--------------------|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5 (RX/W)           | SLERRINT   | Slave Error IRQ. The PKIC_EN_CLR.SLERRINT bit is the individual disable for the Slave Error in- terrupt. When set =1 this bit clears/resets the corresponding bit in the PKIC_EN_CTL register to 0 (disables the interrupt). This bit is cleared automatically.                    | Slave Error IRQ. The PKIC_EN_CLR.SLERRINT bit is the individual disable for the Slave Error in- terrupt. When set =1 this bit clears/resets the corresponding bit in the PKIC_EN_CTL register to 0 (disables the interrupt). This bit is cleared automatically.                    |
...
Figure 46-3: PKIC\_EN\_CTL Register Diagram

![Image](49_Public_Key_Interrupt_Controller_(PKIC)_artifacts/image_000002_9d9afec87740d9e6946d033109e247408c05281736eca94b0e60dbba2bba9637.png)

Table 46-6: PKIC\_EN\_CTL Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                       |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5 (R/W)            | SLERRINT   | Slave Error IRQ. The PKIC_EN_CTL.SLERRINT bit enables control for the Slave Error interrupt. 0 Disable interrupt                                              |
...
Figure 46-4: PKIC\_EN\_SET Register Diagram

![Image](49_Public_Key_Interrupt_Controller_(PKIC)_artifacts/image_000003_ebb620c20117a694b5851e5ff68f58818aa8c866ffa851aa4d7f5b1a710e808e.png)

Table 46-7: PKIC\_EN\_SET Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                        | Description/Enumeration                                                                                                                                                                                                                        |
|--------------------|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5 (RX/W)           | SLERRINT   | Slave Error IRQ. The PKIC_EN_SET.SLERRINT bit is the individual enable for the Slave Error in- terrupt. If =1, sets the corresponding bit in the PKIC_EN_CTL register to 1 (enables interrupt). This bit is cleared automatically. 0=no effect | Slave Error IRQ. The PKIC_EN_SET.SLERRINT bit is the individual enable for the Slave Error in- terrupt. If =1, sets the corresponding bit in the PKIC_EN_CTL register to 1 (enables interrupt). This bit is cleared automatically. 0=no effect |
...
Figure 46-5: PKIC\_EN\_STAT Register Diagram

![Image](49_Public_Key_Interrupt_Controller_(PKIC)_artifacts/image_000004_2754a1a4df13e093ff836ea7917ffbc4da4f7d0a7b0b65fe773dfe2d2681f5d0.png)

Table 46-8: PKIC\_EN\_STAT Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                       |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5 (R/NW)           | SLERRINT   | Slave Error IRQ. The PKIC_EN_STAT.SLERRINT bit provides the status of the Slave Error inter- rupt (after masking from the PKIC_EN_CTL register).                              |
...
Figure 46-6: PKIC\_POL\_CTL Register Diagram

![Image](49_Public_Key_Interrupt_Controller_(PKIC)_artifacts/image_000005_a692edc0352468bcbe913a85e78c3a3f79f01664c2ac87edd0d58c3d22f49362.png)

Table 46-9: PKIC\_POL\_CTL Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                           |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------|
| 5 (R/W)            | SLERRINT   | Slave Error IRQ. The PKIC_POL_CTL.SLERRINT bit provides polarity control for the Slave Error interrupt.                           |
...
Figure 46-7: PKIC\_RAW\_STAT Register Diagram

![Image](49_Public_Key_Interrupt_Controller_(PKIC)_artifacts/image_000006_e87075f5ec1f0e451fc74fa91b2516ed23444595a9fb2ed13169af3cddb8972b.png)

Table 46-10: PKIC\_RAW\_STAT Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                    |
|--------------------|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5 (R/NW)           | SLERRINT   | Slave Error IRQ. The PKIC_RAW_STAT.SLERRINT bit provides the raw status of the Slave Error interrupt.                                                      |
...
Figure 46-8: PKIC\_TYPE\_CTL Register Diagram

![Image](49_Public_Key_Interrupt_Controller_(PKIC)_artifacts/image_000007_3022c15d3148c0ece8609a6850872f25a51358bddffea143fa75148746a8fe12.png)

Table 46-11: PKIC\_TYPE\_CTL Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                 |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------|
| 5 (R/W)            | SLERRINT   | Slave Error IRQ. The PKIC_TYPE_CTL.SLERRINT bit provides signal type control for the Slave Error interrupt.             |
