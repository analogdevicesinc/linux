...
<!-- source: 011_L2_System_Memory.pdf | original pages 317–370 -->
...
- SHARC core data ports can access L2 memory through direct path as well as through the Arm L2 cache.
...
## ADSP-2159x\_SC592\_SC594 L2CTL Register List
...
Table 9-1: ADSP-2159x\_SC592\_SC594 L2CTL Register List
...
Table 9-1: ADSP-2159x\_SC592\_SC594 L2CTL Register List (Continued)
...
## ADSP-2159x\_SC592\_SC594 L2CTL Interrupt List

Table 9-2: ADSP-2159x\_SC592\_SC594 L2CTL Interrupt List
...
## ADSP-2159x\_SC592\_SC594 L2CTL Trigger List

Table 9-3: ADSP-2159x\_SC592\_SC594 L2CTL Trigger List Generators

|   Trigger ID | Name       | Description            | Sensitivity   |
|--------------|------------|------------------------|---------------|
|           47 | L2CTL0_EVT | L2CTL0 L2 Memory Event | Level         |

Table 9-4: ADSP-2159x\_SC592\_SC594 L2CTL Trigger List Receivers
...
Figure 9-1: ADSP-2159x Complete L2 System Block Diagram
...
## ADSP-2159x\_SC592\_SC594 L2CTL Register Descriptions

L2 Memory Controller (L2CTL) contains the following registers.

Table 9-6: ADSP-2159x\_SC592\_SC594 L2CTL Register List
...
Table 9-6: ADSP-2159x\_SC592\_SC594 L2CTL Register List (Continued)
