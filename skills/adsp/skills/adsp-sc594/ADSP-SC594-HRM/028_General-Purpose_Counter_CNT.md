...
<!-- source: 028_General-Purpose_Counter_CNT.pdf | original pages 1508–1537 -->

## 26   General-Purpose Counter (CNT)
...
## ADSP-2159x\_SC592\_SC594 CNT Register List
...
Table 26-1: ADSP-2159x\_SC592\_SC594 CNT Register List
...
## ADSP-2159x\_SC592\_SC594 CNT Interrupt List

Table 26-2: ADSP-2159x\_SC592\_SC594 CNT Interrupt List

|   Interrupt ID | Name      | Description   | Sensitivity   | DMA Channel   |
|----------------|-----------|---------------|---------------|---------------|
|            156 | CNT0_STAT | CNT0 Status   | Level         |               |

## ADSP-2159x\_SC592\_SC594 CNT Trigger List

Table 26-3: ADSP-2159x\_SC592\_SC594 CNT Trigger List Generators
...
Table 26-4: ADSP-2159x\_SC592\_SC594 CNT Trigger List Receivers
...
change within one SCLK0 cycle. Gray coding prohibits such transitions. Therefore, the CNT\_CNTR register remains unchanged, and an error condition is signaled.

Table 26-5: Quadrature Events and Counting Mechanism
...
Figure 26-1: Programmable Noise Filtering

<!-- image -->

The CNT module implements the filtering mechanism using counters for each GP counter pin, where each counter is initialized from the CNT\_DEBNCE.DPRESCALE field. When a transition is detected on a pin, the corresponding counter starts counting up to the programmed number of SCLK0 cycles. The state of the pin is latched after time t filter  and passed on to the GP counter logic.

The following formula determines the time t filter , given SCLK0 and the CNT\_DEBNCE.DPRESCALE value, where lower values of CNT\_DEBNCE.DPRESCALE result in shorter debounce delays:
...
The TIMER\_TMR[n]\_PER register contains the period between the last two count events. The TIMER\_TMR[n]\_WID register contains the time since the last count event and the read of the CNT\_CNTR register, both measured in SCLK0 cycles.
...
NOTE: Speed restrictions apply to the use of the CNT\_TO signal. Therefore, programs must not operate at count event rates that are high. For instance, if CNT\_CNTR is incremented or decremented every SCLK0 cycle (timed direction mode), the CNT\_TO signal is not valid.
...
This mode can also be used with TIMER\_TMR[n]\_CFG.PULSEHI = 0. In this case, the period of CNT\_TO is measured between falling edges. It results in the same values as in the previous case, only the latching occurs one SCLK0 cycle later.
...
## ADSP-2159x\_SC592\_SC594 CNT Register Descriptions

General-Purpose Counter (CNT) contains the following registers.

Table 26-7: ADSP-2159x\_SC592\_SC594 CNT Register List
...
Table 26-7: ADSP-2159x\_SC592\_SC594 CNT Register List (Continued)
...
Figure 26-4: CNT\_CFG Register Diagram

<!-- image -->

Table 26-8: CNT\_CFG Register Fields
...
Table 26-8: CNT\_CFG Register Fields (Continued)
...
Figure 26-5: CNT\_CMD Register Diagram

<!-- image -->

Table 26-9: CNT\_CMD Register Fields
...
Table 26-9: CNT\_CMD Register Fields (Continued)
...
Figure 26-6: CNT\_CNTR Register Diagram

<!-- image -->

Table 26-10: CNT\_CNTR Register Fields
...
Figure 26-7: CNT\_DEBNCE Register Diagram

<!-- image -->

Table 26-11: CNT\_DEBNCE Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                     |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4:0 (R/W)          | DPRESCALE  | Debounce Prescale. The CNT_DEBNCE.DPRESCALE selects the desired number of input filtering cycles (and resulting input debounce time) in multiples of SCLK0. |

## Table 26-11: CNT\_DEBNCE Register Fields (Continued)
...
Figure 26-8: CNT\_IMSK Register Diagram

<!-- image -->

Table 26-12: CNT\_IMSK Register Fields
...
Table 26-12: CNT\_IMSK Register Fields (Continued)
...
Figure 26-9: CNT\_MAX Register Diagram

<!-- image -->

Table 26-13: CNT\_MAX Register Fields
...
Figure 26-10: CNT\_MIN Register Diagram

<!-- image -->

Table 26-14: CNT\_MIN Register Fields
...
Figure 26-11: CNT\_STAT Register Diagram

<!-- image -->

Table 26-15: CNT\_STAT Register Fields
...
Table 26-15: CNT\_STAT Register Fields (Continued)
