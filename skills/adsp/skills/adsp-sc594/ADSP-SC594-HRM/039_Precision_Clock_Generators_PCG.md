...
<!-- source: 039_Precision_Clock_Generators_PCG.pdf | original pages 2312–2361 -->

## 32   Precision Clock Generators (PCG)
...
Figure 32-1: PCG Block Diagram

<!-- image -->

NOTE: In the PCG Block Diagram , the CLKINSEL bit field determines whether SYS\_CLKIN0 or SYS\_CLKIN1 is input to DAI.

## ADSP-2159x\_SC592\_SC594 PCG Register List

Precision Clock Generator

Table 32-1: ADSP-2159x\_SC592\_SC594 PCG Register List
...
Table 32-1: ADSP-2159x\_SC592\_SC594 PCG Register List (Continued)
...
## ADSP-2159x\_SC592\_SC594 PCG Trigger List

Table 32-2: ADSP-2159x\_SC592\_SC594 PCG Trigger List Generators

| Trigger ID   | Name   | Description   | Sensitivity   |
|--------------|--------|---------------|---------------|
| None         | None   | None          | None          |

Table 32-3: ADSP-2159x\_SC592\_SC594 PCG Trigger List Receivers
...
Figure 32-2: Phase and Pulse Width Settings
...
The symmetric dual DAI architecture allows cross connections between both PCGs (A,B) and (C,D) to the other DAI. Each PCG (A through D) supports an alternative input clock (PCG0\_EXTx\_I)(see Figure 32-1 PCG Block Diagram) which can be sourced via a DAI pin buffer from the other DAI. Note however if routing a source (clock or FS) only DAI pin buffer 2 to 20 can be used (DAI pin buffer 1 is no longer available and is replaced by the DAI CRS buffer for the other DAI).
...
Figure 32-3: Bypass and Inverted Bypass
...
Figure 32-4: One Shot Mode PCG A (MISCA2\_I Input)
...
Figure 32-5: PCG Setup for I 2 S or Left-Justified DAI
...
Table 32-4: Precision Clock Generator Division Ratios (33.330 CLKIN)
...
4. Enable all the required PCGs in the DAI\_GBL\_PCG\_EN register that need to be enabled globally. Complete the following steps to globally disable the PCGs using the DAI\_GBL\_PCG\_EN register:
...
Figure 32-6: FS Output Synchronization With External Trigger Input
...
## ADSP-2159x\_SC592\_SC594 PCG Register Descriptions

Precision Clock Generator (PCG) contains the following registers.

Table 32-5: ADSP-2159x\_SC592\_SC594 PCG Register List
...
Figure 32-7: PCG\_CTLA0 Register Diagram

<!-- image -->

Table 32-6: PCG\_CTLA0 Register Fields
...
Figure 32-8: PCG\_CTLA1 Register Diagram

<!-- image -->

Table 32-7: PCG\_CTLA1 Register Fields
...
Figure 32-9: PCG\_CTLB0 Register Diagram

<!-- image -->

Table 32-8: PCG\_CTLB0 Register Fields
...
Figure 32-10: PCG\_CTLB1 Register Diagram

<!-- image -->

Table 32-9: PCG\_CTLB1 Register Fields
...
Figure 32-11: PCG\_CTLC0 Register Diagram

<!-- image -->

Table 32-10: PCG\_CTLC0 Register Fields
...
Figure 32-12: PCG\_CTLC1 Register Diagram

<!-- image -->

Table 32-11: PCG\_CTLC1 Register Fields
...
Figure 32-13: PCG\_CTLD0 Register Diagram

<!-- image -->

Table 32-12: PCG\_CTLD0 Register Fields
...
Figure 32-14: PCG\_CTLD1 Register Diagram

<!-- image -->

Table 32-13: PCG\_CTLD1 Register Fields
...
Figure 32-15: PCG\_CTLE0 Register Diagram

<!-- image -->

Table 32-14: PCG\_CTLE0 Register Fields
...
Figure 32-16: PCG\_CTLE1 Register Diagram

<!-- image -->

Table 32-15: PCG\_CTLE1 Register Fields
...
Figure 32-17: PCG\_CTLF0 Register Diagram

<!-- image -->

Table 32-16: PCG\_CTLF0 Register Fields
...
Figure 32-18: PCG\_CTLF1 Register Diagram

<!-- image -->

Table 32-17: PCG\_CTLF1 Register Fields
...
Figure 32-19: PCG\_CTLG0 Register Diagram

<!-- image -->

Table 32-18: PCG\_CTLG0 Register Fields
...
Figure 32-20: PCG\_CTLG1 Register Diagram

<!-- image -->

Table 32-19: PCG\_CTLG1 Register Fields
...
Figure 32-21: PCG\_CTLH0 Register Diagram

<!-- image -->

Table 32-20: PCG\_CTLH0 Register Fields
...
Figure 32-22: PCG\_CTLH1 Register Diagram

<!-- image -->

Table 32-21: PCG\_CTLH1 Register Fields
...
Figure 32-23: PCG\_PW1 Register Diagram

<!-- image -->

Table 32-22: PCG\_PW1 Register Fields
...
Table 32-22: PCG\_PW1 Register Fields (Continued)
...
Figure 32-24: PCG\_PW2 Register Diagram

<!-- image -->

Table 32-23: PCG\_PW2 Register Fields
...
Table 32-23: PCG\_PW2 Register Fields (Continued)
...
Figure 32-25: PCG\_PW3 Register Diagram

<!-- image -->

Table 32-24: PCG\_PW3 Register Fields
...
Table 32-24: PCG\_PW3 Register Fields (Continued)
...
Figure 32-26: PCG\_PW4 Register Diagram

<!-- image -->

Table 32-25: PCG\_PW4 Register Fields
...
Table 32-25: PCG\_PW4 Register Fields (Continued)
...
Figure 32-27: PCG\_SYNC1 Register Diagram

<!-- image -->

Table 32-26: PCG\_SYNC1 Register Fields
...
Table 32-26: PCG\_SYNC1 Register Fields (Continued)
...
Figure 32-28: PCG\_SYNC2 Register Diagram

<!-- image -->

Table 32-27: PCG\_SYNC2 Register Fields
...
Table 32-27: PCG\_SYNC2 Register Fields (Continued)
...
Figure 32-29: PCG\_SYNC3 Register Diagram

<!-- image -->

Table 32-28: PCG\_SYNC3 Register Fields
...
Table 32-28: PCG\_SYNC3 Register Fields (Continued)
...
Figure 32-30: PCG\_SYNC4 Register Diagram

<!-- image -->

Table 32-29: PCG\_SYNC4 Register Fields
...
Table 32-29: PCG\_SYNC4 Register Fields (Continued)
