...
<!-- source: 043_Extended_Memory_DMA_EMDMA.pdf | original pages 2508–2539 -->

## 36   Extended Memory DMA (EMDMA)
...
## ADSP-2159x\_SC592\_SC594 EMDMA Register List
...
Table 36-1: ADSP-2159x\_SC592\_SC594 EMDMA Register List
...
## ADSP-2159x\_SC592\_SC594 EMDMA Interrupt List

Table 36-2: ADSP-2159x\_SC592\_SC594 EMDMA Interrupt List
...
## ADSP-2159x\_SC592\_SC594 EMDMA Trigger List

Table 36-3: ADSP-2159x\_SC592\_SC594 EMDMA Trigger List Generators

|   Trigger ID | Name        | Description    | Sensitivity   |
|--------------|-------------|----------------|---------------|
|           32 | EMDMA0_DONE | EMDMA0 DMADone | Edge          |
|           33 | EMDMA1_DONE | EMDMA1 DMADone | Edge          |

Table 36-4: ADSP-2159x\_SC592\_SC594 EMDMA Trigger List Receivers
...
Table 36-5: EMDMA TCBs for Standard DMA
...
Table 36-6: EMDMA TCBs for Standard Circular DMA
...
Table 36-7: EMDMA TCBs for Delay Line DMA
...
Table 36-7: EMDMA TCBs for Delay Line DMA (Continued)
...
Table 36-8: EMDMA TCBs for Scatter/Gather DMA
...
Table 36-9: EMDMA TCBs for Circular Scatter/Gather DMA
...
Table 36-9: EMDMA TCBs for Circular Scatter/Gather DMA (Continued)
...
This section and the EMDMA\_CTL Register Bit to Operating Modes table show the different DMA modes which can be used. The complete register bit descriptions are in the External Memory DMA Control Registers (EMD-MA\_CTL) .

Table 36-10: EMDMA\_CTL Register Bit to Operating Modes
...
Table 36-10: EMDMA\_CTL Register Bit to Operating Modes (Continued)
...
Figure 36-1: Circular Buffering Write DMA

<!-- image -->

Figure 36-2: Circular Buffering Read DMA

<!-- image -->

Figure 36-3: Standard Write DMA
...
Figure 36-4: Scatter DMA (Writes)

<!-- image -->

Figure 36-5: Gather DMA (Reads)

<!-- image -->

Figure 36-6: Circular Buffering Scatter DMA (Writes)

<!-- image -->

Figure 36-7: Circular Gather DMA (Reads)
...
Table 36-11: Read/Write Index Pre-Modify (Scatter/Gather DMA)
...
Figure 36-8: Write to Delay Line Buffer
...
Figure 36-9: Read From Delay Line Buffer
...
Table 36-12: Read/Write Index Pre-Modify (Scatter/Gather DMA) (Continued)
...
## ADSP-2159x\_SC592\_SC594 EMDMA Register Descriptions

Extended Memory DMA (EMDMA) contains the following registers.

Table 36-13: ADSP-2159x\_SC592\_SC594 EMDMA Register List
...
Figure 36-10: EMDMA\_BASE Register Diagram

<!-- image -->

Table 36-14: EMDMA\_BASE Register Fields
...
Figure 36-11: EMDMA\_BUFLEN Register Diagram

<!-- image -->

Table 36-15: EMDMA\_BUFLEN Register Fields
...
Figure 36-12: EMDMA\_CHNPTR Register Diagram

<!-- image -->

Table 36-16: EMDMA\_CHNPTR Register Fields
...
| 30 (R/W)           | PCI        | Program Controlled Interrupt. The EMDMA_CHNPTR.PCI bit PCI sets whether an interrupt is generated after the current TCB or if no interrupt is generated. (Only affects DMAif chaining is ena- bled).                                                        | Program Controlled Interrupt. The EMDMA_CHNPTR.PCI bit PCI sets whether an interrupt is generated after the current TCB or if no interrupt is generated. (Only affects DMAif chaining is ena- bled).                                                        |
|                    |            | 0                                                                                                                                                                                                                                                           | Enable DMAChannel interrupt to occur at the comple- tion of the entire DMAchained transfer                                                                                                                                                                  |
|                    |            | 1                                                                                                                                                                                                                                                           | Enable DMAChannel interrupt to occur at the comple- tion of current DMAsequence                                                                                                                                                                             |

## Table 36-16: EMDMA\_CHNPTR Register Fields (Continued)
...
Figure 36-13: EMDMA\_CNT0 Register Diagram

<!-- image -->

Table 36-17: EMDMA\_CNT0 Register Fields
...
Figure 36-14: EMDMA\_CNT1 Register Diagram

<!-- image -->

Table 36-18: EMDMA\_CNT1 Register Fields
...
Figure 36-15: EMDMA\_CTL Register Diagram

<!-- image -->

Table 36-19: EMDMA\_CTL Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                        | Description/Enumeration                                                                                                                                                                                                                                                        |
|--------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 25 (R/NW)          | DIRS       | DMATransfer Direction Status. The EMDMA_CTL.DIRS bit provides the DMAtransfer status direction. This is use- ful for delay line DMAwhere the transfer direction changes with the state of theDMA state machine. For standard DMA, the EMDMA_CTL.DIRS bit reflects the state of | DMATransfer Direction Status. The EMDMA_CTL.DIRS bit provides the DMAtransfer status direction. This is use- ful for delay line DMAwhere the transfer direction changes with the state of theDMA state machine. For standard DMA, the EMDMA_CTL.DIRS bit reflects the state of |
|                    |            | 0                                                                                                                                                                                                                                                                              | DMAdirection is Channel 1 Reads                                                                                                                                                                                                                                                |
|                    |            | 1                                                                                                                                                                                                                                                                              | DMAdirection is Channel 1 Writes                                                                                                                                                                                                                                               |

Table 36-19: EMDMA\_CTL Register Fields (Continued)
...
| 20 (R/NW)          | DMAS0      | 1 DMAchain loading is active DMATransfer Status. The EMDMA_CTL.DMAS0 bit provides the DMAchannel 0 transfer status.                              |
| 17:16 (R/NW)       | DFS        | 0 DMAidle 1 DMAin progress DMAFIFO Status. The EMDMA_CTL.DFS bit field provides the DMAFIFO status.                                              |

Table 36-19: EMDMA\_CTL Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Description/Enumeration                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 12 (R/W)           | INTDONE0   | Internal DMACompletion Interrupt (Control). The EMDMA_CTL.INTDONE0 bit configures when the DMAcomplete interrupt is generated. The EMDMA_CTL.INTDONE0 =1 setting is provided for backward com- patibility with older SHARC processors.                                                                                                                                                                                                                                                                | Internal DMACompletion Interrupt (Control). The EMDMA_CTL.INTDONE0 bit configures when the DMAcomplete interrupt is generated. The EMDMA_CTL.INTDONE0 =1 setting is provided for backward com- patibility with older SHARC processors.                                                                                                                                                                                                                                                                |
...
| 8 (R/W)            | OFCEN      | On the Fly Control Loading Enable. The control bits in EMDMA_CHNPTR register are used to describe the next TCB be- havior if the EMDMA_CTL.OFCEN bit is set. Therefore, the DMAcontrols can be changed from TCB to TCB. 0 = disables the control bits in the EMDMA_CHNPTR register. 1 = enables the control bits in the EMDMA_CHNPTR register. If chaining is enabled with EMDMA_CTL.OFCEN bit set, the EMDMA_CTL.TRAN bit has no ef- fect, and direction is determined by the EMDMA_CHNPTR.CPDR bit. | On the Fly Control Loading Enable. The control bits in EMDMA_CHNPTR register are used to describe the next TCB be- havior if the EMDMA_CTL.OFCEN bit is set. Therefore, the DMAcontrols can be changed from TCB to TCB. 0 = disables the control bits in the EMDMA_CHNPTR register. 1 = enables the control bits in the EMDMA_CHNPTR register. If chaining is enabled with EMDMA_CTL.OFCEN bit set, the EMDMA_CTL.TRAN bit has no ef- fect, and direction is determined by the EMDMA_CHNPTR.CPDR bit. |
| 7 (R/W)            | WRBEN      | Write Back Enable. The EMDMA_CTL.WRBEN bit enables write back of the EIEP register after reads and or writes. Write back is automatically enabled for delay line DMA. WRBEN is applica- ble only if chaining is enabled ( EMDMA_CTL.CHEN =1).                                                                                                                                                                                                                                                         | Write Back Enable. The EMDMA_CTL.WRBEN bit enables write back of the EIEP register after reads and or writes. Write back is automatically enabled for delay line DMA. WRBEN is applica- ble only if chaining is enabled ( EMDMA_CTL.CHEN =1).                                                                                                                                                                                                                                                         |
...
| 4 (R/W)            | CBEN       | Circular Buffering Enable. The EMDMA_CTL.CBEN bit enables circular buffering. Circular buffering can be used with normal DMAas well. If circular buffering is enabled with chaining for nor- mal DMA, then ELEP and EBEP should be part of the TCB.                                                                                                                                                                                                                                                   | Circular Buffering Enable. The EMDMA_CTL.CBEN bit enables circular buffering. Circular buffering can be used with normal DMAas well. If circular buffering is enabled with chaining for nor- mal DMA, then ELEP and EBEP should be part of the TCB.                                                                                                                                                                                                                                                   |
...
| 0 (R/W)            | EN         | DMAEnable. The EMDMA_CTL.EN bit enables DMA.                                                                                                                                                                                                                                                                  |
...
Figure 36-16: EMDMA\_INDX0 Register Diagram

<!-- image -->

Table 36-20: EMDMA\_INDX0 Register Fields
...
Figure 36-17: EMDMA\_INDX1 Register Diagram

<!-- image -->

Table 36-21: EMDMA\_INDX1 Register Fields
...
Figure 36-18: EMDMA\_MOD0 Register Diagram

<!-- image -->

Table 36-22: EMDMA\_MOD0 Register Fields
...
Figure 36-19: EMDMA\_MOD1 Register Diagram

<!-- image -->

Table 36-23: EMDMA\_MOD1 Register Fields
...
Figure 36-20: EMDMA\_TCNT Register Diagram

<!-- image -->

Table 36-24: EMDMA\_TCNT Register Fields
...
Figure 36-21: EMDMA\_TPTR Register Diagram

<!-- image -->

Table 36-25: EMDMA\_TPTR Register Fields
