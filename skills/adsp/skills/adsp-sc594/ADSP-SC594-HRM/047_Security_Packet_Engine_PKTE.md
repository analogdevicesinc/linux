...
<!-- source: 047_Security_Packet_Engine_PKTE.pdf | original pages 2609–2744 -->

## 40   Security Packet Engine (PKTE)
...
## ADSP-2159x\_SC592\_SC594 PKTE Register List
...
Table 40-1: ADSP-2159x\_SC592\_SC594 PKTE Register List
...
Table 40-1: ADSP-2159x\_SC592\_SC594 PKTE Register List (Continued)
...
## ADSP-2159x\_SC592\_SC594 PKTE Interrupt List

Table 40-2: ADSP-2159x\_SC592\_SC594 PKTE Interrupt List
...
Table 40-3: SA Record for PRNG Init Operation
...
When packet processing is complete, the status byte in the first word of the result descriptor reports the pad verification status. Refer to the Table 40-28 Extended Error Codes - Status Encoding table.
...
Table 40-8: Algorithms for Basic Encrypt and Basic Decrypt Operations
...
Table 40-9: Algorithms for Basic Encrypt and Basic Decrypt Operations
...
Table 40-10: Algorithms for Basic Encrypt-Hash and Basic Hash-Decrypt Operations
...
Table 40-10: Algorithms for Basic Encrypt-Hash and Basic Hash-Decrypt Operations (Continued)
...
Table 40-11: Algorithms for IPsec ESP Operations
...
Table 40-12: Algorithms for Basic SSL and Extended SSL Operations
...
Table 40-12: Algorithms for Basic SSL and Extended SSL Operations (Continued)
...
Table 40-13: Algorithms for Basic TLS, Extended TLS and DTLS Operations
...
Table 40-14: Algorithms for SRTP Operations
...
Table 40-16: Different Sources for Loading the Hash State
...
Table 40-17: Sequence Number Generation and Verification Control (Outbound)
...
Table 40-18: Sequence Number Generation and Verification Control (Inbound)
...
Table 40-19: Header Processing Enabled, Anti-replay Service Enabled
...
Table 40-19: Header Processing Enabled, Anti-replay Service Enabled (Continued)
...
Figure 40-1: PKTE Block Diagram
...
The packet engine includes a clock controller that generates clock enable signals. A clock manager external to the packet engine uses the clock enable signals to switch the clocks to modules in the packet engine, reducing power consumption. The power saving can be significant, depending on the crypto-operation and the idle time of the packet engine. The clock controller generates the clock enable signals dynamically depending on the current cryptooperation. A clock control register provides the processor core the possibility to override this dynamic process.
...
```
1. Interrupt Unmasked Status -PKTE_IUMSK_STAT 2. Interrupt Mask Status -PKTE_IMSK_STAT 3. Interrupt Clear Register -PKTE_INT_CLR 4. Interrupt Enable Register -PKTE_INT_EN 5. Interrupt Mask Disable -PKTE_IMSK_DIS 6. Interrupt Mask Enable -PKTE_IMSK_EN
```
...
Figure 40-2: Packet Engine Interrupt Controller Block Diagram
...
Table 40-20: Command Descriptor Structure
...
Table 40-20: Command Descriptor Structure (Continued)
...
Table 40-21: Result Descriptor Structure
...
Figure 40-3: Descriptor Rings in Autonomous Ring Mode
...
Table 40-22: SA Record Structure
...
Table 40-22: SA Record Structure (Continued)
...
|            31 | PKTE_SA_NONCE[31:0] / PKTE_SA_READY | Nonce value (AES-CTR, AES-ICM)/ARC4, i and j               |

Table 40-22: SA Record Structure (Continued)

| Word Offset   | Use                                                    |
|---------------|--------------------------------------------------------|
|               | pointers (ARC4,)/SA ready indicator (Direct Host Mode) |
...
Table 40-23: SA State Structure
...
Table 40-24: ARC4 State Structure
...
Table 40-25: Basic Operation Decoding
...
Table 40-25: Basic Operation Decoding (Continued)
...
Table 40-26: Protocol Operation Decoding
...
Table 40-27: Extended Protocol Operation Decoding
...
Table 40-27: Extended Protocol Operation Decoding (Continued)
...
Table 40-28: Extended Error Codes - Status Encoding
...
Table 40-28: Extended Error Codes - Status Encoding (Continued)
...
## ADSP-2159x\_SC592\_SC594 PKTE Register Descriptions

Security Packet Engine (PKTE) contains the following registers.

Table 40-29: ADSP-2159x\_SC592\_SC594 PKTE Register List
...
Table 40-29: ADSP-2159x\_SC592\_SC594 PKTE Register List (Continued)
...
Figure 40-4: PKTE\_ARC4STATE\_ADDR Register Diagram

<!-- image -->

Table 40-30: PKTE\_ARC4STATE\_ADDR Register Fields
...
Figure 40-5: PKTE\_ARC4STATE\_BUF Register Diagram

<!-- image -->

Table 40-31: PKTE\_ARC4STATE\_BUF Register Fields
...
Figure 40-6: PKTE\_BUF\_PTR Register Diagram

<!-- image -->

Table 40-32: PKTE\_BUF\_PTR Register Fields
...
Figure 40-7: PKTE\_BUF\_THRESH Register Diagram

<!-- image -->

Table 40-33: PKTE\_BUF\_THRESH Register Fields
...
Table 40-33: PKTE\_BUF\_THRESH Register Fields (Continued)
...
Figure 40-8: PKTE\_CDRBASE\_ADDR Register Diagram

<!-- image -->

Table 40-34: PKTE\_CDRBASE\_ADDR Register Fields
...
Figure 40-9: PKTE\_CDSC\_CNT Register Diagram

<!-- image -->

Table 40-35: PKTE\_CDSC\_CNT Register Fields
...
Figure 40-10: PKTE\_CDSC\_INCR Register Diagram

<!-- image -->

Table 40-36: PKTE\_CDSC\_INCR Register Fields
...
Figure 40-11: PKTE\_CFG Register Diagram

<!-- image -->

Table 40-37: PKTE\_CFG Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                               |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 18 (R/W)           | SWPDAT     | Swap Data. The PKTE_CFG.SWPDAT bit enables endian swap for packet data as configured in the PKTE_ENDIAN_CFG.MSTRBSWP bits for the packet data DMAread and write. 0 No Endian Swap 1 Apply Endian Swap                                                                                                 |
...
Table 40-37: PKTE\_CFG Register Fields (Continued)
...
Figure 40-12: PKTE\_CLK\_CTL Register Diagram

<!-- image -->

Table 40-38: PKTE\_CLK\_CTL Register Fields
...
Table 40-38: PKTE\_CLK\_CTL Register Fields (Continued)
...
Figure 40-13: PKTE\_CONT Register Diagram

<!-- image -->

Table 40-39: PKTE\_CONT Register Fields
...
Figure 40-14: PKTE\_CTL\_STAT Register Diagram

<!-- image -->

Table 40-40: PKTE\_CTL\_STAT Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 31:24 (R/W)        | PADCTLSTAT | Pad Control/Pad Status. The PKTE_CTL_STAT.PADCTLSTAT bit field is used to control the pad boundary for pad insertion (outbound) and after processing returns the number of inserted (out- bound) or detected (inbound) pad bytes. For the command descriptor, the enumerations below provide the codes for the pad boundary for the outbound operations. This can be used for "traffic flow security" to conceal the number of payload bytes in an encrypted packet. For the result descriptor inbound operations that use pad types SSL, TLS, IPsec or PKCS#7, it returns the number of detected pad bytes. For all other inbound opera- tions, it returns zero since the other pad modes do not allow implicit determination of pad count. If a "pad verify failure" occurs, it returns zero. For an outbound operation, it returns the number of inserted pad bytes for all pad types. The pad value includes added bytes such as the pad length and the next header field in an IPsec ESP pad type. |
...
Table 40-40: PKTE\_CTL\_STAT Register Fields (Continued)
...
Figure 40-15: PKTE\_DATAIO\_BUF Register Diagram

<!-- image -->

Table 40-41: PKTE\_DATAIO\_BUF Register Fields
...
Figure 40-16: PKTE\_DEST\_ADDR Register Diagram

<!-- image -->

Table 40-42: PKTE\_DEST\_ADDR Register Fields
...
Figure 40-17: PKTE\_DMA\_CFG Register Diagram

<!-- image -->

Table 40-43: PKTE\_DMA\_CFG Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                            |
|--------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 20 (R/NW)          | IDLE       | Idle Enable. The PKTE_DMA_CFG.IDLE bit allows the peripheral bus requester to insert one ad- ditional IDLE transfer between two successive peripheral bus requester burst opera- tions. This provides the arbiter one additional cycle to hand over the grant to another peripheral bus requester. |
...
Table 40-43: PKTE\_DMA\_CFG Register Fields (Continued)
...
| 16 (R/NW)          | MSTRBIGEND | Requester Big Endian. The PKTE_DMA_CFG.MSTRBIGEND bit determines whether the engine is used in a little or big endian system.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Requester Big Endian. The PKTE_DMA_CFG.MSTRBIGEND bit determines whether the engine is used in a little or big endian system.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
Figure 40-18: PKTE\_ENDIAN\_CFG Register Diagram

<!-- image -->

Table 40-44: PKTE\_ENDIAN\_CFG Register Fields
...
Figure 40-19: PKTE\_HLT\_CTL Register Diagram

<!-- image -->

Table 40-45: PKTE\_HLT\_CTL Register Fields
...
Table 40-45: PKTE\_HLT\_CTL Register Fields (Continued)
...
Figure 40-20: PKTE\_HLT\_STAT Register Diagram

<!-- image -->

Table 40-46: PKTE\_HLT\_STAT Register Fields
...
Table 40-46: PKTE\_HLT\_STAT Register Fields (Continued)
...
Figure 40-21: PKTE\_IMSK\_DIS Register Diagram

<!-- image -->

Table 40-47: PKTE\_IMSK\_DIS Register Fields
...
Table 40-47: PKTE\_IMSK\_DIS Register Fields (Continued)
...
Figure 40-22: PKTE\_IMSK\_EN Register Diagram

<!-- image -->

Table 40-48: PKTE\_IMSK\_EN Register Fields
...
Table 40-48: PKTE\_IMSK\_EN Register Fields (Continued)
...
Figure 40-23: PKTE\_IMSK\_STAT Register Diagram

<!-- image -->

Table 40-49: PKTE\_IMSK\_STAT Register Fields
...
Table 40-49: PKTE\_IMSK\_STAT Register Fields (Continued)
...
Figure 40-24: PKTE\_INBUF\_CNT Register Diagram

<!-- image -->

Table 40-50: PKTE\_INBUF\_CNT Register Fields
...
Figure 40-25: PKTE\_INBUF\_INCR Register Diagram

<!-- image -->

Table 40-51: PKTE\_INBUF\_INCR Register Fields
...
Figure 40-26: PKTE\_INT\_CFG Register Diagram

<!-- image -->

Table 40-52: PKTE\_INT\_CFG Register Fields
...
Figure 40-27: PKTE\_INT\_CLR Register Diagram

<!-- image -->

Table 40-53: PKTE\_INT\_CLR Register Fields
...
Table 40-53: PKTE\_INT\_CLR Register Fields (Continued)
...
Figure 40-28: PKTE\_INT\_EN Register Diagram

<!-- image -->

Table 40-54: PKTE\_INT\_EN Register Fields
...
Table 40-54: PKTE\_INT\_EN Register Fields (Continued)
...
Figure 40-29: PKTE\_IUMSK\_STAT Register Diagram

<!-- image -->

Table 40-55: PKTE\_IUMSK\_STAT Register Fields
...
Table 40-55: PKTE\_IUMSK\_STAT Register Fields (Continued)
...
Figure 40-30: PKTE\_LEN Register Diagram

<!-- image -->

Table 40-56: PKTE\_LEN Register Fields
...
Table 40-56: PKTE\_LEN Register Fields (Continued)
...
Figure 40-31: PKTE\_OUTBUF\_CNT Register Diagram

<!-- image -->

Table 40-57: PKTE\_OUTBUF\_CNT Register Fields
...
Figure 40-32: PKTE\_OUTBUF\_DECR Register Diagram

<!-- image -->

Table 40-58: PKTE\_OUTBUF\_DECR Register Fields
...
Figure 40-33: PKTE\_RDRBASE\_ADDR Register Diagram

<!-- image -->

Table 40-59: PKTE\_RDRBASE\_ADDR Register Fields
...
Figure 40-34: PKTE\_RDSC\_CNT Register Diagram

<!-- image -->

Table 40-60: PKTE\_RDSC\_CNT Register Fields
...
Figure 40-35: PKTE\_RDSC\_DECR Register Diagram

<!-- image -->

Table 40-61: PKTE\_RDSC\_DECR Register Fields
...
Figure 40-36: PKTE\_RING\_CFG Register Diagram

<!-- image -->

Table 40-62: PKTE\_RING\_CFG Register Fields
...
Result Descriptor Ring Write Pointer

Figure 40-37: PKTE\_RING\_PTR Register Diagram

<!-- image -->

Table 40-63: PKTE\_RING\_PTR Register Fields
...
Figure 40-38: PKTE\_RING\_STAT Register Diagram

<!-- image -->

Table 40-64: PKTE\_RING\_STAT Register Fields
...
Figure 40-39: PKTE\_RING\_THRESH Register Diagram

<!-- image -->

Table 40-65: PKTE\_RING\_THRESH Register Fields
...
Table 40-65: PKTE\_RING\_THRESH Register Fields (Continued)
...
Figure 40-40: PKTE\_SA\_ADDR Register Diagram

<!-- image -->

Table 40-66: PKTE\_SA\_ADDR Register Fields
...
Figure 40-41: PKTE\_SA\_ARC4IJPTR Register Diagram

<!-- image -->

Table 40-67: PKTE\_SA\_ARC4IJPTR Register Fields
...
Figure 40-42: PKTE\_SA\_CMD0 Register Diagram

<!-- image -->

Table 40-68: PKTE\_SA\_CMD0 Register Fields
...
Table 40-68: PKTE\_SA\_CMD0 Register Fields (Continued)
...
| 28 (R/W)           | SVIV       | 1 ARC4 State is not saved.                                                                                                                                                                                                                                           |
...
Figure 40-43: PKTE\_SA\_CMD1 Register Diagram

<!-- image -->

Table 40-69: PKTE\_SA\_CMD1 Register Fields
...
Table 40-69: PKTE\_SA\_CMD1 Register Fields (Continued)
...
Figure 40-44: PKTE\_SA\_IDIGEST[n] Register Diagram

<!-- image -->

Table 40-70: PKTE\_SA\_IDIGEST[n] Register Fields
...
Figure 40-45: PKTE\_SA\_KEY[n] Register Diagram

<!-- image -->

Table 40-71: PKTE\_SA\_KEY[n] Register Fields
...
Figure 40-46: PKTE\_SA\_NONCE Register Diagram

<!-- image -->

Table 40-72: PKTE\_SA\_NONCE Register Fields
...
Figure 40-47: PKTE\_SA\_ODIGEST[n] Register Diagram

<!-- image -->

Table 40-73: PKTE\_SA\_ODIGEST[n] Register Fields
...
Figure 40-48: PKTE\_SA\_RDY Register Diagram

<!-- image -->

Table 40-74: PKTE\_SA\_RDY Register Fields
...
Figure 40-49: PKTE\_SA\_SEQNUM[n] Register Diagram

<!-- image -->

Table 40-75: PKTE\_SA\_SEQNUM[n] Register Fields
...
Figure 40-50: PKTE\_SA\_SEQNUM\_MSK[n] Register Diagram

<!-- image -->

Table 40-76: PKTE\_SA\_SEQNUM\_MSK[n] Register Fields
...
Figure 40-51: PKTE\_SA\_SPI Register Diagram

<!-- image -->

Table 40-77: PKTE\_SA\_SPI Register Fields
...
Figure 40-52: PKTE\_SRC\_ADDR Register Diagram

<!-- image -->

Table 40-78: PKTE\_SRC\_ADDR Register Fields
...
Figure 40-53: PKTE\_STAT Register Diagram

<!-- image -->

Table 40-79: PKTE\_STAT Register Fields
...
Table 40-79: PKTE\_STAT Register Fields (Continued)
...
Figure 40-54: PKTE\_STATE\_ADDR Register Diagram

<!-- image -->

Table 40-80: PKTE\_STATE\_ADDR Register Fields
...
Figure 40-55: PKTE\_STATE\_BYTE\_CNT[n] Register Diagram

<!-- image -->

Table 40-81: PKTE\_STATE\_BYTE\_CNT[n] Register Fields
...
Figure 40-56: PKTE\_STATE\_IDIGEST[n] Register Diagram

<!-- image -->

Table 40-82: PKTE\_STATE\_IDIGEST[n] Register Fields
...
Figure 40-57: PKTE\_STATE\_IV[n] Register Diagram

<!-- image -->

Table 40-83: PKTE\_STATE\_IV[n] Register Fields
...
Figure 40-58: PKTE\_USERID Register Diagram

<!-- image -->

Table 40-84: PKTE\_USERID Register Fields
