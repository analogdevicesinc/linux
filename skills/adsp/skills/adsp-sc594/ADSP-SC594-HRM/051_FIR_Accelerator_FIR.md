...
<!-- source: 051_FIR_Accelerator_FIR.pdf | original pages 2833–2884 -->

## 44   FIR Accelerator (FIR)
...
## ADSP-2159x\_SC592\_SC594 FIR Register List
...
Table 44-1: ADSP-2159x\_SC592\_SC594 FIR Register List
...
## ADSP-2159x\_SC592\_SC594 FIR Interrupt List

Table 44-2: ADSP-2159x\_SC592\_SC594 FIR Interrupt List
...
## ADSP-2159x\_SC592\_SC594 FIR Trigger List

Table 44-3: ADSP-2159x\_SC592\_SC594 FIR Trigger List Generators

|   Trigger ID | Name        | Description   | Sensitivity   |
|--------------|-------------|---------------|---------------|
|           36 | C1_FIR0_DMA | FIR0 Core1DMA | Edge          |
|           37 | C2_FIR0_DMA | FIR1 Core2DMA | Edge          |

Table 44-4: ADSP-2159x\_SC592\_SC594 FIR Trigger List Receivers
...
Table 44-5: Pipeline Operation for Window Size = 1

<!-- image -->

Table 44-5: Pipeline Operation for Window Size = 1 (Continued)
...
Figure 44-3: Multi-Iteration Filtering Flow
...
Figure 44-4: Filter Output Calculation
...
Table 44-6: TCBs for Chained DMA in Legacy Mode
...
Table 44-7: TCBs for Chained DMA in Auto Configuration Mode
...
Figure 44-6: Wait for Core Intervention ≥ Idle (if auto channel iterate bit = 0)
...
Table 44-8: FIR Interrupt Overview
...
## ADSP-2159x\_SC592\_SC594 FIR Register Descriptions

The FIR accelerator (FIR) contains the following registers.

Table 44-9: ADSP-2159x\_SC592\_SC594 FIR Register List
...
Figure 44-8: FIR\_CHNPTR Register Diagram

<!-- image -->

Table 44-10: FIR\_CHNPTR Register Fields
...
Figure 44-9: FIR\_COEFCNT Register Diagram

<!-- image -->

Table 44-11: FIR\_COEFCNT Register Fields
...
Figure 44-10: FIR\_COEFIDX Register Diagram

<!-- image -->

Table 44-12: FIR\_COEFIDX Register Fields
...
Figure 44-11: FIR\_COEFMOD Register Diagram

<!-- image -->

Table 44-13: FIR\_COEFMOD Register Fields
...
Figure 44-12: FIR\_CTL1 Register Diagram

<!-- image -->

Table 44-14: FIR\_CTL1 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                |
|--------------------|------------|----------------------------------------------------------------------------------------|
| 31 (R/W)           | ACM        | Auto Configuration Mode. The FIR_CTL1.ACM bit configures the mode for loading the TCB. |

Table 44-14: FIR\_CTL1 Register Fields (Continued)
...
| 29 (R/W)           | BURST16_DIS  | Disable 16 Burst. The FIR_CTL1.BURST16_DIS bit configures the accelerator to disable 16 burst when in burst mode. 0 Maximum burst of INCR16 in burst mode forDMA and TCB                                                                                                                   |
| 28 (R/W)           | DCP_DIS      | Disable Data Coefficient Load in Parallel. The FIR_CTL1.DCP_DIS bit enables data and coefficient loading to occur in par- allel. 0 Enable                                                                                                                                                  |
...
| 26 (R/W)           |              |                                                                                                                                                                                                                                                                                            |
|                    | SMQ_LIUPS_EN | Legacy I/P and O/P Index Update Scheme in SMART_Q Mode. The FIR_CTL1.SMQ_LIUPS_EN bit configures the scheme the accelerator uses to update the input index (II) and output index (OI). This bit is only valid in ACM. 0 Update the II with all '0' and the OI with all 'F', respec- tively |
...
Figure 44-13: FIR\_CTL2 Register Diagram

<!-- image -->

Table 44-15: FIR\_CTL2 Register Fields
...
Table 44-15: FIR\_CTL2 Register Fields (Continued)
...
Figure 44-14: FIR\_DBG\_ADDR Register Diagram

<!-- image -->

Table 44-16: FIR\_DBG\_ADDR Register Fields
...
Figure 44-15: FIR\_DBG\_CTL Register Diagram

<!-- image -->

Table 44-17: FIR\_DBG\_CTL Register Fields
...
Figure 44-16: FIR\_DBG\_RDDAT Register Diagram

<!-- image -->

Table 44-18: FIR\_DBG\_RDDAT Register Fields
...
Figure 44-17: FIR\_DBG\_WRDAT Register Diagram

<!-- image -->

Table 44-19: FIR\_DBG\_WRDAT Register Fields
...
Figure 44-18: FIR\_DMASTAT Register Diagram

<!-- image -->

Table 44-20: FIR\_DMASTAT Register Fields
...
Table 44-20: FIR\_DMASTAT Register Fields (Continued)
...
Figure 44-19: FIR\_INBASE Register Diagram

<!-- image -->

Table 44-21: FIR\_INBASE Register Fields
...
Figure 44-20: FIR\_INCNT Register Diagram

<!-- image -->

Table 44-22: FIR\_INCNT Register Fields
...
Figure 44-21: FIR\_INIDX Register Diagram

<!-- image -->

Table 44-23: FIR\_INIDX Register Fields
...
Figure 44-22: FIR\_INMOD Register Diagram

<!-- image -->

Table 44-24: FIR\_INMOD Register Fields
...
Figure 44-23: FIR\_MACSTAT Register Diagram

<!-- image -->

Table 44-25: FIR\_MACSTAT Register Fields
...
Table 44-25: FIR\_MACSTAT Register Fields (Continued)
...
Figure 44-24: FIR\_OUTBASE Register Diagram

<!-- image -->

Table 44-26: FIR\_OUTBASE Register Fields
...
Figure 44-25: FIR\_OUTCNT Register Diagram

<!-- image -->

Table 44-27: FIR\_OUTCNT Register Fields
...
Figure 44-26: FIR\_OUTIDX Register Diagram

<!-- image -->

Table 44-28: FIR\_OUTIDX Register Fields
...
Figure 44-27: FIR\_OUTMOD Register Diagram

<!-- image -->

Table 44-29: FIR\_OUTMOD Register Fields
...
Figure 44-28: FIR\_SCTL1 Register Diagram

<!-- image -->

Table 44-30: FIR\_SCTL1 Register Fields
...
Figure 44-29: FIR\_SCTL2 Register Diagram

<!-- image -->

Table 44-31: FIR\_SCTL2 Register Fields
...
Figure 44-30: FIR\_SGCTL Register Diagram

<!-- image -->

Table 44-32: FIR\_SGCTL Register Fields
