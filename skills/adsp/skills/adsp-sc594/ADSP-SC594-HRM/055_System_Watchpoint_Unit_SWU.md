...
<!-- source: 055_System_Watchpoint_Unit_SWU.pdf | original pages 3310–3334 -->

## 48   System Watchpoint Unit (SWU)
...
## ADSP-2159x\_SC592\_SC594 SWU Register List
...
Table 48-1: ADSP-2159x\_SC592\_SC594 SWU Register List
...
## 48.2.2 SWU Interrupt List

## 48.2.3 SWU Trigger List
...
Figure 48-1: System Watchpoint Unit Top-Level Block Diagram
...
## ADSP-2159x\_SC592\_SC594 SWU Register Descriptions

System Watchpoint Unit (SWU) contains the following registers.

Table 48-2: ADSP-2159x\_SC592\_SC594 SWU Register List
...
Figure 48-3: SWU\_CNT[n] Register Diagram

<!-- image -->

Table 48-3: SWU\_CNT[n] Register Fields
...
Figure 48-4: SWU\_CTL[n] Register Diagram

<!-- image -->

Table 48-4: SWU\_CTL[n] Register Fields
...
| 14 (R/W)           | TRGEN      | 1 Bandwidth Mode Trigger Enable. Each SWU_CTL[n].TRGEN bit controls whether a match for a watchpoint group generates a trigger event. This feature is valid in both bandwidth and watchpoint modes. 0 Disable                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 13 (R/W)           | INTEN      | 1 Enable Interrupt Enable. Each SWU_CTL[n].INTEN bit controls whether a match for a watchpoint group generates an interrupt. This feature is valid in both bandwidth and watchpoint modes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| 4                  |            | 0 Match on all transaction 1 Match only secure transactions                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| (R/W)              | IDCMPEN    | ID Comparison Enable. Each SWU_CTL[n].IDCMPEN bit controls the ID comparison operation of an SWU watchpoint group. The ID match is based on comparison with the value in the SWU_ID[n] register.                                                                                                                                                                                                                                                                                                                                                                                      |
...
Figure 48-5: SWU\_CUR[n] Register Diagram

<!-- image -->

Table 48-5: SWU\_CUR[n] Register Fields
...
Figure 48-6: SWU\_GCTL Register Diagram

<!-- image -->

Table 48-6: SWU\_GCTL Register Fields
...
Figure 48-7: SWU\_GSTAT Register Diagram

<!-- image -->

Table 48-7: SWU\_GSTAT Register Fields
...
Table 48-7: SWU\_GSTAT Register Fields (Continued)
...
Figure 48-8: SWU\_HIST[n] Register Diagram

Table 48-8: SWU\_HIST[n] Register Fields
...
Figure 48-9: SWU\_ID[n] Register Diagram

<!-- image -->

Table 48-9: SWU\_ID[n] Register Fields
...
Figure 48-10: SWU\_LA[n] Register Diagram

<!-- image -->

Table 48-10: SWU\_LA[n] Register Fields
...
Figure 48-11: SWU\_TARG[n] Register Diagram

<!-- image -->

Table 48-11: SWU\_TARG[n] Register Fields
...
Figure 48-12: SWU\_UA[n] Register Diagram

<!-- image -->

Table 48-12: SWU\_UA[n] Register Fields
