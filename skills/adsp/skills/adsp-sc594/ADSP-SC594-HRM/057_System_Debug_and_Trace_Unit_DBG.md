...
<!-- source: 057_System_Debug_and_Trace_Unit_DBG.pdf | original pages 3370–3486 -->

## 50   System Debug and Trace Unit (DBG)
...
## ADSP-2159x\_SC592\_SC594 CSPFT Register List
...
Table 50-1: ADSP-2159x\_SC592\_SC594 CSPFT Register List
...
Table 50-1: ADSP-2159x\_SC592\_SC594 CSPFT Register List (Continued)
...
## ADSP-2159x\_SC592\_SC594 TAPC Register List
...
Table 50-2: ADSP-2159x\_SC592\_SC594 TAPC Register List
...
Figure 50-1: ADSP-SC58x Block Diagram
...
Table 50-3: System CTI Trigger Connection

| CTI Port      | Input                  | CTI Port        | Output          |
|---------------|------------------------|-----------------|-----------------|
| CTITRIGIN[7]  | From STM ASYNCOUT      | CTITRIGOUT[7:6] | Unused          |
| CTITRIGIN [6] | From STM TRIGOU- THETE |                 |                 |
| CTITRIGIN [5] | From STM TRIG- OUTSW   | CTITRIGOUT[5]   | To TPIU FLUSHIN |
| CTITRIGIN [4] | From STM TRIG- OUTSPTE | CTITRIGOUT[4]   | To ETR TRIGIN   |
...
Table 50-4: ADSP-SC5xx-Core 1/2 CTI Trace Connection
...
Table 50-4: ADSP-SC5xx-Core 1/2 CTI Trace Connection (Continued)
...
## Table 50-5: ADSP-2159x CTI Trace Connection
...
## Table 50-6: 2159x Arm Core CTI Connection
...
## Table 50-7: Trigger Descriptions
...
Table 50-7: Trigger Descriptions (Continued)
...
## ADSP-2159x\_SC592\_SC594 CSPFT Register Descriptions

Program Flow Trace (CSPFT) contains the following registers.

Table 50-8: ADSP-2159x\_SC592\_SC594 CSPFT Register List
...
Table 50-8: ADSP-2159x\_SC592\_SC594 CSPFT Register List (Continued)
...
Figure 50-4: CSPFT\_ACTR[n] Register Diagram

<!-- image -->

Table 50-9: CSPFT\_ACTR[n] Register Fields
...
Figure 50-5: CSPFT\_ACVR[n] Register Diagram

<!-- image -->

Table 50-10: CSPFT\_ACVR[n] Register Fields
...
Figure 50-6: CSPFT\_AUTHSTATUS Register Diagram

<!-- image -->

Table 50-11: CSPFT\_AUTHSTATUS Register Fields
...
Figure 50-7: CSPFT\_CCER Register Diagram

<!-- image -->

Table 50-12: CSPFT\_CCER Register Fields
...
Figure 50-8: CSPFT\_CID0 Register Diagram

<!-- image -->

Table 50-13: CSPFT\_CID0 Register Fields
...
Figure 50-9: CSPFT\_CID1 Register Diagram

<!-- image -->

Table 50-14: CSPFT\_CID1 Register Fields
...
Figure 50-10: CSPFT\_CID2 Register Diagram

<!-- image -->

Table 50-15: CSPFT\_CID2 Register Fields
...
Figure 50-11: CSPFT\_CID3 Register Diagram

<!-- image -->

Table 50-16: CSPFT\_CID3 Register Fields
...
Figure 50-12: CSPFT\_CIDCMR Register Diagram

<!-- image -->

Table 50-17: CSPFT\_CIDCMR Register Fields
...
Figure 50-13: CSPFT\_CIDCVR[n] Register Diagram

<!-- image -->

Table 50-18: CSPFT\_CIDCVR[n] Register Fields
...
Figure 50-14: CSPFT\_CLAIMCLR Register Diagram

<!-- image -->

Table 50-19: CSPFT\_CLAIMCLR Register Fields
...
Figure 50-15: CSPFT\_CLAIMSET Register Diagram

<!-- image -->

Table 50-20: CSPFT\_CLAIMSET Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                               |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------|
| 3:0                | TAGS       | Supported Tags.                                                                                                       |
| (R1/W1S)           |            | The CSPFT_CLAIMSET.TAGS bit field sets bits in the claim tag and finds the number of bits supported by the claim tag. |

## Counter Enable Event Register

The CSPFT\_CNTENR[n] register describes the event that enables the corresponding counter.

Figure 50-16: CSPFT\_CNTENR[n] Register Diagram

<!-- image -->

Table 50-21: CSPFT\_CNTENR[n] Register Fields
...
Table 50-21: CSPFT\_CNTENR[n] Register Fields (Continued)
...
Figure 50-17: CSPFT\_CNTRLDEVR[n] Register Diagram

<!-- image -->

Table 50-22: CSPFT\_CNTRLDEVR[n] Register Fields
...
Table 50-22: CSPFT\_CNTRLDEVR[n] Register Fields (Continued)
...
Figure 50-18: CSPFT\_CNTRLDVR[n] Register Diagram

<!-- image -->

Table 50-23: CSPFT\_CNTRLDVR[n] Register Fields
...
Figure 50-19: CSPFT\_CNTVR[n] Register Diagram

<!-- image -->

Table 50-24: CSPFT\_CNTVR[n] Register Fields
...
Figure 50-20: CSPFT\_CTL Register Diagram

<!-- image -->

Table 50-25: CSPFT\_CTL Register Fields
...
Table 50-25: CSPFT\_CTL Register Fields (Continued)
...
Figure 50-21: CSPFT\_DEVTYPE Register Diagram

<!-- image -->

Table 50-26: CSPFT\_DEVTYPE Register Fields
...
Figure 50-22: CSPFT\_EXTOUTEVR[n] Register Diagram

<!-- image -->

Table 50-27: CSPFT\_EXTOUTEVR[n] Register Fields
...
Table 50-27: CSPFT\_EXTOUTEVR[n] Register Fields (Continued)
...
Figure 50-23: CSPFT\_HWFEAT Register Diagram

<!-- image -->

Table 50-28: CSPFT\_HWFEAT Register Fields
...
Table 50-28: CSPFT\_HWFEAT Register Fields (Continued)
...
Figure 50-24: CSPFT\_LAR Register Diagram

<!-- image -->

Table 50-29: CSPFT\_LAR Register Fields
...
Figure 50-25: CSPFT\_LSR Register Diagram

<!-- image -->

Table 50-30: CSPFT\_LSR Register Fields
...
Figure 50-26: CSPFT\_PID0 Register Diagram

<!-- image -->

Table 50-31: CSPFT\_PID0 Register Fields
...
Figure 50-27: CSPFT\_PID1 Register Diagram

<!-- image -->

Table 50-32: CSPFT\_PID1 Register Fields
...
Figure 50-28: CSPFT\_PID2 Register Diagram

<!-- image -->

Table 50-33: CSPFT\_PID2 Register Fields
...
Figure 50-29: CSPFT\_PID3 Register Diagram

<!-- image -->

Table 50-34: CSPFT\_PID3 Register Fields
...
Figure 50-30: CSPFT\_PID4 Register Diagram

<!-- image -->

Table 50-35: CSPFT\_PID4 Register Fields
...
Figure 50-31: CSPFT\_STAT Register Diagram

<!-- image -->

Table 50-36: CSPFT\_STAT Register Fields
...
Figure 50-32: CSPFT\_SYNCFR Register Diagram

<!-- image -->

Table 50-37: CSPFT\_SYNCFR Register Fields
...
Figure 50-33: CSPFT\_TRACEIDR Register Diagram

<!-- image -->

Table 50-38: CSPFT\_TRACEIDR Register Fields
...
## ADSP-2159x\_SC592\_SC594 TAPC Register Descriptions

TAPC (TAPC) contains the following registers.

Table 50-39: ADSP-2159x\_SC592\_SC594 TAPC Register List
...
Figure 50-34: TAPC\_DBGCTL Register Diagram

<!-- image -->

Table 50-40: TAPC\_DBGCTL Register Fields
...
Table 50-40: TAPC\_DBGCTL Register Fields (Continued)
...
Figure 50-35: TAPC\_IDCODE Register Diagram

<!-- image -->

Table 50-41: TAPC\_IDCODE Register Fields
...
Figure 50-36: TAPC\_SDBGKEY0 Register Diagram

<!-- image -->

Table 50-42: TAPC\_SDBGKEY0 Register Fields
...
Figure 50-37: TAPC\_SDBGKEY1 Register Diagram

<!-- image -->

Table 50-43: TAPC\_SDBGKEY1 Register Fields
...
Figure 50-38: TAPC\_SDBGKEY2 Register Diagram

<!-- image -->

Table 50-44: TAPC\_SDBGKEY2 Register Fields
...
Figure 50-39: TAPC\_SDBGKEY3 Register Diagram

<!-- image -->

Table 50-45: TAPC\_SDBGKEY3 Register Fields
...
Figure 50-40: TAPC\_SDBGKEY\_CTL Register Diagram

<!-- image -->

Table 50-46: TAPC\_SDBGKEY\_CTL Register Fields
...
Figure 50-41: TAPC\_SDBGKEY\_STAT Register Diagram

<!-- image -->

Table 50-47: TAPC\_SDBGKEY\_STAT Register Fields
...
Figure 50-42: TAPC\_USERCODE Register Diagram

<!-- image -->

Table 50-48: TAPC\_USERCODE Register Fields
...
## ADSP-2159x\_SC592\_SC594 CTI Register Descriptions

CSCTI\_Register\_Definitions (CTI) contains the following registers.

Table 50-49: ADSP-2159x\_SC592\_SC594 CTI Register List

| Name            | Description                            |
|-----------------|----------------------------------------|
| CTI_ASICCTL     | External Multiplexor Control Register  |
| CTI_AUTHSTATUS  | Authentication Status                  |
| CTI_CLAIMCLR    | Claim Tag Clear Register               |
| CTI_CLAIMSET    | Claim Tag Set Register                 |
| CTI_COMPID0     | Component ID0                          |
| CTI_COMPID1     | Component ID1                          |
| CTI_COMPID2     | Component ID2                          |
| CTI_COMPID3     | Component ID3                          |
| CTI_CTIAPPCLEAR | CTI Application Trigger Clear Register |
| CTI_CTIAPPPULSE | CTI Application Pulse Register         |
| CTI_CTIAPPSET   | CTI Application Trigger Set Register   |

Table 50-49: ADSP-2159x\_SC592\_SC594 CTI Register List (Continued)
...
| CTI_ITCHIN           | Integration Test Channel Input           |
| CTI_ITCHINACK        | ITCHINACK                                |
| CTI_ITCHOUT          | Integration Test Channel Output          |
| CTI_ITCHOUTACK       | ITCHOUTACK                               |
| CTI_ITCTRL           | Integration Mode Control Register        |
| CTI_ITTRIGIN         | Integration Test Trigger Input           |
...
| CTI_ITTRIGOUT    | Integration Test Trigger Output |
...
The CTI\_ASICCTL register is for I/O port control.

Figure 50-43: CTI\_ASICCTL Register Diagram

<!-- image -->

Table 50-50: CTI\_ASICCTL Register Fields
...
The CTI\_AUTHSTATUS register reports the current status of the authentication control signals.

Figure 50-44: CTI\_AUTHSTATUS Register Diagram

<!-- image -->

Table 50-51: CTI\_AUTHSTATUS Register Fields
...
The CTI\_CLAIMCLR register forms one half of the claim tag value. On writes, this location enables individual bits to be cleared. On reads, it returns the current claim tag value.

Figure 50-45: CTI\_CLAIMCLR Register Diagram

<!-- image -->

Table 50-52: CTI\_CLAIMCLR Register Fields
...
The CTI\_CLAIMSET register forms one half of the claim tag value. On writes, this location enables individual bits to be set. On reads, it returns the number of bits that can be set.

Figure 50-46: CTI\_CLAIMSET Register Diagram

<!-- image -->

Table 50-53: CTI\_CLAIMSET Register Fields
...
The CTI\_COMPID0 register is part of the set of component identification registers.

Figure 50-47: CTI\_COMPID0 Register Diagram

<!-- image -->

Table 50-54: CTI\_COMPID0 Register Fields
...
The CTI\_COMPID1 register is part of the set of component identification registers.

Figure 50-48: CTI\_COMPID1 Register Diagram

<!-- image -->

Table 50-55: CTI\_COMPID1 Register Fields
...
The CTI\_COMPID2 register is part of the set of component identification registers.

Figure 50-49: CTI\_COMPID2 Register Diagram

<!-- image -->

Table 50-56: CTI\_COMPID2 Register Fields
...
The CTI\_COMPID3 register is part of the set of component identification registers.

Figure 50-50: CTI\_COMPID3 Register Diagram

<!-- image -->

Table 50-57: CTI\_COMPID3 Register Fields
...
The CTI\_CTIAPPSET register allows software to set any channel output. Software can use this register to generate a channel event in place of a hardware source on a trigger input. This register must not be used in a system where all events are sent as single-cycle pulses. It is only retained for compatibility with older systems and software. The register is implemented before the CTI\_CTIGATE register. Therefore, for the channel event to propagate outside the CTI, the corresponding CTIGATE bit must be set to 1.

Figure 50-53: CTI\_CTIAPPSET Register Diagram

<!-- image -->

Table 50-60: CTI\_CTIAPPSET Register Fields
...
If the channel input is driven by a source that generates single cycle pulses, the CTI\_CTICHINSTATUS register is generally read as 0.

Figure 50-54: CTI\_CTICHINSTATUS Register Diagram

<!-- image -->

Table 50-61: CTI\_CTICHINSTATUS Register Fields
...
The CTI\_CTICHOUTSTATUS register only has meaning if the trigger source drives static levels, rather than pulses.

Figure 50-55: CTI\_CTICHOUTSTATUS Register Diagram

<!-- image -->

Table 50-62: CTI\_CTICHOUTSTATUS Register Fields
...
The CTI\_CTICONTROL register enables and disables the CTI.

Figure 50-56: CTI\_CTICONTROL Register Diagram

<!-- image -->

Table 50-63: CTI\_CTICONTROL Register Fields
...
The CTI\_CTIGATE register enables the propagation of channel events out of the CTI, one bit per channel.

Figure 50-57: CTI\_CTIGATE Register Diagram

<!-- image -->

Table 50-64: CTI\_CTIGATE Register Fields
...
The CTI\_CTIINEN1 register maps trigger inputs to channels in the cross trigger system. The CTIINEN registers are bit maps that allow the trigger input to be mapped to any channel output, including none (0x0) and all (0xF). There is one register per trigger input, so it is possible to map any combination of trigger inputs to any channel outputs.
...
Figure 50-59: CTI\_CTIINEN1 Register Diagram

<!-- image -->

Table 50-66: CTI\_CTIINEN1 Register Fields
...
The CTI\_CTIINEN2 register maps trigger inputs to channels in the cross trigger system. The CTIINEN registers are bit maps that allow the trigger input to be mapped to any channel output, including none (0x0) and all (0xF). There is one register per trigger input, so it is possible to map any combination of trigger inputs to any channel outputs.

CTIINEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-60: CTI\_CTIINEN2 Register Diagram

<!-- image -->

Table 50-67: CTI\_CTIINEN2 Register Fields
...
The CTI\_CTIINEN3 register maps trigger inputs to channels in the cross trigger system. The CTIINEN registers are bit maps that allow the trigger input to be mapped to any channel output, including none (0x0) and all (0xF). There is one register per trigger input, so it is possible to map any combination of trigger inputs to any channel outputs.

CTIINEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-61: CTI\_CTIINEN3 Register Diagram

<!-- image -->

Table 50-68: CTI\_CTIINEN3 Register Fields
...
Figure 50-62: CTI\_CTIINEN4 Register Diagram

<!-- image -->

Table 50-69: CTI\_CTIINEN4 Register Fields
...
The CTI\_CTIINEN5 register maps trigger inputs to channels in the cross trigger system. The CTIINEN registers are bit maps that allow the trigger input to be mapped to any channel output, including none (0x0) and all (0xF). There is one register per trigger input, so it is possible to map any combination of trigger inputs to any channel outputs.

CTIINEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-63: CTI\_CTIINEN5 Register Diagram

<!-- image -->

Table 50-70: CTI\_CTIINEN5 Register Fields
...
The CTI\_CTIINEN6 register maps trigger inputs to channels in the cross trigger system. The CTIINEN registers are bit maps that allow the trigger input to be mapped to any channel output, including none (0x0) and all (0xF). There is one register per trigger input, so it is possible to map any combination of trigger inputs to any channel outputs.

CTIINEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-64: CTI\_CTIINEN6 Register Diagram

<!-- image -->

Table 50-71: CTI\_CTIINEN6 Register Fields
...
The CTI\_CTIINEN7 register maps trigger inputs to channels in the cross trigger system. The CTIINEN registers are bit maps that allow the trigger input to be mapped to any channel output, including none (0x0) and all (0xF). There is one register per trigger input, so it is possible to map any combination of trigger inputs to any channel outputs.

CTIINEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-65: CTI\_CTIINEN7 Register Diagram

<!-- image -->

Table 50-72: CTI\_CTIINEN7 Register Fields
...
The CTI\_CTIINTACK register acknowledges trigger outputs.
...
Figure 50-66: CTI\_CTIINTACK Register Diagram

<!-- image -->

Table 50-73: CTI\_CTIINTACK Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                  |
|--------------------|------------|--------------------------------------------------------------------------------------------------------------------------|
| 7:0 (R0/W)         | INTACK     | Interrupt Acknowledge. The CTI_CTIINTACK.INTACK bit field acknowledges the corresponding event output. It is write only. |

## CTI Channel to Trigger 0 Enable Register

The CTI\_CTIOUTEN0 register maps channels in the cross trigger system to trigger outputs. The CTIOUTEN registers are bit maps that allow any channel input to be mapped to the trigger output, including none (0x0) and all (0xF). There is one register per trigger output so it is possible to map any channel input to any combination of trigger outputs.

Figure 50-67: CTI\_CTIOUTEN0 Register Diagram

<!-- image -->

Table 50-74: CTI\_CTIOUTEN0 Register Fields
...
The CTI\_CTIOUTEN1 register maps channels in the cross trigger system to trigger outputs. The CTIOUTEN registers are bit maps that allow any channel input to be mapped to the trigger output, including none (0x0) and all (0xF). There is one register per trigger output so it is possible to map any channel input to any combination of trigger outputs.
...
Figure 50-68: CTI\_CTIOUTEN1 Register Diagram

<!-- image -->

Table 50-75: CTI\_CTIOUTEN1 Register Fields
...
The CTI\_CTIOUTEN2 register maps channels in the cross trigger system to trigger outputs. The CTIOUTEN registers are bit maps that allow any channel input to be mapped to the trigger output, including none (0x0) and all (0xF). There is one register per trigger output so it is possible to map any channel input to any combination of trigger outputs.

CTIOUTEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-69: CTI\_CTIOUTEN2 Register Diagram

<!-- image -->

Table 50-76: CTI\_CTIOUTEN2 Register Fields
...
The CTI\_CTIOUTEN3 register maps channels in the cross trigger system to trigger outputs. The CTIOUTEN registers are bit maps that allow any channel input to be mapped to the trigger output, including none (0x0) and all (0xF). There is one register per trigger output so it is possible to map any channel input to any combination of trigger outputs.

CTIOUTEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-70: CTI\_CTIOUTEN3 Register Diagram

<!-- image -->

Table 50-77: CTI\_CTIOUTEN3 Register Fields
...
The CTI\_CTIOUTEN4 register maps channels in the cross trigger system to trigger outputs. The CTIOUTEN registers are bit maps that allow any channel input to be mapped to the trigger output, including none (0x0) and all (0xF). There is one register per trigger output so it is possible to map any channel input to any combination of trigger outputs.

CTIOUTEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-71: CTI\_CTIOUTEN4 Register Diagram

<!-- image -->

Table 50-78: CTI\_CTIOUTEN4 Register Fields
...
The CTI\_CTIOUTEN5 register maps channels in the cross trigger system to trigger outputs. The CTIOUTEN registers are bit maps that allow any channel input to be mapped to the trigger output, including none (0x0) and all (0xF). There is one register per trigger output so it is possible to map any channel input to any combination of trigger outputs.

CTIOUTEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-72: CTI\_CTIOUTEN5 Register Diagram

<!-- image -->

Table 50-79: CTI\_CTIOUTEN5 Register Fields
...
The CTI\_CTIOUTEN6 register maps channels in the cross trigger system to trigger outputs. The CTIOUTEN registers are bit maps that allow any channel input to be mapped to the trigger output, including none (0x0) and all (0xF). There is one register per trigger output so it is possible to map any channel input to any combination of trigger outputs.

CTIOUTEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-73: CTI\_CTIOUTEN6 Register Diagram

<!-- image -->

Table 50-80: CTI\_CTIOUTEN6 Register Fields
...
The CTI\_CTIOUTEN7 register maps channels in the cross trigger system to trigger outputs. The CTIOUTEN registers are bit maps that allow any channel input to be mapped to the trigger output, including none (0x0) and all (0xF). There is one register per trigger output so it is possible to map any channel input to any combination of trigger outputs.

CTIOUTEN1-31 registers are IMPLEMENTATION-DEFINED. If they are not implemented, the locations are RO and return 0. If they are implemented, they are RW and return a reset value of 0.

Figure 50-74: CTI\_CTIOUTEN7 Register Diagram

<!-- image -->

Table 50-81: CTI\_CTIOUTEN7 Register Fields
...
If the event\_in input is driven by a source that generates single cycle pulses, the CTI\_CTITRIGINSTATUS register is generally read as 0.

Figure 50-75: CTI\_CTITRIGINSTATUS Register Diagram

<!-- image -->

Table 50-82: CTI\_CTITRIGINSTATUS Register Fields
...
The CTI\_CTITRIGOUTSTATUS register only has meaning if the trigger source drives static levels, rather than pulses.

Figure 50-76: CTI\_CTITRIGOUTSTATUS Register Diagram

<!-- image -->

Table 50-83: CTI\_CTITRIGOUTSTATUS Register Fields
...
The CTI\_DEVID register is implementation defined for each part number and designer. The register indicates the capabilities of the component.

Figure 50-77: CTI\_DEVID Register Diagram

<!-- image -->

Table 50-84: CTI\_DEVID Register Fields
...
A debugger can use the CTI\_DEVTYPE register to get information about a component that has an unrecognized part number.

Figure 50-78: CTI\_DEVTYPE Register Diagram

<!-- image -->

Table 50-85: CTI\_DEVTYPE Register Fields
...
Figure 50-79: CTI\_ITCHIN Register Diagram

<!-- image -->

Table 50-86: CTI\_ITCHIN Register Fields
...
Figure 50-80: CTI\_ITCHINACK Register Diagram

<!-- image -->

Table 50-87: CTI\_ITCHINACK Register Fields
...
The CTI\_ITCHOUT register is used to generate channel events. Writing to the register creates a single pulse on the output. The CTI\_ITCHOUT register is self-clearing.

Figure 50-81: CTI\_ITCHOUT Register Diagram

<!-- image -->

Table 50-88: CTI\_ITCHOUT Register Fields
...
Figure 50-82: CTI\_ITCHOUTACK Register Diagram

<!-- image -->

Table 50-89: CTI\_ITCHOUTACK Register Fields
...
The CTI\_ITCTRL register is used to enable topology detection.

Figure 50-83: CTI\_ITCTRL Register Diagram

<!-- image -->

Table 50-90: CTI\_ITCTRL Register Fields
...
Figure 50-85: CTI\_ITTRIGINACK Register Diagram

<!-- image -->

Table 50-92: CTI\_ITTRIGINACK Register Fields
...
Figure 50-86: CTI\_ITTRIGOUT Register Diagram

<!-- image -->

Table 50-93: CTI\_ITTRIGOUT Register Fields
...
Figure 50-87: CTI\_ITTRIGOUTACK Register Diagram

<!-- image -->

Table 50-94: CTI\_ITTRIGOUTACK Register Fields
...
Figure 50-88: CTI\_LAR Register Diagram

<!-- image -->

Table 50-95: CTI\_LAR Register Fields
...
Figure 50-89: CTI\_LSR Register Diagram

<!-- image -->

Table 50-96: CTI\_LSR Register Fields
...
The CTI\_PERIPHID0 register is part of the set of peripheral identification registers.

Figure 50-90: CTI\_PERIPHID0 Register Diagram

<!-- image -->

Table 50-97: CTI\_PERIPHID0 Register Fields
...
The CTI\_PERIPHID1 register is part of the set of peripheral identification registers.

Figure 50-91: CTI\_PERIPHID1 Register Diagram

<!-- image -->

Table 50-98: CTI\_PERIPHID1 Register Fields
...
The CTI\_PERIPHID2 register is part of the set of peripheral identification registers.

Figure 50-92: CTI\_PERIPHID2 Register Diagram

<!-- image -->

Table 50-99: CTI\_PERIPHID2 Register Fields
...
The CTI\_PERIPHID3 register is part of the set of peripheral identification registers.

Figure 50-93: CTI\_PERIPHID3 Register Diagram

<!-- image -->

Table 50-100: CTI\_PERIPHID3 Register Fields
...
The CTI\_PERIPHID4 register is part of the set of peripheral identification registers.

Figure 50-94: CTI\_PERIPHID4 Register Diagram

<!-- image -->

Table 50-101: CTI\_PERIPHID4 Register Fields
...
The CTI\_PERIPHID5 register is part of the set of peripheral identification registers.

Figure 50-95: CTI\_PERIPHID5 Register Diagram

<!-- image -->

Table 50-102: CTI\_PERIPHID5 Register Fields
...
The CTI\_PERIPHID6 register is part of the set of peripheral identification registers.

Figure 50-96: CTI\_PERIPHID6 Register Diagram

<!-- image -->

Table 50-103: CTI\_PERIPHID6 Register Fields
...
The CTI\_PERIPHID7 register is part of the set of peripheral identification registers.

Figure 50-97: CTI\_PERIPHID7 Register Diagram

<!-- image -->

Table 50-104: CTI\_PERIPHID7 Register Fields
