...
<!-- source: 007_Reset_Control_Unit_RCU.pdf | original pages 211–238 -->
...
Table 5-1: ADSP-SC59x RCU Register List
...
## ADSP-SC59x RCU Trigger List

Table 5-2: ADSP-SC59x RCU Trigger List Generators

| Trigger ID   | Name   | Description   | Sensitivity   |
|--------------|--------|---------------|---------------|
|              |        | None          |               |

Table 5-3: ADSP-SC59x RCU Trigger List Receivers
...
|-------------------------------------------------------------|-----------------|----------------------------------------------------------------------------------------------------------------|
| SYSCLK clock domain system reset by the Fault Unit (FMU) or | System Reset    | All functional units, except: • RTC (if present) • RCU_STAT • RCU_BCODE • the units on the VDDEXT power domain |
...
## ADSP-SC59x RCU Register Descriptions

Reset Control Unit (RCU) contains the following registers.

Table 5-5: ADSP-SC59x RCU Register List
...
Table 5-5: ADSP-SC59x RCU Register List (Continued)
...
Figure 5-1: RCU\_BCODE Register Diagram

<!-- image -->

Table 5-6: RCU\_BCODE Register Fields
...
Table 5-6: RCU\_BCODE Register Fields (Continued)
...
Figure 5-2: RCU\_CRCTL Register Diagram

<!-- image -->

Table 5-7: RCU\_CRCTL Register Fields
...
Figure 5-3: RCU\_CRSTAT Register Diagram

<!-- image -->

Table 5-8: RCU\_CRSTAT Register Fields
...
Figure 5-4: RCU\_CTL Register Diagram

<!-- image -->

Table 5-9: RCU\_CTL Register Fields
...
Table 5-9: RCU\_CTL Register Fields (Continued)
...
Figure 5-5: RCU\_MSG Register Diagram

<!-- image -->

Table 5-10: RCU\_MSG Register Fields
...
Table 5-10: RCU\_MSG Register Fields (Continued)
...
Figure 5-6: RCU\_MSG\_CLR Register Diagram

<!-- image -->

Table 5-11: RCU\_MSG\_CLR Register Fields
...
Figure 5-7: RCU\_MSG\_SET Register Diagram

<!-- image -->

Table 5-12: RCU\_MSG\_SET Register Fields
...
Figure 5-8: RCU\_SIDIS Register Diagram

<!-- image -->

Table 5-13: RCU\_SIDIS Register Fields
...
|                    |            | 1 RCU_SI_DISABLE_REQ[0] system interface disable                                                                                                                                            |
...
Figure 5-9: RCU\_SISTAT Register Diagram

<!-- image -->

Table 5-14: RCU\_SISTAT Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                     | Description/Enumeration                                                                                                     |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| 2:0 (R/NW)         | SI[n]      | System Interface Disable Acknowledge [2:0]. The RCU_SISTAT.SI[n] bit indicates whether a functional unit has or has not ac- | System Interface Disable Acknowledge [2:0]. The RCU_SISTAT.SI[n] bit indicates whether a functional unit has or has not ac- |
|                    |            | 0                                                                                                                           | No Acknowledge                                                                                                              |
...
Figure 5-10: RCU\_SRRQSTAT Register Diagram

<!-- image -->

Table 5-15: RCU\_SRRQSTAT Register Fields
...
Figure 5-11: RCU\_STAT Register Diagram

Table 5-16: RCU\_STAT Register Fields
...
Table 5-16: RCU\_STAT Register Fields (Continued)
...
Figure 5-12: RCU\_SVECT0 Register Diagram

<!-- image -->

Table 5-17: RCU\_SVECT0 Register Fields
...
Figure 5-13: RCU\_SVECT1 Register Diagram

<!-- image -->

Table 5-18: RCU\_SVECT1 Register Fields
...
Figure 5-14: RCU\_SVECT2 Register Diagram

<!-- image -->

Table 5-19: RCU\_SVECT2 Register Fields
...
Figure 5-15: RCU\_SVECT\_LCK Register Diagram

<!-- image -->

Table 5-20: RCU\_SVECT\_LCK Register Fields
