...
<!-- source: 010_L2_System_Memory.pdf | original pages 333–386 -->
...
## ADSP-SC59x L2CTL Register List
...
Table 8-1: ADSP-SC59x L2CTL Register List
...
Table 8-1: ADSP-SC59x L2CTL Register List (Continued)
...
## ADSP-SC59x L2CTL Interrupt List

Table 8-2: ADSP-SC59x L2CTL Interrupt List
...
## ADSP-SC59x L2CTL Trigger List

Table 8-3: ADSP-SC59x L2CTL Trigger List Generators

|   Trigger ID | Name       | Description            | Sensitivity   |
|--------------|------------|------------------------|---------------|
|           42 | L2CTL0_EVT | L2CTL0 L2 Memory Event | Level         |

Table 8-4: ADSP-SC59x L2CTL Trigger List Receivers
...
The ADSP-SC59x Complete L2 System Memory Block Diagram shows the complete L2 system memory, including the memory block instance L2CTL0. The L2CTL0 block contains boot ROM code for Arm and eight banks of L2 RAM containing 256 Kbytes each. The Arm reset ISR (location 0x00000000) is mapped to this block.

Figure 8-1: ADSP-SC59x Complete L2 System Block Diagram
...
Table 8-5: Fixed Priority With Priority Elevation (Continued)
...
## ADSP-SC59x L2CTL Register Descriptions

L2 Memory Controller (L2CTL) contains the following registers.

Table 8-6: ADSP-SC59x L2CTL Register List
...
Table 8-6: ADSP-SC59x L2CTL Register List (Continued)
...
Figure 8-5: L2CTL\_CTL Register Diagram

<!-- image -->

Table 8-7: L2CTL\_CTL Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                               |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 31 (R/W)           | LOCK       | Lock. If the global lock bit is set ( SPU_CTL.GLCK bit =1) and the L2CTL_CTL.LOCK bit is set, the L2CTL_CTL register is read only (locked).                                                           |
| 28 (R/W)           | DISURP     | Disable Urgent Request Priority. The L2CTL_CTL.DISURP disables urgent request priority mode for all L2 banks. 0 Enable URP                                                                            |
| 8 (R/W)            | BK8EDIS    | Bank 8 (ROM) ECC Disable. The L2CTL_CTL.BK8EDIS bit disables L2 bank 8 (ROM) ECC operation. ECC operation should be enabled or disable before the start of L2 bank access. 0 Enable ECC 1 Disable ECC |

Table 8-7: L2CTL\_CTL Register Fields (Continued)
...
| 2 (R/W)            | BK2EDIS    | 0 Enable ECC                                                                                                                                                   |
| 2 (R/W)            | BK2EDIS    | 1 Disable ECC                                                                                                                                                  |

Table 8-7: L2CTL\_CTL Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                   |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1 (R/W)            | BK1EDIS    | Bank 1 ECC Disable. The L2CTL_CTL.BK1EDIS bit disables L2 bank 1 ECC operation. ECC operation should be enabled or disable before the start of L2 bank access. 0 Enable ECC               |
| 0 (R/W)            | BK0EDIS    | Bank 0 ECC Disable. The L2CTL_CTL.BK0EDIS bit disables L2 bank 0 ECC operation. ECC operation should be enabled or disable before the start of L2 bank access. 0 Enable ECC 1 Disable ECC |
...
Figure 8-6: L2CTL\_EADDR0 Register Diagram

<!-- image -->

Table 8-8: L2CTL\_EADDR0 Register Fields
...
Figure 8-7: L2CTL\_EADDR1 Register Diagram

<!-- image -->

Table 8-9: L2CTL\_EADDR1 Register Fields
...
Figure 8-8: L2CTL\_EADDR2 Register Diagram

<!-- image -->

Table 8-10: L2CTL\_EADDR2 Register Fields
...
Figure 8-9: L2CTL\_EADDR3 Register Diagram

<!-- image -->

Table 8-11: L2CTL\_EADDR3 Register Fields
...
Figure 8-10: L2CTL\_EADDR4 Register Diagram

<!-- image -->

Table 8-12: L2CTL\_EADDR4 Register Fields
...
Figure 8-11: L2CTL\_ERRADDR0 Register Diagram

<!-- image -->

Table 8-13: L2CTL\_ERRADDR0 Register Fields
...
Figure 8-12: L2CTL\_ERRADDR1 Register Diagram

<!-- image -->

Table 8-14: L2CTL\_ERRADDR1 Register Fields
...
Figure 8-13: L2CTL\_ERRADDR2 Register Diagram

<!-- image -->

Table 8-15: L2CTL\_ERRADDR2 Register Fields
...
Figure 8-14: L2CTL\_ERRADDR3 Register Diagram

<!-- image -->

Table 8-16: L2CTL\_ERRADDR3 Register Fields
...
Figure 8-15: L2CTL\_ERRADDR4 Register Diagram

<!-- image -->

Table 8-17: L2CTL\_ERRADDR4 Register Fields
...
Figure 8-16: L2CTL\_ERRADDR5 Register Diagram

<!-- image -->

Table 8-18: L2CTL\_ERRADDR5 Register Fields
...
Figure 8-17: L2CTL\_ERRADDR6 Register Diagram

<!-- image -->

Table 8-19: L2CTL\_ERRADDR6 Register Fields
...
Figure 8-18: L2CTL\_ERRADDR7 Register Diagram

<!-- image -->

Table 8-20: L2CTL\_ERRADDR7 Register Fields
...
Figure 8-19: L2CTL\_ERRADDR8 Register Diagram

<!-- image -->

Table 8-21: L2CTL\_ERRADDR8 Register Fields
...
Figure 8-20: L2CTL\_ET0 Register Diagram

<!-- image -->

Table 8-22: L2CTL\_ET0 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                            |
|--------------------|------------|----------------------------------------------------------------------------------------------------|
| 20:8 (R/NW)        | ID         | Error ID. The L2CTL_ET0.ID bits hold the bus requester ID of the access that caused an er- ror.    |
| 4 (R/NW)           | RDWR       | Read/Write Error. The L2CTL_ET0.RDWR bit indicates whether a read or write access caused an error. |
...
Table 8-22: L2CTL\_ET0 Register Fields (Continued)
...
Figure 8-21: L2CTL\_ET1 Register Diagram

<!-- image -->

Table 8-23: L2CTL\_ET1 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                        |
|--------------------|------------|--------------------------------------------------------------------------------------------------------------------------------|
| 20:8 (R/NW)        | ID         | Error ID. The L2CTL_ET1.ID bits hold the bus requester ID of the access that caused an er- ror.                                |
...
Figure 8-22: L2CTL\_ET2 Register Diagram

<!-- image -->

Table 8-24: L2CTL\_ET2 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                            |
|--------------------|------------|----------------------------------------------------------------------------------------------------|
| 20:8 (R/NW)        | ID         | Error ID. The L2CTL_ET2.ID bits hold the bus requester ID of the access that caused an er- ror.    |
...
Figure 8-23: L2CTL\_ET3 Register Diagram

<!-- image -->

Table 8-25: L2CTL\_ET3 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                            |
|--------------------|------------|----------------------------------------------------------------------------------------------------|
| 20:8 (R/NW)        | ID         | Error ID. The L2CTL_ET3.ID bits hold the bus requester ID of the access that caused an er- ror.    |
...
Figure 8-24: L2CTL\_ET4 Register Diagram

<!-- image -->

Table 8-26: L2CTL\_ET4 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                            |
|--------------------|------------|----------------------------------------------------------------------------------------------------|
| 20:8 (R/NW)        | ID         | Error ID. The L2CTL_ET4.ID bits hold the bus requester ID of the access that caused an er- ror.    |
...
Figure 8-25: L2CTL\_INIT Register Diagram

<!-- image -->

Table 8-27: L2CTL\_INIT Register Fields
...
Table 8-27: L2CTL\_INIT Register Fields (Continued)
...
Figure 8-26: L2CTL\_ISTAT Register Diagram

<!-- image -->

Table 8-28: L2CTL\_ISTAT Register Fields
...
Table 8-28: L2CTL\_ISTAT Register Fields (Continued)
...
Figure 8-27: L2CTL\_PCTL Register Diagram

<!-- image -->

Table 8-29: L2CTL\_PCTL Register Fields
...
Table 8-29: L2CTL\_PCTL Register Fields (Continued)
...
Figure 8-28: L2CTL\_REVID Register Diagram

<!-- image -->

Table 8-30: L2CTL\_REVID Register Fields
...
Figure 8-29: L2CTL\_RPCR0 Register Diagram

<!-- image -->

Table 8-31: L2CTL\_RPCR0 Register Fields
...
Figure 8-30: L2CTL\_RPCR1 Register Diagram

<!-- image -->

Table 8-32: L2CTL\_RPCR1 Register Fields
...
Figure 8-31: L2CTL\_SADR Register Diagram

<!-- image -->

Table 8-33: L2CTL\_SADR Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                      |
|--------------------|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 31:0               | VALUE      | Scrub Start Address. The L2CTL_SADR.VALUE bits hold the scrub start address. The writes to this regis- ter can be prevented by setting the L2_SCTL.LOCK and the global lock. |
| (R/W)              |            |                                                                                                                                                                              |
...
Figure 8-32: L2CTL\_SCNT Register Diagram

<!-- image -->

Table 8-34: L2CTL\_SCNT Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                        |
|--------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 17:0 (R/W)         | VALUE      | Scrub Count. The L2CTL_SCNT.VALUE bits determines the number of 128-bit locations scrub- bed starting from the start address. Ensure value programmed is less than the total ad- dressable 128-bit L2 RAM locations available. |
...
Figure 8-33: L2CTL\_SCTL Register Diagram

<!-- image -->

Table 8-35: L2CTL\_SCTL Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                |
|--------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| 31 (R/W)           | LOCK       | Lock. If the global lock bit is set ( SPU_CTL.GLCK bit =1) and the L2CTL_SCTL.LOCK bit is set, the L2CTL_SCTL register is read only (locked). 0 Unlock |
| 30 (R/W)           | SEN        | Scrub Enable. The L2CTL_SCTL.SEN bits enable automatic scrub.                                                                                          |

Table 8-35: L2CTL\_SCTL Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                |
|--------------------|------------|------------------------------------------------------------------------------------------------------------------------|
| 15:0 (R/W)         | SRT        | Scrub Rate. The L2CTL_SCTL.SRT bits determines the number of clock cycles that elapsed be- tween two automatic scrubs. |

## Status Register

The L2CTL\_STAT register indicates ECC error status, refresh register status, and bus error status of Port0 and Port1.

Figure 8-34: L2CTL\_STAT Register Diagram

<!-- image -->

Table 8-36: L2CTL\_STAT Register Fields
...
Table 8-36: L2CTL\_STAT Register Fields (Continued)
...
| 1 (R/W1C)          | ERR1       | Error Port 1. The L2CTL_STAT.ERR1 indicates whether the L2CTL has detected a bus access er- ror on L2s bus port 1.       |
| 1 (R/W1C)          | ERR1       | 0 No Error                                                                                                               |
| 1 (R/W1C)          | ERR1       | 1 Bus Access                                                                                                             |
| 0 (R/W1C)          | ERR0       | Error Error Port 0. The L2CTL_STAT.ERR0 indicates whether the L2CTL has detected a bus access er- ror on L2s bus port 0. |
...
Figure 8-35: L2CTL\_STAT\_1 Register Diagram

<!-- image -->

Table 8-37: L2CTL\_STAT\_1 Register Fields
...
Figure 8-36: L2CTL\_WPCR0 Register Diagram

<!-- image -->

Table 8-38: L2CTL\_WPCR0 Register Fields
...
Figure 8-37: L2CTL\_WPCR1 Register Diagram

<!-- image -->

Table 8-39: L2CTL\_WPCR1 Register Fields
