...
<!-- source: 011_Dynamic_Memory_Controller_DMC.pdf | original pages 387–480 -->
...
Table 9-1: ADSP-SC59x DMC Register List
...
Table 9-1: ADSP-SC59x DMC Register List (Continued)
...
Table 9-2: ADSP-SC59x DMC Register List
...
```
6. Bits [20:16] of the DMC_DDR_SCRATCH_4 holds the write leveling code for lane 0. 7. Increment or decrement the write leveling code as needed. Write it to the
```

- DMC\_DDR\_LANE0\_CTL1.BYPCODE bit. Set the DMC\_DDR\_LANE0\_CTL1.BYPDELCHAINEN
...
## ADSP-SC59x DMC Register Descriptions

Dynamic Memory Controller (DMC) contains the following registers.

Table 9-5: ADSP-SC59x DMC Register List
...
Table 9-5: ADSP-SC59x DMC Register List (Continued)
...
Figure 9-1: DMC\_CFG Register Diagram

<!-- image -->

Table 9-6: DMC\_CFG Register Fields
...
Table 9-6: DMC\_CFG Register Fields (Continued)
...
Figure 9-2: DMC\_CTL Register Diagram

<!-- image -->

Table 9-7: DMC\_CTL Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                             | Description/Enumeration                                                                                             |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|
| 28 (R0/W)          | DDR3_2133  | DDR3_2133. The DMC_CTL.DDR3_2133 bit starts the ZQ calibration long sequence. Note that this bit always reads as 0. | DDR3_2133. The DMC_CTL.DDR3_2133 bit starts the ZQ calibration long sequence. Note that this bit always reads as 0. |
| 27 (R/W)           | AL_EN      | AL_EN. When set, enables 800MHz operation                                                                           | AL_EN. When set, enables 800MHz operation                                                                           |
|                    |            | 0                                                                                                                   | Disables greater than 667MHz operation                                                                              |
|                    |            | 1                                                                                                                   | Enables greater than 667MHz operation                                                                               |

Table 9-7: DMC\_CTL Register Fields (Continued)
...
| 26 (R/W)           | RL_DQS     | 0 Enable                                                                                                                                                                                                                                                                                            |
| 26 (R/W)           | RL_DQS     | 1 Disable                                                                                                                                                                                                                                                                                           |
...
| 14 (R0/W)          | RDECMDDAT  | Enhanced Read Command and Data Buffer Enable. Enhanced Read Command and Data Buffer Enable. 0 DDR AXI interface works with legacy Read Data and Command Buffer depth. (default state) 1 DDR AXI interface works with enhanced (double) Read Data and Command Buffer depth. 0 - No effect 1 - Enable |
| 14 (R0/W)          | RDECMDDAT  | 0 No effect                                                                                                                                                                                                                                                                                         |
| 14 (R0/W)          | RDECMDDAT  | 1 Start PHY DLL calibration                                                                                                                                                                                                                                                                         |
...
| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                                                                                                                               |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 12 (R/W)           | PPREF      | Postpone Refresh. The DMC_CTL.PPREF bit enables postponing the DMCs sending of auto-refresh                                                                                                                                                                                                                                                                                                           |
| 11:9 (R/W)         | RDTOWR     | 1 Enable Postpone Refresh Read-to-Write Cycle. The DMC_CTL.RDTOWR bits select the number of cycles that the DMCadds when a write operation follows a read operation. For proper operation, it should be program- med with the value of 010. 0 1 Cycle Added from JEDEC Spec Value 1 2 Cycles Added from JEDEC Spec Value 2 3 Cycles Added from JEDEC Spec Value                                       |
| 8 (R/W)            | ADDRMODE   | 4 5 Cycles Added from JEDEC Spec Value 5 6 Cycles Added from JEDEC Spec Value 6 7 Cycles Added from JEDEC Spec Value 7 8 Cycles Added from JEDEC Spec Value (Page/Bank) Mode. DMC_CTL.ADDRMODE bit selects whether the DMCuses page or bank inter- for addressing. When using page interleaving, the bank address bits follow significant column address bits. When using bank interleaving, the bank |
|                    |            | Addressing The leaving the most address bits follow the most significant row address bits. 0 Bank Interleaving 1 Page Interleaving Reset SDRAM.                                                                                                                                                                                                                                                       |
| 7 (R/W)            | RESET      | The DMC_CTL.RESET bit starts the reset sequence. Note that this bit always reads as 0. 0 No effect                                                                                                                                                                                                                                                                                                    |

Table 9-7: DMC\_CTL Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                  |
|--------------------|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6 (R/W)            | PREC       | Precharge. The DMC_CTL.PREC bit enables precharge, which closes DRAM rows immediately after access. When disabled, all accesses result in the respective DRAM rows remaining open, until the DMCneeds to close them.                     |
...
| 3 (R/W)            | SRREQ      | 0 Disable Self-Refresh                                                                                                                                                                                                                   |
| 3 (R/W)            | SRREQ      | 1 Enable Self-Refresh                                                                                                                                                                                                                    |
...
| 2 (R0/W)           | INIT       | 0 No Effect                                                                                                                                                                                                                              |
| 2 (R0/W)           | INIT       | 1 Start DRAM Initialization                                                                                                                                                                                                              |
| 0 (R/W)            | DDR3EN     | DDR3 Mode. The DMC_CTL.DDR3EN bit selects whether the DMCoperates in DDR3 mode.                                                                                                                                                          |
| 0 (R/W)            | DDR3EN     | 0 Reserved                                                                                                                                                                                                                               |
| 0 (R/W)            | DDR3EN     | 1 Enable DDR3 mode                                                                                                                                                                                                                       |

## DLL Control Register

The DMC\_DLLCTL register holds the programmable parameters associated with the DLLs within the DMC PHY.

Figure 9-3: DMC\_DLLCTL Register Diagram

<!-- image -->

Table 9-8: DMC\_DLLCTL Register Fields
...
Figure 9-4: DMC\_DT\_CALIB\_ADDR Register Diagram

<!-- image -->

Table 9-9: DMC\_DT\_CALIB\_ADDR Register Fields
...
Figure 9-5: DMC\_DT\_DATA\_CALIB\_DATA0 Register Diagram

<!-- image -->

Table 9-10: DMC\_DT\_DATA\_CALIB\_DATA0 Register Fields
...
Figure 9-6: DMC\_DT\_DATA\_CALIB\_DATA1 Register Diagram

<!-- image -->

Table 9-11: DMC\_DT\_DATA\_CALIB\_DATA1 Register Fields
...
Figure 9-7: DMC\_EFFCTL Register Diagram

<!-- image -->

Table 9-12: DMC\_EFFCTL Register Fields
...
Table 9-12: DMC\_EFFCTL Register Fields (Continued)
...
Figure 9-8: DMC\_EMR3 Register Diagram

<!-- image -->

Table 9-13: DMC\_EMR3 Register Fields
...
Figure 9-9: DMC\_MR Register Diagram

<!-- image -->

Table 9-14: DMC\_MR Register Fields
...
Table 9-14: DMC\_MR Register Fields (Continued)
...
Figure 9-10: DMC\_MR1 Register Diagram

<!-- image -->

Table 9-15: DMC\_MR1 Register Fields
...
Table 9-15: DMC\_MR1 Register Fields (Continued)
...
Figure 9-11: DMC\_MR2 Register Diagram

<!-- image -->

Table 9-16: DMC\_MR2 Register Fields
...
Table 9-16: DMC\_MR2 Register Fields (Continued)
...
Figure 9-12: DMC\_MSK Register Diagram

<!-- image -->

Table 9-17: DMC\_MSK Register Fields
...
Table 9-17: DMC\_MSK Register Fields (Continued)
...
Figure 9-13: DMC\_PM\_CTL Register Diagram

<!-- image -->

Table 9-18: DMC\_PM\_CTL Register Fields
...
Table 9-18: DMC\_PM\_CTL Register Fields (Continued)
...
Figure 9-14: DMC\_PM\_IDCYDQ\_CNT Register Diagram

<!-- image -->

Table 9-19: DMC\_PM\_IDCYDQ\_CNT Register Fields
...
Figure 9-15: DMC\_PM\_IDPG\_CNT Register Diagram

<!-- image -->

Table 9-20: DMC\_PM\_IDPG\_CNT Register Fields
...
Figure 9-16: DMC\_PM\_PGHT\_CNT Register Diagram

<!-- image -->

Table 9-21: DMC\_PM\_PGHT\_CNT Register Fields
...
Figure 9-17: DMC\_PM\_PGMS\_CNT Register Diagram

<!-- image -->

Table 9-22: DMC\_PM\_PGMS\_CNT Register Fields
...
Figure 9-18: DMC\_PM\_RD2WRTA\_CNT Register Diagram

<!-- image -->

Table 9-23: DMC\_PM\_RD2WRTA\_CNT Register Fields
...
Figure 9-19: DMC\_PM\_REF\_CNT Register Diagram

<!-- image -->

Table 9-24: DMC\_PM\_REF\_CNT Register Fields
...
Figure 9-20: DMC\_PM\_WR2RDTA\_CNT Register Diagram

<!-- image -->

Table 9-25: DMC\_PM\_WR2RDTA\_CNT Register Fields
...
Figure 9-21: DMC\_PRIO Register Diagram

<!-- image -->

Table 9-26: DMC\_PRIO Register Fields
...
Figure 9-22: DMC\_PRIO2 Register Diagram

<!-- image -->

Table 9-27: DMC\_PRIO2 Register Fields
...
Figure 9-23: DMC\_PRIOMSK Register Diagram

<!-- image -->

Table 9-28: DMC\_PRIOMSK Register Fields
...
Figure 9-24: DMC\_PRIOMSK2 Register Diagram

<!-- image -->

Table 9-29: DMC\_PRIOMSK2 Register Fields
...
Figure 9-25: DMC\_RDDATABUFID1 Register Diagram

<!-- image -->

Table 9-30: DMC\_RDDATABUFID1 Register Fields
...
Figure 9-26: DMC\_RDDATABUFID2 Register Diagram

<!-- image -->

Table 9-31: DMC\_RDDATABUFID2 Register Fields
...
Figure 9-27: DMC\_RDDATABUFMSK1 Register Diagram

<!-- image -->

Table 9-32: DMC\_RDDATABUFMSK1 Register Fields
...
Figure 9-28: DMC\_RDDATABUFMSK2 Register Diagram

<!-- image -->

Table 9-33: DMC\_RDDATABUFMSK2 Register Fields
...
Figure 9-29: DMC\_RDD\_BUFHT\_CNT Register Diagram

<!-- image -->

Table 9-34: DMC\_RDD\_BUFHT\_CNT Register Fields
...
Figure 9-30: DMC\_SCB\_PM\_BRLN\_CNT Register Diagram

<!-- image -->

Table 9-35: DMC\_SCB\_PM\_BRLN\_CNT Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                         |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 31:0 (R/NW)        | VALUE      | SCB performance monitor register for showing the count of number of times AXI transfer of burst length selected by performance control register is encountered. |
...
Figure 9-31: DMC\_SCB\_PM\_BRSZ\_CNT Register Diagram

<!-- image -->

Table 9-36: DMC\_SCB\_PM\_BRSZ\_CNT Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                       |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 31:0 (R/NW)        | VALUE      | SCB performance monitor register for showing the count of number of times AXI transfer of burst size selected by performance control register is encountered. |
...
Figure 9-32: DMC\_SCB\_PM\_IDRDDCY\_CNT Register Diagram

<!-- image -->

Table 9-37: DMC\_SCB\_PM\_IDRDDCY\_CNT Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                            |
|--------------------|------------|----------------------------------------------------------------------------------------------------|
| 31:0 (R/NW)        | VALUE      | SCB performance monitor register for showing the count of number idle cycles on the read data bus. |

## SCB Performance Monitor Idle Cycle Count Register

The DMC\_SCB\_PM\_IDWRDCY\_CNT register reports the count of number idle cycles on the write data bus.

Figure 9-33: DMC\_SCB\_PM\_IDWRDCY\_CNT Register Diagram

<!-- image -->

Table 9-38: DMC\_SCB\_PM\_IDWRDCY\_CNT Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                             |
|--------------------|------------|-----------------------------------------------------------------------------------------------------|
| 31:0 (R/NW)        | VALUE      | SCB performance monitor register for showing the count of number idle cycles on the write data bus. |
...
Figure 9-34: DMC\_STAT Register Diagram

<!-- image -->

Table 9-39: DMC\_STAT Register Fields
...
Table 9-39: DMC\_STAT Register Fields (Continued)
...
Figure 9-35: DMC\_TR0 Register Diagram

<!-- image -->

Table 9-40: DMC\_TR0 Register Fields
...
Table 9-40: DMC\_TR0 Register Fields (Continued)
...
Figure 9-36: DMC\_TR1 Register Diagram

<!-- image -->

Table 9-41: DMC\_TR1 Register Fields
...
Figure 9-37: DMC\_TR2 Register Diagram

<!-- image -->

Table 9-42: DMC\_TR2 Register Fields
...
Table 9-42: DMC\_TR2 Register Fields (Continued)
...
Table 9-43: ADSP-SC59x DMC Register List
...
Figure 9-38: DMC\_DDR\_CA\_CTL Register Diagram

<!-- image -->

Table 9-44: DMC\_DDR\_CA\_CTL Register Fields
...
Table 9-44: DMC\_DDR\_CA\_CTL Register Fields (Continued)
...
Figure 9-39: DMC\_DDR\_LANE0\_CTL0 Register Diagram

<!-- image -->

Table 9-45: DMC\_DDR\_LANE0\_CTL0 Register Fields
...
Table 9-45: DMC\_DDR\_LANE0\_CTL0 Register Fields (Continued)
...
Figure 9-40: DMC\_DDR\_LANE0\_CTL1 Register Diagram

<!-- image -->

Table 9-46: DMC\_DDR\_LANE0\_CTL1 Register Fields
...
Figure 9-41: DMC\_DDR\_LANE1\_CTL0 Register Diagram

<!-- image -->

Table 9-47: DMC\_DDR\_LANE1\_CTL0 Register Fields
...
Table 9-47: DMC\_DDR\_LANE1\_CTL0 Register Fields (Continued)
...
Figure 9-42: DMC\_DDR\_LANE1\_CTL1 Register Diagram

<!-- image -->

Table 9-48: DMC\_DDR\_LANE1\_CTL1 Register Fields
...
Figure 9-43: DMC\_DDR\_ROOT\_CTL Register Diagram

<!-- image -->

Table 9-49: DMC\_DDR\_ROOT\_CTL Register Fields
...
Table 9-49: DMC\_DDR\_ROOT\_CTL Register Fields (Continued)
...
Figure 9-44: DMC\_DDR\_SCRATCH\_2 Register Diagram

<!-- image -->

Table 9-50: DMC\_DDR\_SCRATCH\_2 Register Fields
...
Figure 9-45: DMC\_DDR\_SCRATCH\_3 Register Diagram

<!-- image -->

Table 9-51: DMC\_DDR\_SCRATCH\_3 Register Fields
...
Figure 9-46: DMC\_DDR\_SCRATCH\_4 Register Diagram

<!-- image -->

Table 9-52: DMC\_DDR\_SCRATCH\_4 Register Fields
...
Figure 9-47: DMC\_DDR\_SCRATCH\_5 Register Diagram

<!-- image -->

Table 9-53: DMC\_DDR\_SCRATCH\_5 Register Fields
...
Figure 9-48: DMC\_DDR\_SCRATCH\_6 Register Diagram

<!-- image -->

Table 9-54: DMC\_DDR\_SCRATCH\_6 Register Fields
...
Figure 9-49: DMC\_DDR\_SCRATCH\_7 Register Diagram

<!-- image -->

Table 9-55: DMC\_DDR\_SCRATCH\_7 Register Fields
...
Figure 9-50: DMC\_DDR\_ZQ\_CTL0 Register Diagram

<!-- image -->

Table 9-56: DMC\_DDR\_ZQ\_CTL0 Register Fields
...
Figure 9-51: DMC\_DDR\_ZQ\_CTL1 Register Diagram

Table 9-57: DMC\_DDR\_ZQ\_CTL1 Register Fields
...
Figure 9-52: DMC\_DDR\_ZQ\_CTL2 Register Diagram

<!-- image -->

Table 9-58: DMC\_DDR\_ZQ\_CTL2 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                              |
|--------------------|------------|------------------------------------------------------|
| 31 (R/W)           | RTTCALEN   | Pad ODT Strength Calibration Enable.                 |
...
Table 9-58: DMC\_DDR\_ZQ\_CTL2 Register Fields (Continued)
