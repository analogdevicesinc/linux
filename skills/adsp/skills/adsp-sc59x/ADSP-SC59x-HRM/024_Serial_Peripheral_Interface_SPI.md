...
<!-- source: 024_Serial_Peripheral_Interface_SPI.pdf | original pages 1384–1464 -->
...
NOTE: SPI peripherals on the processor operate in the SCLK0 domain. For more details on SCLK programming, refer the Clock Generation Unit (CGU) chapter.
...
Table 22-1: ADSP-SC59x SPI Register List
...
## ADSP-SC59x SPI Interrupt List

Table 22-2: ADSP-SC59x SPI Interrupt List
...
Table 22-2: ADSP-SC59x SPI Interrupt List (Continued)
...
## ADSP-SC59x SPI Trigger List

Table 22-3: ADSP-SC59x SPI Trigger List Generators
...
Table 22-4: ADSP-SC59x SPI Trigger List Receivers
...
## ADSP-SC59x SPI DMA Channel List

Table 22-5: ADSP-SC59x SPI DMA Channel List
...
Figure 22-1: SPI Controller Block Diagram, Quad Mode
...
Figure 22-4: SPI Timing with Lead and Lag Programming (Independent of SPI\_CTL.CPHA Setting)
...
Figure 22-5: SPI Timing with SPI\_DLY.STOP Programming (Independent of SPI\_CTL.CPHA Setting)
...
Figure 22-6: SPI Flow Control Timing in Controller Mode.
...
Figure 22-7: Single-Controller, Multiple-Target Configuration
...
Figure 22-10: Quad Mode Timing for CPHA=0, SOSI=1, 16-Bit Transfer, LSBF=0.
...
Figure 22-11: SPI Transfer Protocol in Fast Mode for SPI\_CTL.CPHA = 0

<!-- image -->

Figure 22-12: SPI Transfer Protocol in Fast Mode for SPI\_CTL.CPHA = 1
...
Table 22-6: Types of Operations
...
Table 22-6: Types of Operations (Continued)
...
Table 22-7: Pins Used to Transmit the Address (ADRPINS)
...
Table 22-8: SPI Read Operations
...
Table 22-10: SPI Control (SPI\_CTL) Register
...
Table 22-11: SPI Receive Control Register (Continued)
...
## ADSP-SC59x SPI Register Descriptions

Serial Peripheral Interface (SPI) contains the following registers.

Table 22-16: ADSP-SC59x SPI Register List
...
Table 22-16: ADSP-SC59x SPI Register List (Continued)
...
Figure 22-20: SPI\_CLK Register Diagram

<!-- image -->

Table 22-17: SPI\_CLK Register Fields
...
Figure 22-21: SPI\_CTL Register Diagram

<!-- image -->

Table 22-18: SPI\_CTL Register Fields
...
Table 22-18: SPI\_CTL Register Fields (Continued)
...
Figure 22-22: SPI\_DLY Register Diagram

<!-- image -->

Table 22-19: SPI\_DLY Register Fields
...
Figure 22-23: SPI\_ILAT Register Diagram

<!-- image -->

Table 22-20: SPI\_ILAT Register Fields
...
Table 22-20: SPI\_ILAT Register Fields (Continued)
...
Figure 22-24: SPI\_ILAT\_CLR Register Diagram

<!-- image -->

Table 22-21: SPI\_ILAT\_CLR Register Fields
...
Table 22-21: SPI\_ILAT\_CLR Register Fields (Continued)
...
Figure 22-25: SPI\_IMSK Register Diagram

<!-- image -->

Table 22-22: SPI\_IMSK Register Fields
...
Table 22-22: SPI\_IMSK Register Fields (Continued)
...
| 2 (R/NW)           | TUWM       | 1 Enable (unmask) interrupt request Transmit Urgent Watermark. The SPI_IMSK.TUWM bit unmasks (enables) or masks (disables) the TUWMinter- rupt. 0 Disable (mask) interrupt request 1 Enable (unmask) interrupt request |
| 1 (R/NW)           | RUWM       | Receive Urgent Watermark. The SPI_IMSK.RUWM bit unmasks (enables) or masks (disables) the RUWMinter- rupt. 0 Disable (mask) interrupt request                                                                          |
...
Figure 22-26: SPI\_IMSK\_CLR Register Diagram

<!-- image -->

Table 22-23: SPI\_IMSK\_CLR Register Fields
...
Table 22-23: SPI\_IMSK\_CLR Register Fields (Continued)
...
Figure 22-27: SPI\_IMSK\_SET Register Diagram

<!-- image -->

Table 22-24: SPI\_IMSK\_SET Register Fields
...
Table 22-24: SPI\_IMSK\_SET Register Fields (Continued)
...
Figure 22-28: SPI\_MMRDH Register Diagram

<!-- image -->

Table 22-25: SPI\_MMRDH Register Fields
...
Table 22-25: SPI\_MMRDH Register Fields (Continued)
...
Figure 22-29: SPI\_MMTOP Register Diagram

<!-- image -->

Table 22-26: SPI\_MMTOP Register Fields
...
Figure 22-30: SPI\_RFIFO Register Diagram

<!-- image -->

Table 22-27: SPI\_RFIFO Register Fields
...
Figure 22-31: SPI\_RWC Register Diagram

<!-- image -->

Table 22-28: SPI\_RWC Register Fields
...
Figure 22-32: SPI\_RWCR Register Diagram

<!-- image -->

Table 22-29: SPI\_RWCR Register Fields
...
Figure 22-33: SPI\_RXCTL Register Diagram

<!-- image -->

Table 22-30: SPI\_RXCTL Register Fields
...
Table 22-30: SPI\_RXCTL Register Fields (Continued)
...
Figure 22-34: SPI\_SLVSEL Register Diagram

<!-- image -->

Table 22-31: SPI\_SLVSEL Register Fields
...
Table 22-31: SPI\_SLVSEL Register Fields (Continued)
...
Figure 22-35: SPI\_STAT Register Diagram

<!-- image -->

Table 22-32: SPI\_STAT Register Fields
...
Table 22-32: SPI\_STAT Register Fields (Continued)
...
| 18:16 (R/NW)       | TFS        | 1 Stall (RDY pin deasserted) SPI_TFIFO Status. The SPI_STAT.TFS bits indicate the status of the SPI_TFIFO . The SPI uses this status when evaluating transmit watermark conditions.                                                                                                                                                         |
...
Figure 22-36: SPI\_TFIFO Register Diagram

<!-- image -->

Table 22-33: SPI\_TFIFO Register Fields
...
Figure 22-37: SPI\_TWC Register Diagram

<!-- image -->

Table 22-34: SPI\_TWC Register Fields
...
Figure 22-38: SPI\_TWCR Register Diagram

<!-- image -->

Table 22-35: SPI\_TWCR Register Fields
...
Figure 22-39: SPI\_TXCTL Register Diagram

<!-- image -->

Table 22-36: SPI\_TXCTL Register Fields
...
Table 22-36: SPI\_TXCTL Register Fields (Continued)
