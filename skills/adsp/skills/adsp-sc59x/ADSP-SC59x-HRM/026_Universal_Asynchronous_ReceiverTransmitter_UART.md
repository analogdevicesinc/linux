...
<!-- source: 026_Universal_Asynchronous_ReceiverTransmitter_UART.pdf | original pages 1532–1584 -->
...
Table 24-1: UART Specifications
...
Table 24-2: ADSP-SC59x UART Register List
...
## ADSP-SC59x UART Interrupt List

Table 24-3: ADSP-SC59x UART Interrupt List
...
Table 24-3: ADSP-SC59x UART Interrupt List (Continued)
...
## ADSP-SC59x UART Trigger List

Table 24-4: ADSP-SC59x UART Trigger List Generators
...
Table 24-5: ADSP-SC59x UART Trigger List Receivers
...
Table 24-5: ADSP-SC59x UART Trigger List Receivers (Continued)
...
## ADSP-SC59x UART DMA Channel List

Table 24-6: ADSP-SC59x UART DMA Channel List
...
Figure 24-2: UART Hardware Flow Control
...
Table 24-7: UART Bit Rate Examples with 100 MHz SCLK0
...
Table 24-7: UART Bit Rate Examples with 100 MHz SCLK0 (Continued)
...
Figure 24-3: Autobaud Detection
...
Figure 24-4: Autobaud Detection Character 0x40
...
Figure 24-5: Bit Stream on a UART TX Pin Transmitting an 'S' Character (0x53)
...
Figure 24-6: UART Frame with Address Bit
...
Figure 24-7: IrDA Transmit Pulse
...
Figure 24-8: IrDA Receiver Pulse Detection
...
Figure 24-9: Transmit Interrupts
...
Figure 24-10: Receive Interrupts
...
## ADSP-SC59x UART Register Descriptions

UART (UART) contains the following registers.

Table 24-9: ADSP-SC59x UART Register List

| Name     | Description         |
|----------|---------------------|
| UART_CLK | Clock Rate Register |

Table 24-9: ADSP-SC59x UART Register List (Continued)
...
Figure 24-11: UART\_CLK Register Diagram

<!-- image -->

Table 24-10: UART\_CLK Register Fields
...
Figure 24-12: UART\_CTL Register Diagram

<!-- image -->

Table 24-11: UART\_CTL Register Fields
...
Table 24-11: UART\_CTL Register Fields (Continued)
...
Figure 24-13: UART\_IMSK Register Diagram

Table 24-12: UART\_IMSK Register Fields
...
Table 24-12: UART\_IMSK Register Fields (Continued)
...
Figure 24-14: UART\_IMSK\_CLR Register Diagram

Table 24-13: UART\_IMSK\_CLR Register Fields
...
Table 24-13: UART\_IMSK\_CLR Register Fields (Continued)
...
Figure 24-15: UART\_IMSK\_SET Register Diagram

<!-- image -->

Table 24-14: UART\_IMSK\_SET Register Fields
...
Table 24-14: UART\_IMSK\_SET Register Fields (Continued)
...
Figure 24-16: UART\_RBR Register Diagram

<!-- image -->

Table 24-15: UART\_RBR Register Fields
...
Figure 24-17: UART\_RSR Register Diagram

<!-- image -->

Table 24-16: UART\_RSR Register Fields
...
Figure 24-18: UART\_RXCNT Register Diagram

<!-- image -->

Table 24-17: UART\_RXCNT Register Fields
...
Figure 24-19: UART\_SCR Register Diagram

<!-- image -->

Table 24-18: UART\_SCR Register Fields
...
Figure 24-20: UART\_STAT Register Diagram

<!-- image -->

Table 24-19: UART\_STAT Register Fields
...
Table 24-19: UART\_STAT Register Fields (Continued)
...
Figure 24-21: UART\_TAIP Register Diagram

<!-- image -->

Table 24-20: UART\_TAIP Register Fields
...
Figure 24-22: UART\_THR Register Diagram

<!-- image -->

Table 24-21: UART\_THR Register Fields
...
Figure 24-23: UART\_TSR Register Diagram

<!-- image -->

Table 24-22: UART\_TSR Register Fields
...
Figure 24-24: UART\_TXCNT Register Diagram

<!-- image -->

Table 24-23: UART\_TXCNT Register Fields
