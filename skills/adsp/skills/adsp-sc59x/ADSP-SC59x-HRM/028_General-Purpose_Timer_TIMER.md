...
<!-- source: 028_General-Purpose_Timer_TIMER.pdf | original pages 1665–1720 -->

## 26   General-Purpose Timer (TIMER)
...
## ADSP-SC59x TIMER Register List
...
Table 26-1: ADSP-SC59x TIMER Register List
...
## ADSP-SC59x TIMER Interrupt List

Table 26-2: ADSP-SC59x TIMER Interrupt List
...
## ADSP-SC59x TIMER Trigger List

Table 26-3: ADSP-SC59x TIMER Trigger List Generators
...
Table 26-3: ADSP-SC59x TIMER Trigger List Generators (Continued)
...
Table 26-4: ADSP-SC59x TIMER Trigger List Receivers
...
Table 26-4: ADSP-SC59x TIMER Trigger List Receivers (Continued)
...
Table 26-5: Timer Signal Routing
...
Table 26-6: Timer Mode Descriptions
...
Table 26-7: Usage of the Period, Width, and Delay Registers in Different Timer Modes

| Timer Mode   | TIMER_TMR[n]_PER   | TIMER_TMR[n]_WID   | TIMER_TMR[n]_DLY   |
|--------------|--------------------|--------------------|--------------------|
| IDLE         | Not writable       | Not writable       | Not writable       |

Table 26-7: Usage of the Period, Width, and Delay Registers in Different Timer Modes  (Continued)
...
Figure 26-2: Signal Generation in Continuous PWMOUT Mode
...
Figure 26-3: Timer Signal Flow in Width Capture Mode
...
Figure 26-4: Example of Width Capture Deasserted Mode (TMODE=b#1011)
...
Figure 26-5: Example of Width Capture Asserted Mode (TMODE=b#1010)
...
Figure 26-6: Example Timing for Width Capture Followed by Period Overflow (TMR\_CFG.TMODE=b#1010)
...
Figure 26-7: Example Timing for Width Capture Followed by Period Overflow (TMR\_CFG.TMODE=b#1011)
...
Figure 26-8: Watchdog Width Mode Timing
...
Table 26-8: Windowed Watchdog Width Mode Interpretation
...
Figure 26-9: Watchdog Period Mode Timing
...
Table 26-9: Windowed Watchdog Period Mode Interpretation
...
Table 26-9: Windowed Watchdog Period Mode Interpretation (Continued)
...
Figure 26-10: EXTCLK Mode Control Flow
...
Table 26-10: Startup Event (Continued)
...
Table 26-12: Overflow Event (On TMR\_PER Register Programming Error Only)
...
Table 26-14: Overflow Event (On another error, such as DELAY + WIDTH ≥ 2 32 - 1)
...
Table 26-16: Startup Event

| TIMER_TMR[ n]_PER   | TIMER_TMR[n]_DLY   | TIMER_TMR[ n]_WID   | TIMER_TMR[ n]_WID + TIMER_TMR[ n]_DLY   | TIMER_ERR_ TYPE   | TIMER_STAT_ILAT (if enabled)   |
|---------------------|--------------------|---------------------|-----------------------------------------|-------------------|--------------------------------|
| =0                  | N/A                | N/A                 | N/A                                     | b#01              | Set                            |

Table 26-16: Startup Event (Continued)

| TIMER_TMR[ n]_PER   | TIMER_TMR[n]_DLY   | TIMER_TMR[ n]_WID   | TIMER_TMR[ n]_WID + TIMER_TMR[ n]_DLY   | TIMER_ERR_ TYPE   | TIMER_STAT_ILAT (if enabled)   |
|---------------------|--------------------|---------------------|-----------------------------------------|-------------------|--------------------------------|
| ≥ 1                 | N/A                | N/A                 | N/A                                     | Unchanged         | Unchanged                      |

Table 26-17: Rollover Event
...
Table 26-18: Overflow Event (On TMR\_PER Register = 0 Only)
...
Table 26-20: Rollover Event

| TIMER_TMR[n]_ PER   | TIMER_TMR[n]_ DLY   | TIMER_TMR[ n]_WID   | TIMER_TMR[ n]_WID + TIMER_TMR[ n]_DLY   | TIMER_ERR_ TYPE   | TIMER_STAT_ILAT (if enabled)   |
|---------------------|---------------------|---------------------|-----------------------------------------|-------------------|--------------------------------|
| ≤ Allowed MIN *1    | Anything < PERIOD   | N/A                 | N/A                                     | b#01              | Set                            |

Table 26-20: Rollover Event (Continued)
...
Table 26-21: Overflow Event

| TIMER_TMR[n]_ PER   | TIMER_TMR[n]_ DLY   | TIMER_TMR[ n]_WID   | TIMER_TMR[ n]_WID + TIMER_TMR[ n]_DLY   | TIMER_ERR_ TYPE   | TIMER_STAT_ILAT (if enabled)   |
|---------------------|---------------------|---------------------|-----------------------------------------|-------------------|--------------------------------|
| Anything            | Anything            | N/A                 | N/A                                     | b#01              | Set                            |

## ADSP-SC59x TIMER Register Descriptions

General-Purpose Timer Block (TIMER) contains the following registers.

Table 26-22: ADSP-SC59x TIMER Register List
...
Table 26-22: ADSP-SC59x TIMER Register List (Continued)
...
Figure 26-11: TIMER\_BCAST\_DLY Register Diagram

<!-- image -->

Table 26-23: TIMER\_BCAST\_DLY Register Fields
...
Figure 26-12: TIMER\_BCAST\_PER Register Diagram

<!-- image -->

Table 26-24: TIMER\_BCAST\_PER Register Fields
...
Figure 26-13: TIMER\_BCAST\_WID Register Diagram

<!-- image -->

Table 26-25: TIMER\_BCAST\_WID Register Fields
...
Figure 26-14: TIMER\_DATA\_ILAT Register Diagram

<!-- image -->

Table 26-26: TIMER\_DATA\_ILAT Register Fields
...
Figure 26-15: TIMER\_DATA\_IMSK Register Diagram

<!-- image -->

Table 26-27: TIMER\_DATA\_IMSK Register Fields
...
Figure 26-16: TIMER\_ERR\_TYPE Register Diagram

<!-- image -->

Table 26-28: TIMER\_ERR\_TYPE Register Fields
...
Table 26-28: TIMER\_ERR\_TYPE Register Fields (Continued)
...
Figure 26-17: TIMER\_RUN Register Diagram

<!-- image -->

Table 26-29: TIMER\_RUN Register Fields
...
Figure 26-18: TIMER\_RUN\_CLR Register Diagram

<!-- image -->

Table 26-30: TIMER\_RUN\_CLR Register Fields
...
Figure 26-19: TIMER\_RUN\_SET Register Diagram

<!-- image -->

Table 26-31: TIMER\_RUN\_SET Register Fields
...
Figure 26-20: TIMER\_STAT\_ILAT Register Diagram

<!-- image -->

Table 26-32: TIMER\_STAT\_ILAT Register Fields
...
Figure 26-21: TIMER\_STAT\_IMSK Register Diagram

<!-- image -->

Table 26-33: TIMER\_STAT\_IMSK Register Fields
...
Figure 26-22: TIMER\_STOP\_CFG Register Diagram

<!-- image -->

Table 26-34: TIMER\_STOP\_CFG Register Fields
...
Figure 26-23: TIMER\_STOP\_CFG\_CLR Register Diagram

<!-- image -->

Table 26-35: TIMER\_STOP\_CFG\_CLR Register Fields
...
Figure 26-24: TIMER\_STOP\_CFG\_SET Register Diagram

<!-- image -->

Table 26-36: TIMER\_STOP\_CFG\_SET Register Fields
...
Figure 26-25: TIMER\_TMR[n]\_CFG Register Diagram

<!-- image -->

Table 26-37: TIMER\_TMR[n]\_CFG Register Fields
...
Table 26-37: TIMER\_TMR[n]\_CFG Register Fields (Continued)
...
Figure 26-26: TIMER\_TMR[n]\_CNT Register Diagram

<!-- image -->

Table 26-38: TIMER\_TMR[n]\_CNT Register Fields
...
Figure 26-27: TIMER\_TMR[n]\_DLY Register Diagram

<!-- image -->

Table 26-39: TIMER\_TMR[n]\_DLY Register Fields
...
Figure 26-28: TIMER\_TMR[n]\_PER Register Diagram

<!-- image -->

Table 26-40: TIMER\_TMR[n]\_PER Register Fields
...
Figure 26-29: TIMER\_TMR[n]\_WID Register Diagram

<!-- image -->

Table 26-41: TIMER\_TMR[n]\_WID Register Fields
...
Figure 26-30: TIMER\_TRG\_IE Register Diagram

<!-- image -->

Table 26-42: TIMER\_TRG\_IE Register Fields
...
Figure 26-31: TIMER\_TRG\_MSK Register Diagram

<!-- image -->

Table 26-43: TIMER\_TRG\_MSK Register Fields
