...
<!-- source: 029_General-Purpose_Counter_CNT.pdf | original pages 1721–1750 -->

## 27   General-Purpose Counter (CNT)
...
Table 27-1: ADSP-SC59x CNT Register List
...
## ADSP-SC59x CNT Interrupt List

Table 27-2: ADSP-SC59x CNT Interrupt List

|   Interrupt ID | Name      | Description   | Sensitivity   | DMA Channel   |
|----------------|-----------|---------------|---------------|---------------|
|            156 | CNT0_STAT | CNT0 Status   | Level         |               |

## ADSP-SC59x CNT Trigger List

Table 27-3: ADSP-SC59x CNT Trigger List Generators
...
Table 27-4: ADSP-SC59x CNT Trigger List Receivers
...
Table 27-5: Quadrature Events and Counting Mechanism
...
Table 27-6: Binary Events and Counting Mechanism
...
Figure 27-1: Programmable Noise Filtering
...
Figure 27-3: Period Register Timing
...
## ADSP-SC59x CNT Register Descriptions

General-Purpose Counter (CNT) contains the following registers.

Table 27-7: ADSP-SC59x CNT Register List
...
Table 27-7: ADSP-SC59x CNT Register List (Continued)
...
Figure 27-4: CNT\_CFG Register Diagram

<!-- image -->

Table 27-8: CNT\_CFG Register Fields
...
Table 27-8: CNT\_CFG Register Fields (Continued)
...
Figure 27-5: CNT\_CMD Register Diagram

<!-- image -->

Table 27-9: CNT\_CMD Register Fields
...
Table 27-9: CNT\_CMD Register Fields (Continued)
...
Figure 27-6: CNT\_CNTR Register Diagram

<!-- image -->

Table 27-10: CNT\_CNTR Register Fields
...
Figure 27-7: CNT\_DEBNCE Register Diagram

<!-- image -->

Table 27-11: CNT\_DEBNCE Register Fields
...
## Table 27-11: CNT\_DEBNCE Register Fields (Continued)
...
Figure 27-8: CNT\_IMSK Register Diagram

<!-- image -->

Table 27-12: CNT\_IMSK Register Fields
...
Table 27-12: CNT\_IMSK Register Fields (Continued)
...
Figure 27-9: CNT\_MAX Register Diagram

<!-- image -->

Table 27-13: CNT\_MAX Register Fields
...
Figure 27-10: CNT\_MIN Register Diagram

<!-- image -->

Table 27-14: CNT\_MIN Register Fields
...
Figure 27-11: CNT\_STAT Register Diagram

<!-- image -->

Table 27-15: CNT\_STAT Register Fields
...
Table 27-15: CNT\_STAT Register Fields (Continued)
