...
<!-- source: 031_Two-Wire_Interface_TWI.pdf | original pages 1815–1857 -->
...
Table 29-1: ADSP-SC59x TWI Register List
...
## ADSP-SC59x TWI Interrupt List

Table 29-2: ADSP-SC59x TWI Interrupt List
...
Figure 29-4: Clock Synchronization
...
Figure 29-6: Start and Stop Conditions
...
Figure 29-7: Repeated Start Followed by Data Receive
...
Figure 29-8: Repeated Start Data Receive Followed by Data Transmit
...
Figure 29-9: Clock Stretching during FIFO Underflow
...
Figure 29-10: Clock Stretching During FIFO Overflow
...
Figure 29-11: Clock Stretching during Repeated Start Condition
...
Figure 29-12: TWI Completer Mode Program Flow

<!-- image -->

Table 29-3: Completer Mode Interaction
...
Figure 29-13: Requester Mode Program Flow
...
Table 29-4: Requester Mode Transmit Setup Interaction
...
Table 29-5: Requester Mode Receive Setup Interaction
...
## ADSP-SC59x TWI Register Descriptions

Two-Wire Interface (TWI) contains the following registers.

Table 29-6: ADSP-SC59x TWI Register List
...
Figure 29-14: TWI\_CLKDIV Register Diagram

<!-- image -->

Table 29-7: TWI\_CLKDIV Register Fields
...
Figure 29-15: TWI\_CTL Register Diagram

<!-- image -->

Table 29-8: TWI\_CTL Register Fields
...
Table 29-8: TWI\_CTL Register Fields (Continued)
...
Figure 29-16: TWI\_FIFOCTL Register Diagram

<!-- image -->

Table 29-9: TWI\_FIFOCTL Register Fields
...
Table 29-9: TWI\_FIFOCTL Register Fields (Continued)
...
Figure 29-17: TWI\_FIFOSTAT Register Diagram

<!-- image -->

Table 29-10: TWI\_FIFOSTAT Register Fields
...
Figure 29-18: TWI\_IMSK Register Diagram

<!-- image -->

Table 29-11: TWI\_IMSK Register Fields
...
Table 29-11: TWI\_IMSK Register Fields (Continued)
...
Figure 29-19: TWI\_ISTAT Register Diagram

<!-- image -->

Table 29-12: TWI\_ISTAT Register Fields
...
Table 29-12: TWI\_ISTAT Register Fields (Continued)
...
Figure 29-20: TWI\_MSTRADDR Register Diagram

<!-- image -->

Table 29-13: TWI\_MSTRADDR Register Fields
...
Figure 29-21: TWI\_MSTRCTL Register Diagram

<!-- image -->

Table 29-14: TWI\_MSTRCTL Register Fields
...
Table 29-14: TWI\_MSTRCTL Register Fields (Continued)
...
| 5 (R/W)            | RSTART     | was NAK'ed by the completer is counted as a sent byte. Repeat Start. The TWI_MSTRCTL.RSTART enables the TWI to issue a repeat start condition at the conclusion of the current transfer ( TWI_MSTRCTL.DCNT =0) and begin the next transfer. The current transfer concludes with updates to the appropriate status and in- terrupt bits. If errors occurred during the previous transfer, a repeat start does not oc-                                                                                                                                                         | was NAK'ed by the completer is counted as a sent byte. Repeat Start. The TWI_MSTRCTL.RSTART enables the TWI to issue a repeat start condition at the conclusion of the current transfer ( TWI_MSTRCTL.DCNT =0) and begin the next transfer. The current transfer concludes with updates to the appropriate status and in- terrupt bits. If errors occurred during the previous transfer, a repeat start does not oc-                                                                                                                                                         |
...
| 2 (R/W)            | DIR        | Transfer Direction for Controller. The TWI_MSTRCTL.DIR selects the transfer direction for the TWI as requester ini- tiated receive or transmit.                                                                                                                                                                                                                                                                                                                                                                                                                              | Transfer Direction for Controller. The TWI_MSTRCTL.DIR selects the transfer direction for the TWI as requester ini- tiated receive or transmit.                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
Figure 29-22: TWI\_MSTRSTAT Register Diagram

<!-- image -->

Table 29-15: TWI\_MSTRSTAT Register Fields
...
Table 29-15: TWI\_MSTRSTAT Register Fields (Continued)
...
Figure 29-23: TWI\_RXDATA16 Register Diagram

<!-- image -->

Table 29-16: TWI\_RXDATA16 Register Fields
...
Figure 29-24: TWI\_RXDATA8 Register Diagram

<!-- image -->

Table 29-17: TWI\_RXDATA8 Register Fields
...
Figure 29-25: TWI\_SLVADDR Register Diagram

<!-- image -->

Table 29-18: TWI\_SLVADDR Register Fields
...
Figure 29-26: TWI\_SLVCTL Register Diagram

<!-- image -->

Table 29-19: TWI\_SLVCTL Register Fields
...
Table 29-19: TWI\_SLVCTL Register Fields (Continued)
...
Figure 29-27: TWI\_SLVSTAT Register Diagram

<!-- image -->

Table 29-20: TWI\_SLVSTAT Register Fields
...
Figure 29-28: TWI\_TXDATA16 Register Diagram

<!-- image -->

Table 29-21: TWI\_TXDATA16 Register Fields
...
Figure 29-29: TWI\_TXDATA8 Register Diagram

<!-- image -->

Table 29-22: TWI\_TXDATA8 Register Fields
