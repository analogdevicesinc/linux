...
<!-- source: 307_Precision_Clock_Generators_PCG.pdf | original pages 2861–2911 -->

## 33   Precision Clock Generators (PCG)
...
Table 33-1: ADSP-SC59x PCG Register List (Continued)
...
## ADSP-SC59x PCG Trigger List

Table 33-2: ADSP-SC59x PCG Trigger List Generators
...
Table 33-3: ADSP-SC59x PCG Trigger List Receivers
...
Table 33-3: ADSP-SC59x PCG Trigger List Receivers (Continued)
...
When CLKIN is chosen as input clock in PCG, the clock source bits ( PCG\_SYNC1.CLKA\_CLKINSEL , PCG\_SYNC1.CLKB\_CLKINSEL ) determine whether the clock source is SYS\_CLKIN0 or SYS\_CLKIN1 .
...
However, if the frame sync divisor is 0 or 1, the PCG's frame sync clock generation unit is bypassed, and the frame sync input is connected directly to the frame sync output. For PCG\_CTLB0.FSDIV =0, 1 the PCG\_PW1 -PCG\_PW4 registers function differently than in normal mode.
...
Figure 33-2: Phase and Pulse Width Settings
...
The symmetric dual DAI architecture allows cross connections between both PCGs (A,B) and (C,D) to the other DAI. Each PCG (A through D) supports an alternative input clock (PCG0\_EXTx\_I)(see Figure 33-1 PCG Block Diagram) which can be sourced via a DAI pin buffer from the other DAI. Note however if routing a source (clock or FS) only DAI pin buffer 2 to 20 can be used (DAI pin buffer 1 is no longer available and is replaced by the DAI CRS buffer for the other DAI).
...
Figure 33-3: Bypass and Inverted Bypass
...
Figure 33-4: One Shot Mode PCG A (MISCA2\_I Input)
...
Figure 33-5: PCG Setup for I 2 S or Left-Justified DAI
...
Table 33-4: Precision Clock Generator Division Ratios (33.330 CLKIN)
...
Figure 33-6: FS Output Synchronization With External Trigger Input
...
## ADSP-SC59x PCG Register Descriptions

Precision Clock Generator (PCG) contains the following registers.

Table 33-5: ADSP-SC59x PCG Register List
...
Table 33-5: ADSP-SC59x PCG Register List (Continued)
...
Figure 33-7: PCG\_CTLA0 Register Diagram

<!-- image -->

Table 33-6: PCG\_CTLA0 Register Fields
...
Figure 33-8: PCG\_CTLA1 Register Diagram

<!-- image -->

Table 33-7: PCG\_CTLA1 Register Fields
...
Figure 33-9: PCG\_CTLB0 Register Diagram

<!-- image -->

Table 33-8: PCG\_CTLB0 Register Fields
...
Figure 33-10: PCG\_CTLB1 Register Diagram

<!-- image -->

Table 33-9: PCG\_CTLB1 Register Fields
...
Figure 33-11: PCG\_CTLC0 Register Diagram

<!-- image -->

Table 33-10: PCG\_CTLC0 Register Fields
...
Figure 33-12: PCG\_CTLC1 Register Diagram

<!-- image -->

Table 33-11: PCG\_CTLC1 Register Fields
...
Figure 33-13: PCG\_CTLD0 Register Diagram

<!-- image -->

Table 33-12: PCG\_CTLD0 Register Fields
...
Figure 33-14: PCG\_CTLD1 Register Diagram

<!-- image -->

Table 33-13: PCG\_CTLD1 Register Fields
...
Figure 33-15: PCG\_CTLE0 Register Diagram

<!-- image -->

Table 33-14: PCG\_CTLE0 Register Fields
...
Figure 33-16: PCG\_CTLE1 Register Diagram

<!-- image -->

Table 33-15: PCG\_CTLE1 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                             |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| 31 (R/W)           | CLKSRC     | Clock Source. The PCG_CTLE1.CLKSRC bit specifies the clock source. 0 CLKIN0 pin selected for clock                                                  |
...
Figure 33-17: PCG\_CTLF0 Register Diagram

<!-- image -->

Table 33-16: PCG\_CTLF0 Register Fields
...
Figure 33-18: PCG\_CTLF1 Register Diagram

<!-- image -->

Table 33-17: PCG\_CTLF1 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                             |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| 31 (R/W)           | CLKSRC     | Clock Source. The PCG_CTLF1.CLKSRC bit specifies the clock source. 0 CLKIN0 pin selected for clock                                                  |
...
Figure 33-19: PCG\_CTLG0 Register Diagram

<!-- image -->

Table 33-18: PCG\_CTLG0 Register Fields
...
Figure 33-20: PCG\_CTLG1 Register Diagram

<!-- image -->

Table 33-19: PCG\_CTLG1 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                             |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| 31 (R/W)           | CLKSRC     | Clock Source. The PCG_CTLG1.CLKSRC bit specifies the clock source. 0 CLKIN0 pin selected for clock                                                  |
...
Figure 33-21: PCG\_CTLH0 Register Diagram

<!-- image -->

Table 33-20: PCG\_CTLH0 Register Fields
...
Figure 33-22: PCG\_CTLH1 Register Diagram

<!-- image -->

Table 33-21: PCG\_CTLH1 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                             |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| 31 (R/W)           | CLKSRC     | Clock Source. The PCG_CTLH1.CLKSRC bit specifies the clock source. 0 CLKIN0 pin selected for clock                                                  |
...
Figure 33-23: PCG\_PW1 Register Diagram

<!-- image -->

Table 33-22: PCG\_PW1 Register Fields
...
| 16 (R/W)           | STROBEB    | One Shot Frame Sync Bypass Mode PCG B. The PCG_PW1.STROBEB bit sets the frame sync pulse in bypass mode for PCG B. This is the duration equal to one period of the DAI_MISCA3_I signal (PCG B) re- peating at the beginning of every frame. |
...
Table 33-22: PCG\_PW1 Register Fields (Continued)
...
Figure 33-24: PCG\_PW2 Register Diagram

<!-- image -->

Table 33-23: PCG\_PW2 Register Fields
...
| 16 (R/W)           | STROBED    | One Shot Frame Sync PCG D. The PCG_PW2.STROBED bit sets the frame sync pulse for PCG Din bypass mode. This is the duration equal to one period of the DAI_MISCA3_I signal (PCG D) re- peating at the beginning of every frame. |
...
Table 33-23: PCG\_PW2 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                         |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0 (R/W)            | STROBEC    | One Shot Frame Sync PCG C. The PCG_PW2.STROBEC bit sets the frame sync pulse for PCG C in bypass mode. This is the duration equal to one period of the DAI_MISCA2_I signal (PCG C) re- peating at the beginning of every frame. |
...
Figure 33-25: PCG\_PW3 Register Diagram

<!-- image -->

Table 33-24: PCG\_PW3 Register Fields
...
| 16 (R/W)           | STROBEF    | One Shot Frame Sync PCG D. The PCG_PW3.STROBEF bit sets the frame sync pulse for PCG F in bypass mode. This is the duration equal to one period of the DAI_MISCA1_I signal (PCG F) re- peating at the beginning of every frame. |
...
| 0 (R/W)            | STROBEE    | One Shot Frame Sync PCG E. The PCG_PW3.STROBEE bit sets the frame sync pulse for PCG E in bypass mode. This is the duration equal to one period of the DAI_MISCA0_I signal (PCG E) re- peating at the beginning of every frame. |

Table 33-24: PCG\_PW3 Register Fields (Continued)
...
Figure 33-26: PCG\_PW4 Register Diagram

<!-- image -->

Table 33-25: PCG\_PW4 Register Fields
...
| 16 (R/W)           | STROBEH    | One Shot Frame Sync PCG H. The PCG_PW4.STROBEH bit sets the frame sync pulse for PCG Hin bypass mode. This is the duration equal to one period of the DAI_MISCA1_I signal (PCG H) re- peating at the beginning of every frame. |
...
Table 33-25: PCG\_PW4 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                         |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0 (R/W)            | STROBEG    | One Shot Frame Sync PCG G. The PCG_PW4.STROBEG bit sets the frame sync pulse for PCG G in bypass mode. This is the duration equal to one period of the DAI_MISCA0_I signal (PCG G) re- peating at the beginning of every frame. |
...
Figure 33-27: PCG\_SYNC1 Register Diagram

<!-- image -->

Table 33-26: PCG\_SYNC1 Register Fields

| Bit No. (Access)   | Bit Name     | Description/Enumeration                                                                                                                                                                                      |
|--------------------|--------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 22 (R/W)           | HWB_TRIGEN   | Hardware Trigger Sync B Enable. The PCG_SYNC1.HWB_TRIGEN bit enables synchronization of clock B and frame sync B with the external frame sync only after an internal receiver trigger for PCG B is received. |
| 21 (R/W)           | FSB_CLKINSEL | CLKIN Source for FSB. The PCG_SYNC1.FSB_CLKINSEL bit enables the CLKIN input source for FSB.                                                                                                                 |
| 21 (R/W)           | FSB_CLKINSEL | 0 CLKIN0                                                                                                                                                                                                     |
| 21 (R/W)           | FSB_CLKINSEL | 1 CLKIN1                                                                                                                                                                                                     |

Table 33-26: PCG\_SYNC1 Register Fields (Continued)

| Bit No. (Access)   | Bit Name      | Description/Enumeration                                                                                                                                                                                      |
|--------------------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 20 (R/W)           | CLKB_CLKINSEL | CLKIN Source for CLKB. The PCG_SYNC1.CLKB_CLKINSEL bit enables the CLKIN input source for CLKB.                                                                                                              |
| 20 (R/W)           | CLKB_CLKINSEL | 0 CLKIN0                                                                                                                                                                                                     |
| 20 (R/W)           | CLKB_CLKINSEL | 1 CLKIN1                                                                                                                                                                                                     |
| 19 (R/W)           | FSBSRC        | Frame Sync B Source. The PCG_SYNC1.FSBSRC bit enables the frame sync B input source.                                                                                                                         |
| 19 (R/W)           | FSBSRC        | 0 Output selected by FSBSOURCE bit                                                                                                                                                                           |
| 19 (R/W)           | FSBSRC        | 1 Clock derived from core PLL selected for frame sync B                                                                                                                                                      |
| 18 (R/W)           | CLKBSRC       | Clock B Source. The PCG_SYNC1.CLKBSRC bit enables the clock B input source.                                                                                                                                  |
| 18 (R/W)           | CLKBSRC       | 0 Output selected by CLKBSOURCE bit                                                                                                                                                                          |
| 18 (R/W)           | CLKBSRC       | 1 Clock derived from core PLL selected for clock B                                                                                                                                                           |
| 17 (R/W)           | CLKB          | Clock B Enable. The PCG_SYNC1.CLKB bit enables synchronization of clock B with the external frame sync.                                                                                                      |
| 17 (R/W)           | CLKB          | 0 Clock disabled                                                                                                                                                                                             |
| 17 (R/W)           | CLKB          | 1 Clock enabled                                                                                                                                                                                              |
...
| 16 (R/W)           | FSB           | 0 Frame sync disabled                                                                                                                                                                                        |
| 16 (R/W)           | FSB           | 1 Frame sync enabled                                                                                                                                                                                         |
| 6 (R/W)            | HWA_TRIGEN    | Hardware Trigger Sync A Enable. The PCG_SYNC1.HWA_TRIGEN bit enables synchronization of clock A and frame sync A with the external frame sync only after an internal receiver trigger for PCG A is received. |
| 5 (R/W)            | FSA_CLKINSEL  | CLKIN Source for FSA. The PCG_SYNC1.FSA_CLKINSEL bit enables the CLKIN input source for FSA.                                                                                                                 |
| 5 (R/W)            | FSA_CLKINSEL  | 0 CLKIN0                                                                                                                                                                                                     |
| 5 (R/W)            | FSA_CLKINSEL  | 1 CLKIN1                                                                                                                                                                                                     |
...
| 3 (R/W)            | FSASRC        | Frame Sync Source. The PCG_SYNC1.FSASRC bit enables the frame sync A input source. 0 Output selected by FSASOURCE bit                                              |
...
Figure 33-28: PCG\_SYNC2 Register Diagram

<!-- image -->

Table 33-27: PCG\_SYNC2 Register Fields
...
Table 33-27: PCG\_SYNC2 Register Fields (Continued)
...
Figure 33-29: PCG\_SYNC3 Register Diagram

<!-- image -->

Table 33-28: PCG\_SYNC3 Register Fields

| Bit No. (Access)   | Bit Name     | Description/Enumeration                                                                                                                                                                                      |
|--------------------|--------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 22 (R/W)           | HWF_TRIGEN   | Hardware Trigger Sync F Enable. The PCG_SYNC3.HWF_TRIGEN bit enables synchronization of clock F and frame sync F with the external frame sync only after an internal receiver trigger for PCG-F is received. |
| 21 (R/W)           | FSF_CLKINSEL | CLKIN Source for FSF. The PCG_SYNC3.FSF_CLKINSEL bit enables the CLKIN input source for FSF.                                                                                                                 |
| 21 (R/W)           | FSF_CLKINSEL | 0 Selects CLKIN0 as source for FSA CLKIN                                                                                                                                                                     |
| 21 (R/W)           | FSF_CLKINSEL | 1 Selects CLKIN1 as source for FSA CLKIN                                                                                                                                                                     |

Table 33-28: PCG\_SYNC3 Register Fields (Continued)
...
| 16                 | FSF           | 0 Clock disabled 1 Clock enabled                                                                                                                                                                             |
| (R/W)              |               | Frame Sync F Enable. The PCG_SYNC3.FSF bit enables synchronization of frame sync F with the external frame sync. 0 Frame sync disabled 1 Frame sync enabled                                                  |
| 6 (R/W)            | HWE_TRIGEN    | Hardware Trigger Sync E Enable. The PCG_SYNC3.HWE_TRIGEN bit enables synchronization of clock E and frame sync E with the external frame sync only after an internal receiver trigger for PCG-E is received. |
| 5 (R/W)            | FSE_CLKINSEL  | CLKIN Source for FSE. The PCG_SYNC3.FSE_CLKINSEL bit enables the CLKIN input source for FSE. 0 Selects CLKIN0 as source for FSA CLKIN                                                                        |
...
| 2 (R/W)            | CLKESRC       | Clock E Source. The PCG_SYNC3.CLKESRC bit enables the clock E input source. 0 Output selected by CLKCSOURCE bit 1 Clock derived from core PLL selected for clock C |
| 1 (R/W)            | CLKE          | Clock E Enable. The PCG_SYNC3.CLKE bit enables synchronization of clock E with the external frame sync. 0 Clock disabled                                           |
...
Figure 33-30: PCG\_SYNC4 Register Diagram

<!-- image -->

Table 33-29: PCG\_SYNC4 Register Fields
...
Table 33-29: PCG\_SYNC4 Register Fields (Continued)
...
| 17 (R/W)           | CLKH          | 1 Clock derived from core PLL selected for clockD Clock HEnable. The PCG_SYNC4.CLKH bit enables synchronization of clock Hwith the external frame sync.                                                      |
| 16                 | FSH           | 0 Clock disabled 1 Clock enabled                                                                                                                                                                             |
| (R/W)              |               | Frame Sync HEnable. The PCG_SYNC4.FSH bit enables synchronization of frame sync Hwith the exter- nal frame sync. 0 Frame sync disabled 1 Frame sync enabled                                                  |
| 6 (R/W)            | HWG_TRIGEN    | Hardware Trigger Sync G Enable. The PCG_SYNC4.HWG_TRIGEN bit enables synchronization of clock G and frame sync G with the external frame sync only after an internal receiver trigger for PCG G is received. |
