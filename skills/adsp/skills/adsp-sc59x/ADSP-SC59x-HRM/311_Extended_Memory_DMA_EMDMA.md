...
<!-- source: 311_Extended_Memory_DMA_EMDMA.pdf | original pages 3059–3089 -->

## 37   Extended Memory DMA (EMDMA)
...
## ADSP-SC59x EMDMA Register List
...
Table 37-1: ADSP-SC59x EMDMA Register List
...
## ADSP-SC59x EMDMA Interrupt List

Table 37-2: ADSP-SC59x EMDMA Interrupt List
...
## ADSP-SC59x EMDMA Trigger List

Table 37-3: ADSP-SC59x EMDMA Trigger List Generators
...
Table 37-4: ADSP-SC59x EMDMA Trigger List Receivers
...
Table 37-5: EMDMA TCBs for Standard DMA
...
Table 37-6: EMDMA TCBs for Standard Circular DMA
...
Table 37-7: EMDMA TCBs for Delay Line DMA
...
Table 37-7: EMDMA TCBs for Delay Line DMA (Continued)
...
Table 37-8: EMDMA TCBs for Scatter/Gather DMA
...
Table 37-9: EMDMA TCBs for Circular Scatter/Gather DMA
...
Table 37-9: EMDMA TCBs for Circular Scatter/Gather DMA (Continued)
...
Table 37-10: EMDMA\_CTL Register Bit to Operating Modes
...
Table 37-10: EMDMA\_CTL Register Bit to Operating Modes (Continued)
...
Figure 37-1: Circular Buffering Write DMA

<!-- image -->

Figure 37-2: Circular Buffering Read DMA

<!-- image -->

Figure 37-3: Standard Write DMA
...
Figure 37-4: Scatter DMA (Writes)

<!-- image -->

Figure 37-5: Gather DMA (Reads)

<!-- image -->

Figure 37-6: Circular Buffering Scatter DMA (Writes)

<!-- image -->

Figure 37-7: Circular Gather DMA (Reads)
...
Table 37-11: Read/Write Index Pre-Modify (Scatter/Gather DMA)
...
Figure 37-8: Write to Delay Line Buffer
...
Figure 37-9: Read From Delay Line Buffer
...
Table 37-12: Read/Write Index Pre-Modify (Scatter/Gather DMA)
...
Table 37-12: Read/Write Index Pre-Modify (Scatter/Gather DMA) (Continued)
...
Table 37-13: ADSP-SC59x EMDMA Register List
...
Figure 37-10: EMDMA\_BASE Register Diagram

<!-- image -->

Table 37-14: EMDMA\_BASE Register Fields
...
Figure 37-11: EMDMA\_BUFLEN Register Diagram

<!-- image -->

Table 37-15: EMDMA\_BUFLEN Register Fields
...
Figure 37-12: EMDMA\_CHNPTR Register Diagram

<!-- image -->

Table 37-16: EMDMA\_CHNPTR Register Fields
...
Figure 37-13: EMDMA\_CNT0 Register Diagram

<!-- image -->

Table 37-17: EMDMA\_CNT0 Register Fields
...
Figure 37-14: EMDMA\_CNT1 Register Diagram

<!-- image -->

Table 37-18: EMDMA\_CNT1 Register Fields
...
Figure 37-16: EMDMA\_INDX0 Register Diagram

<!-- image -->

Table 37-20: EMDMA\_INDX0 Register Fields
...
Figure 37-17: EMDMA\_INDX1 Register Diagram

<!-- image -->

Table 37-21: EMDMA\_INDX1 Register Fields
...
Figure 37-18: EMDMA\_MOD0 Register Diagram

<!-- image -->

Table 37-22: EMDMA\_MOD0 Register Fields
...
Figure 37-19: EMDMA\_MOD1 Register Diagram

<!-- image -->

Table 37-23: EMDMA\_MOD1 Register Fields
...
Figure 37-20: EMDMA\_TCNT Register Diagram

<!-- image -->

Table 37-24: EMDMA\_TCNT Register Fields
...
Figure 37-21: EMDMA\_TPTR Register Diagram

<!-- image -->

Table 37-25: EMDMA\_TPTR Register Fields
