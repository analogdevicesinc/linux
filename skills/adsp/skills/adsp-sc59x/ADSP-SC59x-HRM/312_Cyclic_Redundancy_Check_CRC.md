...
<!-- source: 312_Cyclic_Redundancy_Check_CRC.pdf | original pages 3090–3130 -->
...
Figure 38-1: Memory Flow

<!-- image -->

## ADSP-SC59x CRC Register List
...
Table 38-1: ADSP-SC59x CRC Register List
...
## ADSP-SC59x CRC Interrupt List

Table 38-2: ADSP-SC59x CRC Interrupt List
...
Table 38-3: Data Mirroring Options
...
2. Initialize the CRC\_DCNTRLD register.
2. ADDITIONAL INFORMATION: This value is used to reload the CRC\_DCNT register upon completion of the current CRC operation. If no further operation is needed, then this register can be initialized to zero.
3. Initialize the CRC\_RESULT\_CUR register.
...
4. Initialize the CRC\_COMP register. ADDITIONAL INFORMATION: This register contains the pre-calculated final CRC signature result for the memory region that the software uses in the final compare operation.
5. Initialize the CRC\_INEN register. ADDITIONAL INFORMATION: The CRC module uses this register to enable the generation of the CRC

interrupts for notification of compare errors and block completion. Configure these interrupts, as needed. If enabled, ensure that the corresponding interrupt handlers are also configured.
...
## ADSP-SC59x CRC Register Descriptions

Cyclic Redundancy Check Unit (CRC) contains the following registers.

Table 38-4: ADSP-SC59x CRC Register List
...
Table 38-4: ADSP-SC59x CRC Register List (Continued)
...
Figure 38-3: CRC\_COMP Register Diagram

<!-- image -->

Table 38-5: CRC\_COMP Register Fields
...
Figure 38-4: CRC\_CTL Register Diagram

<!-- image -->

Table 38-6: CRC\_CTL Register Fields
...
Table 38-6: CRC\_CTL Register Fields (Continued)
...
Figure 38-5: CRC\_DCNT Register Diagram

<!-- image -->

Table 38-7: CRC\_DCNT Register Fields
...
Figure 38-6: CRC\_DCNTCAP Register Diagram

<!-- image -->

Table 38-8: CRC\_DCNTCAP Register Fields
...
Figure 38-7: CRC\_DCNTRLD Register Diagram

<!-- image -->

Table 38-9: CRC\_DCNTRLD Register Fields
...
Figure 38-8: CRC\_DFIFO Register Diagram

<!-- image -->

Table 38-10: CRC\_DFIFO Register Fields
...
Figure 38-9: CRC\_FILLVAL Register Diagram

<!-- image -->

Table 38-11: CRC\_FILLVAL Register Fields
...
Figure 38-10: CRC\_INEN Register Diagram

<!-- image -->

Table 38-12: CRC\_INEN Register Fields
...
Figure 38-11: CRC\_INEN\_CLR Register Diagram

<!-- image -->

Table 38-13: CRC\_INEN\_CLR Register Fields
...
Figure 38-12: CRC\_INEN\_SET Register Diagram

<!-- image -->

Table 38-14: CRC\_INEN\_SET Register Fields
...
Figure 38-13: CRC\_POLY Register Diagram

<!-- image -->

Table 38-15: CRC\_POLY Register Fields
...
Figure 38-14: CRC\_RESULT\_CUR Register Diagram

<!-- image -->

Table 38-16: CRC\_RESULT\_CUR Register Fields
...
Figure 38-15: CRC\_RESULT\_FIN Register Diagram

<!-- image -->

Table 38-17: CRC\_RESULT\_FIN Register Fields
...
Figure 38-16: CRC\_STAT Register Diagram

<!-- image -->

Table 38-18: CRC\_STAT Register Fields
...
Table 38-18: CRC\_STAT Register Fields (Continued)
