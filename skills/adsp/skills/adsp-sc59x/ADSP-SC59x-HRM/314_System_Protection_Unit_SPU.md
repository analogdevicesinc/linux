...
<!-- source: 314_System_Protection_Unit_SPU.pdf | original pages 3135–3158 -->

## 40   System Protection Unit (SPU)
...
Table 40-1: ADSP-SC59x SPU Register List
...
Table 40-1: ADSP-SC59x SPU Register List (Continued)
...
## ADSP-SC59x SPU Interrupt List

Table 40-2: ADSP-SC59x SPU Interrupt List
...
Figure 40-1: SPU Write Protect Registers
...
Figure: SPU Write-Protect Register Blocking Access from System Master 0 and Core Master 1 Figure 40-2: SPU Write-Protect Register Blocking Access from System Requester 0 and Core Requester 1
...
Figure 40-4: SPU System-Level Block Diagram
...
1. Determine which peripheral needs protection and locate the corresponding write-protect register ( SPU\_WP[n] ) in the SPU. See the section.
2. Determine the SMMR requesters from which the peripheral needs protection. Then, set the corresponding bit or bits in the write-protect register ( SPU\_WP[n] ) for the peripheral. See the section.
...
1. Determine the peripheral and its corresponding secure peripheral register ( SPU\_SECUREP[n] ) in the SPU. See the section.
...
## ADSP-SC59x SPU Register Descriptions

System Protection Unit (SPU) contains the following registers.

Table 40-3: ADSP-SC59x SPU Register List
...
Figure 40-5: SPU\_CTL Register Diagram

<!-- image -->

Table 40-4: SPU\_CTL Register Fields
...
Figure 40-6: SPU\_SECURECHK Register Diagram

<!-- image -->

Table 40-5: SPU\_SECURECHK Register Fields
...
Figure 40-7: SPU\_SECURECTL Register Diagram

<!-- image -->

Table 40-6: SPU\_SECURECTL Register Fields
...
Table 40-6: SPU\_SECURECTL Register Fields (Continued)
...
Figure 40-8: SPU\_SECUREC[n] Register Diagram

<!-- image -->

Table 40-7: SPU\_SECUREC[n] Register Fields
...
Figure 40-9: SPU\_SECUREP[n] Register Diagram

<!-- image -->

Table 40-8: SPU\_SECUREP[n] Register Fields
...
Figure 40-10: SPU\_STAT Register Diagram

<!-- image -->

Table 40-9: SPU\_STAT Register Fields
...
Figure 40-11: SPU\_WP[n] Register Diagram

<!-- image -->

Table 40-10: SPU\_WP[n] Register Fields
...
Table 40-11: Write-Protect Register and Secure Peripheral Number(n)
...
Table 40-11: Write-Protect Register and Secure Peripheral Number(n) (Continued)
...
|    51 | Reserved                | WP51              | SECUREP51          | N/A                  |
|    52 | Reserved                | WP52              | SECUREP52          | N/A                  |
...
|    59 | Reserved                | WP59              | SECUREP59          | N/A                  |
...
|    90 | Reserved                | WP90              | SECUREP90          | N/A                  |
...
|    92 | Reserved                | WP92              | SECUREP92          | N/A                  |
...
|   110 | Reserved                | WP110             | SECUREP110         | N/A                  |
|   111 | Reserved                | WP111             | SECUREP111         | N/A                  |
|   112 | Reserved                | WP112             | SECUREP112         | N/A                  |
|   113 | L2CTL0                  | WP113             | SECUREP113         | N/A                  |
|   114 | SMPU L2CTL0 CL2 0       | WP114             | SECUREP114         | N/A                  |
|   115 | SMPU L2CTL0 DL2 0       | WP115             | SECUREP115         | N/A                  |
|   116 | SMPU L2CTL0 CL2 1       | WP116             | SECUREP116         | N/A                  |
|   117 | SMPU L2CTL0 DL2 1       | WP117             | SECUREP117         | N/A                  |
|   118 | SMPU L2CTL0 CL2 2       | WP118             | SECUREP118         | N/A                  |
|   119 | SEC0                    | WP119             | SECUREP119         | N/A                  |
|   120 | TRU0                    | WP120             | SECUREP120         | N/A                  |
|   121 | SPU0                    | WP121             | SECUREP121         | N/A                  |

Table 40-11: Write-Protect Register and Secure Peripheral Number(n) (Continued)

|   No. | Peripheral/Block Name   | SPU WPn Mapping   | SECUREPn Mapping   | Controller Capable   |
|-------|-------------------------|-------------------|--------------------|----------------------|
|   122 | RCU0                    | WP122             | SECUREP122         | N/A                  |
|   123 | CGU0                    | WP123             | SECUREP123         | N/A                  |
|   124 | CGU1                    | WP124             | SECUREP124         | N/A                  |
|   125 | CDU0                    | WP125             | SECUREP125         | N/A                  |
|   126 | DPM0                    | WP126             | SECUREP126         | N/A                  |
|   127 | PLL0                    | WP127             | SECUREP127         | N/A                  |
|   128 | PLL1                    | WP128             | SECUREP128         | N/A                  |
|   129 | SWU_L2CTL0_CL2_0        | WP129             | SECUREP129         | N/A                  |
|   130 | SWU_L2CTL0_DL2_0        | WP130             | SECUREP130         | N/A                  |
|   131 | SWU_L2CTL0_CL2_1        | WP131             | SECUREP131         | N/A                  |
|   132 | SWU_L2CTL0_DL2_1        | WP132             | SECUREP132         | N/A                  |
|   133 | SWU SMMR                | WP133             | SECUREP133         | N/A                  |
|   134 | SWU_L2CTL0_CL2_2        | WP134             | SECUREP134         | N/A                  |
|   135 | MDMA2                   | WP135             | SECUREP135         | Yes                  |
|   136 | MDMA3                   | WP136             | SECUREP136         | Yes                  |
|   137 | MDMA7                   | WP137             | SECUREP137         | Yes                  |
|   138 | MLB0                    | WP138             | SECUREP138         | Yes                  |
|   139 | SWU DMC0                | WP139             | SECUREP139         | N/A                  |
|   140 | SMPU DMC0               | WP140             | SECUREP140         | N/A                  |
|   141 | SMPU SPI2               | WP141             | SECUREP141         | N/A                  |
|   142 | MEC0                    | WP142             | SECUREP142         | N/A                  |
|   143 | MEC1                    | WP143             | SECUREP143         | N/A                  |
|   144 | MEC2                    | WP144             | SECUREP144         | N/A                  |
|   145 | CRC0                    | WP145             | SECUREP145         | N/A                  |
|   146 | CRC1                    | WP146             | SECUREP146         | N/A                  |
|   147 | MDMA0 DDE0 CRC0         | WP147             | SECUREP147         | Yes                  |
|   148 | MDMA0 DDE1 CRC0         | WP148             | SECUREP148         | Yes                  |
|   149 | MDMA1 DDE0 CRC1         | WP149             | SECUREP149         | Yes                  |
|   150 | MDMA1 DDE1 CRC1         | WP150             | SECUREP150         | Yes                  |
|   151 | MDMA4 DDE0 CRC2         | WP151             | SECUREP151         | Yes                  |
|   152 | MDMA4 DDE1 CRC2         | WP152             | SECUREP152         | Yes                  |

Table 40-11: Write-Protect Register and Secure Peripheral Number(n) (Continued)

|   No. | Peripheral/Block Name   | SPU WPn Mapping   | SECUREPn Mapping   | Controller Capable   |
|-------|-------------------------|-------------------|--------------------|----------------------|
|   153 | MDMA5 DDE0 CRC3         | WP153             | SECUREP153         | Yes                  |
|   154 | MDMA5 DDE1 CRC3         | WP154             | SECUREP154         | Yes                  |
|   155 | SWU SPI2                | WP155             | SECUREP155         | N/A                  |
|   156 | MISC REG                | WP156             | SECUREP156         | N/A                  |
|   157 | CRC2                    | WP157             | SECUREP157         | N/A                  |
|   158 | CRC3                    | WP158             | SECUREP158         | N/A                  |
|   159 | MDMA6                   | WP159             | SECUREP159         | Yes                  |
|   160 | A55 MISC                | WP160             | SECUREP160         | N/A                  |
|   161 | A55 SYS TIMER WRITE     | WP161             | SECUREP161         | N/A                  |
|   162 | A55 SYS TIMER READ      | WP162             | SECUREP162         | N/A                  |
|   163 | STM0                    | WP163             | SECUREP163         | N/A                  |
|   164 | SH1_IIR1                | WP164             | SECUREP164         | N/A                  |
|   165 | SH1_IIR2                | WP165             | SECUREP165         | N/A                  |
|   166 | SH1_IIR3                | WP166             | SECUREP166         | N/A                  |
|   167 | SH1_FIR                 | WP167             | SECUREP167         | N/A                  |
|   168 | SH1_IIR0                | WP168             | SECUREP168         | N/A                  |
|   169 | SH0_IIR1                | WP169             | SECUREP169         | N/A                  |
|   170 | SH0_IIR2                | WP170             | SECUREP170         | N/A                  |
|   171 | SH0_IIR3                | WP171             | SECUREP171         | N/A                  |
|   172 | SH0_FIR                 | WP172             | SECUREP172         | N/A                  |
|   173 | SH0_IIR0                | WP173             | SECUREP173         | N/A                  |
|   174 | USB0                    | WP174             | SECUREP174         | Yes                  |
|   175 | SDIO0                   | WP175             | SECUREP175         | Yes                  |
|   176 | DAI0                    | WP176             | SECUREP176         | N/A                  |
|   177 | DAI1                    | WP177             | SECUREP177         | N/A                  |
|   178 | CRYPTO SPE              | WP178             | SECUREP178         | Yes                  |
|   179 | CRYPTO PKP              | WP179             | SECUREP179         | N/A                  |
|   180 | DLMDMA0                 | WP180             | SECUREP180         | Yes                  |
|   181 | DAPROM                  | WP181             | SECUREP181         | N/A                  |
|   182 | SHARC0 DBG              | WP182             | SECUREP182         | N/A                  |
|   183 | SHARC0 CTI              | WP183             | SECUREP183         | N/A                  |

Table 40-11: Write-Protect Register and Secure Peripheral Number(n) (Continued)

|   No. | Peripheral/Block Name         | SPU WPn Mapping   | SECUREPn Mapping   | Controller Capable   |
|-------|-------------------------------|-------------------|--------------------|----------------------|
|   184 | SHARC0 PTM                    | WP184             | SECUREP184         | N/A                  |
|   185 | STM                           | WP185             | SECUREP185         | N/A                  |
|   186 | SHARC1 DBG                    | WP186             | SECUREP186         | N/A                  |
|   187 | SHARC1 CTI                    | WP187             | SECUREP187         | N/A                  |
|   188 | SHARC1 PTM                    | WP188             | SECUREP188         | N/A                  |
|   189 | CSTF                          | WP189             | SECUREP189         | N/A                  |
|   190 | ETF                           | WP190             | SECUREP190         | N/A                  |
|   191 | ETR                           | WP191             | SECUREP191         | N/A                  |
|   192 | TPIU                          | WP192             | SECUREP192         | N/A                  |
|   193 | CTI Trace                     | WP193             | SECUREP193         | N/A                  |
|   194 | CTI System                    | WP194             | SECUREP194         | N/A                  |
|   195 | CoreSight Timestamp Generator | WP195             | SECUREP195         | N/A                  |
|   196 | A55 IntegrationROM            | WP196             | SECUREP196         | N/A                  |
|   197 | A55 DBG                       | WP197             | SECUREP197         | N/A                  |
|   198 | A55 PMU                       | WP198             | SECUREP198         | N/A                  |
|   199 | A55 CTI                       | WP199             | SECUREP199         | N/A                  |
|   200 | A55 ETM                       | WP200             | SECUREP200         | N/A                  |
|   201 | TAPCMMR                       | WP201             | SECUREP201         | N/A                  |
|   202 | Debug Control                 | WP202             | SECUREP202         | N/A                  |
|   203 | SWU C0 S1                     | WP203             | SECUREP203         | N/A                  |
|   204 | SWU C0 S2                     | WP204             | SECUREP204         | N/A                  |
|   205 | SWU C1 S1                     | WP205             | SECUREP205         | N/A                  |
|   206 | SWU C1 S2                     | WP206             | SECUREP206         | N/A                  |
|   207 | GIC Port0 0                   | WP207             | SECUREP207         | N/A                  |
|   209 | GIC Port0 2                   | WP209             | SECUREP209         | N/A                  |
|   210 | GIC Port0 3                   | WP210             | SECUREP210         | N/A                  |
|   212 | GIC Port0 5                   | WP212             | SECUREP212         | N/A                  |
|   213 | GIC Port0 6                   | WP213             | SECUREP213         | N/A                  |

## ADSP-SC59x Processor Specific Information
