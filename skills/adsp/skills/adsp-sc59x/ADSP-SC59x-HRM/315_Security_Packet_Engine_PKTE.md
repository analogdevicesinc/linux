...
<!-- source: 315_Security_Packet_Engine_PKTE.pdf | original pages 3159–3294 -->

## 41   Security Packet Engine (PKTE)
...
Table 41-1: ADSP-SC59x PKTE Register List
...
Table 41-1: ADSP-SC59x PKTE Register List (Continued)
...
## ADSP-SC59x PKTE Interrupt List

Table 41-2: ADSP-SC59x PKTE Interrupt List
...
Table 41-3: SA Record for PRNG Init Operation
...
When packet processing is complete, the status byte in the first word of the result descriptor reports the pad verification status. Refer to the Table 41-28 Extended Error Codes - Status Encoding table.
...
Table 41-8: Algorithms for Basic Encrypt and Basic Decrypt Operations
...
Table 41-9: Algorithms for Basic Encrypt and Basic Decrypt Operations
...
Table 41-10: Algorithms for Basic Encrypt-Hash and Basic Hash-Decrypt Operations
...
Table 41-10: Algorithms for Basic Encrypt-Hash and Basic Hash-Decrypt Operations (Continued)
...
Table 41-11: Algorithms for IPsec ESP Operations
...
Table 41-12: Algorithms for Basic SSL and Extended SSL Operations
...
Table 41-12: Algorithms for Basic SSL and Extended SSL Operations (Continued)
...
Table 41-13: Algorithms for Basic TLS, Extended TLS and DTLS Operations
...
Table 41-14: Algorithms for SRTP Operations
...
Table 41-16: Different Sources for Loading the Hash State
...
Table 41-17: Sequence Number Generation and Verification Control (Outbound)
...
Table 41-18: Sequence Number Generation and Verification Control (Inbound)
...
Table 41-19: Header Processing Enabled, Anti-replay Service Enabled
...
Table 41-19: Header Processing Enabled, Anti-replay Service Enabled (Continued)
...
Figure 41-1: PKTE Block Diagram
...
Figure 41-2: Packet Engine Interrupt Controller Block Diagram
...
Table 41-20: Command Descriptor Structure
...
Table 41-20: Command Descriptor Structure (Continued)
...
Table 41-21: Result Descriptor Structure
...
Figure 41-3: Descriptor Rings in Autonomous Ring Mode
...
Table 41-22: SA Record Structure

|   Word Offset | Description (name)   | Use                                                 |
|---------------|----------------------|-----------------------------------------------------|
|             0 | PKTE_SA_CMD0[31:0]   | SA Control word 0 (all op- erations)                |
|             1 | PKTE_SA_CMD1[31:0]   | SA Control word 1 (all op- erations)                |
...
Table 41-22: SA Record Structure (Continued)
...
Table 41-23: SA State Structure
...
Table 41-24: ARC4 State Structure
...
Table 41-25: Basic Operation Decoding
...
Table 41-26: Protocol Operation Decoding
...
Table 41-27: Extended Protocol Operation Decoding
...
The PKTE\_CTL\_STAT register is used to configure the packet engine for processing in Direct Host Mode (DHM) or Target Command Mode (TCM). The PKTE\_CTL\_STAT structure element in memory is used when the packet
...
Table 41-28: Extended Error Codes - Status Encoding
...
Table 41-28: Extended Error Codes - Status Encoding (Continued)
...
PKTE\_SA\_KEY[n] registers. The first key register PKTE\_SA\_KEY[n] 0 holds bits 31:0, and PKTE\_SA\_KEY[n] 1 holds the next thirty two bits 63:32, and so on.
...
## ADSP-SC59x PKTE Register Descriptions

Security Packet Engine (PKTE) contains the following registers.

Table 41-29: ADSP-SC59x PKTE Register List
...
Table 41-29: ADSP-SC59x PKTE Register List (Continued)
...
Figure 41-4: PKTE\_ARC4STATE\_ADDR Register Diagram

<!-- image -->

Table 41-30: PKTE\_ARC4STATE\_ADDR Register Fields
...
Figure 41-5: PKTE\_ARC4STATE\_BUF Register Diagram

<!-- image -->

Table 41-31: PKTE\_ARC4STATE\_BUF Register Fields
...
Figure 41-6: PKTE\_BUF\_PTR Register Diagram

<!-- image -->

Table 41-32: PKTE\_BUF\_PTR Register Fields
...
Figure 41-7: PKTE\_BUF\_THRESH Register Diagram

<!-- image -->

Table 41-33: PKTE\_BUF\_THRESH Register Fields
...
Table 41-33: PKTE\_BUF\_THRESH Register Fields (Continued)
...
Figure 41-8: PKTE\_CDRBASE\_ADDR Register Diagram

<!-- image -->

Table 41-34: PKTE\_CDRBASE\_ADDR Register Fields
...
Figure 41-9: PKTE\_CDSC\_CNT Register Diagram

<!-- image -->

Table 41-35: PKTE\_CDSC\_CNT Register Fields
...
Figure 41-10: PKTE\_CDSC\_INCR Register Diagram

<!-- image -->

Table 41-36: PKTE\_CDSC\_INCR Register Fields
...
Figure 41-11: PKTE\_CFG Register Diagram

<!-- image -->

Table 41-37: PKTE\_CFG Register Fields
...
Table 41-37: PKTE\_CFG Register Fields (Continued)
...
Figure 41-12: PKTE\_CLK\_CTL Register Diagram

<!-- image -->

Table 41-38: PKTE\_CLK\_CTL Register Fields
...
Table 41-38: PKTE\_CLK\_CTL Register Fields (Continued)
...
Figure 41-13: PKTE\_CONT Register Diagram

<!-- image -->

Table 41-39: PKTE\_CONT Register Fields
...
Figure 41-14: PKTE\_CTL\_STAT Register Diagram

<!-- image -->

Table 41-40: PKTE\_CTL\_STAT Register Fields
...
Table 41-40: PKTE\_CTL\_STAT Register Fields (Continued)
...
Figure 41-15: PKTE\_DATAIO\_BUF Register Diagram

<!-- image -->

Table 41-41: PKTE\_DATAIO\_BUF Register Fields
...
Figure 41-16: PKTE\_DEST\_ADDR Register Diagram

<!-- image -->

Table 41-42: PKTE\_DEST\_ADDR Register Fields
...
Figure 41-17: PKTE\_DMA\_CFG Register Diagram

<!-- image -->

Table 41-43: PKTE\_DMA\_CFG Register Fields
...
Figure 41-18: PKTE\_ENDIAN\_CFG Register Diagram

<!-- image -->

Table 41-44: PKTE\_ENDIAN\_CFG Register Fields
...
Figure 41-19: PKTE\_HLT\_CTL Register Diagram

<!-- image -->

Table 41-45: PKTE\_HLT\_CTL Register Fields
...
Table 41-45: PKTE\_HLT\_CTL Register Fields (Continued)
...
Figure 41-20: PKTE\_HLT\_STAT Register Diagram

<!-- image -->

Table 41-46: PKTE\_HLT\_STAT Register Fields
...
Table 41-46: PKTE\_HLT\_STAT Register Fields (Continued)
...
Figure 41-21: PKTE\_IMSK\_DIS Register Diagram

<!-- image -->

Table 41-47: PKTE\_IMSK\_DIS Register Fields
...
Table 41-47: PKTE\_IMSK\_DIS Register Fields (Continued)
...
Figure 41-22: PKTE\_IMSK\_EN Register Diagram

<!-- image -->

Table 41-48: PKTE\_IMSK\_EN Register Fields
...
Table 41-48: PKTE\_IMSK\_EN Register Fields (Continued)
...
Figure 41-23: PKTE\_IMSK\_STAT Register Diagram

<!-- image -->

Table 41-49: PKTE\_IMSK\_STAT Register Fields
...
Table 41-49: PKTE\_IMSK\_STAT Register Fields (Continued)
...
Figure 41-24: PKTE\_INBUF\_CNT Register Diagram

<!-- image -->

Table 41-50: PKTE\_INBUF\_CNT Register Fields
...
Figure 41-25: PKTE\_INBUF\_INCR Register Diagram

<!-- image -->

Table 41-51: PKTE\_INBUF\_INCR Register Fields
...
Figure 41-26: PKTE\_INT\_CFG Register Diagram

<!-- image -->

Table 41-52: PKTE\_INT\_CFG Register Fields
...
Figure 41-27: PKTE\_INT\_CLR Register Diagram

<!-- image -->

Table 41-53: PKTE\_INT\_CLR Register Fields
...
Table 41-53: PKTE\_INT\_CLR Register Fields (Continued)
...
Figure 41-28: PKTE\_INT\_EN Register Diagram

<!-- image -->

Table 41-54: PKTE\_INT\_EN Register Fields
...
Table 41-54: PKTE\_INT\_EN Register Fields (Continued)
...
Figure 41-29: PKTE\_IUMSK\_STAT Register Diagram

<!-- image -->

Table 41-55: PKTE\_IUMSK\_STAT Register Fields
...
Table 41-55: PKTE\_IUMSK\_STAT Register Fields (Continued)
...
Figure 41-30: PKTE\_LEN Register Diagram

<!-- image -->

Table 41-56: PKTE\_LEN Register Fields
...
Table 41-56: PKTE\_LEN Register Fields (Continued)
...
Figure 41-31: PKTE\_OUTBUF\_CNT Register Diagram

<!-- image -->

Table 41-57: PKTE\_OUTBUF\_CNT Register Fields
...
Figure 41-32: PKTE\_OUTBUF\_DECR Register Diagram

<!-- image -->

Table 41-58: PKTE\_OUTBUF\_DECR Register Fields
...
Figure 41-33: PKTE\_RDRBASE\_ADDR Register Diagram

<!-- image -->

Table 41-59: PKTE\_RDRBASE\_ADDR Register Fields
...
Figure 41-34: PKTE\_RDSC\_CNT Register Diagram

<!-- image -->

Table 41-60: PKTE\_RDSC\_CNT Register Fields
...
Figure 41-35: PKTE\_RDSC\_DECR Register Diagram

<!-- image -->

Table 41-61: PKTE\_RDSC\_DECR Register Fields
...
Figure 41-36: PKTE\_RING\_CFG Register Diagram

<!-- image -->

Table 41-62: PKTE\_RING\_CFG Register Fields
...
Figure 41-37: PKTE\_RING\_PTR Register Diagram

Table 41-63: PKTE\_RING\_PTR Register Fields
...
Figure 41-38: PKTE\_RING\_STAT Register Diagram

<!-- image -->

Table 41-64: PKTE\_RING\_STAT Register Fields
...
Figure 41-39: PKTE\_RING\_THRESH Register Diagram

<!-- image -->

Table 41-65: PKTE\_RING\_THRESH Register Fields
...
Table 41-65: PKTE\_RING\_THRESH Register Fields (Continued)
...
Figure 41-40: PKTE\_SA\_ADDR Register Diagram

<!-- image -->

Table 41-66: PKTE\_SA\_ADDR Register Fields
...
Figure 41-41: PKTE\_SA\_ARC4IJPTR Register Diagram

<!-- image -->

Table 41-67: PKTE\_SA\_ARC4IJPTR Register Fields
...
Figure 41-42: PKTE\_SA\_CMD0 Register Diagram

<!-- image -->

Table 41-68: PKTE\_SA\_CMD0 Register Fields
...
Table 41-68: PKTE\_SA\_CMD0 Register Fields (Continued)
...
Figure 41-43: PKTE\_SA\_CMD1 Register Diagram

<!-- image -->

Table 41-69: PKTE\_SA\_CMD1 Register Fields
...
Table 41-69: PKTE\_SA\_CMD1 Register Fields (Continued)
...
Figure 41-44: PKTE\_SA\_IDIGEST[n] Register Diagram

<!-- image -->

Table 41-70: PKTE\_SA\_IDIGEST[n] Register Fields
...
Figure 41-45: PKTE\_SA\_KEY[n] Register Diagram

<!-- image -->

Table 41-71: PKTE\_SA\_KEY[n] Register Fields
...
Figure 41-46: PKTE\_SA\_NONCE Register Diagram

<!-- image -->

Table 41-72: PKTE\_SA\_NONCE Register Fields
...
Figure 41-47: PKTE\_SA\_ODIGEST[n] Register Diagram

<!-- image -->

Table 41-73: PKTE\_SA\_ODIGEST[n] Register Fields
...
Figure 41-48: PKTE\_SA\_RDY Register Diagram

<!-- image -->

Table 41-74: PKTE\_SA\_RDY Register Fields
...
Figure 41-49: PKTE\_SA\_SEQNUM[n] Register Diagram

<!-- image -->

Table 41-75: PKTE\_SA\_SEQNUM[n] Register Fields
...
Figure 41-50: PKTE\_SA\_SEQNUM\_MSK[n] Register Diagram

<!-- image -->

Table 41-76: PKTE\_SA\_SEQNUM\_MSK[n] Register Fields
...
Figure 41-51: PKTE\_SA\_SPI Register Diagram

<!-- image -->

Table 41-77: PKTE\_SA\_SPI Register Fields
...
Figure 41-52: PKTE\_SRC\_ADDR Register Diagram

<!-- image -->

Table 41-78: PKTE\_SRC\_ADDR Register Fields
...
Figure 41-53: PKTE\_STAT Register Diagram

<!-- image -->

Table 41-79: PKTE\_STAT Register Fields
...
Table 41-79: PKTE\_STAT Register Fields (Continued)
...
Figure 41-54: PKTE\_STATE\_ADDR Register Diagram

<!-- image -->

Table 41-80: PKTE\_STATE\_ADDR Register Fields
...
Figure 41-55: PKTE\_STATE\_BYTE\_CNT[n] Register Diagram

<!-- image -->

Table 41-81: PKTE\_STATE\_BYTE\_CNT[n] Register Fields
...
Figure 41-56: PKTE\_STATE\_IDIGEST[n] Register Diagram

<!-- image -->

Table 41-82: PKTE\_STATE\_IDIGEST[n] Register Fields
...
Figure 41-57: PKTE\_STATE\_IV[n] Register Diagram

<!-- image -->

Table 41-83: PKTE\_STATE\_IV[n] Register Fields
...
Figure 41-58: PKTE\_USERID Register Diagram

<!-- image -->

Table 41-84: PKTE\_USERID Register Fields
