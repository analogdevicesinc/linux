...
<!-- source: 318_True_Random_Number_Generator_TRNG.pdf | original pages 3340–3382 -->
...
Table 44-1: ADSP-SC59x TRNG Register List

| Name        | Description                 |
|-------------|-----------------------------|
| TRNG_ALMCNT | TRNG Alarm Counter Register |

Table 44-1: ADSP-SC59x TRNG Register List (Continued)
...
Table 44-2: Allowable Limits on Runs of 0's and 1's
...
Figure 44-1: System Block Diagram of the TRNG
...
Table 44-3: TRNG Interrupt Signals
...
Table 44-3: TRNG Interrupt Signals (Continued)
...
## ADSP-SC59x TRNG Register Descriptions

True Random Number Generator (TRNG) contains the following registers.

Table 44-4: ADSP-SC59x TRNG Register List
...
Table 44-4: ADSP-SC59x TRNG Register List (Continued)
...
Figure 44-2: TRNG\_ALMCNT Register Diagram

<!-- image -->

Table 44-5: TRNG\_ALMCNT Register Fields
...
Table 44-5: TRNG\_ALMCNT Register Fields (Continued)
...
Figure 44-3: TRNG\_ALMMSK Register Diagram

<!-- image -->

Table 44-6: TRNG\_ALMMSK Register Fields
...
Figure 44-4: TRNG\_ALMSTP Register Diagram

<!-- image -->

Table 44-7: TRNG\_ALMSTP Register Fields
...
Figure 44-5: TRNG\_BLKCNT Register Diagram

<!-- image -->

Table 44-8: TRNG\_BLKCNT Register Fields
...
Figure 44-6: TRNG\_CFG Register Diagram

<!-- image -->

Table 44-9: TRNG\_CFG Register Fields
...
Table 44-9: TRNG\_CFG Register Fields (Continued)
...
Figure 44-7: TRNG\_CNT Register Diagram

<!-- image -->

Table 44-10: TRNG\_CNT Register Fields
...
Figure 44-8: TRNG\_CTL Register Diagram

<!-- image -->

Table 44-11: TRNG\_CTL Register Fields
...
Table 44-11: TRNG\_CTL Register Fields (Continued)
...
Figure 44-9: TRNG\_FRODETUNE Register Diagram

<!-- image -->

Table 44-12: TRNG\_FRODETUNE Register Fields
...
Figure 44-10: TRNG\_FROEN Register Diagram

<!-- image -->

Table 44-13: TRNG\_FROEN Register Fields
...
Figure 44-11: TRNG\_INPUT[n] Register Diagram

<!-- image -->

Table 44-14: TRNG\_INPUT[n] Register Fields
...
Figure 44-12: TRNG\_INTACK Register Diagram

<!-- image -->

Table 44-15: TRNG\_INTACK Register Fields
...
Table 44-15: TRNG\_INTACK Register Fields (Continued)
...
Figure 44-13: TRNG\_KEY[n] Register Diagram

<!-- image -->

Table 44-16: TRNG\_KEY[n] Register Fields
...
Figure 44-14: TRNG\_LFSR\_H Register Diagram

<!-- image -->

Table 44-17: TRNG\_LFSR\_H Register Fields
...
Figure 44-15: TRNG\_LFSR\_L Register Diagram

<!-- image -->

Table 44-18: TRNG\_LFSR\_L Register Fields
...
Figure 44-16: TRNG\_LFSR\_M Register Diagram

<!-- image -->

Table 44-19: TRNG\_LFSR\_M Register Fields
...
Figure 44-17: TRNG\_MONOBITCNT Register Diagram

<!-- image -->

Table 44-20: TRNG\_MONOBITCNT Register Fields
...
Figure 44-18: TRNG\_OUTPUT[n] Register Diagram

<!-- image -->

Table 44-21: TRNG\_OUTPUT[n] Register Fields
...
( TRNG\_INTACK.MBITFAIL ), run fail acknowledge ( TRNG\_INTACK.RUNFAIL ) or the poker fail acknowl- edge ( TRNG\_INTACK.PKRFAIL ) bits.

Figure 44-19: TRNG\_POKER[n] Register Diagram

<!-- image -->

Table 44-22: TRNG\_POKER[n] Register Fields
...
Figure 44-20: TRNG\_RUNCNT Register Diagram

<!-- image -->

Table 44-23: TRNG\_RUNCNT Register Fields
...
Figure 44-21: TRNG\_RUN[n] Register Diagram

<!-- image -->

Table 44-24: TRNG\_RUN[n] Register Fields
...
Table 44-24: TRNG\_RUN[n] Register Fields (Continued)
...
Figure 44-22: TRNG\_STAT Register Diagram

<!-- image -->

Table 44-25: TRNG\_STAT Register Fields
...
Table 44-25: TRNG\_STAT Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                                                        |
|--------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 7 (R/NW)           | MBITFAIL   | Monobit Fail. When the TRNG_STAT.MBITFAIL bit is set, the Monobit Test logic monitoring data, shifted into the main LFSR, detected an out-of-bounds number of 1s after check- ing 20,000 bits (test T1 as specified in the AIS-31 standard).                                                                                   |
...
Figure 44-23: TRNG\_TEST Register Diagram

<!-- image -->

Table 44-26: TRNG\_TEST Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                      |
|--------------------|------------|--------------------------------------------------------------------------------------------------------------|
| 31 (R/W)           | IRQ        | Test IRQ. When the TRNG_TEST.IRQ bit is set force irq output HIGH for interrupt signal connectivity testing. |

Table 44-26: TRNG\_TEST Register Fields (Continued)
...
Figure 44-24: TRNG\_V[n] Register Diagram

<!-- image -->

Table 44-27: TRNG\_V[n] Register Fields
