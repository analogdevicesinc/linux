...
<!-- source: 320_IIR_Accelerator_IIR.pdf | original pages 3435–3483 -->

## 46   IIR Accelerator (IIR)
...
Figure 46-1: IIR Accelerator Block Diagram
...
Figure 46-2: Transposed Direct Form II Biquad
...
The accelerator block is integrated with the SHARC core. For more information, see Figure 48-5 SHARC Fabric Connectivity.

## ADSP-SC59x IIR Register List
...
Table 46-1: ADSP-SC59x IIR Register List
...
Table 46-1: ADSP-SC59x IIR Register List (Continued)
...
## ADSP-SC59x IIR Interrupt List

Table 46-2: ADSP-SC59x IIR Interrupt List
...
Table 46-2: ADSP-SC59x IIR Interrupt List (Continued)
...
## ADSP-SC59x IIR Trigger List

Table 46-3: ADSP-SC59x IIR Trigger List Generators
...
Table 46-4: ADSP-SC59x IIR Trigger List Receivers
...
Table 46-4: ADSP-SC59x IIR Trigger List Receivers (Continued)
...
Figure 46-4: 32 -Bit to 40 -Bit Packing
...
Initialize IIR\_CHNPTR to TCB+12 in legacy mode.

Table 46-5: IIR TCBs for Chained DMA in Lega-
...
Table 46-6: IIR TCBs for Chained DMA in ACM
...
Table 46-6: IIR TCBs for Chained DMA in ACM (Continued)
...
Figure 46-5: Circular Buffer Addressing
...
Table 46-7: IIR Interrupt Overview
...
| Legacy Mode             | IIR_DMA                          | Window complete                    | IIR_CTL2.IMASK if IIR_CTL1.L_ TIMASK_EN is set | ROC from IIR_DMASTAT + RTI instruction |
| Legacy Mode             | IIR_STAT                         | MAC IEEE floating point exceptions | N/A                                            | ROC from IIR_MACSTAT + RTI instruction |
| Legacy Mode             | IIR_STAT                         | MAC fixed point over- flow         | N/A                                            | ROC from IIR_MACSTAT + RTI instruction |
...
| Auto Configuration Mode | IIR_STAT                         | MAC fixed point over- flow         | N/A                                            | ROC from IIR_MACSTAT + RTI instruction |
...
The Legacy Mode Programming section provides programming examples for the Legacy and Auto Configuration Mode.
...
Figure 46-6: Biquad Processing Program Flow
...
Figure 46-7: Multi-channel Filtering in Auto Configuration Mode
...
The accelerator computes the output of the first biquad and updates the intermediate results for that biquad. Then, the accelerator moves to the next biquad of that channel and repeats the process until all the biquads for that channel are completed and the results are stored to memory. The process is repeated with the next sample

until one window of the corresponding channel is processed. When the IIR\_CTL1.SS bit is set, the accelerator saves the states of the biquads of the channel into system memory. If the IIR\_CTL2.TMASK bit is cleared the accelerator sends an output trigger after completion of processing the channel.
...
## ADSP-SC59x IIR Register Descriptions

The IIR filter accelerator (IIR) contains the following registers.

Table 46-8: ADSP-SC59x IIR Register List
...
Table 46-8: ADSP-SC59x IIR Register List (Continued)
...
Figure 46-8: IIR\_CHNPTR Register Diagram

<!-- image -->

Table 46-9: IIR\_CHNPTR Register Fields
...
Figure 46-9: IIR\_COEFIDX Register Diagram

<!-- image -->

Table 46-10: IIR\_COEFIDX Register Fields
...
Figure 46-10: IIR\_COEFLEN Register Diagram

<!-- image -->

Table 46-11: IIR\_COEFLEN Register Fields
...
Figure 46-11: IIR\_COEFMOD Register Diagram

<!-- image -->

Table 46-12: IIR\_COEFMOD Register Fields
...
Figure 46-12: IIR\_CTL1 Register Diagram

<!-- image -->

Table 46-13: IIR\_CTL1 Register Fields
...
Table 46-13: IIR\_CTL1 Register Fields (Continued)
...
Figure 46-13: IIR\_CTL2 Register Diagram

<!-- image -->

Table 46-14: IIR\_CTL2 Register Fields
...
Table 46-14: IIR\_CTL2 Register Fields (Continued)
...
Figure 46-14: IIR\_DBG\_ADDR Register Diagram

<!-- image -->

Table 46-15: IIR\_DBG\_ADDR Register Fields
...
Figure 46-15: IIR\_DBG\_CTL Register Diagram

<!-- image -->

Table 46-16: IIR\_DBG\_CTL Register Fields
...
Figure 46-16: IIR\_DBG\_RDDAT\_HI Register Diagram

<!-- image -->

Table 46-17: IIR\_DBG\_RDDAT\_HI Register Fields
...
Figure 46-17: IIR\_DBG\_RDDAT\_LO Register Diagram

<!-- image -->

Table 46-18: IIR\_DBG\_RDDAT\_LO Register Fields
...
Figure 46-18: IIR\_DBG\_WRDAT\_HI Register Diagram

<!-- image -->

Table 46-19: IIR\_DBG\_WRDAT\_HI Register Fields
...
Figure 46-19: IIR\_DBG\_WRDAT\_LO Register Diagram

<!-- image -->

Table 46-20: IIR\_DBG\_WRDAT\_LO Register Fields
...
Figure 46-20: IIR\_DMASTAT Register Diagram

<!-- image -->

Table 46-21: IIR\_DMASTAT Register Fields
...
Table 46-21: IIR\_DMASTAT Register Fields (Continued)
...
Figure 46-21: IIR\_INBASE Register Diagram

<!-- image -->

Table 46-22: IIR\_INBASE Register Fields
...
Figure 46-22: IIR\_INIDX Register Diagram

<!-- image -->

Table 46-23: IIR\_INIDX Register Fields
...
Figure 46-23: IIR\_INLEN Register Diagram

<!-- image -->

Table 46-24: IIR\_INLEN Register Fields
...
Figure 46-24: IIR\_INMOD Register Diagram

<!-- image -->

Table 46-25: IIR\_INMOD Register Fields
...
Figure 46-25: IIR\_MACSTAT Register Diagram

<!-- image -->

Table 46-26: IIR\_MACSTAT Register Fields
...
Figure 46-26: IIR\_OUTBASE Register Diagram

<!-- image -->

Table 46-27: IIR\_OUTBASE Register Fields
...
Figure 46-27: IIR\_OUTIDX Register Diagram

<!-- image -->

Table 46-28: IIR\_OUTIDX Register Fields
...
Figure 46-28: IIR\_OUTLEN Register Diagram

<!-- image -->

Table 46-29: IIR\_OUTLEN Register Fields
...
Figure 46-29: IIR\_OUTMOD Register Diagram

<!-- image -->

Table 46-30: IIR\_OUTMOD Register Fields
...
Figure 46-30: IIR\_SCTL1 Register Diagram

<!-- image -->

Table 46-31: IIR\_SCTL1 Register Fields
...
Figure 46-31: IIR\_SCTL2 Register Diagram

<!-- image -->

Table 46-32: IIR\_SCTL2 Register Fields
...
Figure 46-32: IIR\_SGCTL Register Diagram

<!-- image -->

Table 46-33: IIR\_SGCTL Register Fields
