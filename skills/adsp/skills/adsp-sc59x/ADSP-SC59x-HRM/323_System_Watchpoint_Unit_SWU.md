...
<!-- source: 323_System_Watchpoint_Unit_SWU.pdf | original pages 3857–3883 -->

## 49   System Watchpoint Unit (SWU)
...
Table 49-1: ADSP-SC59x SWU Register List
...
## ADSP-SC59x SWU Interrupt List

Table 49-2: ADSP-SC59x SWU Interrupt List

|   Interrupt ID | Name      | Description                      | Sensitivity   | DMA Channel   |
|----------------|-----------|----------------------------------|---------------|---------------|
|            314 | SWU1_EVT  | SWU1 Event L2 Memory Core Port 0 | None          |               |
|            315 | SWU2_EVT  | SWU2 Event L2 Memory DMAPort 0   | None          |               |
...
## ADSP-SC59x SWU Trigger List

Table 49-3: ADSP-SC59x SWU Trigger List Generators
...
Table 49-4: ADSP-SC59x SWU Trigger List Receivers
...
Table 49-4: ADSP-SC59x SWU Trigger List Receivers (Continued)
...
Figure 49-1: System Watchpoint Unit Top-Level Block Diagram
...
## ADSP-SC59x SWU Register Descriptions

System Watchpoint Unit (SWU) contains the following registers.

Table 49-5: ADSP-SC59x SWU Register List
...
Figure 49-3: SWU\_CNT[n] Register Diagram

<!-- image -->

Table 49-6: SWU\_CNT[n] Register Fields
...
Figure 49-4: SWU\_CTL[n] Register Diagram

<!-- image -->

Table 49-7: SWU\_CTL[n] Register Fields
...
Table 49-7: SWU\_CTL[n] Register Fields (Continued)
...
Figure 49-5: SWU\_CUR[n] Register Diagram

<!-- image -->

Table 49-8: SWU\_CUR[n] Register Fields
...
Figure 49-6: SWU\_GCTL Register Diagram

<!-- image -->

Table 49-9: SWU\_GCTL Register Fields
...
Figure 49-7: SWU\_GSTAT Register Diagram

<!-- image -->

Table 49-10: SWU\_GSTAT Register Fields
...
Table 49-10: SWU\_GSTAT Register Fields (Continued)
...
Figure 49-8: SWU\_HIST[n] Register Diagram

Table 49-11: SWU\_HIST[n] Register Fields
...
Figure 49-9: SWU\_ID[n] Register Diagram

<!-- image -->

Table 49-12: SWU\_ID[n] Register Fields
...
Figure 49-10: SWU\_LA[n] Register Diagram

<!-- image -->

Table 49-13: SWU\_LA[n] Register Fields
...
Figure 49-11: SWU\_TARG[n] Register Diagram

<!-- image -->

Table 49-14: SWU\_TARG[n] Register Fields
...
Figure 49-12: SWU\_UA[n] Register Diagram

<!-- image -->

Table 49-15: SWU\_UA[n] Register Fields
