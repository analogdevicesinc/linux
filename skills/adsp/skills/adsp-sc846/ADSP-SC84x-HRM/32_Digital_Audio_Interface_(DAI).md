...
NOTE: Each of the DAIs has 20 pin buffers in the HPC package and 14 pin buffers in LPC package.
...
Table 29-1: ADSP-2184x DAI Register List
...
| DAI_CLK6         | Clock Routing Control Register 6                |
| DAI_CLK7         | Clock Routing Control Register 7                |
| DAI_DAI_MISC_CTL | DAI MISC Control Register                       |
...
| DAI_DAT7         | Serial Data Routing Control Register 7          |
| DAI_DAT8         | Serial Data Routing Control Register 8          |
...
| DAI_EXTD_CLK6    | Extended Clock Routing Control Register 6       |
| DAI_EXTD_CLK7    | Extended Clock Routing Control Register 7       |
...
Table 29-1: ADSP-2184x DAI Register List (Continued)
...
| DAI_EXTD_DAT7  | Extended Serial Data Routing Control Register 7 |
| DAI_EXTD_DAT8  | Extended Serial Data Routing Control Register 8 |
...
| DAI_EXTD_FS5   | Extended Frame Sync Routing Control Register 5  |
| DAI_EXTD_FS6   | Extended Frame Sync Routing Control Register 6  |
...
| DAI_FS5        | Frame Sync Routing Control Register 5           |
| DAI_FS6        | Frame Sync Routing Control Register 6           |
...
| DAI_PIN5     | Dummy Pin Buffer Assignment Register          |
| DAI_PIN_STAT | Pin Status Register                           |

## ADSP-2184x DAI Interrupt List

Table 29-2: ADSP-2184x DAI Interrupt List
...
Table 29-2: ADSP-2184x DAI Interrupt List (Continued)
...
## ADSP-2184x DAI Trigger List

Table 29-3: ADSP-2184x DAI Trigger List Generators
...
Table 29-4: ADSP-2184x DAI Trigger List Receivers
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000000_45208d38b1f24dc6c97f182aca2f876ee3200a66454f0c7521689f24c0e95a05.png)

Figure 29-2: Digital Audio Interconnect Unit

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000001_31aab23b18192af56cc6d6e6d9a3ea72f61570eb741bc3df0e6957a197c0ade2.png)
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000002_4af818b0314087cd34f2e5bc5fe0379d81b538b1bb3245be4e22f701be695e5e.png)
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000003_e70142d28c450bc4e0ad34592c4fa2fba08c725012072ff301148f09edf836c4.png)
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000004_2da63a1c4075c1aba2b19c3fbe92078900f5dcb5fa3a202cdd2dfcc30bcb4115.png)
...
Though most peripherals can operate bidirectionally, it is not required that all of the \_I and \_O signals of a peripheral be connected to the pin buffer. When the system design only uses a signal in one direction, it is simpler to connect the pin buffer accordingly.
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000005_b615ef5e4b6ff5ab671e66af631d250d45f71d4ec283febd405f0657347f0675.png)
...
Figure 29-7: Example DAI Group A Multiplexing (DAIn\_CLKx)

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000006_f7c3737bb1aa73d72e32fb571f69cfb9a3c36e728c28952e7ecd533a3fc90e0f.png)
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000007_9ebff0dcabbdccec197431b7827dc761eb6cc7664c7c0245e1f5f0a32820a8ad.png)
...
| SPORT3B-0A (data) SRC3-0 (data, TDMdata) SRC8-11 (data, TDMdata) S/PDIF0 Tx/Rx (data) PDM0 All Group B source signals from other DAI                                                                                                                                       | DAI0 pin buffer 20-1 Logic level high Logic level low | B - data              | SPORT3B-0A (data) SRC3-0 (data, TDMdata) SRC8-11 (data, TDMdata) S/PDIF0 Tx/Rx (data) PDM0 (data0/1)                     |
...
| SPORT3B-0A (clock, FS, TDV, data) PCG A,B (clock, FS) S/PDIF0 Rx (clock, TDMclock, FS, data) S/PDIF0 Tx (data, block start) SRC0-3 (data) SRC4-7 (data) PCG E, F (clock, FS) PCG A, B, E, F (inverted-Clock, FS) PDM0 (clock, FS) All Group Dsource signals from other DAI | DAI0 pin buffer 20-1 Logic level high Logic level low | D-pin buffer in- puts | DAI0 pin buffer 20-1 Options: DAI0 pin buffer 20-19 Polarity change                                                      |

Table 29-6: DAI0 Routing Capabilities (Continued)

| Source Signals - Output (xxxx_O)                                                                                                                                                   | Source Signals - Output (xxxx_O)                      | DAI0 Group                | Destination Signals - Input (xxxx_I)                                                              |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|---------------------------|---------------------------------------------------------------------------------------------------|
| SPORT2B-0A (FS) PCG A (clock) PCG B (clock, FS) S/PDIF0 Tx (block start) SPORT3B-3A (FS) PCG E, F (FS) PCG A, B, E, F (trigger receiver) All Group E source signals from other DAI | DAI0 pin buffer 20-1 Logic level high Logic level low | E - miscellaneous signals | DAI Interrupt 31-22 MISCA5-0 Options: MISCA5-4 Polarity change PCG A, B, E, F (trigger generator) |
...
| SPORT7B-4A (data A, B) SRC4-7 (data, TDMdata) SRC12-15 (data, TDMda- ta) S/PDIF1 Tx/Rx (data) PDM1 All Group B source signals from other DA                  | DAI1 Pin Buffer 20-1 Logic level high Logic level low | B - data     | SPORT7B-4A (data) SRC4-7 (data, TDMdata) SRC12-15 (data, TDMda- ta) S/PDIF1 Tx/Rx (data) PDM1 (data0/1)                 |
...
| SPORT7B-4A (clock, FS, TDV, data) PCG C, D(clock, FS) S/PDIF1 Rx (clock, TDMclock, FS, data) S/PDIF1 Tx (data, block start) SRC11-15 (data) PCG G, H(clock, FS) PCG C, D, G, H(inverted-Clock, FS) PDM1 (clock, FS) All Group Dsource signals from other | DAI1 Pin Buffer 20-1 Logic level high Logic level low | D-pin buffer in- puts     | DAI1 Pin Buffer 20-1 Options: DAI1 Pin Buffer 20-19 Polarity Change                              |
| SPORT6B-4A (FS) PCG C (clock) PCG D(clock, FS) S/PDIF1 Tx (block start) SPORT7B-7A (FS) PCG C, D(FS) PCG C, D, G, H(trigger receiver) All Group E source signals from other DAI                                                                          | DAI1 Pin Buffer 20-1 Logic level high Logic level low | E - miscellaneous signals | DAI Interrupt 31-22 MISCA5-0 Options: MISCA5-4 Polarity Change PCG C, D, G, H(trigger generator) |
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000008_087a1539a40a8c646808d27596320ce58668906d6b5f1e2762d40207c4ea7cb1.png)

Figure 29-10: DAI0 Default Routing Pins 09-20

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000009_7d574c0f8933fea25e8cefca6866514482020aa1c04556960fab7fe9815a8081.png)

Figure 29-11: DAI1 Default Routing Pins 01-08

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000010_5c4131ab078231d8b8e2c8c0e2a4e8d9b13669fed797cfd1fcf938bb0064e6ed.png)
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000011_25088482529ca0f26465749f99a1184ac033ef1d3b4c79b13d4875fa032f9017.png)
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000012_ca02aa38c280e9fd970497451fd8e817dc3c33ff82e7d76ec80597389948517f.png)
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000013_165b090fe87cd3205c59eb4208cc6a830173f551c452acd82c3dbf591519b4f1.png)
...
| 0                               | 1                               | 01001 (0x9)               | DAI0_DUMMY_PB01_O  | Dummy Pin Buffer1 output                                                                                                                                                                                                                                                                                                                       |
| 0                               | 1                               | 01010 (0xA)               | DAI0_DUMMY_PB02_O  | Dummy Pin Buffer2 output                                                                                                                                                                                                                                                                                                                       |
| 0                               | 1                               | 01011 (0xB)               | DAI0_DUMMY_PB03_O  | Dummy Pin Buffer3 output                                                                                                                                                                                                                                                                                                                       |
| 0                               | 1                               | 01100 (0xC)               | DAI0_DUMMY_PB04_O  | Dummy Pin Buffer4 output                                                                                                                                                                                                                                                                                                                       |
| 0                               | 1                               | 01101 (0xD) -11111 (0x1F) | Reserved           |                                                                                                                                                                                                                                                                                                                                                |
| 1                               | 0                               | 00000 (0x0)               | DAI1_PB01_O        | Pin Buffer 1 (from other DAI)                                                                                                                                                                                                                                                                                                                  |
| 1                               | 0                               | 00001(0x1)                | DAI1_PB02_O        | Pin Buffer 2 (from other DAI)                                                                                                                                                                                                                                                                                                                  |
| 1                               | 0                               | 00010 (0x2)               | DAI1_PB03_O        | Pin Buffer 3 (from other DAI). This pin buffer is used for sharing clocks be- tween DAI modules. DAI0_PIN03 and DAI1_PIN03 can be used to share clock signal across DAI. When DAI0_PIN03 is configured as input clock pin then this clock signal is available in Group A of both DAIs. This source signal is DAI0_CRS_PB03_O in group A of DAI |

Table 29-10: Group A - Clock Routing Sources (Continued)

| Extended Selection Code [1:0]   | Extended Selection Code [1:0]   | Selection Code [4:0]   | Source Signal   | Description (Source Selection)                                                                                                                                                                                                                                                                                                                                                         |
|---------------------------------|---------------------------------|------------------------|-----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Bit 1                           | Bit 0                           |                        |                 | 0 and DAI1_CRS_PB03_O in group A of                                                                                                                                                                                                                                                                                                                                                    |
...
| 1                               | 1                               | 01001 (0x9)            | DAI1_DUMMY_PB01_O  | Dummy Pin Buffer1 output (from other DAI)          |
| 1                               | 1                               | 01010 (0xA)            | DAI1_DUMMY_PB02_O  | Dummy Pin Buffer2 output (from other DAI)          |
| 1                               | 1                               | 01011 (0xB)            | DAI1_DUMMY_PB03_O  | Dummy Pin Buffer3 output (from other DAI)          |
| 1                               | 1                               | 01100 (0xC)            | DAI1_DUMMY_PB04_O  | Dummy Pin Buffer4 output (from other DAI)          |
...
|---------------------------------|---------------------------------|---------------------------|-----------------|----------------------------------|
| Bit 1                           | Bit 0                           |                           |                 |                                  |
| 1                               | 1                               | 01101 (0xD) -11111 (0x1F) | Reserved        |                                  |
...
| 0                               | Reserved                        | 110100 (0x34)               | SRC8_DAT_OP_O   | SRC8 Data Out                    |
| 0                               | Reserved                        | 110101 (0x35)               | SRC9_DAT_OP_O   | SRC9 Data Out                    |
| 0                               | Reserved                        | 110110 (0x36)               | SRC10_DAT_OP_O  | SRC10 Data Out                   |
| 0                               | Reserved                        | 110111 (0x37)               | SRC11_DAT_OP_O  | SRC11 Data Out                   |
| 0                               | Reserved                        | 111000 (0x38)               | SRC8_TDM_IP_O   | SRC8 TDMData Out                 |
...
|---------------------------------|---------------------------------|-------------------------------|-----------------|-----------------------------------|
| Bit 1                           | Bit 0                           | Selection Code[5:0]           | Source Signal   | Description (Source Selection)    |
| 0                               | Reserved                        | 111001 (0x39)                 | SRC9_TDM_IP_O   | SRC9 TDMData Out                  |
| 0                               | Reserved                        | 111010 (0x3A)                 | SRC10_TDM_IP_O  | SRC10 TDMData Out                 |
| 0                               | Reserved                        | 111011 (0x3B)                 | SRC11_TDM_IP_O  | SRC11 TDMData Out                 |
| 0                               | Reserved                        | 111100 (0x3C) - 111101 (0x3D) | Reserved        |                                   |
...
| 1                               | Reserved                        | 110100 (0x34)               | SRC12_DAT_OP_O  | SRC12 Data Out                              |
...
|---------------------------------|---------------------------------|-------------------------------|-----------------|----------------------------------|
| Bit 1                           | Bit 0                           | Selection Code[5:0]           | Source Signal   | Description (Source Selection)   |
| 1                               | Reserved                        | 110101 (0x35)                 | SRC13_DAT_OP_O  | SRC13 Data Out                   |
| 1                               | Reserved                        | 110110 (0x36)                 | SRC14_DAT_OP_O  | SRC14 Data Out                   |
| 1                               | Reserved                        | 110111 (0x37)                 | SRC15_DAT_OP_O  | SRC15 Data Out                   |
| 1                               | Reserved                        | 111000 (0x38)                 | SRC12_TDM_IP_O  | SRC12 TDMData Out                |
| 1                               | Reserved                        | 111001 (0x39)                 | SRC13_TDM_IP_O  | SRC13 TDMData Out                |
| 1                               | Reserved                        | 111010 (0x3A)                 | SRC14_TDM_IP_O  | SRC14 TDMData Out                |
| 1                               | Reserved                        | 111011 (0x3B)                 | SRC15_TDM_IP_O  | SRC15 TDMData Out                |
| 1                               | Reserved                        | 110001 (0x3C) - 111101 (0x3D) | Reserved        | Reserved                         |
| 1                               | Reserved                        | 111110 (0x3E)                 | Reserved        | Reserved                         |
| 1                               | Reserved                        | 111111 (0x3F)                 | Reserved        | Reserved                         |
...
| 0                               | 1                               | 01000 (0x8)           | DAI0_DUMMY_PB01_O | Dummy Pin Buffer1 output               |
| 0                               | 1                               | 01001 (0x9)           | DAI0_DUMMY_PB02_O | Dummy Pin Buffer2 output               |
...
|---------------------------------|---------------------------------|----------------------------|-------------------|----------------------------------|
| Bit 1                           | Bit 0                           | Selection Code[4:0]        | Source Signal     | Description (Source Selection)   |
| 0                               | 1                               | 01010 (0xA)                | DAI0_DUMMY_PB03_O | Dummy Pin Buffer3 output         |
| 0                               | 1                               | 01011 (0xB)                | DAI0_DUMMY_PB04_O | Dummy Pin Buffer4 output         |
| 0                               | 1                               | 01100 (0xC) - 11111 (0x1F) | Reserved          |                                  |
...
| 1                               | 1                               | 01000 (0x8)                | DAI0_DUMMY_PB01_O | Dummy Pin Buffer1 output                                |
| 1                               | 1                               | 01001 (0x9)                | DAI0_DUMMY_PB02_O | Dummy Pin Buffer2 output                                |
| 1                               | 1                               | 01010 (0xA)                | DAI0_DUMMY_PB03_O | Dummy Pin Buffer3 output                                |
| 1                               | 1                               | 01011 (0xB)                | DAI0_DUMMY_PB04_O | Dummy Pin Buffer4 output                                |
| 1                               | 1                               | 01100 (0xC) - 11111 (0x1F) | Reserved          | Reserved                                                |
...
| 0                               | Reserved                        | 1100100 (0x64)                  | SRC8_DAT_OP_O      | SRC8 Data Output                       |
| 0                               | Reserved                        | 1100101 (0x65)                  | SRC9_DAT_OP_O      | SRC9 Data Output                       |
| 0                               | Reserved                        | 1100110 (0x66)                  | SRC10_DAT_OP_O     | SRC10 Data Output                      |
| 0                               | Reserved                        | 1100111 (0x67)                  | SRC11_DAT_OP_O     | SRC11 Data Output                      |
| 0                               | Reserved                        | 1101000 (0x68)                  | SRU_FRACPLL0_CLK_O | Fractional-N PLL 0 Clock Output        |
| 0                               | Reserved                        | 1101001 (0x69)                  | SRU_FRACPLL1_CLK_O | Fractional-N PLL 1 Clock Output        |
| 0                               | Reserved                        | 1101010 (0x6A) - 1111101 (0x7D) | Reserved           |                                        |
...
| 1                               | Reserved                        | 1100100 (0x64)                  | SRC12_DAT_OP_O  | SRC12 Data Output                                      |
| 1                               | Reserved                        | 1100101 (0x65)                  | SRC13_DAT_OP_O  | SRC13 Data Output                                      |
| 1                               | Reserved                        | 1100110 (0x66)                  | SRC14_DAT_OP_O  | SRC14 Data Output                                      |
| 1                               | Reserved                        | 1100111 (0x67)                  | SRC15_DAT_OP_O  | SRC15 Data Output                                      |
| 1                               | Reserved                        | 1100100 (0x68) - 1111111 (0x7F) | Reserved        | Reserved                                               |
...
| 1                               | Reserved                        | 000000 (0x0)-000001 (0x1)    | Reserved         | Reserved                                                             |
| 1                               | Reserved                        | 000010 (0x2)                 | DAI1_MISCA0_O    | DAI 1 Miscellaneous Control A0 Output                                |
| 1                               | Reserved                        | 000011 (0x3)                 | DAI1_MISCA1_O    | DAI 1 Miscellaneous Control A1 Output                                |
| 1                               | Reserved                        | 000100 (0x4)                 | DAI1_MISCA2_O    | DAI 1 Miscellaneous Control A2 Output                                |
| 1                               | Reserved                        | 000101 (0x5)                 | DAI1_MISCA3_O    | DAI 1 Miscellaneous Control A3 Output                                |
| 1                               | Reserved                        | 000110 (0x6)                 | DAI1_MISCA4_O    | DAI 1 Miscellaneous Control A4 Output                                |
| 1                               | Reserved                        | 000111 (0x7)                 | DAI1_MISCA5_O    | DAI 1 Miscellaneous Control A5 Output                                |
...
|---------------------------------|---------------------------------|------------------------------|-----------------|----------------------------------|
| Bit 1                           | Bit 0                           |                              |                 |                                  |
| 1                               | Reserved                        | 110010 (0x32)-1111111 (0x3F) | Reserved        |                                  |
...
| DAI_CLK6       | IN0              | SRC8_CLK_IP_I         | SRC12_CLK_IP_I        | SRC8 or SRC12 Clock Input         |
| DAI_CLK6       | IN1              | SRC8_CLK_OP_I         | SRC12_CLK_OP_I        | SRC8 or SRC12 Clock Output        |
| DAI_CLK6       | IN2              | SRC9_CLK_IP_I         | SRC13_CLK_IP_I        | SRC9 or SRC13 Clock Input         |
| DAI_CLK6       | IN3              | SRC9_CLK_OP_I         | SRC13_CLK_OP_I        | SRC9 or SRC13 Clock Output        |
| DAI_CLK6       | IN4              | SRC10_CLK_IP_I        | SRC14_CLK_IP_I        | SRC10 or SRC14 Clock Input        |
| DAI_CLK6       | IN5              | SRC10_CLK_OP_I        | SRC14_CLK_OP_I        | SRC10 or SRC14 Clock Output       |
| DAI_CLK7       | IN0              | SRC11_CLK_IP_I        | SRC15_CLK_IP_I        | SRC11 or SRC15 Clock Input        |
| DAI_CLK7       | IN1              | SRC11_CLK_OP_I        | SRC15_CLK_OP_I        | SRC11 or SRC15 Clock Output       |
...
| DAI_DAT7         | IN0              | SRC8_DAT_IP_I      | SRC12_DAT_IP_I     | SRC8 or SRC12 Data                 |
| DAI_DAT7         | IN1              | SRC9_DAT_IP_I      | SRC13_DAT_IP_I     | SRC9 or SRC13 Data                 |
| DAI_DAT7         | IN2              | SRC10_DAT_IP_I     | SRC14_DAT_IP_I     | SRC10 or SRC14 Data                |
| DAI_DAT7         | IN3              | SRC11_DAT_IP_I     | SRC15_DAT_IP_I     | SRC11 or SRC15 Data                |
| DAI_DAT7         | IN4              | SRC8_DAT_TDM_OP_I  | SRC12_DAT_TDM_OP_I | SRC8 or SRC12 TDMOutput port       |
| DAI_DAT8         | IN0              | SRC9_DAT_TDM_OP_I  | SRC13_DAT_TDM_OP_I | SRC9 or SRC13 TDMOutput port Data  |
| DAI_DAT8         | IN1              | SRC10_DAT_TDM_OP_I | SRC14_DAT_TDM_OP_I | SRC10 or SRC14 TDMOutput port Data |
| DAI_DAT8         | IN2              | SRC11_DAT_TDM_OP_I | SRC15_DAT_TDM_OP_I | SRC11 or SRC15 TDMOutput port Data |
...
| DAI_FS5        | IN0              | SRC8_FS_IP_I   | SRC12_FS_IP_I  | SRC8 or SRC12 Frame Sync Input                    |
| DAI_FS5        | IN1              | SRC8_FS_OP_I   | SRC12_FS_OP_I  | SRC8 or SRC12 Frame Sync Output                   |
| DAI_FS5        | IN2              | SRC9_FS_IP_I   | SRC13_FS_IP_I  | SRC9 or SRC13 Frame Sync Input                    |
| DAI_FS5        | IN3              | SRC9_FS_OP_I   | SRC13_FS_OP_I  | SRC9 or SRC13 Frame Sync Output                   |
| DAI_FS5        | IN4              | SRC10_FS_IP_I  | SRC14_FS_IP_I  | SRC10 or SRC14 Frame Sync Input                   |
| DAI_FS5        | IN5              | SRC10_FS_OP_I  | SRC14_FS_OP_I  | SRC10 or SRC14 Frame Sync Output                  |
| DAI_FS6        | IN0              | SRC11_FS_IP_I  | SRC15_FS_IP_I  | SRC11 or SRC15 Frame Sync Input                   |
| DAI_FS6        | IN1              | SRC11_FS_OP_I  | SRC15_FS_OP_I  | SRC11 or SRC15 Frame Sync Output                  |
...
Table 29-19: Pin Buffer Assignment Destination Registers (Group D) (Continued)
...
| DAI_PIN4       | IN5              | INV_DAI0_PB20_I   | INV_DAI1_PB20_I   | Inverted Pin Buffer 20 |
| DAI_PIN5       | IN0              | DAI0_DUMMY_PB01_1 | DAI1_DUMMY_PB01_1 | Dummy Pin Buffer 1     |
| DAI_PIN5       | IN1              | DAI0_DUMMY_PB02_1 | DAI1_DUMMY_PB02_1 | Dummy Pin Buffer 1     |
| DAI_PIN5       | IN2              | DAI0_DUMMY_PB03_1 | DAI1_DUMMY_PB03_1 | Dummy Pin Buffer 1     |
| DAI_PIN5       | IN3              | DAI0_DUMMY_PB04_1 | DAI1_DUMMY_PB04_1 | Dummy Pin Buffer 1     |

## Miscellaneous Control Destination Registers (Group E)
...
Table 29-20: Pin Buffer Enable Destination Registers (Group F)
...
Table 29-20: Pin Buffer Enable Destination Registers (Group F) (Continued)
...
Table 29-21: Interrupt Events (Continued)
...
DAI supports two registers DAI\_GBL\_SP\_EN and DAI\_GBL\_INT\_EN to group enabling/disabling and interrupt/trigger generation/reception for multiple SPORTs.
...
## ADSP-2184x DAI Register Descriptions
...
Table 29-22: ADSP-2184x DAI Register List
...
Table 29-22: ADSP-2184x DAI Register List (Continued)
...
Figure 29-16: DAI\_CLK0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000014_d6457b10874fa6e0225a33058ea990f4e3cfb97e9e41ec194bffc98b06d02202.png)

Table 29-23: DAI\_CLK0 Register Fields
...
Table 29-23: DAI\_CLK0 Register Fields (Continued)
...
Figure 29-17: DAI\_CLK1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000015_fe74b12cd3dc18110cf227567458aa11dca90adea282cb68892226126f010e95.png)

Table 29-24: DAI\_CLK1 Register Fields
...
Table 29-24: DAI\_CLK1 Register Fields (Continued)
...
Figure 29-18: DAI\_CLK2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000016_eb191b06769968fb7dbf2b126e49230294e01472bb76da6882233fa77a12eb47.png)

Table 29-25: DAI\_CLK2 Register Fields
...
Figure 29-19: DAI\_CLK3 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000017_88d46c24c2d1b0e133f8a30c2e1200635cac47f021f66d448ef4aa3cb0455ca1.png)

Table 29-26: DAI\_CLK3 Register Fields
...
Figure 29-20: DAI\_CLK4 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000018_48291cf79810586273c4148407b9ce3e7f349e56780beaf3b5974cbc38d8b862.png)

Table 29-27: DAI\_CLK4 Register Fields
...
Figure 29-21: DAI\_CLK5 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000019_a697f292436614e36579a5d22f45fbed18dbbb7e6483aeabb7c7653440a82a0c.png)

Table 29-28: DAI\_CLK5 Register Fields
...
Table 29-28: DAI\_CLK5 Register Fields (Continued)
...
## Clock Routing Control Register 6

The DAI\_CLK6 register provides clock routing connections for the serial ports.

Figure 29-22: DAI\_CLK6 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000020_a697f292436614e36579a5d22f45fbed18dbbb7e6483aeabb7c7653440a82a0c.png)

Table 29-29: DAI\_CLK6 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 29:25 (R/W)        | IN5        | Input Clock 5. DAI_CLK6.IN5 holds the source signal assignment that will be routed to the DAI_CLK6.IN5 destination. Refer to the Group A Signals table for source and destination mappings. |
| 24:20 (R/W)        | IN4        | Input Clock 4. DAI_CLK6.IN4 holds the source signal assignment that will be routed to the DAI_CLK6.IN4 destination. Refer to the Group A Signals table for source and destination mappings. |
| 19:15 (R/W)        | IN3        | Input Clock 3. DAI_CLK6.IN3 holds the source signal assignment that will be routed to the DAI_CLK6.IN3 destination. Refer to the Group A Signals table for source and destination mappings. |
| 14:10 (R/W)        | IN2        | Input Clock 2. DAI_CLK6.IN2 holds the source signal assignment that will be routed to the DAI_CLK6.IN2 destination. Refer to the Group A Signals table for source and destination mappings. |
| 9:5 (R/W)          | IN1        | Input Clock 1. DAI_CLK6.IN1 holds the source signal assignment that will be routed to the DAI_CLK6.IN1 destination. Refer to the Group A Signals table for source and destination mappings. |

Table 29-29: DAI\_CLK6 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4:0 (R/W)          | IN0        | Input Clock 0. DAI_CLK6.IN0 holds the source signal assignment that will be routed to the DAI_CLK6.IN0 destination. Refer to the Group A Signals table for source and destination mappings. |

## Clock Routing Control Register 7

The DAI\_CLK7 register provides clock routing connections for the serial ports.

Figure 29-23: DAI\_CLK7 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000021_054a8805d8d5305e050a352c0319cc1760e3bcc39ae7400987a57a205807e4c6.png)

Table 29-30: DAI\_CLK7 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 9:5 (R/W)          | IN1        | Input Clock 1. DAI_CLK7.IN1 holds the source signal assignment that will be routed to the DAI_CLK7.IN1 destination. Refer to the Group A Signals table for source and destination mappings. |
| 4:0 (R/W)          | IN0        | Input Clock 0. DAI_CLK7.IN0 holds the source signal assignment that will be routed to the DAI_CLK7.IN0 destination. Refer to the Group A Signals table for source and destination mappings. |

## DAI MISC Control Register

The DAI\_DAI\_MISC\_CTL register provides the misc control signals related to DAI block.

Figure 29-24: DAI\_DAI\_MISC\_CTL Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000022_bafd0807d39368c4542754e2aa977da122b4f6271d838466319f2e02a7c2a6b3.png)

Table 29-31: DAI\_DAI\_MISC\_CTL Register Fields

| Bit No. (Access)   | Bit Name     | Description/Enumeration                                                                                                                      |
|--------------------|--------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| 0 (R/W)            | DUMMY_PAD_EN | Programmable Dummy Pad Enable. When set (=1), the DAI_DAI_MISC_CTL.DUMMY_PAD_EN bit, enables program- mable dummy pads feature in DAI block. |

## Serial Data Routing Control Register 0

The DAI\_DAT0 register routes serial data to the serial ports.

Figure 29-25: DAI\_DAT0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000023_c6878c09ca5252f7b101a307df4a4a36bd4659d198cb4d364b76a8059ab39444.png)

Table 29-32: DAI\_DAT0 Register Fields
...
Figure 29-26: DAI\_DAT1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000024_19e370a0bbf82e20c2b90480ad27b07419b4e9b9a4aaccf7a3fd93e3e959c6a1.png)

Table 29-33: DAI\_DAT1 Register Fields
...
Figure 29-27: DAI\_DAT2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000025_6beef8192db789d831e884944ea47eb555b9ecf90a2bc6ee254b268e903e8dde.png)

Table 29-34: DAI\_DAT2 Register Fields
...
Figure 29-28: DAI\_DAT3 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000026_cd555168c048d9cb0201ccfe40f8051fd8109012ff759ba39b6deb7a5cf65412.png)

Table 29-35: DAI\_DAT3 Register Fields
...
Figure 29-29: DAI\_DAT4 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000027_1d9acbd024fd72dfa271c7de7d2f86cbbf711873bddfda6e1ecda35130c3e213.png)

Table 29-36: DAI\_DAT4 Register Fields
...
Figure 29-30: DAI\_DAT5 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000028_a31b8987584bc486133fad992fea8a59668512011fcfdb74efa2218a300ba02d.png)

Table 29-37: DAI\_DAT5 Register Fields
...
Figure 29-31: DAI\_DAT6 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000029_2581d71c64ba91957a34c662683796c5c6f425da344501570448f3b9c884b0a0.png)

Table 29-38: DAI\_DAT6 Register Fields
...
## Serial Data Routing Control Register 7

The DAI\_DAT7 register routes serial data to the serial ports.

Figure 29-32: DAI\_DAT7 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000030_cd555168c048d9cb0201ccfe40f8051fd8109012ff759ba39b6deb7a5cf65412.png)

Table 29-39: DAI\_DAT7 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                    |
|--------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 29:24 (R/W)        | IN4        | Input Data 4. DAI_DAT7.IN4 holds the source signal assignment that will be routed to the DAI_DAT7.IN4 destination. Refer to the Group B Signals table for source and destination mappings. |
| 23:18 (R/W)        | IN3        | Input Data 3. DAI_DAT7.IN3 holds the source signal assignment that will be routed to the DAI_DAT7.IN3 destination. Refer to the Group B Signals table for source and destination mappings. |
| 17:12 (R/W)        | IN2        | Input Data 2. DAI_DAT7.IN2 holds the source signal assignment that will be routed to the DAI_DAT7.IN2 destination. Refer to the Group B Signals table for source and destination mappings. |
| 11:6 (R/W)         | IN1        | Input Data 1. DAI_DAT7.IN1 holds the source signal assignment that will be routed to the DAI_DAT7.IN1 destination. Refer to the Group B Signals table for source and destination mappings. |
| 5:0 (R/W)          | IN0        | Input Data 0. DAI_DAT7.IN0 holds the source signal assignment that will be routed to the DAI_DAT7.IN0 destination. Refer to the Group B Signals table for source and destination mappings. |

## Serial Data Routing Control Register 8

The DAI\_DAT8 register routes serial data to the serial ports.

Figure 29-33: DAI\_DAT8 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000031_1d9acbd024fd72dfa271c7de7d2f86cbbf711873bddfda6e1ecda35130c3e213.png)

Table 29-40: DAI\_DAT8 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                    |
|--------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 17:12 (R/W)        | IN2        | Input Data 2. DAI_DAT8.IN2 holds the source signal assignment that will be routed to the DAI_DAT8.IN2 destination. Refer to the Group B Signals table for source and destination mappings. |
| 11:6 (R/W)         | IN1        | Input Data 1. DAI_DAT8.IN1 holds the source signal assignment that will be routed to the DAI_DAT8.IN1 destination. Refer to the Group B Signals table for source and destination mappings. |
| 5:0 (R/W)          | IN0        | Input Data 0. DAI_DAT8.IN0 holds the source signal assignment that will be routed to the DAI_DAT8.IN0 destination. Refer to the Group B Signals table for source and destination mappings. |
...
Figure 29-34: DAI\_EXTD\_CLK0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000032_b00e65093edf3bc84efd511b23d5b5a0743086d0e70ffa2ef7993cb0a31dbdb6.png)

Table 29-41: DAI\_EXTD\_CLK0 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 21:20 (R/W)        | IN5        | Extended Input Clock 5. DAI_EXTD_CLK0.IN5 and DAI_CLK0.IN5 together hold the extended source signal assignment that will be routed to the DAI_CLK0.IN5 destination. Refer to the Group A Signals table for source and destination mappings. |
| 17:16 (R/W)        | IN4        | Extended Input Clock 4. DAI_EXTD_CLK0.IN4 and DAI_CLK0.IN4 together hold the extended source signal assignment that will be routed to the DAI_CLK0.IN4 destination. Refer to the Group A Signals table for source and destination mappings. |
| 13:12 (R/W)        | IN3        | Extended Input Clock 3. DAI_EXTD_CLK0.IN3 and DAI_CLK0.IN3 together hold the extended source signal assignment that will be routed to the DAI_CLK0.IN3 destination. Refer to the Group A Signals table for source and destination mappings. |
| 9:8 (R/W)          | IN2        | Extended Input Clock 2. DAI_EXTD_CLK0.IN2 and DAI_CLK0.IN2 together hold the extended source signal assignment that will be routed to the DAI_CLK0.IN2 destination. Refer to the Group A Signals table for source and destination mappings. |
| 5:4 (R/W)          | IN1        | Extended Input Clock 1. DAI_EXTD_CLK0.IN1 and DAI_CLK0.IN1 together hold the extended source signal assignment that will be routed to the DAI_CLK0.IN1 destination. Refer to the Group A Signals table for source and destination mappings  |

Table 29-41: DAI\_EXTD\_CLK0 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1:0 (R/W)          | IN0        | Extended Input Clock 0. DAI_EXTD_CLK0.IN0 and DAI_CLK0.IN0 together hold the extended source signal assignment that will be routed to the DAI_CLK0.IN0 destination. Refer to the Group A Signals table for source and destination mappings. |
...
Figure 29-35: DAI\_EXTD\_CLK1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000033_b00e65093edf3bc84efd511b23d5b5a0743086d0e70ffa2ef7993cb0a31dbdb6.png)

Table 29-42: DAI\_EXTD\_CLK1 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 21:20 (R/W)        | IN5        | Extended Input Clock 5. DAI_EXTD_CLK1.IN5 and DAI_CLK1.IN5 together hold the extended source signal assignment that will be routed to the DAI_CLK1.IN5 destination. Refer to the Group A Signals table for source and destination mappings. |
| 17:16 (R/W)        | IN4        | Extended Input Clock 4. DAI_EXTD_CLK1.IN4 and DAI_CLK1.IN4 together hold the extended source signal assignment that will be routed to the DAI_CLK1.IN4 destination. Refer to the Group A Signals table for source and destination mappings. |
| 13:12 (R/W)        | IN3        | Extended Input Clock 3. DAI_EXTD_CLK1.IN3 and DAI_CLK1.IN3 together hold the extended source signal assignment that will be routed to the DAI_CLK1.IN3 destination. Refer to the Group A Signals table for source and destination mappings. |
| 9:8 (R/W)          | IN2        | Extended Input Clock 2. DAI_EXTD_CLK1.IN2 and DAI_CLK1.IN2 together hold the extended source signal assignment that will be routed to the DAI_CLK1.IN2 destination. Refer to the Group A Signals table for source and destination mappings. |
| 5:4 (R/W)          | IN1        | Extended Input Clock 1. DAI_EXTD_CLK1.IN1 and DAI_CLK1.IN1 together hold the extended source signal assignment that will be routed to the DAI_CLK1.IN1 destination. Refer to the Group A Signals table for source and destination mappings. |

Table 29-42: DAI\_EXTD\_CLK1 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1:0 (R/W)          | IN0        | Extended Input Clock 0. DAI_EXTD_CLK1.IN0 and DAI_CLK1.IN0 together hold the extended source signal assignment that will be routed to the DAI_CLK1.IN0 destination. Refer to the Group A Signals table for source and destination mappings. |
...
Figure 29-36: DAI\_EXTD\_CLK2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000034_381804b2ad7fc29b117cc7ace7ffdf5ff268ca42fbb4d887dccae45fa3cd8486.png)

Table 29-43: DAI\_EXTD\_CLK2 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 17:16 (R/W)        | IN4        | Extended Input Clock 4. DAI_EXTD_CLK2.IN4 and DAI_CLK2.IN4 together hold the extended source signal assignment that will be routed to the DAI_CLK2.IN4 destination. Refer to the Group A Signals table for source and destination mappings  |
| 13:12 (R/W)        | IN3        | Extended Input Clock 3. DAI_EXTD_CLK2.IN3 and DAI_CLK2.IN3 together hold the extended source signal assignment that will be routed to the DAI_CLK2.IN3 destination. Refer to the Group A Signals table for source and destination mappings  |
| 9:8 (R/W)          | IN2        | Extended Input Clock 2. DAI_EXTD_CLK2.IN2 and DAI_CLK2.IN2 together hold the extended source signal assignment that will be routed to the DAI_CLK2.IN2 destination. Refer to the Group A Signals table for source and destination mappings. |
| 5:4 (R/W)          | IN1        | Extended Input Clock 1. DAI_EXTD_CLK2.IN1 and DAI_CLK2.IN1 together hold the extended source signal assignment that will be routed to the DAI_CLK2.IN1 destination. Refer to the Group A Signals table for source and destination mappings. |
| 1:0 (R/W)          | IN0        | Extended Input Clock 0. DAI_EXTD_CLK2.IN0 and DAI_CLK2.IN0 together hold the extended source signal assignment that will be routed to the DAI_CLK2.IN0 destination. Refer to the Group A Signals table for source and destination mappings. |
...
Figure 29-37: DAI\_EXTD\_CLK3 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000035_e80fe8c66fbf97a3fded8430efde0b08afe80a7efdc46b207db19f5f8945007e.png)

Table 29-44: DAI\_EXTD\_CLK3 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 21:20 (R/W)        | IN5        | Extended Input Clock 0. DAI_EXTD_CLK3.IN5 and DAI_CLK3.IN0 together hold the extended source signal assignment that will be routed to the DAI_CLK3.IN0 destination. Refer to the Group A Signals table for source and destination mappings. |
...
Figure 29-38: DAI\_EXTD\_CLK4 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000036_b9f3c1fa5f5a15afcd1896156e177514f0e5bfc8ff02044d2e818a9fa95d258c.png)

Table 29-45: DAI\_EXTD\_CLK4 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 21:20 (R/W)        | IN5        | Extended Input Clock 5. DAI_EXTD_CLK4.IN5 and DAI_CLK4.IN5 together hold the extended source signal assignment that will be routed to the DAI_CLK4.IN5 destination. Refer to the Group A Signals table for source and destination mappings. |
| 17:16 (R/W)        | IN4        | Extended Input Clock 4. DAI_EXTD_CLK4.IN4 and DAI_CLK4.IN4 together hold the extended source signal assignment that will be routed to the DAI_CLK4.IN4 destination. Refer to the Group A Signals table for source and destination mappings. |
| 13:12 (R/W)        | IN3        | Extended Input Clock 3. DAI_EXTD_CLK4.IN3 and DAI_CLK4.IN3 together hold the extended source signal assignment that will be routed to the DAI_CLK4.IN3 destination. Refer to the Group A Signals table for source and destination mappings. |
| 5:4 (R/W)          | IN1        | Extended Input Clock 1. DAI_EXTD_CLK4.IN1 and DAI_CLK4.IN1 together hold the extended source signal assignment that will be routed to the DAI_CLK4.IN1 destination. Refer to the Group A Signals table for source and destination mappings. |
| 1:0 (R/W)          | IN0        | Extended Input Clock 0. DAI_EXTD_CLK4.IN0 and DAI_CLK4.IN0 together hold the extended source signal assignment that will be routed to the DAI_CLK4.IN0 destination. Refer to the Group A Signals table for source and destination mappings. |
...
Figure 29-39: DAI\_EXTD\_CLK5 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000037_b00e65093edf3bc84efd511b23d5b5a0743086d0e70ffa2ef7993cb0a31dbdb6.png)

Table 29-46: DAI\_EXTD\_CLK5 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                    |
|--------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 21:20 (R/W)        | IN5        | Extended Input Clock 5. DAI_EXTD_CLK5.IN5 and DAI_CLK5.IN5 together hold the extended source signal assignment that will be routed to the DAI_CLK5.IN5 destination. Refer to the Group A Signals table for source and destination mappings |
| 17:16 (R/W)        | IN4        | Extended Input Clock 4. DAI_EXTD_CLK5.IN4 and DAI_CLK5.IN4 together hold the extended source signal assignment that will be routed to the DAI_CLK5.IN4 destination. Refer to the Group A Signals table for source and destination mappings |
| 13:12 (R/W)        | IN3        | Extended Input Clock 3. DAI_EXTD_CLK5.IN3 and DAI_CLK5.IN3 together hold the extended source signal assignment that will be routed to the DAI_CLK5.IN3 destination. Refer to the Group A Signals table for source and destination mappings |
| 9:8 (R/W)          | IN2        | Extended Input Clock 2. DAI_EXTD_CLK5.IN2 and DAI_CLK5.IN2 together hold the extended source signal assignment that will be routed to the DAI_CLK5.IN2 destination. Refer to the Group A Signals table for source and destination mappings |
| 5:4 (R/W)          | IN1        | Extended Input Clock 1. DAI_EXTD_CLK5.IN1 and DAI_CLK5.IN1 together hold the extended source signal assignment that will be routed to the DAI_CLK5.IN1 destination. Refer to the Group A Signals table for source and destination mappings |

Table 29-46: DAI\_EXTD\_CLK5 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1:0 (R/W)          | IN0        | Extended Input Clock 0. DAI_EXTD_CLK5.IN0 and DAI_CLK5.IN0 together hold the extended source signal assignment that will be routed to the DAI_CLK5.IN0 destination. Refer to the Group A Signals table for source and destination mappings. |

## Extended Clock Routing Control Register 6

The DAI\_EXTD\_CLK6 and DAI\_CLK6 registers together provides the extended clock routing connections for the serial ports (SPORTs).

Figure 29-40: DAI\_EXTD\_CLK6 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000038_b00e65093edf3bc84efd511b23d5b5a0743086d0e70ffa2ef7993cb0a31dbdb6.png)

Table 29-47: DAI\_EXTD\_CLK6 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 21:20 (R/W)        | IN5        | Extended Input Clock 5. DAI_EXTD_CLK6.IN5 and DAI_CLK6.IN5 together hold the extended source signal assignment that will be routed to the DAI_CLK6.IN5 destination. Refer to the Group A Signals table for source and destination mappings. |
| 17:16 (R/W)        | IN4        | Extended Input Clock 4. DAI_EXTD_CLK6.IN4 and DAI_CLK6.IN4 together hold the extended source signal assignment that will be routed to the DAI_CLK6.IN4 destination. Refer to the Group A Signals table for source and destination mappings. |
| 13:12 (R/W)        | IN3        | Extended Input Clock 3. DAI_EXTD_CLK6.IN3 and DAI_CLK6.IN3 together hold the extended source signal assignment that will be routed to the DAI_CLK6.IN3 destination. Refer to the Group A Signals table for source and destination mappings. |
| 9:8 (R/W)          | IN2        | Extended Input Clock 2. DAI_EXTD_CLK6.IN2 and DAI_CLK6.IN2 together hold the extended source signal assignment that will be routed to the DAI_CLK6.IN2 destination. Refer to the Group A Signals table for source and destination mappings. |
| 5:4 (R/W)          | IN1        | Extended Input Clock 1. DAI_EXTD_CLK6.IN1 and DAI_CLK6.IN1 together hold the extended source signal assignment that will be routed to the DAI_CLK6.IN1 destination. Refer to the Group A Signals table for source and destination mappings. |

Table 29-47: DAI\_EXTD\_CLK6 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1:0 (R/W)          | IN0        | Extended Input Clock 0. DAI_EXTD_CLK6.IN0 and DAI_CLK6.IN0 together hold the extended source signal assignment that will be routed to the DAI_CLK6.IN0 destination. Refer to the Group A Signals table for source and destination mappings. |

## Extended Clock Routing Control Register 7

The DAI\_EXTD\_CLK7 and DAI\_CLK7 registers together provides the extended clock routing connections for the serial ports (SPORTs).

Figure 29-41: DAI\_EXTD\_CLK7 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000039_373a6da1d322e4afaba61fb4c605efdca9a39a2f0b10a3f583582684e21d7d08.png)

Table 29-48: DAI\_EXTD\_CLK7 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                     |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5:4 (R/W)          | IN1        | Extended Input Clock 1. DAI_EXTD_CLK7.IN1 and DAI_CLK7.IN1 together hold the extended source signal assignment that will be routed to the DAI_CLK7.IN1 destination. Refer to the Group A Signals table for source and destination mappings. |
| 1:0 (R/W)          | IN0        | Extended Input Clock 0. DAI_EXTD_CLK7.IN0 and DAI_CLK7.IN0 together hold the extended source signal assignment that will be routed to the DAI_CLK7.IN0 destination. Refer to the Group A Signals table for source and destination mappings. |
...
Figure 29-42: DAI\_EXTD\_DAT0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000040_56125df9c0a2da461d9a4821a9720a5ac30953e6c26c6a10769502ba435f1f19.png)

Table 29-49: DAI\_EXTD\_DAT0 Register Fields
...
Figure 29-43: DAI\_EXTD\_DAT1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000041_56125df9c0a2da461d9a4821a9720a5ac30953e6c26c6a10769502ba435f1f19.png)

Table 29-50: DAI\_EXTD\_DAT1 Register Fields
...
Figure 29-44: DAI\_EXTD\_DAT2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000042_1a2a4ddae630577ed32b71bb4a07a4ab2303d5a95e1dc5201e3ac9ac1cd42f3e.png)

Table 29-51: DAI\_EXTD\_DAT2 Register Fields
...
Figure 29-45: DAI\_EXTD\_DAT3 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000043_56125df9c0a2da461d9a4821a9720a5ac30953e6c26c6a10769502ba435f1f19.png)

Table 29-52: DAI\_EXTD\_DAT3 Register Fields
...
Figure 29-46: DAI\_EXTD\_DAT4 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000044_8587e0c3ccced2d4a3ac233990269561d1090f393b1ad675ed21bde0ba2783d2.png)

Table 29-53: DAI\_EXTD\_DAT4 Register Fields
...
Figure 29-47: DAI\_EXTD\_DAT5 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000045_30b82d777173e243cc98578db320cc44a2117958bd8ca3d1993bb9a03dd9657a.png)

Table 29-54: DAI\_EXTD\_DAT5 Register Fields
...
Figure 29-48: DAI\_EXTD\_DAT6 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000046_0020c83dd4742bf761f1d473864e4103a3d1c8a4701a30ac4cc9da17eec9ec99.png)

Table 29-55: DAI\_EXTD\_DAT6 Register Fields
...
## Extended Serial Data Routing Control Register 7

The DAI\_EXTD\_DAT7 and DAI\_DAT7 together provides the extended data routing connections to the serial data of serial ports.

Figure 29-49: DAI\_EXTD\_DAT7 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000047_56125df9c0a2da461d9a4821a9720a5ac30953e6c26c6a10769502ba435f1f19.png)

Table 29-56: DAI\_EXTD\_DAT7 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                             |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 17 (R/W)           | IN4        | Extended Input Data 4. DAI_EXTD_DAT7.IN4 and DAI_DAT7.IN4 together hold the source signal as- signment that will be routed to the DAI_DAT7.IN4 destination. Refer to the Group B Signals table for source and destination mappings. |
| 13 (R/W)           | IN3        | Extended Input Data 3. DAI_EXTD_DAT7.IN3 and DAI_DAT7.IN3 together hold the source signal as- signment that will be routed to the DAI_DAT7.IN3 destination. Refer to the Group B Signals table for source and destination mappings. |
| 9 (R/W)            | IN2        | Extended Input Data 2. DAI_EXTD_DAT7.IN2 and DAI_DAT7.IN2 together hold the source signal as- signment that will be routed to the DAI_DAT7.IN2 destination. Refer to the Group B Signals table for source and destination mappings. |
| 5 (R/W)            | IN1        | Extended Input Data 1. DAI_EXTD_DAT7.IN1 and DAI_DAT7.IN1 together hold the source signal as- signment that will be routed to the DAI_DAT7.IN1 destination. Refer to the Group B Signals table for source and destination mappings. |
| 1 (R/W)            | IN0        | Extended Input Data 0. DAI_EXTD_DAT7.IN0 and DAI_DAT7.IN0 together hold the source signal as- signment that will be routed to the DAI_DAT7.IN0 destination. Refer to the Group B Signals table for source and destination mappings. |

## Extended Serial Data Routing Control Register 8

The DAI\_EXTD\_DAT8 and DAI\_DAT8 together provides the extended data routing connections to the serial data of serial ports.

Figure 29-50: DAI\_EXTD\_DAT8 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000048_8587e0c3ccced2d4a3ac233990269561d1090f393b1ad675ed21bde0ba2783d2.png)

Table 29-57: DAI\_EXTD\_DAT8 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                             |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 9 (R/W)            | IN2        | Extended Input Data 2. DAI_EXTD_DAT8.IN2 and DAI_DAT8.IN2 together hold the source signal as- signment that will be routed to the DAI_DAT8.IN2 destination. Refer to the Group B Signals table for source and destination mappings. |
| 5 (R/W)            | IN1        | Extended Input Data 1. DAI_EXTD_DAT8.IN1 and DAI_DAT8.IN1 together hold the source signal as- signment that will be routed to the DAI_DAT8.IN1 destination. Refer to the Group B Signals table for source and destination mappings. |
| 1 (R/W)            | IN0        | Extended Input Data 0. DAI_EXTD_DAT8.IN0 and DAI_DAT8.IN0 together hold the source signal as- signment that will be routed to the DAI_DAT8.IN0 destination. Refer to the Group B Signals table for source and destination mappings. |
...
Figure 29-51: DAI\_EXTD\_FS0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000049_04350e750788c8326b8b43a7a4a211cd52551545f32c1db8ad32da203e8b32d1.png)

Table 29-58: DAI\_EXTD\_FS0 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                |
|--------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 21:20 (R/W)        | IN5        | Extended Input Frame Sync 5. DAI_EXTD_FS0.IN5 and DAI_FS0.IN5 together hold the source signal assign- ment that will be routed to the DAI_FS0.IN5 destination. Refer to the Group C Signals table for source and destination mappings. |
| 17:16 (R/W)        | IN4        | Extended Input Frame Sync 4. DAI_EXTD_FS0.IN4 and DAI_FS0.IN4 together hold the source signal assign- ment that will be routed to the DAI_FS0.IN4 destination. Refer to the Group C Signals table for source and destination mappings. |
| 13:12 (R/W)        | IN3        | Extended Input Frame Sync 3. DAI_EXTD_FS0.IN3 and DAI_FS0.IN3 together hold the source signal assign- ment that will be routed to the DAI_FS0.IN3 destination. Refer to the Group C Signals table for source and destination mappings. |
| 9:8 (R/W)          | IN2        | Extended Input Frame Sync 2. DAI_EXTD_FS0.IN2 and DAI_FS0.IN2 together hold the source signal assign- ment that will be routed to the DAI_FS0.IN2 destination. Refer to the Group C Signals table for source and destination mappings. |
| 5:4 (R/W)          | IN1        | Extended Input Frame Sync 1. DAI_EXTD_FS0.IN1 and DAI_FS0.IN1 together hold the source signal assign- ment that will be routed to the DAI_FS0.IN1 destination. Refer to the Group C Signals table for source and destination mappings. |

Table 29-58: DAI\_EXTD\_FS0 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                |
|--------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1:0 (R/W)          | IN0        | Extended Input Frame Sync 0. DAI_EXTD_FS0.IN0 and DAI_FS0.IN0 together hold the source signal assign- ment that will be routed to the DAI_FS0.IN0 destination. Refer to the Group C Signals table for source and destination mappings. |
...
Figure 29-52: DAI\_EXTD\_FS1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000050_04350e750788c8326b8b43a7a4a211cd52551545f32c1db8ad32da203e8b32d1.png)

Table 29-59: DAI\_EXTD\_FS1 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                |
|--------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 21:20 (R/W)        | IN5        | Extended Input Frame Sync 5. DAI_EXTD_FS1.IN5 and DAI_FS1.IN5 together hold the source signal assign- ment that will be routed to the DAI_FS1.IN5 destination. Refer to the Group C Signals table for source and destination mappings. |
| 17:16 (R/W)        | IN4        | Extended Input Frame Sync 4. DAI_EXTD_FS1.IN4 and DAI_FS1.IN4 together hold the source signal assign- ment that will be routed to the DAI_FS1.IN4 destination. Refer to the Group C Signals table for source and destination mappings. |
| 13:12 (R/W)        | IN3        | Extended Input Frame Sync 3. DAI_EXTD_FS1.IN3 and DAI_FS1.IN3 together hold the source signal assign- ment that will be routed to the DAI_FS1.IN3 destination. Refer to the Group C Signals table for source and destination mappings. |
| 9:8 (R/W)          | IN2        | Extended Input Frame Sync 2. DAI_EXTD_FS1.IN2 and DAI_FS1.IN2 together hold the source signal assign- ment that will be routed to the DAI_FS1.IN2 destination. Refer to the Group C Signals table for source and destination mappings. |
| 5:4 (R/W)          | IN1        | Extended Input Frame Sync 1. DAI_EXTD_FS1.IN1 and DAI_FS1.IN1 together hold the source signal assign- ment that will be routed to the DAI_FS1.IN1 destination. Refer to the Group C Signals table for source and destination mappings. |

Table 29-59: DAI\_EXTD\_FS1 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                |
|--------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1:0 (R/W)          | IN0        | Extended Input Frame Sync 0. DAI_EXTD_FS1.IN0 and DAI_FS1.IN0 together hold the source signal assign- ment that will be routed to the DAI_FS1.IN0 destination. Refer to the Group C Signals table for source and destination mappings. |
...
Figure 29-53: DAI\_EXTD\_FS2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000051_078e79a5dc00e4dca438f4625d9b5ada01e5701f3fcdd52775dbb0cfd30a0394.png)

Table 29-60: DAI\_EXTD\_FS2 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                |
|--------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 9:8 (R/W)          | IN2        | Extended Input Frame Sync 2. DAI_EXTD_FS2.IN2 and DAI_FS2.IN2 together hold the source signal assign- ment that will be routed to the DAI_FS2.IN2 destination. Refer to the Group C Signals table for source and destination mappings. |
| 5:4 (R/W)          | IN1        | Extended Input Frame Sync 1. DAI_EXTD_FS2.IN1 and DAI_FS2.IN1 together hold the source signal assign- ment that will be routed to the DAI_FS2.IN1 destination. Refer to the Group C Signals table for source and destination mappings. |
| 1:0 (R/W)          | IN0        | Extended Input Frame Sync 0. DAI_EXTD_FS2.IN0 and DAI_FS2.IN0 together hold the source signal assign- ment that will be routed to the DAI_FS2.IN0 destination. Refer to the Group C Signals table for source and destination mappings. |
...
Figure 29-54: DAI\_EXTD\_FS4 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000052_6c4908157adfc2e1e63c43d0e971e52d4103f1e3cbc53928c765aea505d0405f.png)

Table 29-61: DAI\_EXTD\_FS4 Register Fields
...
| 5:4 (R/W)          | IN1        | Extended Input Frame Sync 1. DAI_EXTD_FS4.IN1 and DAI_FS4.IN1 together hold the source signal assign- ment that will be routed to the DAI_FS4.IN1 destination. Refer to the Group C Signals table for source and destination mappings.                                                                      |
| 1:0 (R/W)          | IN0        | Extended Input Frame Sync 0. DAI_EXTD_FS4.IN0 and DAI_FS4.IN0 together hold the source signal assign- ment that will be routed to the DAI_FS4.IN0 destination. Refer to the Group C Signals table for source and destination mappings.                                                                      |

## Extended Frame Sync Routing Control Register 5

The DAI\_EXTD\_FS5 and DAI\_FS5 together provides the extended frame sync routing connections to the frame syncs of serial ports.

Figure 29-55: DAI\_EXTD\_FS5 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000053_04350e750788c8326b8b43a7a4a211cd52551545f32c1db8ad32da203e8b32d1.png)

Table 29-62: DAI\_EXTD\_FS5 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                |
|--------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 21:20 (R/W)        | IN5        | Extended Input Frame Sync 5. DAI_EXTD_FS5.IN5 and DAI_FS5.IN5 together hold the source signal assign- ment that will be routed to the DAI_FS5.IN5 destination. Refer to the Group C Signals table for source and destination mappings. |
| 17:16 (R/W)        | IN4        | Extended Input Frame Sync 4. DAI_EXTD_FS5.IN4 and DAI_FS5.IN4 together hold the source signal assign- ment that will be routed to the DAI_FS5.IN4 destination. Refer to the Group C Signals table for source and destination mappings. |
| 13:12 (R/W)        | IN3        | Extended Input Frame Sync 3. DAI_EXTD_FS5.IN3 and DAI_FS5.IN3 together hold the source signal assign- ment that will be routed to the DAI_FS5.IN3 destination. Refer to the Group C Signals table for source and destination mappings. |
| 9:8 (R/W)          | IN2        | Extended Input Frame Sync 2. DAI_EXTD_FS5.IN2 and DAI_FS5.IN2 together hold the source signal assign- ment that will be routed to the DAI_FS5.IN2 destination. Refer to the Group C Signals table for source and destination mappings. |
| 5:4 (R/W)          | IN1        | Extended Input Frame Sync 1. DAI_EXTD_FS5.IN1 and DAI_FS5.IN1 together hold the source signal assign- ment that will be routed to the DAI_FS5.IN1 destination. Refer to the Group C Signals table for source and destination mappings. |

Table 29-62: DAI\_EXTD\_FS5 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                |
|--------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1:0 (R/W)          | IN0        | Extended Input Frame Sync 0. DAI_EXTD_FS5.IN0 and DAI_FS5.IN0 together hold the source signal assign- ment that will be routed to the DAI_FS5.IN0 destination. Refer to the Group C Signals table for source and destination mappings. |

## Extended Frame Sync Routing Control Register 6

The DAI\_EXTD\_FS6 and DAI\_FS6 together provides the extended frame sync routing connections to the frame syncs of serial ports.

Figure 29-56: DAI\_EXTD\_FS6 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000054_5b4357f432600209ab2d7807d4bf2d9c0da324685911bc935d15cd4467686296.png)

Table 29-63: DAI\_EXTD\_FS6 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                |
|--------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5:4 (R/W)          | IN1        | Extended Input Frame Sync 1. DAI_EXTD_FS6.IN1 and DAI_FS6.IN1 together hold the source signal assign- ment that will be routed to the DAI_FS6.IN1 destination. Refer to the Group C Signals table for source and destination mappings. |
| 1:0 (R/W)          | IN0        | Extended Input Frame Sync 0. DAI_EXTD_FS6.IN0 and DAI_FS6.IN0 together hold the source signal assign- ment that will be routed to the DAI_FS6.IN0 destination. Refer to the Group C Signals table for source and destination mappings. |
...
Figure 29-57: DAI\_EXTD\_MISC0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000055_55ed58a93366a056174438d9b97878db42eb0516e5aef357542a83c4757e23fb.png)

Table 29-64: DAI\_EXTD\_MISC0 Register Fields
...
Table 29-64: DAI\_EXTD\_MISC0 Register Fields (Continued)
...
Figure 29-58: DAI\_EXTD\_MISC1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000056_3e31c4bdb5baa9dbd547df2a1aac807d901abbcac26ac5625c2a7dc07c0398c0.png)

Table 29-65: DAI\_EXTD\_MISC1 Register Fields
...
Figure 29-59: DAI\_EXTD\_MISC2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000057_9f9276b177bdc83e6670170d36a386e32783c8a90916d1509645dc8747a7e507.png)

Table 29-66: DAI\_EXTD\_MISC2 Register Fields
...
Figure 29-60: DAI\_EXTD\_PBEN0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000058_ea3ff60421321a2e59511e41e8c94cc91c4bd290b2541a2ac821b026dffda777.png)

Table 29-67: DAI\_EXTD\_PBEN0 Register Fields
...
Figure 29-61: DAI\_EXTD\_PBEN1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000059_1541edcc2a8d036a0b02c47cf60c60588d160b89a8a096891d4719ffe406dc92.png)

Table 29-68: DAI\_EXTD\_PBEN1 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                         |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 17 (R/W)           | PB10       | Extended Pin Buffer Enable 10. The DAI_EXTD_PBEN1.PB10 bit field and DAI_PBEN0.PB10 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 10. |
| 13 (R/W)           | PB09       | Extended Pin Buffer Enable 9. The DAI_EXTD_PBEN1.PB09 bit field and DAI_PBEN0.PB09 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 9.   |
| 9 (R/W)            | PB08       | Extended Pin Buffer Enable 8. The DAI_EXTD_PBEN1.PB08 bit field and DAI_PBEN0.PB08 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 8.   |
| 5 (R/W)            | PB07       | Extended Pin Buffer Enable 7. The DAI_EXTD_PBEN1.PB07 bit field and DAI_PBEN0.PB07 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 7.   |
| 1 (R/W)            | PB06       | Extended Pin Buffer Enable 6. The DAI_EXTD_PBEN1.PB06 bit field and DAI_PBEN0.PB06 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 6.   |
...
Figure 29-62: DAI\_EXTD\_PBEN2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000060_aed4ce65941ce34e60f7663788813446b89323e5ae6a9fcf8f61d6624ae98bbc.png)

Table 29-69: DAI\_EXTD\_PBEN2 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                         |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 17 (R/W)           | PB15       | Extended Pin Buffer Enable 15. The DAI_EXTD_PBEN2.PB15 bit field and DAI_PBEN0.PB15 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 15. |
| 13 (R/W)           | PB14       | Extended Pin Buffer Enable 14. The DAI_EXTD_PBEN2.PB14 bit field and DAI_PBEN0.PB14 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 14. |
| 9 (R/W)            | PB13       | Extended Pin Buffer Enable 13. The DAI_EXTD_PBEN2.PB13 bit field and DAI_PBEN0.PB13 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 13. |
| 5 (R/W)            | PB12       | Extended Pin Buffer Enable 12. The DAI_EXTD_PBEN2.PB12 bit field and DAI_PBEN0.PB12 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 12. |
| 1 (R/W)            | PB11       | Extended Pin Buffer Enable 11. The DAI_EXTD_PBEN2.PB11 bit field and DAI_PBEN0.PB11 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 11. |
...
Figure 29-63: DAI\_EXTD\_PBEN3 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000061_a9e3b0f0128938091ff525797bd750640de88a14b9f4ad5fbbd75ed237af0358.png)

Table 29-70: DAI\_EXTD\_PBEN3 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                         |
|--------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 17 (R/W)           | PB20       | Extended Pin Buffer Enable 20. The DAI_EXTD_PBEN3.PB20 bit field and DAI_PBEN0.PB20 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 20. |
| 13 (R/W)           | PB19       | Extended Pin Buffer Enable 19. The DAI_EXTD_PBEN3.PB19 bit field and DAI_PBEN0.PB19 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 19. |
| 9 (R/W)            | PB18       | Extended Pin Buffer Enable 18. The DAI_EXTD_PBEN3.PB18 bit field and DAI_PBEN0.PB18 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 18. |
| 5 (R/W)            | PB17       | Extended Pin Buffer Enable 17. The DAI_EXTD_PBEN3.PB17 bit field and DAI_PBEN0.PB17 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 17. |
| 1 (R/W)            | PB16       | Extended Pin Buffer Enable 16. The DAI_EXTD_PBEN3.PB16 bit field and DAI_PBEN0.PB16 bit field together hold the extended source signal assignment which will be routed to the pin buffer enable of DAI port 16. |
...
Figure 29-64: DAI\_EXTD\_PIN0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000062_b37197b178eed21c28260a5ab252e8132503bbed492010b6411d26efc4e9850a.png)

Table 29-71: DAI\_EXTD\_PIN0 Register Fields
...
Figure 29-65: DAI\_EXTD\_PIN1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000063_4aebe3b1f58a7f253223c9ed8a45a31e35c8389dbe627c4ac74d589c6f666ca3.png)

Table 29-72: DAI\_EXTD\_PIN1 Register Fields
...
Figure 29-66: DAI\_EXTD\_PIN2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000064_e08e916ebaee568d9f75539dc6b95c22ab37e0ea0bcc88aa82f5f4f552177dde.png)

Table 29-73: DAI\_EXTD\_PIN2 Register Fields
...
Figure 29-67: DAI\_EXTD\_PIN3 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000065_c6a2ef77eaf447f58cf513d436f25957e3774953e215612c1c86c0c56d1add4f.png)

Table 29-74: DAI\_EXTD\_PIN3 Register Fields
...
Figure 29-68: DAI\_EXTD\_PIN4 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000066_17539ceda5aaf78516efaeeea61ee385e6f66101e589f188b5557e3b86fc48e6.png)

Table 29-75: DAI\_EXTD\_PIN4 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                          |
|--------------------|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 29 (R/W)           | DUMMY_PB3  | Extended Dummy Pin Buffer 3 Input. DAI_EXTD_PIN4.DUMMY_PB3 and DAI_PIN5.DUMMY_PB3 together hold the source signal assignment that will be routed to the DAI_PIN5.DUMMY_PB3 destina- tion. Refer to the Group DSignals table for source and destination mappings. |
| 25 (R/W)           | DUMMY_PB2  | Extended Dummy Pin Buffer 2 Input. DAI_EXTD_PIN4.DUMMY_PB2 and DAI_PIN5.DUMMY_PB2 together hold the source signal assignment that will be routed to the DAI_PIN5.DUMMY_PB2 destina- tion. Refer to the Group DSignals table for source and destination mappings. |
| 21 (R/W)           | DUMMY_PB1  | Extended Dummy Pin Buffer 1 Input. DAI_EXTD_PIN4.DUMMY_PB1 and DAI_PIN5.DUMMY_PB1 together hold the source signal assignment that will be routed to the DAI_PIN5.DUMMY_PB1 destina- tion. Refer to the Group DSignals table for source and destination mappings. |
| 17 (R/W)           | DUMMY_PB0  | Extended Dummy Pin Buffer 0 Input. DAI_EXTD_PIN4.DUMMY_PB0 and DAI_PIN5.DUMMY_PB0 together hold the source signal assignment that will be routed to the DAI_PIN5.DUMMY_PB0 destina- tion. Refer to the Group DSignals table for source and destination mappings. |

Table 29-75: DAI\_EXTD\_PIN4 Register Fields (Continued)
...
Figure 29-69: DAI\_FS0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000067_1c49d0b5f2711e12b10945745a532d508311c3ef06a0226f1f5a5159daff9c62.png)

Table 29-76: DAI\_FS0 Register Fields
...
Table 29-76: DAI\_FS0 Register Fields (Continued)
...
Figure 29-70: DAI\_FS1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000068_496ed73354a33b04530e222b113ebbf853f3291c948e93165507ecc241633b76.png)

Table 29-77: DAI\_FS1 Register Fields
...
Table 29-77: DAI\_FS1 Register Fields (Continued)
...
Figure 29-71: DAI\_FS2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000069_bd4f457830fb60662d68bd5686e83cdf1a97ac266d48d2074e43abfaee88230a.png)

Table 29-78: DAI\_FS2 Register Fields
...
Figure 29-72: DAI\_FS4 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000070_2382c73f2e9e95ad4be11b11dbc873b266c2e7e6991546adc6def0808eea6c96.png)

Table 29-79: DAI\_FS4 Register Fields
...
## Frame Sync Routing Control Register 5

The DAI\_FS5 register routes frame syncs to the asynchronous sample rate converter (ASRC).

Figure 29-73: DAI\_FS5 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000071_496ed73354a33b04530e222b113ebbf853f3291c948e93165507ecc241633b76.png)

Table 29-80: DAI\_FS5 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                        |
|--------------------|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 29:25 (R/W)        | IN5        | Input Frame Sync 5. DAI_FS5.IN5 holds the source signal assignment that will be routed to the DAI_FS5.IN5 destination. Refer to the Group C Signals table for source and destination mappings. |
| 24:20 (R/W)        | IN4        | Input Frame Sync 4. DAI_FS5.IN4 holds the source signal assignment that will be routed to the DAI_FS5.IN4 destination. Refer to the Group C Signals table for source and destination mappings. |
| 19:15 (R/W)        | IN3        | Input Frame Sync 3. DAI_FS5.IN3 holds the source signal assignment that will be routed to the DAI_FS5.IN3 destination. Refer to the Group C Signals table for source and destination mappings. |
| 14:10 (R/W)        | IN2        | Input Frame Sync 2. DAI_FS5.IN2 holds the source signal assignment that will be routed to the DAI_FS5.IN2 destination. Refer to the Group C Signals table for source and destination mappings. |
| 9:5 (R/W)          | IN1        | Input Frame Sync 1. DAI_FS5.IN1 holds the source signal assignment that will be routed to the DAI_FS5.IN1 destination. Refer to the Group C Signals table for source and destination mappings. |

Table 29-80: DAI\_FS5 Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                        |
|--------------------|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4:0 (R/W)          | IN0        | Input Frame Sync 0. DAI_FS5.IN0 holds the source signal assignment that will be routed to the DAI_FS5.IN0 destination. Refer to the Group C Signals table for source and destination mappings. |

## Frame Sync Routing Control Register 6

The DAI\_FS6 register routes frame syncs to the asynchronous sample rate converter (ASRC).

Figure 29-74: DAI\_FS6 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000072_d09c1b7b69db4d1ee44abbc73b5b93b2c44a06bfc553d118fb4496a24721d268.png)

Table 29-81: DAI\_FS6 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                        |
|--------------------|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 9:5 (R/W)          | IN1        | Input Frame Sync 1. DAI_FS6.IN1 holds the source signal assignment that will be routed to the DAI_FS6.IN1 destination. Refer to the Group C Signals table for source and destination mappings. |
| 4:0 (R/W)          | IN0        | Input Frame Sync 0. DAI_FS6.IN0 holds the source signal assignment that will be routed to the DAI_FS6.IN0 destination. Refer to the Group C Signals table for source and destination mappings. |
...
Figure 29-75: DAI\_GBL\_INT\_EN Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000073_f8fd04ea9ccc5a376cf4f760129d1f9e926b33d945cbebdd0320cc981dd85711.png)

Table 29-82: DAI\_GBL\_INT\_EN Register Fields
...
Table 29-82: DAI\_GBL\_INT\_EN Register Fields (Continued)
...
Figure 29-76: DAI\_GBL\_PCG\_EN Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000074_01bc1e7a8a9344ad976db3aa565fa4fa0ce096c2494bffe2104784c5671d19e8.png)

Table 29-83: DAI\_GBL\_PCG\_EN Register Fields
...
Table 29-83: DAI\_GBL\_PCG\_EN Register Fields (Continued)
...
| 0 (R/W)            | GBL_PCG_EN      | Global PCG Enable. This bit globally enables the PCGs across DAI0 and DAI1. The DAI_GBL_PCG_EN.GBL_PCG_EN bit, when set (=1), along with bit [2:1] and [23:8] enables all the PCGs across DAI0 and DAI1. This bit when cleared (=0) disables all the PCGs across DAI0 and DAI1. |
...
Figure 29-77: DAI\_GBL\_SP\_EN Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000075_f517212fecefea3b5ffbb8e0658baffaeb2528853f5191501b2bba26566eef6c.png)

Table 29-84: DAI\_GBL\_SP\_EN Register Fields
...
Table 29-84: DAI\_GBL\_SP\_EN Register Fields (Continued)
...
Figure 29-78: DAI\_IMSK\_FE Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000076_34f19ed87d19c6dedb0762c780228ee9781be4e2813e9e7a553e2b0e60233913.png)

Table 29-85: DAI\_IMSK\_FE Register Fields
...
Table 29-85: DAI\_IMSK\_FE Register Fields (Continued)
...
| 17 (R/W)           | SRC7MUTE     | SRC7 Mute. The DAI_IMSK_FE.SRC7MUTE bit masks or unmasks the corresponding SRC mute out interrupt for the falling edge of this interrupt. This interrupt can be generat- ed either entering mute, exiting muting or both.                               |
| 16 (R/W)           | SRC6MUTE     | SRC6 Mute. The DAI_IMSK_FE.SRC6MUTE bit masks or unmasks the corresponding SRC mute out interrupt for the falling edge of this interrupt. This interrupt can be generat- ed either entering mute, exiting muting or both.                               |
| 15 (R/W)           | SRC5MUTE     | SRC5 Mute. The DAI_IMSK_FE.SRC5MUTE bit masks or unmasks the corresponding SRC mute out interrupt for the falling edge of this interrupt. This interrupt can be generat- ed either entering mute, exiting muting or both.                               |
| 14 (R/W)           | SRC4MUTE     | SRC4 Mute. The DAI_IMSK_FE.SRC4MUTE bit masks or unmasks the corresponding SRC mute out interrupt for the falling edge of this interrupt. This interrupt can be generat- ed either entering mute, exiting muting or both.                               |
...
Figure 29-79: DAI\_IMSK\_PRI Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000077_e09d51773deeb539118d196cd273b1daa19a9a7b2d8ac4caa142142aa0255387.png)

Table 29-86: DAI\_IMSK\_PRI Register Fields
...
Table 29-86: DAI\_IMSK\_PRI Register Fields (Continued)
...
| 17 (R/W)           | SRC7MUTE   | SRC7 Mute. If the DAI_IMSK_PRI.SRC7MUTE bit is cleared (=0), the interrupt is mapped to INTR_DAI_IRQL signal from the SEC. If the DAI_IMSK_PRI.SRC7MUTE bit is set (=1) the interrupt is mapped to INTR_DAI_IRQH signal from the SEC.                    |
| 16 (R/W)           | SRC6MUTE   | SRC6 Mute. If the DAI_IMSK_PRI.SRC6MUTE bit is cleared (=0), the interrupt is mapped to INTR_DAI_IRQL signal from the SEC. If the DAI_IMSK_PRI.SRC6MUTE bit is set (=1) the interrupt is mapped to INTR_DAI_IRQH signal from the SEC.                    |
| 15 (R/W)           | SRC5MUTE   | SRC5 Mute. If the DAI_IMSK_PRI.SRC5MUTE bit is cleared (=0), the interrupt is mapped to INTR_DAI_IRQL signal from the SEC. If the DAI_IMSK_PRI.SRC5MUTE bit is set (=1) the interrupt is mapped to INTR_DAI_IRQH signal from the SEC.                    |
| 14 (R/W)           | SRC4MUTE   | SRC4 Mute. If the DAI_IMSK_PRI.SRC4MUTE bit is cleared (=0), the interrupt is mapped to INTR_DAI_IRQL signal from the SEC. If the DAI_IMSK_PRI.SRC4MUTE bit is set (=1) the interrupt is mapped to INTR_DAI_IRQH signal from the SEC.                    |
...
Figure 29-80: DAI\_IMSK\_RE Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000078_4fb3f1f4834a11bf815a36a79e24e9c474a4e9c90ea2d1dd74309dbd1ee4cc06.png)

Table 29-87: DAI\_IMSK\_RE Register Fields
...
Table 29-87: DAI\_IMSK\_RE Register Fields (Continued)
...
| 17 (R/W)           | SRC7MUTE     | SRC7 Mute. The DAI_IMSK_RE.SRC7MUTE bit masks or unmasks the corresponding SRC mute out interrupt for the rising edge of this interrupt. This interrupt can be generated either entering mute, exiting muting or both.                                       |
| 16 (R/W)           | SRC6MUTE     | SRC6 Mute. The DAI_IMSK_RE.SRC6MUTE bit masks or unmasks the corresponding SRC mute out interrupt for the rising edge of this interrupt. This interrupt can be generated either entering mute, exiting muting or both.                                       |
| 15 (R/W)           | SRC5MUTE     | SRC5 Mute. The DAI_IMSK_RE.SRC5MUTE bit masks or unmasks the corresponding SRC mute out interrupt for the rising edge of this interrupt. This interrupt can be generated either entering mute, exiting muting or both.                                       |
| 14 (R/W)           | SRC4MUTE     | SRC4 Mute. The DAI_IMSK_RE.SRC4MUTE bit masks or unmasks the corresponding SRC mute out interrupt for the rising edge of this interrupt. This interrupt can be generated either entering mute, exiting muting or both.                                       |
...
Figure 29-81: DAI\_IRPTL\_H Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000079_fb93c289711f0b2e16e5185040a71b5eaee3cf413a3d9bcd7d223d54baf6c881.png)

Table 29-88: DAI\_IRPTL\_H Register Fields
...
Table 29-88: DAI\_IRPTL\_H Register Fields (Continued)
...
| 17 (RC/NW)         | SRC7MUTE     | SRC7 Mute. The DAI_IRPTL_H.SRC7MUTE bit is set if the interrupt is mapped to the INTR_DAI_IRQH signal in the SEC using the DAI_IMSK_PRI register.                                |
| 16 (RC/NW)         | SRC6MUTE     | SRC6 Mute. The DAI_IRPTL_H.SRC6MUTE bit is set if the interrupt is mapped to the INTR_DAI_IRQH signal in the SEC using the DAI_IMSK_PRI register.                                |
| 15 (RC/NW)         | SRC5MUTE     | SRC5 Mute. The DAI_IRPTL_H.SRC5MUTE bit is set if the interrupt is mapped to the INTR_DAI_IRQH signal in the SEC using the DAI_IMSK_PRI register.                                |
| 14 (RC/NW)         | SRC4MUTE     | SRC4 Mute. The DAI_IRPTL_H.SRC4MUTE bit is set if the interrupt is mapped to the INTR_DAI_IRQH signal in the SEC using the DAI_IMSK_PRI register.                                |
...
Figure 29-82: DAI\_IRPTL\_HS Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000080_0bcb412701ad757fd45122e774bd98f388090c45768b595ecf743e5431a5076f.png)

Table 29-89: DAI\_IRPTL\_HS Register Fields
...
Table 29-89: DAI\_IRPTL\_HS Register Fields (Continued)
...
| Bit No. (Access)   | Bit Name     | Description/Enumeration                                                                                                                                                                                                                                         |
|--------------------|--------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 17 (R/NW)          | SRC7MUTE     | SRC7 Mute. The DAI_IRPTL_HS.SRC7MUTE bit is the shadow of the DAI_IRPTL_H.SRC0MUTE bit and contains the same content. Reading the DAI_IRPTL_HS.SRC7MUTE bit does not affect its contents while reading the DAI_IRPTL_H.SRC0MUTE bit clears it.                  |
| 16 (R/NW)          | SRC6MUTE     | SRC6 Mute. The DAI_IRPTL_HS.SRC6MUTE bit is the shadow of the DAI_IRPTL_H.SRC0MUTE bit and contains the same content. Reading the DAI_IRPTL_HS.SRC6MUTE bit does not affect its contents while reading the DAI_IRPTL_H.SRC0MUTE bit clears it.                  |
| 15 (R/NW)          | SRC5MUTE     | SRC5 Mute. The DAI_IRPTL_HS.SRC5MUTE bit is the shadow of the DAI_IRPTL_H.SRC0MUTE bit and contains the same content. Reading the DAI_IRPTL_HS.SRC5MUTE bit does not affect its contents while reading the DAI_IRPTL_H.SRC0MUTE bit clears it.                  |
| 14 (R/NW)          | SRC4MUTE     | SRC4 Mute. The DAI_IRPTL_HS.SRC4MUTE bit is the shadow of the DAI_IRPTL_H.SRC0MUTE bit and contains the same content. Reading the DAI_IRPTL_HS.SRC4MUTE bit does not affect its contents while reading the DAI_IRPTL_H.SRC0MUTE bit clears it.                  |
...
Figure 29-83: DAI\_IRPTL\_L Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000081_5f9f424ee13ac94291ff9c763f330d5d3c7ae7b987edbe0e6e91d2f54ef2323c.png)

Table 29-90: DAI\_IRPTL\_L Register Fields
...
Table 29-90: DAI\_IRPTL\_L Register Fields (Continued)
...
| 17 (RC/NW)         | SRC7MUTE     | SRC7 Mute. The DAI_IRPTL_L.SRC7MUTE bit is set if the interrupt is mapped to the INTR_DAI_IRQL signal in the SEC using the DAI_IMSK_PRI register.                     |
| 16 (RC/NW)         | SRC6MUTE     | SRC6 Mute. The DAI_IRPTL_L.SRC6MUTE bit is set if the interrupt is mapped to the INTR_DAI_IRQL signal in the SEC using the DAI_IMSK_PRI register.                     |
| 15 (RC/NW)         | SRC5MUTE     | SRC5 Mute. The DAI_IRPTL_L.SRC5MUTE bit is set if the interrupt is mapped to the INTR_DAI_IRQL signal in the SEC using the DAI_IMSK_PRI register.                     |
| 14 (RC/NW)         | SRC4MUTE     | SRC4 Mute. The DAI_IRPTL_L.SRC4MUTE bit is set if the interrupt is mapped to the INTR_DAI_IRQL signal in the SEC using the DAI_IMSK_PRI register.                     |
...
| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                               |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------|
| 0                  | RXVALID    | Receive Valid.                                                                                                                        |
| (RC/NW)            |            | The DAI_IRPTL_L.RXVALID bit is set if the interrupt is mapped to the INTR_DAI_IRQL signal in the SEC using the DAI_IMSK_PRI register. |
...
Figure 29-84: DAI\_IRPTL\_LS Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000082_283eecb7ad3fbd4fa1b50932b80c5db00a47728629180cad8a9a682cdaf69cc7.png)

Table 29-91: DAI\_IRPTL\_LS Register Fields
...
Table 29-91: DAI\_IRPTL\_LS Register Fields (Continued)
...
| Bit No. (Access)   | Bit Name     | Description/Enumeration                                                                                                                                                                                                                                         |
|--------------------|--------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 17 (R/NW)          | SRC7MUTE     | SRC7 Mute. The DAI_IRPTL_LS.SRC7MUTE bit is the shadow of the DAI_IRPTL_L.SRC0MUTE bit and contains the same content. Reading the DAI_IRPTL_LS.SRC7MUTE bit does not affect its contents while reading the DAI_IRPTL_L.SRC0MUTE bit clears it.                  |
| 16 (R/NW)          | SRC6MUTE     | SRC6 Mute. The DAI_IRPTL_LS.SRC6MUTE bit is the shadow of the DAI_IRPTL_L.SRC0MUTE bit and contains the same content. Reading the DAI_IRPTL_LS.SRC6MUTE bit does not affect its contents while reading the DAI_IRPTL_L.SRC0MUTE bit clears it.                  |
| 15 (R/NW)          | SRC5MUTE     | SRC5 Mute. The DAI_IRPTL_LS.SRC5MUTE bit is the shadow of the DAI_IRPTL_L.SRC0MUTE bit and contains the same content. Reading the DAI_IRPTL_LS.SRC5MUTE bit does not affect its contents while reading the DAI_IRPTL_L.SRC0MUTE bit clears it.                  |
| 14 (R/NW)          | SRC4MUTE     | SRC4 Mute. The DAI_IRPTL_LS.SRC4MUTE bit is the shadow of the DAI_IRPTL_L.SRC0MUTE bit and contains the same content. Reading the DAI_IRPTL_LS.SRC4MUTE bit does not affect its contents while reading the DAI_IRPTL_L.SRC0MUTE bit clears it.                  |
...
Figure 29-85: DAI\_MISC0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000083_0753377f07baefe1d96ebe909781e729a971ea997eccf2b69d94d751411a46b6.png)

Table 29-92: DAI\_MISC0 Register Fields
...
| 19:15 (R/W)        | IN9        | Input 9. The DAI_MISC0.IN9 bit field configures miscellaneous A3 input/miscellaneous Interrupt 9(DAI interrupt 31). |
| 14:10 (R/W)        | IN8        | Input 8. The DAI_MISC0.IN8 bit field configures miscellaneous A2 input/miscellaneous Interrupt 8(DAI interrupt 30). |

Table 29-92: DAI\_MISC0 Register Fields (Continued)
...
Figure 29-86: DAI\_MISC1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000084_150b3026da1bc6cfaed9b9f9b1e6e43da0efe5d0dcb8a5e66cdce795bb8465d0.png)

Table 29-93: DAI\_MISC1 Register Fields
...
Table 29-93: DAI\_MISC1 Register Fields (Continued)
...
![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000085_5edf1b417214ef59a4fe386802447cd1f9cbfdb3b521fde5bcaddb344de91b59.png)

Input 3

Figure 29-87: DAI\_MISC2 Register Diagram

Table 29-94: DAI\_MISC2 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                       |
|--------------------|------------|-----------------------------------------------------------------------------------------------|
| 19:15 (R/W)        | IN3        | Input 3. The DAI_MISC2.IN3 bit field configures PCG-F's hardware completer trigger input.     |
| 14:10 (R/W)        | IN2        | Input 2. The DAI_MISC2.IN2 bit field configures PCG-E's hardware completer trigger input.     |
...
Figure 29-88: DAI\_PBEN0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000086_4fdf20c3cffe5d71b8b60776b4b2e0acbd89ade73b36b6262c5e9a3f956e3743.png)

Table 29-95: DAI\_PBEN0 Register Fields
...
Figure 29-89: DAI\_PBEN1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000087_e605d4b7aff0b97888c98cf77af1475393db41c848699595d6ebbcc34d269335.png)

Table 29-96: DAI\_PBEN1 Register Fields
...
Figure 29-90: DAI\_PBEN2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000088_d9815f01a36071fa3ce3b5ee6dd5c499ad774a29663efd869c6367f90af70476.png)

Table 29-97: DAI\_PBEN2 Register Fields
...
Figure 29-91: DAI\_PBEN3 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000089_db237af64107e29bffde306c86efd6d48f66e6ff407c69a6d5420e09dfeffda9.png)

Table 29-98: DAI\_PBEN3 Register Fields
...
Figure 29-92: DAI\_PIN0 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000090_3da11e5d97999b92ac3b782f6fc994199cbf092123353fd9531ea43645e638f8.png)

Table 29-99: DAI\_PIN0 Register Fields
...
Figure 29-93: DAI\_PIN1 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000091_1ac66591a0a618dac98a1506d5500ce8eeede5bc37fa82463091118a873256fd.png)

Table 29-100: DAI\_PIN1 Register Fields
...
Figure 29-94: DAI\_PIN2 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000092_6e6c57779ec6a7ee5ea67cc866fc9e001b3c2ebae39b968b4898b240e0917df9.png)

Table 29-101: DAI\_PIN2 Register Fields
...
Figure 29-95: DAI\_PIN3 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000093_f2e3e0b9d4667c62d12614e8ee770484cf9bb4b70c9a939b8b4673609451bb00.png)

Table 29-102: DAI\_PIN3 Register Fields
...
Figure 29-96: DAI\_PIN4 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000094_62118d323de3c505ea6a6192843b69d8baedebf4cb8040417837065ca7dd8aff.png)

Table 29-103: DAI\_PIN4 Register Fields
...
Table 29-103: DAI\_PIN4 Register Fields (Continued)
...
## Dummy Pin Buffer Assignment Register

The DAI\_PIN5 register routes physical pins that are connected to a bonded pad.

Figure 29-97: DAI\_PIN5 Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000095_d358cd66b3454769ed37e0aa53034fb08452f783049c9d059fcfee0a6321e8ff.png)

Table 29-104: DAI\_PIN5 Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                           |
|--------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 27:21 (R/W)        | DUMMY_PB3  | Dummy Pin Buffer 3 Input. DAI_PIN5.DUMMY_PB3 holds the source signal assignment that will be routed to the DAI_PIN5.DUMMY_PB3 destination. Refer to the Group DSignals table for source and destination mappings. |
| 20:14 (R/W)        | DUMMY_PB2  | Dummy Pin Buffer 2 Input. DAI_PIN5.DUMMY_PB2 holds the source signal assignment that will be routed to the DAI_PIN5.DUMMY_PB2 destination. Refer to the Group DSignals table for source and destination mappings. |
| 13:7 (R/W)         | DUMMY_PB1  | Dummy Pin Buffer 1 Input. DAI_PIN5.DUMMY_PB1 holds the source signal assignment that will be routed to the DAI_PIN5.DUMMY_PB1 destination. Refer to the Group DSignals table for source and destination mappings. |
| 6:0 (R/W)          | DUMMY_PB0  | Dummy Pin Buffer 0 Input. DAI_PIN5.DUMMY_PB0 holds the source signal assignment that will be routed to the DAI_PIN5.DUMMY_PB0 destination. Refer to the Group DSignals table for source and destination mappings. |
...
Figure 29-98: DAI\_PIN\_STAT Register Diagram

![Image](32_Digital_Audio_Interface_(DAI)_artifacts/image_000096_8cb2d9986246807169a22fc5a9244dd96fa7fdb14bf207f4defaac91273145f3.png)

Table 29-105: DAI\_PIN\_STAT Register Fields
...
Table 29-105: DAI\_PIN\_STAT Register Fields (Continued)
