...
![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000000_7e6e0c432259a8ac11b72e8d28a7f56d307a04a9ebf4f9f798d5a8198f84ab4d.png)

## ADSP-2184x CRC Register List
...
of the code/data available in memory. A set of registers govern CRC operations. For more information on CRC functionality, see the CRC register descriptions.

Table 36-1: ADSP-2184x CRC Register List
...
## ADSP-2184x CRC Interrupt List

Table 36-2: ADSP-2184x CRC Interrupt List
...
![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000001_df06c99dc5c8645b533b4e8f3fbf6b1ecf6b100c6309686335ee483faceef79f.png)
...
The CRC compute-and-compare mode of operation requires both incoming and outgoing data channels. The operation occurs either using DMA channels, using core-driven write or read operations to and from the FIFO

or using a combination of both. The data fill mode of operation requires only a memory write DMA destination channel-this mode does not support core driven operations.
...
The CRC peripheral can generate two interrupt requests that are enabled as events to SEC1 for fault operations. One is a CRC status interrupt and the other is a CRC error interrupt.
...
2. ADDITIONAL INFORMATION: Perform this step only if counter expired interrupt is disabled. Polling

ensures that all the data has been processed.

9. Poll the CRC\_STAT.CMPERR bit if the interrupt was disabled to check for a compare error.
2. ADDITIONAL INFORMATION: Perform this step only if the compare error interrupt is not enabled.
...
2. ADDITIONAL INFORMATION: This value is used to reload the CRC\_DCNT register upon completion of current operation. If no further operation is needed, then this register can be initialized to zero.
3. Initialize the CRC\_RESULT\_CUR register. ADDITIONAL INFORMATION: This register can be initialized to provide an initial seed for the CRC operation that is about to take place.
...
2. ADDITIONAL INFORMATION: This step starts the data transfer from the memory region and writes the data to the CRC peripheral.
8. Poll the CRC\_STAT.DCNTEXP bit if the interrupt was disabled.
4. ADDITIONAL INFORMATION: Perform this step only if the counter expired interrupt is disabled. Polling
5. ensures all the data has been processed.
...
8. The CRC compute-and-compare operation is now complete. The CRC peripheral is ready to be configured for
...
2. Initialize the CRC\_DCNTRLD register.
2. ADDITIONAL INFORMATION: This value is used to reload the CRC\_DCNT register upon completion of
...
- b. Write the CRC\_DFIFO register with 32-bit data.
3. ADDITIONAL INFORMATION: Repeat these two steps until the entire memory region has been written to the CRC peripheral.
7. Poll the CRC\_INEN\_SET.DCNTEXP bit if the interrupt was disabled.
5. ADDITIONAL INFORMATION: Perform this step only if counter expired interrupt is disabled. Polling ensures all the data has been processed.
...
6. 5.
7. Initialize the CRC\_CTL register with the CRC\_CTL.OPMODE bit set to memory scan data verify mode and CRC\_CTL.BLKEN configured to enable the CRC peripheral. The CRC peripheral is now enabled and ready for the core or DMA channel to write the data.
...
9. Poll the CRC\_STAT.CMPERR bit if the interrupt was disabled to check for a compare error.
4. ADDITIONAL INFORMATION: Perform this step only if the compare error interrupt is not enabled.
10. Write the CRC\_STAT register to clear both CRC\_STAT.DCNTEXP and CRC\_STAT.CMPERR bits.
6. ADDITIONAL INFORMATION: If interrupts were enabled, then clear these status bits within the interrupt handlers for the respective interrupts.
...
8. Poll the
4. CRC\_STAT.DCNTEXP bit if the interrupt was disabled. ADDITIONAL INFORMATION: Perform this step only if counter expired interrupt is disabled. Polling ensures all the data has been processed.
9. Poll the CRC\_STAT.CMPERR bit if the interrupt was disabled to check for a compare error.

ADDITIONAL INFORMATION: Perform this step only if the compare error interrupt is not enabled.

10. Write the CRC\_STAT register to clear both the CRC\_STAT.DCNTEXP and the CRC\_STAT.CMPERR bits. ADDITIONAL INFORMATION: If interrupts were enabled, then clear these status bits within the interrupt handlers for the respective interrupts.
...
2. ADDITIONAL INFORMATION: This step starts the data transfer taking the constant 32-bit value from the CRC peripheral and writing the data to the DMA channel.
...
## ADSP-2184x CRC Register Descriptions

Cyclic Redundancy Check Unit (CRC) contains the following registers.

Table 36-4: ADSP-2184x CRC Register List
...
Table 36-4: ADSP-2184x CRC Register List (Continued)
...
Figure 36-3: CRC\_COMP Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000002_9ae05c3bc316132ed6b45b6ede7526f3bae18f1173d75b5d37f053f195f69ccf.png)

Table 36-5: CRC\_COMP Register Fields
...
Figure 36-4: CRC\_CTL Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000003_d3a98b368a99d7f86f98cc89fccd62d0617e5393cf7d6ea0079848317c521d24.png)

Table 36-6: CRC\_CTL Register Fields
...
| 21 (R/W)           | POLYMIRR   | Polynomial Register Mirroring. The CRC_CTL.POLYMIRR bit enables data mirroring for the CRC_POLY polyno- mial register. When enabled, the 32-bit value in this register is fully bit mirrored (reversed). The bit-reversed value is used for CRC computations.                   | Polynomial Register Mirroring. The CRC_CTL.POLYMIRR bit enables data mirroring for the CRC_POLY polyno- mial register. When enabled, the 32-bit value in this register is fully bit mirrored (reversed). The bit-reversed value is used for CRC computations.                   |
| 21 (R/W)           | POLYMIRR   | 0                                                                                                                                                                                                                                                                               | Disable polynomial mirroring                                                                                                                                                                                                                                                    |
| 21 (R/W)           | POLYMIRR   | 1                                                                                                                                                                                                                                                                               | Enable polynomial mirroring                                                                                                                                                                                                                                                     |

Table 36-6: CRC\_CTL Register Fields (Continued)
...
| 19 (R/W)           | FDSEL      | FIFO Data Select. The CRC_CTL.FDSEL bit selects whether the CRC writes modified or unmodi- fied data to the FIFO in memory transfer mode. If enabled, the data written is affected by the state of the data mirroring selections ( CRC_CTL.BITMIRR , CRC_CTL.BYTMIRR , and CRC_CTL.W16SWP ) before being written to the FIFO. |
...
| Bit No. (Access) Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          | Description/Enumeration                                                                                                                                                                                                                                                                                                                          |
|-----------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 12 (R/W) OBRSTALL           | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       | Output Buffer Ready Stall. The CRC_CTL.OBRSTALL bit enables stalling the state machine for input data when there is valid data in the output buffer. This feature should be used only in memory-to-memory transfer modes (for example, CRC_CTL.OPMODE =1).                                                                                       |
| 9 (R/W) AUTOCLRF            | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear | 1 Stall on OBR Auto Clear to One. The CRC_CTL.AUTOCLRF bit enables auto clear to one when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that the CRC_CTL.AUTOCLRZ bit must be disabled, or the CRC_CTL.AUTOCLRF bit has no effect. 0 No auto clear 1 Auto clear |
| 8 (R/W) AUTOCLRZ            | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       | Auto Clear to Zero. The CRC_CTL.AUTOCLRZ bit enables auto clear to zero when the CRC is in intermediate results ready stall mode ( CRC_CTL.IRRSTALL =1) and the CRC data count expires ( CRC_DCNT =0). Note that CRC_CTL.AUTOCLRF must be disabled, or the CRC_CTL.AUTOCLRZ has no effect.                                                       |
| 7:4 (R/W) OPMODE            | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 | 1 Auto clear Operation Mode. The CRC_CTL.OPMODE bit field selects the memory transfer or scan mode. 0 Reserved 1 CRC compute/compare memory transfer 2 Data fill memory transfer                                                                                                                                                                 |
|                             | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                | 3 CRC compute/compare memory scan                                                                                                                                                                                                                                                                                                                |
| 0 BLKEN                     | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      | Block Enable. The CRC_CTL.BLKEN bit enables and disables the CRC operation.                                                                                                                                                                                                                                                                      |
| (R/W)                       |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                  |
|                             | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        | 0 Disable                                                                                                                                                                                                                                                                                                                                        |
|                             | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         | 1 Enable                                                                                                                                                                                                                                                                                                                                         |
|                             | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        | 4 Data verify memory scan                                                                                                                                                                                                                                                                                                                        |
...
Figure 36-5: CRC\_DCNT Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000004_1f7967e0e22bcef14ac61a03adf82a4492372142f4a18856687adb9e406c31eb.png)

Table 36-7: CRC\_DCNT Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                |
|--------------------|------------|--------------------------------------------------------------------------------------------------------|
| 31:0 (R/W)         | VALUE      | Data Word Count. The CRC_DCNT.VALUE bit field holds the word count that is used for the CRC operation. |
...
Figure 36-6: CRC\_DCNTCAP Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000005_3e5111947169b3fcfe987fc5926153226500ee569435148eb532f1ee0b50dd14.png)

Table 36-8: CRC\_DCNTCAP Register Fields
...
Figure 36-7: CRC\_DCNTRLD Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000006_49629f86e3479f1460b7f21377bd415009891ec5a1eb5f616c7dd763b997b60e.png)

Table 36-9: CRC\_DCNTRLD Register Fields
...
Figure 36-8: CRC\_DFIFO Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000007_ac4c36d94cfae7fcb63ea35febaa9c74cd4e6b528b35a292aa4da1663c57b6a2.png)

Table 36-10: CRC\_DFIFO Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                         |
|--------------------|------------|-------------------------------------------------------------------------------------------------|
| 31:0 (R/W)         | VALUE      | Data FIFO Value. The CRC_DFIFO.VALUE bit field is the data from the DMAor processor core buses. |
...
Figure 36-9: CRC\_FILLVAL Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000008_2f6b2f35b2e8e10bca2b848eb4135a9c482be1cd16d8ddc6b1c0122a8cb2c99f.png)

Table 36-11: CRC\_FILLVAL Register Fields
...
Figure 36-10: CRC\_INEN Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000009_7e928bc8cc66d12f6ac53e56767031f1a79c44a42f2005a5e9b555c1f9db5960.png)

Table 36-12: CRC\_INEN Register Fields
...
Figure 36-11: CRC\_INEN\_CLR Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000010_9bceeab89c2d92fb295f170ef319dbc1a31fee5943be539a9d4c0775213c216d.png)

Table 36-13: CRC\_INEN\_CLR Register Fields
...
Figure 36-12: CRC\_INEN\_SET Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000011_d53e92e9bf4daabc4d804e24fedf5a4306006420c98534fbbb27f6e51ac2ad9d.png)

Table 36-14: CRC\_INEN\_SET Register Fields
...
Figure 36-13: CRC\_POLY Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000012_8ac3442b00607a252ba66960d99fcc809cdfe24ece72fce7e09ed81e705dc3cc.png)

Table 36-15: CRC\_POLY Register Fields
...
Figure 36-14: CRC\_RESULT\_CUR Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000013_ff3c27dea9e41f654f71ea1b6b07c464373baab28a79422fc240c2076b9d19c8.png)

Table 36-16: CRC\_RESULT\_CUR Register Fields
...
Figure 36-15: CRC\_RESULT\_FIN Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000014_2dde4bfeaecc806ad96e5b0e4062599bc4125ac36c401afb6eddef65907a95ec.png)

Table 36-17: CRC\_RESULT\_FIN Register Fields
...
Figure 36-16: CRC\_STAT Register Diagram

![Image](39_Cyclic_Redundancy_Check_(CRC)_artifacts/image_000015_72c44f2b5ea43b4c27a7f7fd2f2fcb8af7c1f94bbd003a579406e0d90f22e691.png)

Table 36-18: CRC\_STAT Register Fields
...
| 19 (R/NW)          | LUTDONE    | Look-Up Table Done. The CRC_STAT.LUTDONE bit indicates that the CRC has generated the look-up table for the current polynomial. This read-only bit is cleared at reset and cleared when the CRC_POLY is written. No status |
| 19 (R/NW)          | LUTDONE    | 0                                                                                                                                                                                                                          |
| 19 (R/NW)          | LUTDONE    | 1 LUT generation done                                                                                                                                                                                                      |

Table 36-18: CRC\_STAT Register Fields (Continued)

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                                                                                                                                 |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 18 (R/NW)          | IRR        | Intermediate Result Ready. The CRC_STAT.IRR bit indicates that the CRC has updated the CRC_RESULT_CUR register with intermediate CRC results for the new data written to the CRC. The processor core should read from the CRC_RESULT_CUR register only after detecting CRC_STAT.IRR =1. This read-only bit is cleared by CRC                                                                            |
