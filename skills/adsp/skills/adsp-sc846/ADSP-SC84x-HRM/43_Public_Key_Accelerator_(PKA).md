...
Table 40-1: ADSP-2184x PKA Register List
...
![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000000_6263e663e02e8369e5cee8f390df5114be9ee5715af03858c053b22c71f26fb4.png)
...
Table 40-8: ExpMod Result Vector/Scratchpad Area Memory Allocation Starting at PKA\_DPTR
...
| Function                                | Result Vector   | Restrictions                                                                                                                                                                                      |
|-----------------------------------------|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ExpMod-ACT2 ExpMod-ACT4 ExpMod-variable | D               | Scratchpad area starting at Dmay not overlap with any of the other vectors, except that base C may be co-located with result vector Dto save space (for example, PKA_CPTR = PKA_DPTR is allowed). |
| ExpMod-CRT                              | D               | Scratchpad area starting at Dmay not overlap with any of the other vectors. This area is also the location of the main input vector (with length 2 x B_Len)                                       |
...
Table 40-13: PKA\_SHIFT Result Values for ModInv Operation
...
Table 40-16: ModInv Result Vector/Scratchpad Area Memory Allocation (Both Starting at PKA\_DPTR)
...
Table 40-18: PKA\_SHIFT Result Values for ECC Operations
...
| Function        | Result Vector   | Restrictions                                                               |
|-----------------|-----------------|----------------------------------------------------------------------------|
| ECC-ADD ECC-MUL | D               | Scratchpad area starting at Dmay not overlap with any of the other vectors |

The &gt;ECC Result Vector/Scratchpad Area Memory Allocation table shows the required scratchpad sizes for the ECC operations:

Table 40-21: ECC Result Vector/Scratchpad Area Memory Allocation (Both Starting at PKA\_DPTR)
...
## ADSP-2184x PKA Register Descriptions

Public Key Accelerator (PKA) contains the following registers.

Table 40-23: ADSP-2184x PKA Register List
...
Figure 40-2: PKA\_ALEN Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000001_11b94780702cb9b05c26b9fecfb0de019d04bdc1c46d41d8687441ba1b60cec3.png)

Table 40-24: PKA\_ALEN Register Fields
...
Figure 40-3: PKA\_APTR Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000002_ae2ecab77d44413bf25138f3d0d31a6cdca8d88ad2c4b0a8c9da693067545efd.png)

Table 40-25: PKA\_APTR Register Fields
...
Figure 40-4: PKA\_BLEN Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000003_3b4433f4859253ccd8be2e74abcdc43027e57d0736ecd20e546a2bab112b0f65.png)

Table 40-26: PKA\_BLEN Register Fields
...
Figure 40-5: PKA\_BPTR Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000004_6ebca15b10e9b8f3b09c4b43f9f2973e5f803c40e3b850a2eb0c3196beb02230.png)

Table 40-27: PKA\_BPTR Register Fields
...
Figure 40-6: PKA\_COMPARE Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000005_6da67ff72ea98dfe00455378e6fc098a3570b8d7bca308b4deb7b1fd70b78181.png)

Table 40-28: PKA\_COMPARE Register Fields
...
Figure 40-7: PKA\_CPTR Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000006_0f4769c938c0ec266c1f3379956d6ac36e4cffdc34e022aac283005f25f7906b.png)

Table 40-29: PKA\_CPTR Register Fields
...
The PKA\_DIVMSW register indicates the (32-bit word) address in the PKA RAM where the most significant non-zero 32-bit word of the Remainder result for the basic Divide and Modulo operations is stored. Bits [4:0] are loaded with the bit number of the most significant non-zero bit in the most significant non-zero word when MS one control bit is set. For Divide, Modulo and MS one reporting, this register is updated when the PKA\_FUNC.RUN bit is reset at the end of the operation.
...
Figure 40-8: PKA\_DIVMSW Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000007_1e1d42f81a75db1ebc738bc0b9557ae94c909f4d60ada029d9671ff530e649c2.png)

Table 40-30: PKA\_DIVMSW Register Fields
...
Figure 40-9: PKA\_DPTR Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000008_fecd18a86d276ece75479e9421641862d7cc3cc6e71b5656e1aca8530698ae7b.png)

Table 40-31: PKA\_DPTR Register Fields
...
![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000009_262f6f7dffce9655aeb4ce1ffa5a8ee3548aa1322301149c6abe99447f6069ae.png)

Stall Result

Figure 40-10: PKA\_FUNC Register Diagram

Table 40-32: PKA\_FUNC Register Fields

| Bit No. (Access)   | Bit Name   | Description/Enumeration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Description/Enumeration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|--------------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 24                 | STALLRSLT  | Stall Result.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Stall Result.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 15 (R/W)           | RUN        | operations. Run. Set the PKA_FUNC.RUN bit to instruct the PKA module to begin processing the basic PKCP or complex sequencer operation. This bit is reset low automatically when the operation is complete. The complement of this bit is output as the pkaint1 interrupt. After a reset, the run bit is always set to 1b but the first sequencer firmware instruction sets this bit to 0 immediately after the hardware reset is released. A few clock cycles are needed before the first instruction is executed and the run bit state has been propagated. | operations. Run. Set the PKA_FUNC.RUN bit to instruct the PKA module to begin processing the basic PKCP or complex sequencer operation. This bit is reset low automatically when the operation is complete. The complement of this bit is output as the pkaint1 interrupt. After a reset, the run bit is always set to 1b but the first sequencer firmware instruction sets this bit to 0 immediately after the hardware reset is released. A few clock cycles are needed before the first instruction is executed and the run bit state has been propagated. |
...
Table 40-32: PKA\_FUNC Register Fields (Continued)
...
| 3 (R/W)            | MSONE      | Most Significant One. Setting the PKA_FUNC.MSONE bit loads the location of the most significant one bit within the result word indicated in the PKA_RESULTMSW register into bits [4:0] of the PKA_DIVMSW register; it can only be used with basic PKCP operations, except for divide, modulo and compare. |
...
Figure 40-11: PKA\_RAM Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000010_14d3c336b4b90f3fe6ae2bb4c07d296357dec6dc638757c76dd87374a6ff6d64.png)

Table 40-33: PKA\_RAM Register Fields
...
Figure 40-12: PKA\_RESULTMSW Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000011_43bf208ca1a56e1fa5f987ee0b5e742f01863df0dd252db17bb97de00cf16e98.png)

Table 40-34: PKA\_RESULTMSW Register Fields
...
Figure 40-13: PKA\_SHIFT Register Diagram

![Image](43_Public_Key_Accelerator_(PKA)_artifacts/image_000012_9d98deaad48fca1e90e02bc4ec8d2bdea75547dbfac42e0817b840438b54d6ae.png)

Table 40-35: PKA\_SHIFT Register Fields
