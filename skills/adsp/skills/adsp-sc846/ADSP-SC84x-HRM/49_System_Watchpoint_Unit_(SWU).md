## 46   System Watchpoint Unit (SWU)

The system watchpoint unit (SWU) is a single module used for transaction monitoring. The SWU is attached to each system completer through the system crossbar interface and provides ports for all address channel signals for the system crossbar. The SWU does not have ports for the read/write data channel signals or the low-power interface signals.
...
In this chapter, the naming convention for registers omit the numeric reference to any of the SWUs or it's groups. For example, SWU\_GCTL represents registers SWU1\_GCTL, SWU2\_GCTL, and so on. Similarly, SWU\_CUR[n] represents SWU1\_CUR0/CUR1/CUR2/CUR3, SWU2\_CUR0/CUR1/CUR2/CUR3 and so on.
...
NOTE: In the SWU Interrupt List table, there are three SWUs, SWU1 (CL2\_0), SWU3 (CL2\_1) and SWU5 (CL2\_2) for L2 Memory Core access and two SWUs, SWU2 (DL2\_0) and SWU4 (DL2\_1) for L2 Memory DMA access. CL2\_2, DL2\_0 and DL2\_1 have access to the entire L2 range. CL2\_0 has access to first 1MB and CL2\_1 has access to second 1MB of L2.

## ADSP-2184x SWU Register List

The System Watchpoint Unit (SWU) provides debug and development support through flexible transaction level and bandwidth monitoring and associated event triggering. The SWU can generate events based on monitoring transactions at the system targets through watchpoint-match groups. The SWU also provides watchpoint event

status reporting, a global lock, and processor reset capability. A set of registers governs SWU operations. For more information on SWU functionality, see the SWU register descriptions.

Table 46-1: ADSP-2184x SWU Register List
...
## ADSP-2184x SWU Interrupt List

Table 46-2: ADSP-2184x SWU Interrupt List
...
## ADSP-2184x SWU Trigger List

Table 46-3: ADSP-2184x SWU Trigger List Generators
...
Table 46-4: ADSP-2184x SWU Trigger List Receivers
...
Table 46-4: ADSP-2184x SWU Trigger List Receivers (Continued)
...
Figure 46-1: System Watchpoint Unit Top-Level Block Diagram

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000000_e4e1bfa2d77dde6f794264fa58d6e47fc9fe246c7a8a8002ab4774373e6ce615.png)
...
Do not use scaling by 10 with the SWU\_CTL[n].BLENINC bit enabled if any of the requesters accessing the completer can launch a transaction of burst length 16.
...
The SWU can be either a trigger generator or a trigger receiver depending on the trigger routing unit (TRU) configuration. As a trigger generator, programs must set the SWU\_CTL[n].TRGEN bit so that when a match condition is met, a trigger event is generated. Each SWU in the system can also be a trigger receiver when mapped as one in the TRU.

When the SWU is a receiver, a trigger event activates the SWU by automatically setting the SWU\_GCTL.EN bit. Since the SWU can be automatically enabled through a trigger event, programs must pre-configure the SWU before enabling the TRU. Furthermore, although a trigger event can enable the SWU as a generator, to disable the SWU, programs must manually clear the SWU\_GCTL.EN bit.
...
Figure 46-2: SWU Logical Flow

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000001_439de3fd1f0cc347e0df3bba8a8c48ccd831e73a0b2511e2178d031eaf7a8ef5.png)
...
## ADSP-2184x SWU Register Descriptions

System Watchpoint Unit (SWU) contains the following registers.

Table 46-5: ADSP-2184x SWU Register List
...
Figure 46-3: SWU\_CNT[n] Register Diagram

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000002_d8733da89abf4ae91ddb39bb6d4f512657ad4bf9850b14ab4cf98b564897de5b.png)

Table 46-6: SWU\_CNT[n] Register Fields
...
Figure 46-4: SWU\_CTL[n] Register Diagram

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000003_1b818f71232eeaeec792a02bb358b58f8f6920bcc449e92f864b250902eb7b68.png)

Table 46-7: SWU\_CTL[n] Register Fields
...
| 9 (R/W)            | CNTRPTEN   | Count Repeat Enable. Each SWU_CTL[n].CNTRPTEN bit controls whether the watchpoint group's cycle count is reloaded and repeated after cycle countdown. If the SWU_CTL[n] register's SWU_CTL[n].CNTRPTEN bit is set, the SWU_CUR[n] register's SWU_CUR[n].CURCNT field is reloaded from SWU_CNT[n] reg- ister's SWU_CNT[n].COUNT field, and the countdown starts again. If SWU_CTL[n].CNTRPTEN bit is cleared, the expired count remains zero, and no further events are signalled. (See the SWU_CTL[n].CNTEN bit description for infor- mation regarding the countdown setup.) 0 Disable |
| 8 (R/W)            | CNTEN      | 1 Enable Count Enable. Each SWU_CTL[n].CNTEN bit controls whether the cycle count in the watch- point group's SWU_CNT[n] register is decremented each cycle until it reaches zero. This feature is only valid in watchpoint mode ( SWU_CTL[n].BWEN bit == 0).When the count reaches zero, any enabled watchpoint events are triggered. (See the SWU_CTL[n].CNTRPTEN bit description for optional actions at that may occur at                                                                                                                                                           |
| 5 (R/W)            | SCMPEN     | 1 Enable Secure Comparison Enable. Each SWU_CTL[n].SCMPEN bit controls secure transaction comparison operation of an SWU watchpoint group, permitting matches based on transaction security.                                                                                                                                                                                                                                                                                                                                                                                            |
| 4 (R/W)            |            | 0 Match on all transaction 1 Match only secure transactions                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|                    | IDCMPEN    | ID Comparison Enable. Each SWU_CTL[n].IDCMPEN bit controls the ID comparison operation of an SWU watchpoint group. The ID match is based on comparison with the value in the SWU_ID[n] register.                                                                                                                                                                                                                                                                                                                                                                                        |
...
| 3:2 (R/W)          | ACMPM      | 0 No address comparison                                                                                                                                                                                                                                                                                                                                                                                                     |
| 3:2 (R/W)          | ACMPM      | 1 Exact match on LAn                                                                                                                                                                                                                                                                                                                                                                                                        |
| 3:2 (R/W)          | ACMPM      | 2 Match on address within range                                                                                                                                                                                                                                                                                                                                                                                             |
| 3:2 (R/W)          | ACMPM      | 3 Match on address outside range                                                                                                                                                                                                                                                                                                                                                                                            |
...
Figure 46-5: SWU\_CUR[n] Register Diagram

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000004_5c69d7743632f96405f1966b9491ce9f5235e28c4e07c7e9955e8c0c2d6f8aae.png)

Table 46-8: SWU\_CUR[n] Register Fields
...
Figure 46-6: SWU\_GCTL Register Diagram

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000005_0f842476b77866cde89eb5935f95cdb845e7a66ec2e3a457b51ef3c4abf8f44a.png)

Table 46-9: SWU\_GCTL Register Fields
...
| 0 (R/W)            | EN         | Global Enable. The SWU_GCTL.EN controls the SWU operational state. Clearing SWU_GCTL.EN halts the execution of all watchpoint and bandwidth tracking operations without resetting status registers or associated signals. Setting SWU_GCTL.EN enables the SWU to begin/resume operation with the current configuration and status. 0 Disable 1 Enable |

## Global Status Register

The SWU global status register ( SWU\_GSTAT ) contains status bits for all four watchpoint groups.

Figure 46-7: SWU\_GSTAT Register Diagram

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000006_d59ac556e4d0101f4bbbe85cc626e784186221be57fa543302568990a87ad26f.png)

Table 46-10: SWU\_GSTAT Register Fields
...
Table 46-10: SWU\_GSTAT Register Fields (Continued)
...
| 8 (R/W1C)          | UNDRBW0    | 0 Group 0 was not below minimum bandwidth                                                                                                                                                                                                                                                                                                                                 |
| 7 (R/W1C)          | INT3       | Group 3 Interrupt Status. See SWU_GSTAT.INT0 description.                                                                                                                                                                                                                                                                                                                 |
| 7 (R/W1C)          | INT3       | 0 No Interrupt                                                                                                                                                                                                                                                                                                                                                            |
| 7 (R/W1C)          | INT3       | 1 Interrupt Occurred                                                                                                                                                                                                                                                                                                                                                      |
| 6 (R/W1C)          | INT2       | Group 2 Interrupt Status. See SWU_GSTAT.INT0 description.                                                                                                                                                                                                                                                                                                                 |
| 6 (R/W1C)          | INT2       | 0 No Interrupt                                                                                                                                                                                                                                                                                                                                                            |
| 6 (R/W1C)          | INT2       | 1 Interrupt Occurred                                                                                                                                                                                                                                                                                                                                                      |
| 5 (R/W1C)          | INT1       | Group 1 Interrupt Status. See SWU_GSTAT.INT0 description.                                                                                                                                                                                                                                                                                                                 |
| 5 (R/W1C)          | INT1       | 0 No Interrupt                                                                                                                                                                                                                                                                                                                                                            |
...
| 4 (R/W1C)          | INT0       | 0 No interrupt                                                                                                                                                                                                                                                                                                                                                            |
| 4 (R/W1C)          | INT0       | 1 Interrupt Occurred                                                                                                                                                                                                                                                                                                                                                      |
| 3 (R/W1C)          | MTCH3      | Group 3 Match. See SWU_GSTAT.MTCH0 description.                                                                                                                                                                                                                                                                                                                           |
| 3 (R/W1C)          | MTCH3      | 0 No Match                                                                                                                                                                                                                                                                                                                                                                |
| 3 (R/W1C)          | MTCH3      | 1 Group 3 Watchpoint Match                                                                                                                                                                                                                                                                                                                                                |
...
| 0 (R/W1C)          | MTCH0      | Group 0 Match. The SWU_GSTAT.MTCH0 - SWU_GSTAT.MTCH3 -- Group 0 through 3 match bits. Each match bit indicates (for each group) whether a watchpoint match has occurred in a SWU watchpoint group, as controlled by the group's related watchpoint control register ( SWU_CTL[n] ). This status bit is sticky; write-1-to-clear it. 0 No match |
...
![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000007_23c6887780d9d4e7151cf787b5a1b307629e192b4499ce0a47c42325b1c74c85.png)

Bandwidth from Window Before Last

Figure 46-8: SWU\_HIST[n] Register Diagram

Table 46-11: SWU\_HIST[n] Register Fields
...
Figure 46-9: SWU\_ID[n] Register Diagram

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000008_bc8cd67e1e72edc70b11bad26edeb584b258eb2e2e6e6800fa006143955d0065.png)

Table 46-12: SWU\_ID[n] Register Fields
...
Figure 46-10: SWU\_LA[n] Register Diagram

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000009_8d96db870bdd1e111fa2aa9467653f22081b5622e5a69870abb4f62a3f8af068.png)

Table 46-13: SWU\_LA[n] Register Fields
...
Figure 46-11: SWU\_TARG[n] Register Diagram

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000010_837973f536e0d8db4a47d94b28cf25c754610c7e336afa290518c475118d7bff.png)

Table 46-14: SWU\_TARG[n] Register Fields
...
Figure 46-12: SWU\_UA[n] Register Diagram

![Image](49_System_Watchpoint_Unit_(SWU)_artifacts/image_000011_7859f80a30d15a707e7cb683f9ac9b0ce6f8e5c0bd0b5bc75d76a27855a2ee04.png)

Table 46-15: SWU\_UA[n] Register Fields
